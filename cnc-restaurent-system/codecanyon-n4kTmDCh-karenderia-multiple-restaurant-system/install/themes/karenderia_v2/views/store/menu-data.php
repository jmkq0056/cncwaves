...
<section v-cloak v-for="val in menu_data" :id="val.category_uiid" :data-cat_id="val.cat_id">
    ...
    <div class="col-9 p-0">                
        <div class="row m-0 p-0">
            ...
            <el-button size="large" :disabled="!isEligibleItem(items)" :color="isEligibleItem(items) ? '#f17d00' :'#b2b2b2' " @click="viewItemBefore({cat_id:val.cat_id,item_uuid:items.item_uuid})" class="white-color" >                                      
                <?php echo t("Add to cart")?>
            </el-button>             
