                    ...
                    <div class="d-flex align-items-start flex-column" >
                        ...
                        <div class="d-flex justify-content-between align-items-center w-100">
                            ...
                            <div>                                
                                ...
                                <template v-else>                                    
                                    <el-button :disabled="!isEligible(items)" :color="isEligible(items) ? '#f17d00' :'#b2b2b2' " @click="viewItem({cat_id:items.cat_id,item_uuid:items.item_uuid})" class="white-color">
                                    <?php echo t("Add")?>
                                    </el-button>
                                </template>
                            </div>
