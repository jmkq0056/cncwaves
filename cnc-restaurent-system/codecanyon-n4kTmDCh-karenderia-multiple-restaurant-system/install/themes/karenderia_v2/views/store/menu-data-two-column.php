                  ...
                  <div class="row align-items-center">
                      ...
                      <div class="col-6 text-right">
                            ...
                            <template v-if="itemAvailable(items.item_id,val.cat_id)">
                                <template v-if="items.total_addon <=0 && items.total_meta <=1 && items.price.length<=1 ">
                                    ...
                                    <template v-if=" items.qty>0 " >
                                        ...
                                        <div class="quantity-parent">
                                            ...
                                            <el-button @click.stop="updateInlineQtyBefore('less',items,val.cat_id)" color="#f17d00" class="white-color" circle>
                                               <i class="zmdi zmdi-minus font20"></i>
                                            </el-button>
                                            <div class="qty">{{ items.qty }}</div>                                            
                                            <el-button @click.stop="updateInlineQtyBefore('add',items,val.cat_id)" color="#f17d00" class="white-color" circle>
                                    ...
                                    <template v-else=" items<=0 " >  
                                        <?php if($disabled_inline_addtocart):?>
                                            <el-button @click="viewItemBefore({cat_id:val.cat_id,item_uuid:items.item_uuid})" color="#f17d00" class="white-color" circle>
                                              <i class="zmdi zmdi-plus font20"></i>
                                            </el-button>
                                        <?php else :?>                                                                                        
                                            <el-button @click="updateInlineQtyBefore('add',items,val.cat_id)"  color="#f17d00" class="white-color" circle>
                                               <i class="zmdi zmdi-plus font20"></i>
                                            </el-button>
                                        <?php endif;?> 
                                    </template>
                                ...
                                <template v-else>                                                                  
                                    <el-button :disabled="!isEligibleItem(items)" :color="isEligibleItem(items) ? '#f17d00' :'#b2b2b2' " @click="viewItemBefore({cat_id:val.cat_id,item_uuid:items.item_uuid})" class="white-color" circle >                                      
                                      <i class="zmdi zmdi-plus font20"></i>
                                    </el-button>
                                </template>
                            </template>
