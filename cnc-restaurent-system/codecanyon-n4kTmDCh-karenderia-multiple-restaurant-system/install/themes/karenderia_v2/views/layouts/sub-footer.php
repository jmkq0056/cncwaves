  ...
  <div class="container">
    ...
    <div class="row align-items-center">
      <div class="col-lg-8 col-md-7 mb-3 mb-md-0">
        <div style="border-radius:12px; overflow:hidden; box-shadow:0 2px 12px rgba(0,0,0,0.1);">
          <iframe
            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCL2EoyEg7aw6rVo90aIue6fmJgm8PcIAU&q=Over+B%C3%B8lgen+3,+2670+Greve,+Denmark&zoom=16&language=da"
            width="100%"
            height="300"
