...
/* items.html */
class __TwigTemplate_a00f9b95b4e4653cfbcf403dc3f59445ac40a32f153f4ab8425508a24124408d extends Template
{
    private $source;
    private $macros = [];
 ...
 <tr>
  ...
  ";
            // line 23
            if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "price", [], "any", false, false, false, 23), "discount", [], "any", false, false, false, 23) > 0)) {
                // line 24
                echo "    <del>";
  ...
  ";
   ...
   ";
            // line 29
            if ((twig_get_attribute($this->env, $this->source, $context["item"], "item_changes", [], "any", false, false, false, 29) == "replacement")) {
                // line 30
                echo "   <br>Replacement
   <br/>Replace \"";
                // line 31
  ...
  ";
     ...
     ";
             ...
             ";
                        // line 43
                        if (($context["attributes_index"] < (twig_get_attribute($this->env, $this->source, $context["attributes"], "length", [], "any", false, false, false, 43) - 1))) {
                            // line 44
                            echo "             ,
             ";
                        }
  ...
  <td>
   ";
            // line 53
            if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "price", [], "any", false, false, false, 53), "discount", [], "any", false, false, false, 53) > 0)) {
                // line 54
                echo "    ";
...
";
 ...
 <tr class=\"summary_order\">
  ...
  <td style=\"padding:0 20px 0;\">
      ...
      ";
            // line 101
            if ((twig_get_attribute($this->env, $this->source, $context["summary"], "type", [], "any", false, false, false, 101) == "total")) {
                echo "  
       <b>";
                // line 102
  ...
  <td>
     ...
     ";
            // line 110
            if ((twig_get_attribute($this->env, $this->source, $context["summary"], "type", [], "any", false, false, false, 110) == "total")) {
                echo "  
     <b>";
                // line 111
...
</table>", "items.html", "/var/www/html/backoffice/twig/items.html");
    }
}
