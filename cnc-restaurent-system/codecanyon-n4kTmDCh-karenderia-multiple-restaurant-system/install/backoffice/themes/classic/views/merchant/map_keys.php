...
<div class="form-label-group">    
   <?php echo $form->textField($model,'merchant_google_maps_api_key_for_mobile',array(
     'class'=>"form-control form-control-text",
     'placeholder'=>$form->label($model,'merchant_google_maps_api_key_for_mobile')     
   )); ?>   
   <?php    
    echo $form->label($model,'merchant_google_maps_api_key_for_mobile'); ?>
   <?php echo $form->error($model,'merchant_google_maps_api_key_for_mobile'); ?>   
</div>
