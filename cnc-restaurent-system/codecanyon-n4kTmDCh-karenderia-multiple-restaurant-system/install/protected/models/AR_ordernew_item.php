...
{	
	...
	public $quantity_sold,$total_sales,$percent_of_total;
	...
	public function rules()
	{
		 return array(
            ...
            array('special_instructions,discount,discount_type,
			kot_status,voided_by,voided_at,void_reason,merchant_price,commission_amount,merchant_earning
			','safe'),
