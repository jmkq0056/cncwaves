...
class CMaps{
	...
	{		
		...
		if(isset(Yii::app()->params['settings']['map_provider'])){
			...
			$map_custom_style = isset(Yii::app()->params['settings']['map_custom_style'])? (!empty(Yii::app()->params['settings']['map_custom_style'])?Yii::app()->params['settings']['map_custom_style']:'') :'';
