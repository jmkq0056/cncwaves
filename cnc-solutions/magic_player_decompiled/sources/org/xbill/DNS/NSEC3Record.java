...
public class NSEC3Record extends Record {
    ...
    public static byte[] hashName(Name name, int i4, int i5, byte[] bArr) throws NoSuchAlgorithmException {
        if (i4 != 1) {
            throw new NoSuchAlgorithmException(v2.a.a("Unknown NSEC3 algorithmidentifier: ", i4));
        }
    ...
    public NSEC3Record(Name name, int i4, long j4, int i5, int i6, int i7, byte[] bArr, byte[] bArr2, int[] iArr) {
        super(name, 50, i4, j4);
