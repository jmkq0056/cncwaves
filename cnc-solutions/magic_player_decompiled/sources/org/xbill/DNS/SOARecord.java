...
public class SOARecord extends Record {
    ...
    public void rrToWire(DNSOutput dNSOutput, Compression compression, boolean z3) {
        this.host.toWire(dNSOutput, compression, z3);
        this.admin.toWire(dNSOutput, compression, z3);
    ...
    public SOARecord(Name name, int i4, long j4, Name name2, Name name3, long j5, long j6, long j7, long j8, long j9) {
        super(name, 6, i4, j4);
        this.host = Record.checkName("host", name2);
        this.admin = Record.checkName("admin", name3);
        this.serial = Record.checkU32("serial", j5);
        this.refresh = Record.checkU32("refresh", j6);
        this.retry = Record.checkU32("retry", j7);
        this.expire = Record.checkU32("expire", j8);
        this.minimum = Record.checkU32("minimum", j9);
    }
}
