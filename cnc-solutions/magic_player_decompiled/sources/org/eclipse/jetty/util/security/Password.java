...
public class Password extends Credential {
    ...
    public static String deobfuscate(String str) {
        ...
        while (i4 < str.length()) {
            int i6 = i4 + 4;
            int i7 = Integer.parseInt(str.substring(i4, i6), 36);
            bArr[i5] = (byte) ((((i7 / 256) + (i7 % 256)) - 254) / 2);
            i4 = i6;
            i5++;
        }
    ...
    */
    ...
    public static String obfuscate(String str) {
        ...
        while (i4 < bytes.length) {
            byte b4 = bytes[i4];
            i4++;
            byte b5 = bytes[str.length() - i4];
            int i5 = b4 + 127;
            String string = Integer.toString(((i5 + b5) * 256) + (i5 - b5), 36);
