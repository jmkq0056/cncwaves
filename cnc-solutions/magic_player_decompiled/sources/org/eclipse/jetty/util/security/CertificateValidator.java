...
public class CertificateValidator {
    ...
    public void validate(KeyStore keyStore) throws CertificateException {
        try {
            ...
            throw new CertificateException("Unable to retrieve aliases from keystore", e4);
        }
    }
    ...
    public String validate(KeyStore keyStore, String str) throws CertificateException {
        ...
        try {
            ...
            LOG.debug(e4);
            StringBuilder sbA = b.a("Unable to validate certificate for alias [", str, "]: ");
            sbA.append(e4.getMessage());
            throw new CertificateException(sbA.toString(), e4);
        }
    }
    ...
    public void validate(KeyStore keyStore, Certificate certificate) throws CertificateException {
        ...
        try {
            ...
            LOG.debug(e4);
            StringBuilder sbA = f.a("Unable to validate certificate");
            sbA.append(0 == 0 ? "" : h.a(" for alias [", null, "]"));
            sbA.append(": ");
            sbA.append(e4.getMessage());
            throw new CertificateException(sbA.toString(), e4);
        }
