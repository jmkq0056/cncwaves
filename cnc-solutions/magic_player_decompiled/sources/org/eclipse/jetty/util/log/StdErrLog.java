...
public class StdErrLog extends AbstractLogger {
    ...
    public static String condensePackageString(String str) {
        ...
        for (int i4 = 0; i4 < strArrSplit.length - 1; i4++) {
            sb.append(strArrSplit[i4].charAt(0));
        }
        if (sb.length() > 0) {
            sb.append('.');
        }
    ...
    private void tag(StringBuilder sb, String str, int i4, String str2) {
        sb.setLength(0);
        sb.append(str);
        if (i4 > 99) {
            sb.append('.');
    ...
    public void setHideStacks(boolean z3) {
        this._hideStacks = z3;
    }
    ...
    public void setPrintLongNames(boolean z3) {
        this._printLongNames = z3;
    }

    public void setSource(boolean z3) {
        this._source = z3;
    }
    ...
    public String toString() {
        StringBuilder sbA = f.a("StdErrLog:");
    ...
    private void format(StringBuilder sb, String str, Object... objArr) {
        ...
        for (Object obj : objArr) {
            int iIndexOf = str.indexOf(MessageFormatter.DELIM_STR, length);
            if (iIndexOf < 0) {
    ...
    private void format(StringBuilder sb, Throwable th) {
        ...
        for (int i4 = 0; stackTrace != null && i4 < stackTrace.length; i4++) {
            sb.append(EOL);
            sb.append("\tat ");
            format(sb, stackTrace[i4].toString(), new Object[0]);
        }
