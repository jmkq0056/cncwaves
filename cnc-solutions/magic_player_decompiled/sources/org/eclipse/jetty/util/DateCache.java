...
public class DateCache {
    ...
    private void setMinFormatString() {
        ...
        this._minFormatString = h.a(this._tzFormatString.substring(0, iIndexOf), "'ss'", this._tzFormatString.substring(iIndexOf + 2));
    }
    ...
    public synchronized String format(long j4) {
        long j5 = j4 / 1000;
        long j6 = this._lastSeconds;
        if (j5 >= j6 && (j6 <= 0 || j5 <= __hitWindow + j6)) {
            if (j6 == j5) {
                return this._lastResult;
            }
            Date date = new Date(j4);
            long j7 = j5 / 60;
            if (this._lastMinutes != j7) {
                this._lastMinutes = j7;
        ...
        return this._tzFormat.format(new Date(j4));
    }
    ...
    public void format(long j4, StringBuilder sb) {
        sb.append(format(j4));
    }
}
