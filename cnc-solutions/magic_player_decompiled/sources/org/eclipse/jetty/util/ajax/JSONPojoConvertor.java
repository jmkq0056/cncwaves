...
public class JSONPojoConvertor implements JSON.Convertor {
    ...
    public static class Setter {
        ...
        public void invokeObject(Object obj, Object obj2) throws IllegalAccessException, InvocationTargetException {
            ...
            if (this._numberType == null) {
                ...
                try {
                    ...
                    JSONPojoConvertor.LOG.ignore(e4);
                    this._setter.invoke(obj, obj2);
                    return;
                }
            }
            ...
            for (int i4 = 0; i4 < objArr.length; i4++) {
                try {
                    Array.set(objNewInstance2, i4, this._numberType.getActualValue((Number) objArr[i4]));
                } catch (Exception e5) {
                    JSONPojoConvertor.LOG.ignore(e5);
                    this._setter.invoke(obj, obj2);
                    return;
                }
            }
    ...
    public JSONPojoConvertor(Class<?> cls, Set<String> set, boolean z3) {
    ...
    public JSONPojoConvertor(Class<?> cls, boolean z3) {
        this(cls, null, z3);
    }
}
