...
public class MultiMap<K> implements ConcurrentMap<K, Object>, Serializable {
    ...
    public void add(K k4, Object obj) {
        Object obj2 = this._map.get(k4);
        Object objAdd = LazyList.add(obj2, obj);
        if (obj2 != objAdd) {
            this._map.put(k4, objAdd);
        }
    }

    public void addValues(K k4, List<? extends Object> list) {
        Object obj = this._map.get(k4);
        Object objAddCollection = LazyList.addCollection(obj, list);
        if (obj != objAddCollection) {
            this._map.put(k4, objAddCollection);
        }
    }
    ...
    public String getString(Object obj) {
        ...
        for (int i4 = 0; i4 < LazyList.size(obj2); i4++) {
            Object obj4 = LazyList.get(obj2, i4);
            if (obj4 != null) {
                if (sb.length() > 0) {
                    sb.append(',');
                }
    ...
    public Object getValue(Object obj, int i4) {
        Object obj2 = this._map.get(obj);
        if (i4 == 0 && LazyList.size(obj2) == 0) {
            return null;
        }
        return LazyList.get(obj2, i4);
    }
    ...
    @Override // java.util.Map
    public Object put(K k4, Object obj) {
        return this._map.put(k4, LazyList.add(null, obj));
    }
    ...
    public Object putIfAbsent(K k4, Object obj) {
        ConcurrentMap<K, Object> concurrentMap = this._cmap;
        if (concurrentMap != null) {
            return concurrentMap.putIfAbsent(k4, obj);
        }
        throw new UnsupportedOperationException();
    }

    public Object putValues(K k4, List<? extends Object> list) {
        return this._map.put(k4, list);
    }
    ...
    public boolean removeValue(K k4, Object obj) {
        Object objRemove = this._map.get(k4);
    ...
    @Override // java.util.concurrent.ConcurrentMap, java.util.Map
    public boolean replace(K k4, Object obj, Object obj2) {
        ConcurrentMap<K, Object> concurrentMap = this._cmap;
        if (concurrentMap != null) {
            return concurrentMap.replace(k4, obj, obj2);
        }
        throw new UnsupportedOperationException();
    }
        ...
        HashMap<K, String[]> map = new HashMap<K, String[]>((this._map.size() * 3) / 2) { // from class: org.eclipse.jetty.util.MultiMap.1
            ...
            public String toString() {
                ...
                for (K k4 : keySet()) {
                    ...
                    sb.append(Arrays.asList(get(k4)));
                }
    ...
    public Object putValues(K k4, String... strArr) {
        Object objAdd = null;
        for (String str : strArr) {
            objAdd = LazyList.add(objAdd, str);
        }
        return this._map.put(k4, objAdd);
    }
    ...
    public void addValues(K k4, String[] strArr) {
        Object obj = this._map.get(k4);
    ...
    @Override // java.util.concurrent.ConcurrentMap, java.util.Map
    public Object replace(K k4, Object obj) {
        ConcurrentMap<K, Object> concurrentMap = this._cmap;
        if (concurrentMap != null) {
            return concurrentMap.replace(k4, obj);
        }
        throw new UnsupportedOperationException();
    }
    ...
    public MultiMap(int i4) {
        this._map = new HashMap(i4);
    }

    public MultiMap(boolean z3) {
        if (z3) {
