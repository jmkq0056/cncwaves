...
public class PooledBuffers extends AbstractBuffers {
    ...
    public PooledBuffers(Buffers.Type type, int i4, Buffers.Type type2, int i5, Buffers.Type type3, int i6) {
    ...
    public Buffer getBuffer(int i4) {
        if (this._otherHeaders && i4 == getHeaderSize()) {
            return getHeader();
        }
        if (this._otherBuffers && i4 == getBufferSize()) {
            return getBuffer();
        }
        Buffer bufferPoll = this._others.poll();
        while (bufferPoll != null && bufferPoll.capacity() != i4) {
            this._size.decrementAndGet();
