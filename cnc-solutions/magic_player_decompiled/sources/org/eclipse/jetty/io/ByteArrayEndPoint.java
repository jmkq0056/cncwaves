...
public class ByteArrayEndPoint implements ConnectedEndPoint {
    ...
    public void setGrowOutput(boolean z3) {
        this._growOutput = z3;
    }
    ...
    public void setNonBlocking(boolean z3) {
        this._nonBlocking = z3;
    }
    ...
    public ByteArrayEndPoint(byte[] bArr, int i4) {
        this._inBytes = bArr;
        this._in = new ByteArrayBuffer(bArr);
        this._out = new ByteArrayBuffer(i4);
    }
