...
public class ChannelEndPoint implements EndPoint {
    ...
    */
    ...
    @Override // org.eclipse.jetty.io.EndPoint
    public void setMaxIdleTime(int i4) throws SocketException {
        if (this._socket != null && i4 != this._maxIdleTime) {
            this._socket.setSoTimeout(i4 > 0 ? i4 : 0);
        }
        this._maxIdleTime = i4;
    }

    public final void shutdownChannelInput() {
        Socket socket;
        ...
        try {
            try {
                ...
                Logger logger = LOG;
                logger.debug(e4.toString(), new Object[0]);
                logger.ignore(e4);
                if (!this._oshut) {
                    return;
                }
    ...
    public final void shutdownChannelOutput() {
        Socket socket;
    ...
    public ChannelEndPoint(ByteChannel byteChannel, int i4) throws SocketException {
        this._gather2 = new ByteBuffer[2];
        this._channel = byteChannel;
        this._maxIdleTime = i4;
        Socket socket = byteChannel instanceof SocketChannel ? ((SocketChannel) byteChannel).socket() : null;
