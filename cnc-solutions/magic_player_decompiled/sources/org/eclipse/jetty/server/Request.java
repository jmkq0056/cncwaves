...
public class Request implements c {
    ...
    private Map<Object, g> _savedNewSessions;
    ...
    public static class MultiPartCleanerListener implements c0 {
        @Override // g2.c0
        public void requestDestroyed(b0 b0Var) {
            MultiPartInputStream multiPartInputStream = (MultiPartInputStream) b0Var.f1717a.getAttribute(Request.__MULTIPART_INPUT_STREAM);
            if (multiPartInputStream == null || ((ContextHandler.Context) b0Var.f1717a.getAttribute(Request.__MULTIPART_CONTEXT)) != b0Var.a()) {
                return;
            }
            try {
                multiPartInputStream.deleteParts();
            } catch (MultiException e4) {
                b0Var.a().log("Errors deleting multipart tmp files", e4);
            }
        }

        @Override // g2.c0
        public void requestInitialized(b0 b0Var) {
        }
    }
    ...
    public static Request getRequest(c cVar) {
        return cVar instanceof Request ? (Request) cVar : AbstractHttpConnection.getCurrentConnection().getRequest();
    }
    ...
    public void addEventListener(EventListener eventListener) {
        ...
        if (eventListener instanceof g2.c) {
            throw new IllegalArgumentException(eventListener.getClass().toString());
        }
    }
    ...
    public boolean authenticate(e eVar) {
        ...
        if (authentication instanceof Authentication.Deferred) {
            setAuthentication(((Authentication.Deferred) authentication).authenticate(this, eVar));
    ...
    public void extractParameters() {
        ...
        try {
            ...
            if (contentType != null && contentType.length() > 0) {
                ...
                if (MimeTypes.FORM_ENCODED.equalsIgnoreCase(contentType) && this._inputState == 0 && ((HttpMethods.POST.equals(getMethod()) || HttpMethods.PUT.equals(getMethod())) && (contentLength = getContentLength()) != 0)) {
                    try {
            ...
            if (contentType != null && contentType.length() > 0 && contentType.startsWith("multipart/form-data") && getAttribute(__MULTIPART_CONFIG_ELEMENT) != null) {
                try {
                    ...
                    if (LOG.isDebugEnabled()) {
                        ...
                        LOG.warn(e6.toString(), new Object[0]);
                    }
                } catch (IOException e7) {
                    if (LOG.isDebugEnabled()) {
                        LOG.warn(e7);
                    } else {
                        LOG.warn(e7.toString(), new Object[0]);
                    }
                }
            }
    ...
    public String getLocalName() {
        ...
        return (localAddr == null || localAddr.indexOf(58) < 0) ? localAddr : h.a("[", localAddr, "]");
    }
    ...
    public Enumeration getLocales() {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            String strValueParameters = HttpFields.valueParameters((String) listQualityList.get(i4), null);
            int iIndexOf = strValueParameters.indexOf(45);
            if (iIndexOf > -1) {
                strTrim = strValueParameters.substring(iIndexOf + 1).trim();
                strValueParameters = strValueParameters.substring(0, iIndexOf).trim();
    ...
    @Override // j2.c
    public q getPart(String str) throws Throwable {
        getParts();
        return this._multiPartInputStream.getPart(str);
    }

    @Override // j2.c
    public Collection<q> getParts() throws Throwable {
        if (getContentType() == null || !getContentType().startsWith("multipart/form-data")) {
            throw new u("Content-Type != multipart/form-data");
        }
        if (this._multiPartInputStream == null) {
            this._multiPartInputStream = (MultiPartInputStream) getAttribute(__MULTIPART_INPUT_STREAM);
        }
        if (this._multiPartInputStream == null) {
            k kVar = (k) getAttribute(__MULTIPART_CONFIG_ELEMENT);
            if (kVar == null) {
                throw new IllegalStateException("No multipart config for servlet");
            }
            v inputStream = getInputStream();
            String contentType = getContentType();
            ContextHandler.Context context = this._context;
            ByteArrayOutputStream byteArrayOutputStream = null;
            MultiPartInputStream multiPartInputStream = new MultiPartInputStream(inputStream, contentType, kVar, context != null ? (File) context.getAttribute("javax.servlet.context.tempdir") : null);
            ...
            Iterator<q> it = this._multiPartInputStream.getParts().iterator();
            while (it.hasNext()) {
                ...
                if (multiPart.getContentDispositionFilename() == null) {
                    ...
                    try {
                        ...
                        try {
                            IO.copy(inputStream2, byteArrayOutputStream2);
                            ...
                            IO.close((OutputStream) byteArrayOutputStream2);
                            IO.close(inputStream2);
                        } catch (Throwable th) {
                            th = th;
                            byteArrayOutputStream = byteArrayOutputStream2;
                            IO.close((OutputStream) byteArrayOutputStream);
                            IO.close(inputStream2);
                            throw th;
                        }
                    } catch (Throwable th2) {
    ...
    public BufferedReader getReader() {
        ...
        if (this._reader == null || !characterEncoding.equalsIgnoreCase(this._readerEncoding)) {
            final v inputStream = getInputStream();
    ...
    public m getRequestDispatcher(String str) {
        String strCompactPath = URIUtil.compactPath(str);
        if (strCompactPath == null || this._context == null) {
            return null;
        }
        if (!strCompactPath.startsWith("/")) {
            String strAddPaths = URIUtil.addPaths(this._servletPath, this._pathInfo);
            int iLastIndexOf = strAddPaths.lastIndexOf("/");
            strCompactPath = URIUtil.addPaths(iLastIndexOf > 1 ? strAddPaths.substring(0, iLastIndexOf + 1) : "/", strCompactPath);
        }
        return this._context.getRequestDispatcher(strCompactPath);
    }
    ...
    public String getServerName() {
        ...
        while (true) {
            ...
            char cPeek = (char) (buffer.peek(i4) & 255);
            if (cPeek == ':') {
                this._serverName = BufferUtil.to8859_1_String(buffer.peek(buffer.getIndex(), i4 - buffer.getIndex()));
                try {
                    try {
                        this._port = BufferUtil.toInt(buffer.peek(i4 + 1, (buffer.putIndex() - i4) - 1));
    ...
    public int getServerPort() {
        ...
        int i4 = this._port;
        return i4 <= 0 ? getScheme().equalsIgnoreCase("https") ? 443 : 80 : i4;
    }
    ...
    public Buffer getTimeStampBuffer() {
        if (this._timeStampBuffer == null) {
            long j4 = this._timeStamp;
            if (j4 > 0) {
                this._timeStampBuffer = HttpFields.__dateCache.formatBuffer(j4);
            }
        }
    ...
    public void login(String str, String str2) throws u {
        Authentication authentication = this._authentication;
        if (!(authentication instanceof Authentication.Deferred)) {
            StringBuilder sbA = f.a("Authenticated as ");
            sbA.append(this._authentication);
            throw new u(sbA.toString());
        }
            ...
            if (z3) {
                ...
                for (Map.Entry entry2 : multiMap3.entrySet()) {
                    ...
                    if (!multiMap4.containsKey(str3)) {
                        ...
                        for (int i5 = 0; i5 < LazyList.size(value2); i5++) {
                            sb.append("&");
                            sb.append(str3);
                            sb.append("=");
                            sb.append(LazyList.get(value2, i5));
                        }
                    }
                }
                str = str + ((Object) sb);
    ...
    public g recoverNewSession(Object obj) {
        Map<Object, g> map = this._savedNewSessions;
        if (map == null) {
            return null;
        }
        return map.get(obj);
    ...
    public void recycle() {
        if (this._inputState == 2) {
            try {
                int i4 = this._reader.read();
                while (i4 != -1) {
                    i4 = this._reader.read();
                }
            } catch (Exception e4) {
                LOG.ignore(e4);
                this._reader = null;
    ...
    public void removeAttribute(String str) {
        ...
        z zVar = new z(this._context, this, str, attribute);
        int size = LazyList.size(this._requestAttributeListeners);
        for (int i4 = 0; i4 < size; i4++) {
            a0 a0Var = (a0) LazyList.get(this._requestAttributeListeners, i4);
    ...
    public void saveNewSession(Object obj, g gVar) {
    ...
    public void setAttribute(String str, Object obj) {
        ...
        if (this._requestAttributeListeners != null) {
            z zVar = new z(this._context, this, str, attribute == null ? obj : attribute);
            int size = LazyList.size(this._requestAttributeListeners);
            for (int i4 = 0; i4 < size; i4++) {
                a0 a0Var = (a0) LazyList.get(this._requestAttributeListeners, i4);
                if (a0Var instanceof a0) {
    ...
    public void setCookies(j2.a[] aVarArr) {
        if (this._cookies == null) {
            this._cookies = new CookieCutter();
        }
    ...
    public void setDispatchTime(long j4) {
        this._dispatchTime = j4;
    }

    public void setDispatcherType(d dVar) {
    ...
    public void setRequestedSessionIdFromCookie(boolean z3) {
        this._requestedSessionIdFromCookie = z3;
    }
    ...
    public g getSession(boolean z3) {
        ...
        if (gVar != null) {
            ...
            if (sessionManager == null || sessionManager.isValid(gVar)) {
        ...
        g gVarNewHttpSession = sessionManager2.newHttpSession(this);
        this._session = gVarNewHttpSession;
        HttpCookie sessionCookie = this._sessionManager.getSessionCookie(gVarNewHttpSession, getContextPath(), isSecure());
    ...
    public a startAsync(y yVar, e0 e0Var) {
        if (this._asyncSupported) {
            this._async.startAsync(this._context, yVar, e0Var);
            return this._async;
        }
        throw new IllegalStateException("!asyncSupported");
    }
