...
public class Server extends HandlerWrapper implements Attributes {
    ...
    public void doStart() throws Exception {
        ...
        if (this._connectors != null && multiException.size() == 0) {
            while (true) {
                ...
                if (i4 >= connectorArr.length) {
                    break;
                }
                try {
                    connectorArr[i4].start();
                } catch (Throwable th2) {
    ...
    */
    ...
    public void handleAsync(AbstractHttpConnection abstractHttpConnection) {
        ...
        c cVar = (c) asyncContinuation.getRequest();
        e eVar = (e) asyncContinuation.getResponse();
        Logger logger = LOG;
        if (!logger.isDebugEnabled()) {
    ...
    public void setDumpAfterStart(boolean z3) {
        this._dumpAfterStart = z3;
    }

    public void setDumpBeforeStop(boolean z3) {
        this._dumpBeforeStop = z3;
    }

    public void setGracefulShutdown(int i4) {
        this._graceful = i4;
    }

    @Deprecated
    public void setMaxCookieVersion(int i4) {
    }

    public void setSendDateHeader(boolean z3) {
        this._sendDateHeader = z3;
    }
    ...
    public void setUncheckedPrintWriter(boolean z3) {
        this._uncheckedPrintWriter = z3;
    }
    ...
    public Server(int i4) {
        setServer(this);
        SelectChannelConnector selectChannelConnector = new SelectChannelConnector();
        selectChannelConnector.setPort(i4);
