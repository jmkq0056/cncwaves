...
public abstract class AbstractHttpConnection extends AbstractConnection {
    ...
    public class Output extends HttpOutput {
        ...
        public void close() throws HttpException, EofException {
            if (isClosed()) {
                return;
            }
        ...
        @Override // org.eclipse.jetty.server.HttpOutput, g2.w
        ...
        public void sendContent(Object obj) {
            ...
            try {
                ...
                while (from >= 0 && !AbstractHttpConnection.this._endp.isOutputShutdown()) {
    ...
    public class RequestHandler extends HttpParser.EventHandler {
        ...
        @Override // org.eclipse.jetty.http.HttpParser.EventHandler
        public void messageComplete(long j4) throws Throwable {
            AbstractHttpConnection.this.messageComplete(j4);
        }
        ...
        @Override // org.eclipse.jetty.http.HttpParser.EventHandler
        public void startRequest(Buffer buffer, Buffer buffer2, Buffer buffer3) throws HttpException {
            AbstractHttpConnection.this.startRequest(buffer, buffer2, buffer3);
        }

        @Override // org.eclipse.jetty.http.HttpParser.EventHandler
        public void startResponse(Buffer buffer, int i4, Buffer buffer2) {
            if (AbstractHttpConnection.LOG.isDebugEnabled()) {
                AbstractHttpConnection.LOG.debug("Bad request!: " + buffer + " " + i4 + " " + buffer2, new Object[0]);
            }
        }
    }
    ...
    public AbstractHttpConnection(Connector connector, EndPoint endPoint, Server server) {
        ...
        this._uri = StringUtil.__UTF8.equals(str) ? new HttpURI() : new EncodedHttpURI(str);
    ...
    public void commitResponse(boolean z3) throws HttpException {
        if (!this._generator.isCommitted()) {
            ...
            try {
                ...
                this._generator.completeHeader(this._responseFields, z3);
            } catch (RuntimeException e4) {
                LOG.warn("header full: " + e4, new Object[0]);
                this._response.reset();
                this._generator.reset();
                this._generator.setResponse(HttpStatus.INTERNAL_SERVER_ERROR_500, null);
    ...
    public void completeResponse() throws HttpException {
        if (!this._generator.isCommitted()) {
            this._generator.setResponse(this._response.getStatus(), this._response.getReason());
            try {
                this._generator.completeHeader(this._responseFields, true);
                ...
                Logger logger = LOG;
                logger.warn("header full: " + e4, new Object[0]);
                logger.debug(e4);
                this._response.reset();
                this._generator.reset();
                this._generator.setResponse(HttpStatus.INTERNAL_SERVER_ERROR_500, null);
    ...
    public void flushResponse() throws EofException {
        try {
    ...
    /* JADX WARN: Removed duplicated region for block: B:207:0x036b A[Catch: all -> 0x0374, TryCatch #6 {all -> 0x0374, blocks: (B:202:0x0349, B:204:0x0351, B:205:0x035a, B:207:0x036b, B:209:0x0371, B:210:0x0373), top: B:283:0x0349 }] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:283:0x0349 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:287:0x0062 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:320:? A[ADDED_TO_REGION, Catch: all -> 0x0374, REMOVE, SYNTHETIC, TRY_LEAVE, TryCatch #6 {all -> 0x0374, blocks: (B:202:0x0349, B:204:0x0351, B:205:0x035a, B:207:0x036b, B:209:0x0371, B:210:0x0373), top: B:283:0x0349 }] */
    ...
    */
    ...
    public void headerComplete() throws Throwable {
        ...
        if (i4 == 10) {
            ...
            if (!this._host) {
                LOG.debug("!host {}", this);
                this._generator.setResponse(HttpStatus.BAD_REQUEST_400, null);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void parsedHeader(org.eclipse.jetty.io.Buffer r8, org.eclipse.jetty.io.Buffer r9) {
        /*
            r7 = this;
    ...
    public void startRequest(Buffer buffer, Buffer buffer2, Buffer buffer3) throws HttpException {
        ...
        try {
            ...
            if (!(e4 instanceof HttpException)) {
                throw new HttpException(HttpStatus.BAD_REQUEST_400, null, e4);
            }
    ...
    public AbstractHttpConnection(Connector connector, EndPoint endPoint, Server server, Parser parser, Generator generator, Request request) {
        ...
        this._earlyEOF = false;
        String str = URIUtil.__CHARSET;
        this._uri = str.equals(StringUtil.__UTF8) ? new HttpURI() : new EncodedHttpURI(str);
        this._connector = connector;
        this._parser = parser;
        this._requestFields = new HttpFields();
        this._responseFields = new HttpFields();
