...
public abstract class AbstractSessionIdManager extends AbstractLifeCycle implements SessionIdManager {
    ...
    public void initRandom() {
        ...
        try {
            ...
            LOG.warn("Could not generate SecureRandom for session-id randomness", e4);
    ...
    @Override // org.eclipse.jetty.server.SessionIdManager
    public String newSessionId(c cVar, long j4) {
        synchronized (this) {
            if (cVar != null) {
                try {
                    ...
                    String str = (String) cVar.getAttribute(__NEW_SESSION_ID);
            ...
            while (true) {
                if (str2 != null && str2.length() != 0 && !idInUse(str2)) {
                    cVar.setAttribute(__NEW_SESSION_ID, str2);
                    return str2;
                }
                long jHashCode = this._weakRandom ? ((((long) hashCode()) ^ Runtime.getRuntime().freeMemory()) ^ ((long) this._random.nextInt())) ^ (((long) cVar.hashCode()) << 32) : this._random.nextLong();
                if (jHashCode < 0) {
                    jHashCode = -jHashCode;
                }
                long j5 = this._reseed;
                if (j5 > 0 && jHashCode % j5 == 1) {
                    ...
                    if (random instanceof SecureRandom) {
                        ...
                        random.setSeed(((random.nextLong() ^ System.currentTimeMillis()) ^ ((long) cVar.hashCode())) ^ Runtime.getRuntime().freeMemory());
                    }
                }
                long jHashCode2 = this._weakRandom ? (((long) cVar.hashCode()) << 32) ^ ((((long) hashCode()) ^ Runtime.getRuntime().freeMemory()) ^ ((long) this._random.nextInt())) : this._random.nextLong();
                if (jHashCode2 < 0) {
