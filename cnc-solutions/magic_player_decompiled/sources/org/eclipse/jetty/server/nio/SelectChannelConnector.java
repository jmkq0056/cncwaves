...
public class SelectChannelConnector extends AbstractNIOConnector {
    ...
    public void setLowResourcesConnections(int i4) {
        this._lowResourcesConnections = i4;
    }

    @Override // org.eclipse.jetty.server.AbstractConnector
    public void setLowResourcesMaxIdleTime(int i4) {
        this._lowResourcesMaxIdleTime = i4;
        super.setLowResourcesMaxIdleTime(i4);
    }

    @Override // org.eclipse.jetty.server.AbstractConnector, org.eclipse.jetty.server.Connector
    public void setMaxIdleTime(int i4) {
        this._manager.setMaxIdleTime(i4);
