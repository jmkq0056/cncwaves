...
public class BlockingChannelConnector extends AbstractNIOConnector {
            ...
            public void run() {
                while (BlockingChannelConnector.this.isRunning()) {
                    try {
                        ...
                        BlockingChannelConnector.LOG.warn(e5);
                    }
                }
            }
        });
    ...
    public class BlockingChannelEndPoint extends ChannelEndPoint implements Runnable, ConnectedEndPoint {
        ...
        public BlockingChannelEndPoint(ByteChannel byteChannel) {
        ...
        public void checkIdleTimestamp(long j4) {
            if (this._idleTimestamp == 0 || this._timeout <= 0 || j4 <= this._idleTimestamp + ((long) this._timeout)) {
                return;
            }
            idleExpired();
        }
            ...
            try {
                try {
                    try {
                        ...
                        BlockingChannelConnector.LOG.debug("EOF", e7);
                        try {
                            close();
                    ...
                    try {
                        ...
                        BlockingChannelConnector.LOG.ignore(e9);
                    }
                    BlockingChannelConnector.this.connectionClosed(this._connection);
                    BlockingChannelConnector.this._endpoints.remove(this);
                    if (this._socket.isClosed()) {
                ...
                BlockingChannelConnector.LOG.ignore(e10);
            }
        }
