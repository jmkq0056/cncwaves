...
public abstract class AbstractNIOConnector extends AbstractConnector implements NIOConnector {
    ...
    public void setUseDirectBuffers(boolean z3) {
        this._buffers.setRequestBufferType(z3 ? Buffers.Type.DIRECT : Buffers.Type.INDIRECT);
        this._buffers.setResponseBufferType(z3 ? Buffers.Type.DIRECT : Buffers.Type.INDIRECT);
    }
}
