...
public class LocalConnector extends AbstractConnector {
    ...
    public class Request implements Runnable {
        ...
        private Request(ByteArrayBuffer byteArrayBuffer, boolean z3, CountDownLatch countDownLatch) {
    ...
    public void accept(int i4) throws InterruptedException {
    ...
    public String getResponses(String str, boolean z3) throws InterruptedException {
        ByteArrayBuffer responses = getResponses(new ByteArrayBuffer(str, "ISO-8859-1"), z3);
        if (responses == null) {
            return null;
        }
    ...
    public ByteArrayBuffer getResponses(ByteArrayBuffer byteArrayBuffer, boolean z3) throws InterruptedException {
        CountDownLatch countDownLatch = new CountDownLatch(1);
        Request request = new Request(byteArrayBuffer, z3, countDownLatch);
