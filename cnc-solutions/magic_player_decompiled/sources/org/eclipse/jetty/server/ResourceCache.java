...
public class ResourceCache {
    ...
    public ResourceCache(ResourceCache resourceCache, ResourceFactory resourceFactory, MimeTypes mimeTypes, boolean z3, boolean z4) {
        this._useFileMappedBuffer = true;
        this._factory = resourceFactory;
        this._mimeTypes = mimeTypes;
        this._parent = resourceCache;
        this._etags = z4;
        this._useFileMappedBuffer = z3;
    }
    ...
    public HttpContent lookup(String str) {
    ...
    public void setMaxCacheSize(int i4) {
        this._maxCacheSize = i4;
        shrinkCache();
    }

    public void setMaxCachedFileSize(int i4) {
        this._maxCachedFileSize = i4;
        shrinkCache();
    }

    public void setMaxCachedFiles(int i4) {
        this._maxCachedFiles = i4;
        shrinkCache();
    }

    public void setUseFileMappedBuffer(boolean z3) {
        this._useFileMappedBuffer = z3;
    }

    public String toString() {
        StringBuilder sbA = f.a("ResourceCache[");
        sbA.append(this._parent);
        sbA.append(",");
        sbA.append(this._factory);
        sbA.append("]@");
        sbA.append(hashCode());
        return sbA.toString();
    }
