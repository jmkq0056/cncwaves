...
public abstract class AbstractHttpConnection extends AbstractConnection implements Dumpable {
    ...
    public class Handler extends HttpParser.EventHandler {
        ...
        public void startResponse(Buffer buffer, int i4, Buffer buffer2) {
            ...
            } else if (i4 == 200 && HttpMethods.CONNECT.equalsIgnoreCase(httpExchange.getMethod())) {
            ...
            AbstractHttpConnection.this._status = i4;
            httpExchange.getEventListener().onResponseStatus(buffer, i4, buffer2);
