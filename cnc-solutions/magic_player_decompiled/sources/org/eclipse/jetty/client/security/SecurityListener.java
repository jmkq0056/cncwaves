...
public class SecurityListener extends HttpEventListenerWrapper {
    ...
    public void onRequestComplete() {
        ...
        if (!this._needIntercept) {
            ...
            if (logger.isDebugEnabled()) {
                StringBuilder sbA = f.a("onRequestComplete, delegating to super with Request complete=");
                sbA.append(this._requestComplete);
                sbA.append(", response complete=");
                sbA.append(this._responseComplete);
                sbA.append(" ");
                sbA.append(this._exchange);
        ...
        if (!this._responseComplete) {
            ...
            if (logger2.isDebugEnabled()) {
                StringBuilder sbA2 = f.a("onRequestComplete, Response not yet complete onRequestComplete, calling super for ");
                sbA2.append(this._exchange);
        ...
        if (logger3.isDebugEnabled()) {
            StringBuilder sbA3 = f.a("onRequestComplete, Both complete: Resending from onResponseComplete ");
            sbA3.append(this._exchange);
            logger3.debug(sbA3.toString(), new Object[0]);
        }
    ...
    public void onResponseComplete() {
        ...
        if (!this._needIntercept) {
            Logger logger = LOG;
            if (logger.isDebugEnabled()) {
                StringBuilder sbA = f.a("OnResponseComplete, delegating to super with Request complete=");
                sbA.append(this._requestComplete);
                sbA.append(", response complete=");
                sbA.append(this._responseComplete);
                sbA.append(" ");
        ...
        if (!this._requestComplete) {
            Logger logger2 = LOG;
            if (logger2.isDebugEnabled()) {
                StringBuilder sbA2 = f.a("onResponseComplete, Request not yet complete from onResponseComplete,  calling super ");
                sbA2.append(this._exchange);
                logger2.debug(sbA2.toString(), new Object[0]);
            }
            super.onResponseComplete();
        ...
        Logger logger3 = LOG;
        if (logger3.isDebugEnabled()) {
            StringBuilder sbA3 = f.a("onResponseComplete, Both complete: Resending from onResponseComplete");
            sbA3.append(this._exchange);
            logger3.debug(sbA3.toString(), new Object[0]);
        }
        this._responseComplete = false;
    ...
    public void onResponseHeader(Buffer buffer, Buffer buffer2) {
        Logger logger = LOG;
        if (logger.isDebugEnabled()) {
            StringBuilder sbA = f.a("SecurityListener:Header: ");
        ...
        if (!isDelegatingResponses() && HttpHeaders.CACHE.getOrdinal(buffer) == 51) {
            ...
            if (realmResolver != null) {
                ...
                if (realm == null) {
                    StringBuilder sbA2 = f.a("Unknown Security Realm: ");
                    sbA2.append(mapScrapeAuthenticationDetails.get("realm"));
                    logger.warn(sbA2.toString(), new Object[0]);
    ...
    public void onResponseStatus(Buffer buffer, int i4, Buffer buffer2) {
        Logger logger = LOG;
        if (logger.isDebugEnabled()) {
            logger.debug(d.a("SecurityListener:Response Status: ", i4), new Object[0]);
        }
        if (i4 != 401 || this._attempts >= this._destination.getHttpClient().maxRetries()) {
            setDelegatingResponses(true);
            setDelegatingRequests(true);
    ...
    public Map<String, String> scrapeAuthenticationDetails(String str) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (strArrSplit.length == 2) {
                ...
                LOG.debug(a.a("SecurityListener: missed scraping authentication details - ", strNextToken), new Object[0]);
            }
        }
        return map;
    }
