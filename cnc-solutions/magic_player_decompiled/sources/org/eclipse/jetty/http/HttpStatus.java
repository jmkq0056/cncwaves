...
public class HttpStatus {
    ...
    public enum Code {
        ...
        MULTIPLE_CHOICES(HttpStatus.MULTIPLE_CHOICES_300, "Multiple Choices"),
        MOVED_PERMANENTLY(HttpStatus.MOVED_PERMANENTLY_301, "Moved Permanently"),
        MOVED_TEMPORARILY(302, "Moved Temporarily"),
        FOUND(302, "Found"),
        SEE_OTHER(HttpStatus.SEE_OTHER_303, "See Other"),
        NOT_MODIFIED(HttpStatus.NOT_MODIFIED_304, "Not Modified"),
        USE_PROXY(HttpStatus.USE_PROXY_305, "Use Proxy"),
        TEMPORARY_REDIRECT(HttpStatus.TEMPORARY_REDIRECT_307, "Temporary Redirect"),
        ...
        INTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR_500, "Server Error"),
        ...
        Code(int i4, String str) {
            this._code = i4;
            this._message = str;
        }

        public boolean equals(int i4) {
            return this._code == i4;
        }
    ...
    public static Code getCode(int i4) {
        if (i4 <= 507) {
            return codeMap[i4];
        }
        return null;
    ...
    public static String getMessage(int i4) {
        Code code = getCode(i4);
        return code != null ? code.getMessage() : Integer.toString(i4);
    }

    public static boolean isClientError(int i4) {
        return 400 <= i4 && i4 <= 499;
    }

    public static boolean isInformational(int i4) {
        return 100 <= i4 && i4 <= 199;
    }

    public static boolean isRedirection(int i4) {
        return 300 <= i4 && i4 <= 399;
    }

    public static boolean isServerError(int i4) {
        return 500 <= i4 && i4 <= 599;
    }
