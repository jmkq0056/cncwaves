...
public class PathMap extends HashMap implements Externalizable {
    ...
    public static String relativePath(String str, String str2, String str3) {
        ...
        if (!str.endsWith("/")) {
            return str3.startsWith("/") ? a.a(str, str3) : h.a(str, "/", str3);
        }
        if (!str3.startsWith("/")) {
            return a.a(str, str3);
        }
        StringBuilder sbA = f.a(str);
        sbA.append(str3.substring(1));
        return sbA.toString();
    }
    ...
    public Object put(Object obj, Object obj2) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (!strNextToken.startsWith("/") && !strNextToken.startsWith("*.")) {
                throw new IllegalArgumentException(h.a("PathSpec ", strNextToken, ". must start with '/' or '*.'"));
            }
    ...
    public static boolean match(String str, String str2, boolean z3) {
        if (str.length() == 0) {
            return "/".equals(str2);
        }
        char cCharAt = str.charAt(0);
        if (cCharAt == '/') {
            if ((!z3 && str.length() == 1) || str.equals(str2) || isPathWildcardMatch(str, str2)) {
                return true;
            }
        } else if (cCharAt == '*') {
