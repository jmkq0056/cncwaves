...
public class HashLoginService extends MappedLoginService implements PropertyUserStore.UserListener {
    ...
    public void doStart() {
        ...
        if (this._propertyUserStore == null) {
            ...
            if (logger.isDebugEnabled()) {
                StringBuilder sbA = f.a("doStart: Starting new PropertyUserStore. PropertiesFile: ");
                sbA.append(this._config);
                sbA.append(" refreshInterval: ");
                sbA.append(this._refreshInterval);
    ...
    public void remove(String str) {
        Logger logger = LOG;
        if (logger.isDebugEnabled()) {
            logger.debug(a.a("remove: ", str), new Object[0]);
        }
        removeUser(str);
    }
    ...
    public void update(String str, Credential credential, String[] strArr) {
        Logger logger = LOG;
        if (logger.isDebugEnabled()) {
            StringBuilder sbA = b.a("update: ", str, " Roles: ");
            sbA.append(strArr.length);
            logger.debug(sbA.toString(), new Object[0]);
        }
