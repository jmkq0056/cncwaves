...
public class ConnectionManagerService {
    ...
    public synchronized ConnectionInfo getCurrentConnectionInfo(@UpnpInputArgument(name = "ConnectionID") int i4) {
        ConnectionInfo connectionInfo;
        log.fine("Getting connection information of connection ID: " + i4);
        connectionInfo = this.activeConnections.get(Integer.valueOf(i4));
        if (connectionInfo == null) {
            throw new ConnectionManagerException(ConnectionManagerErrorCode.INVALID_CONNECTION_REFERENCE, "Non-active connection ID: " + i4);
        }
