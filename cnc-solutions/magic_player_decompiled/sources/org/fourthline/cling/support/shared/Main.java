...
public abstract class Main implements ShutdownHandler, Thread.UncaughtExceptionHandler {
    ...
    public void init() {
        ...
        this.errorWindow.setPreferredSize(new Dimension(900, HttpStatus.BAD_REQUEST_400));
