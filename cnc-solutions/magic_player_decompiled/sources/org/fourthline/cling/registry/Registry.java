...
public interface Registry {
    ...
    void addResource(Resource resource, int i4);

    void advertiseLocalDevices();

    UpnpServiceConfiguration getConfiguration();

    Device getDevice(UDN udn, boolean z3);
    ...
    LocalDevice getLocalDevice(UDN udn, boolean z3);
    ...
    RemoteDevice getRemoteDevice(UDN udn, boolean z3);
