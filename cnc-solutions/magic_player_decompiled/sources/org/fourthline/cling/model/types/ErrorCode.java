...
public enum ErrorCode {
    INVALID_ACTION(HttpStatus.UNAUTHORIZED_401, "No action by that name at this service"),
    INVALID_ARGS(HttpStatus.PAYMENT_REQUIRED_402, "Not enough IN args, too many IN args, no IN arg by that name, one or more IN args are of the wrong data type"),
    ACTION_FAILED(HttpStatus.NOT_IMPLEMENTED_501, "Current state of service prevents invoking that action"),
    ...
    public static ErrorCode getByCode(int i4) {
