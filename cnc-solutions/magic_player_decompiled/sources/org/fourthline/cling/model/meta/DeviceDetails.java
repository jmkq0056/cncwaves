...
public class DeviceDetails implements Validatable {
    ...
    public List<ValidationError> validate() {
        ...
        if (getUpc() != null) {
            if (getUpc().length() != 12) {
                Logger logger = log;
                StringBuilder sbA = f.a("UPnP specification violation, UPC must be 12 digits: ");
                sbA.append(getUpc());
                ...
                try {
                    ...
                    Logger logger2 = log;
                    StringBuilder sbA2 = f.a("UPnP specification violation, UPC must be 12 digits all-numeric: ");
                    sbA2.append(getUpc());
