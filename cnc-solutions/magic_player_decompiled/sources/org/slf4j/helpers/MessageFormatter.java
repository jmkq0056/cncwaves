...
public final class MessageFormatter {
    ...
    private static void objectArrayAppend(StringBuilder sb, Object[] objArr, Map<Object[], Object> map) {
        ...
        if (map.containsKey(objArr)) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                deeplyAppendParameter(sb, objArr[i4], map);
                if (i4 != length - 1) {
                    sb.append(", ");
                }
            }
    ...
    private static void safeObjectAppend(StringBuilder sb, Object obj) {
        try {
            ...
            StringBuilder sbA = f.a("SLF4J: Failed toString() invocation on an object of type [");
            sbA.append(obj.getClass().getName());
            sbA.append("]");
            Util.report(sbA.toString(), th);
        ...
        while (i5 < objArr.length) {
            ...
            if (isEscapedDelimeter(str, iIndexOf)) {
                if (!isDoubleEscaped(str, iIndexOf)) {
                    i5--;
                    sb.append((CharSequence) str, i6, iIndexOf - 1);
                    ...
                    sb.append((CharSequence) str, i6, iIndexOf - 1);
                    deeplyAppendParameter(sb, objArr[i5], new HashMap());
                }
            } else {
