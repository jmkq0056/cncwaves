...
public class WindowInsetsCompat {
    ...
    public static class Impl {
        ...
        @NonNull
        public WindowInsetsCompat inset(int i4, int i5, int i6, int i7) {
    ...
    public static Insets insetInsets(Insets insets, int i4, int i5, int i6, int i7) {
        int iMax = Math.max(0, insets.left - i4);
        int iMax2 = Math.max(0, insets.top - i5);
        int iMax3 = Math.max(0, insets.right - i6);
        int iMax4 = Math.max(0, insets.bottom - i7);
        return (iMax == i4 && iMax2 == i5 && iMax3 == i6 && iMax4 == i7) ? insets : Insets.of(iMax, iMax2, iMax3, iMax4);
    }
        ...
        private static WindowInsets createWindowInsetsInstance() {
            if (!sConsumedFieldFetched) {
                try {
                    ...
                    Log.i(WindowInsetsCompat.TAG, "Could not retrieve WindowInsets.CONSUMED field", e4);
                }
            ...
            if (field != null) {
                try {
                    ...
                    Log.i(WindowInsetsCompat.TAG, "Could not get value from WindowInsets.CONSUMED field", e5);
                }
            }
    ...
    public WindowInsetsCompat(@Nullable WindowInsetsCompat windowInsetsCompat) {
        if (windowInsetsCompat != null) {
            ...
            if (i4 >= 28 && (impl instanceof Impl28)) {
                this.mImpl = new Impl28(this, (Impl28) impl);
                return;
            }
            if (i4 >= 21 && (impl instanceof Impl21)) {
