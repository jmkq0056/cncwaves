...
public class AccessibilityDelegateCompat {
    ...
    public static final class AccessibilityDelegateAdapter extends View.AccessibilityDelegate {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            for (int i4 = 0; i4 < actionList.size(); i4++) {
                accessibilityNodeInfoCompatWrap.addAction(actionList.get(i4));
            }
        }
    ...
    public boolean performAccessibilityAction(View view, int i4, Bundle bundle) {
        ...
        if (!zPerformAccessibilityAction) {
            zPerformAccessibilityAction = this.mOriginalDelegate.performAccessibilityAction(view, i4, bundle);
        }
        return (zPerformAccessibilityAction || i4 != R.id.accessibility_action_clickable_span) ? zPerformAccessibilityAction : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }
