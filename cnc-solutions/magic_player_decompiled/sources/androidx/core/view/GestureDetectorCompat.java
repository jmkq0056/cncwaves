...
public final class GestureDetectorCompat {
    ...
    public static class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
        ...
        private boolean isConsideredDoubleTap(MotionEvent motionEvent, MotionEvent motionEvent2, MotionEvent motionEvent3) {
            ...
            return (y3 * y3) + (x3 * x3) < this.mDoubleTapSlopSquare;
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (i4 == 1) {
                ...
                if (!this.mAlwaysInTapRegion) {
                    ...
                    boolean zOnScroll = this.mListener.onScroll(this.mCurrentDownEvent, motionEvent, f7, f8);
                    this.mLastFocusX = f5;
                    this.mLastFocusY = f6;
                    return zOnScroll;
                }
                int i7 = (int) (f5 - this.mDownFocusX);
                int i8 = (int) (f6 - this.mDownFocusY);
                int i9 = (i8 * i8) + (i7 * i7);
                if (i9 > this.mTouchSlopSquare) {
                    zOnFling = this.mListener.onScroll(this.mCurrentDownEvent, motionEvent, f7, f8);
                    this.mLastFocusX = f5;
                    this.mLastFocusY = f6;
                    this.mAlwaysInTapRegion = false;
                    this.mHandler.removeMessages(3);
