...
public final class MenuItemCompat {
    ...
    public static void setAlphabeticShortcut(MenuItem menuItem, char c4, int i4) {
        if (menuItem instanceof SupportMenuItem) {
    ...
    public static void setNumericShortcut(MenuItem menuItem, char c4, int i4) {
        if (menuItem instanceof SupportMenuItem) {
    ...
    public static void setShortcut(MenuItem menuItem, char c4, char c5, int i4, int i5) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setShortcut(c4, c5, i4, i5);
        } else if (Build.VERSION.SDK_INT >= 26) {
    ...
    @Deprecated
    public static MenuItem setActionView(MenuItem menuItem, int i4) {
