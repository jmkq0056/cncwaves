    ...
    private static void forceSetFactory2(LayoutInflater layoutInflater, LayoutInflater.Factory2 factory2) {
        if (!sCheckedField) {
            try {
                ...
                StringBuilder sbA = f.a("forceSetFactory2 Could not find field 'mFactory2' on class ");
                sbA.append(LayoutInflater.class.getName());
                sbA.append("; inflation may have unexpected results.");
        ...
        if (field != null) {
            try {
                ...
                Log.e(TAG, "forceSetFactory2 could not set the Factory2 on LayoutInflater " + layoutInflater + "; inflation may have unexpected results.", e5);
            }
        }
    }
