...
public class ViewCompat {
    ...
    public static class AccessibilityPaneVisibilityManager implements ViewTreeObserver.OnGlobalLayoutListener, View.OnAttachStateChangeListener {
        ...
        private void checkPaneVisibility(View view, boolean z3) {
            ...
            if (z3 != z4) {
                ...
                this.mPanesToVisible.put(view, Boolean.valueOf(z4));
            }
        }
    ...
    public static abstract class AccessibilityViewProperty<T> {
        ...
        public void set(View view, T t3) {
            ...
            } else if (extrasAvailable() && shouldUpdate(get(view), t3)) {
        ...
        public boolean shouldUpdate(T t3, T t4) {
            return !t4.equals(t3);
        }
    ...
    public static class Api29Impl {
        ...
        public static void saveAttributeDataForStyleable(@NonNull View view, @NonNull Context context, @NonNull int[] iArr, @Nullable AttributeSet attributeSet, @NonNull TypedArray typedArray, int i4, int i5) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static boolean dispatchNestedPreScroll(@NonNull View view, int i4, int i5, @Nullable int[] iArr, @Nullable int[] iArr2) {
        if (Build.VERSION.SDK_INT >= 21) {
            return view.dispatchNestedPreScroll(i4, i5, iArr, iArr2);
        }
        if (view instanceof NestedScrollingChild) {
            return ((NestedScrollingChild) view).dispatchNestedPreScroll(i4, i5, iArr, iArr2);
        }
        return false;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static boolean dispatchNestedScroll(@NonNull View view, int i4, int i5, int i6, int i7, @Nullable int[] iArr) {
        if (Build.VERSION.SDK_INT >= 21) {
            return view.dispatchNestedScroll(i4, i5, i6, i7, iArr);
        }
        if (view instanceof NestedScrollingChild) {
            return ((NestedScrollingChild) view).dispatchNestedScroll(i4, i5, i6, i7, iArr);
        }
        return false;
    }
    ...
    public static View keyboardNavigationClusterSearch(@NonNull View view, View view2, int i4) {
        if (Build.VERSION.SDK_INT >= 26) {
    ...
    @RequiresApi(19)
    public static void notifyViewAccessibilityStateChangedIfNeeded(View view, int i4) {
        if (((AccessibilityManager) view.getContext().getSystemService("accessibility")).isEnabled()) {
            boolean z3 = getAccessibilityPaneTitle(view) != null;
            if (getAccessibilityLiveRegion(view) != 0 || (z3 && view.getVisibility() == 0)) {
    ...
    public static boolean performAccessibilityAction(@NonNull View view, int i4, Bundle bundle) {
    ...
    public static void saveAttributeDataForStyleable(@NonNull View view, @NonNull @SuppressLint({"ContextFirst"}) Context context, @NonNull int[] iArr, @Nullable AttributeSet attributeSet, @NonNull TypedArray typedArray, int i4, int i5) {
        if (Build.VERSION.SDK_INT >= 29) {
            Api29Impl.saveAttributeDataForStyleable(view, context, iArr, attributeSet, typedArray, i4, i5);
        }
    }
    ...
    public static void setPaddingRelative(@NonNull View view, @Px int i4, @Px int i5, @Px int i6, @Px int i7) {
    ...
    public static boolean startDragAndDrop(@NonNull View view, ClipData clipData, View.DragShadowBuilder dragShadowBuilder, Object obj, int i4) {
        return Build.VERSION.SDK_INT >= 24 ? view.startDragAndDrop(clipData, dragShadowBuilder, obj, i4) : view.startDrag(clipData, dragShadowBuilder, obj, i4);
    }
    ...
    public static boolean startNestedScroll(@NonNull View view, int i4) {
        ...
        if (view instanceof NestedScrollingChild) {
            return ((NestedScrollingChild) view).startNestedScroll(i4);
        }
        return false;
    }
    ...
    public static void postInvalidateOnAnimation(@NonNull View view, int i4, int i5, int i6, int i7) {
        view.postInvalidateOnAnimation(i4, i5, i6, i7);
    }

    public static void setScrollIndicators(@NonNull View view, int i4, int i5) {
        if (Build.VERSION.SDK_INT >= 23) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static boolean dispatchNestedPreScroll(@NonNull View view, int i4, int i5, @Nullable int[] iArr, @Nullable int[] iArr2, int i6) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static void dispatchNestedScroll(@NonNull View view, int i4, int i5, int i6, int i7, @Nullable int[] iArr, int i8, @NonNull int[] iArr2) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static boolean startNestedScroll(@NonNull View view, int i4, int i5) {
        if (view instanceof NestedScrollingChild2) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static boolean dispatchNestedScroll(@NonNull View view, int i4, int i5, int i6, int i7, @Nullable int[] iArr, int i8) {
        if (view instanceof NestedScrollingChild2) {
