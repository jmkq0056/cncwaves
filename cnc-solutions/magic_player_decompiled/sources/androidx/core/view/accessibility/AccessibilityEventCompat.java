...
public final class AccessibilityEventCompat {
    ...
    @Deprecated
    public static AccessibilityRecordCompat getRecord(AccessibilityEvent accessibilityEvent, int i4) {
        return new AccessibilityRecordCompat(accessibilityEvent.getRecord(i4));
    }
