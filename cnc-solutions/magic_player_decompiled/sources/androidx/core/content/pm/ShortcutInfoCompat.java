...
public class ShortcutInfoCompat {
    ...
    private PersistableBundle buildLegacyExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            int i4 = 0;
            while (i4 < this.mPersons.length) {
                StringBuilder sbA = f.a(EXTRA_PERSON_);
                int i5 = i4 + 1;
                sbA.append(i5);
                persistableBundle.putPersistableBundle(sbA.toString(), this.mPersons[i4].toPersistableBundle());
                i4 = i5;
            }
        }
    ...
    public static Person[] getPersonsFromExtra(@NonNull PersistableBundle persistableBundle) {
        ...
        while (i5 < i4) {
            ...
            int i6 = i5 + 1;
            sbA.append(i6);
            personArr[i5] = Person.fromPersistableBundle(persistableBundle.getPersistableBundle(sbA.toString()));
            i5 = i6;
        }
        return personArr;
    }
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (personArr != null && personArr.length > 0) {
                ...
                for (int i4 = 0; i4 < length; i4++) {
                    personArr2[i4] = this.mPersons[i4].toAndroidPerson();
                }
