...
public class FontResourcesParserCompat {
    ...
    public static final class FontFileResourceEntry {
        ...
        public FontFileResourceEntry(@NonNull String str, int i4, boolean z3, @Nullable String str2, int i5, int i6) {
            this.mFileName = str;
            this.mWeight = i4;
            this.mItalic = z3;
    ...
    public static final class ProviderResourceEntry implements FamilyResourceEntry {
        ...
        public ProviderResourceEntry(@NonNull FontRequest fontRequest, int i4, int i5) {
    ...
    public static List<List<byte[]>> readCerts(Resources resources, @ArrayRes int i4) {
        if (i4 == 0) {
