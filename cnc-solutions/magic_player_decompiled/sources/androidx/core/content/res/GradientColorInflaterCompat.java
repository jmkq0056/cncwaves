...
final class GradientColorInflaterCompat {
    ...
    private static ColorStops checkColors(@Nullable ColorStops colorStops, @ColorInt int i4, @ColorInt int i5, boolean z3, @ColorInt int i6) {
        return colorStops != null ? colorStops : z3 ? new ColorStops(i4, i6, i5) : new ColorStops(i4, i5);
    }
    ...
    public static Shader createFromXmlInner(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException {
        ...
        int namedInt = TypedArrayUtils.getNamedInt(typedArrayObtainAttributes, xmlPullParser, NotificationCompat.MessagingStyle.Message.KEY_DATA_MIME_TYPE, R.styleable.GradientColor_android_type, 0);
    ...
    */
    ...
    private static Shader.TileMode parseTileMode(int i4) {
