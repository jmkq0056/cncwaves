...
public final class ComplexColorCompat {
    ...
    @NonNull
    private static ComplexColorCompat createFromXml(@NonNull Resources resources, @ColorRes int i4, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        int next;
    ...
    public static ComplexColorCompat inflate(@NonNull Resources resources, @ColorRes int i4, @Nullable Resources.Theme theme) {
        try {
            ...
            Log.e(LOG_TAG, "Failed to inflate ComplexColor.", e4);
            return null;
        }
    }
