...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static PrecomputedTextCompat create(@NonNull CharSequence charSequence, @NonNull Params params) {
        ...
        try {
            ...
            int i4 = 0;
            while (i4 < length) {
                int iIndexOf = TextUtils.indexOf(charSequence, LINE_FEED, i4, length);
    ...
    public int getParagraphEnd(@IntRange(from = 0) int i4) {
        ...
        return Build.VERSION.SDK_INT >= 29 ? this.mWrapped.getParagraphEnd(i4) : this.mParagraphEnds[i4];
    }
    ...
    public <T> T[] getSpans(int i4, int i5, Class<T> cls) {
        return Build.VERSION.SDK_INT >= 29 ? (T[]) this.mWrapped.getSpans(i4, i5, cls) : (T[]) this.mText.getSpans(i4, i5, cls);
    }
    ...
    public static final class Params {
        ...
        public int hashCode() {
            int i4 = Build.VERSION.SDK_INT;
            return i4 >= 24 ? ObjectsCompat.hash(Float.valueOf(this.mPaint.getTextSize()), Float.valueOf(this.mPaint.getTextScaleX()), Float.valueOf(this.mPaint.getTextSkewX()), Float.valueOf(this.mPaint.getLetterSpacing()), Integer.valueOf(this.mPaint.getFlags()), this.mPaint.getTextLocales(), this.mPaint.getTypeface(), Boolean.valueOf(this.mPaint.isElegantTextHeight()), this.mTextDir, Integer.valueOf(this.mBreakStrategy), Integer.valueOf(this.mHyphenationFrequency)) : i4 >= 21 ? ObjectsCompat.hash(Float.valueOf(this.mPaint.getTextSize()), Float.valueOf(this.mPaint.getTextScaleX()), Float.valueOf(this.mPaint.getTextSkewX()), Float.valueOf(this.mPaint.getLetterSpacing()), Integer.valueOf(this.mPaint.getFlags()), this.mPaint.getTextLocale(), this.mPaint.getTypeface(), Boolean.valueOf(this.mPaint.isElegantTextHeight()), this.mTextDir, Integer.valueOf(this.mBreakStrategy), Integer.valueOf(this.mHyphenationFrequency)) : ObjectsCompat.hash(Float.valueOf(this.mPaint.getTextSize()), Float.valueOf(this.mPaint.getTextScaleX()), Float.valueOf(this.mPaint.getTextSkewX()), Integer.valueOf(this.mPaint.getFlags()), this.mPaint.getTextLocale(), this.mPaint.getTypeface(), this.mTextDir, Integer.valueOf(this.mBreakStrategy), Integer.valueOf(this.mHyphenationFrequency));
        }

        public String toString() {
            StringBuilder sb = new StringBuilder("{");
            StringBuilder sbA = f.a("textSize=");
            sbA.append(this.mPaint.getTextSize());
            sb.append(sbA.toString());
            sb.append(", textScaleX=" + this.mPaint.getTextScaleX());
            sb.append(", textSkewX=" + this.mPaint.getTextSkewX());
            int i4 = Build.VERSION.SDK_INT;
            if (i4 >= 21) {
                StringBuilder sbA2 = f.a(", letterSpacing=");
                sbA2.append(this.mPaint.getLetterSpacing());
                sb.append(sbA2.toString());
                sb.append(", elegantTextHeight=" + this.mPaint.isElegantTextHeight());
            }
            if (i4 >= 24) {
                StringBuilder sbA3 = f.a(", textLocale=");
                sbA3.append(this.mPaint.getTextLocales());
                sb.append(sbA3.toString());
            } else {
                StringBuilder sbA4 = f.a(", textLocale=");
                sbA4.append(this.mPaint.getTextLocale());
                sb.append(sbA4.toString());
            }
            StringBuilder sbA5 = f.a(", typeface=");
            sbA5.append(this.mPaint.getTypeface());
            sb.append(sbA5.toString());
            if (i4 >= 26) {
                StringBuilder sbA6 = f.a(", variationSettings=");
                sbA6.append(this.mPaint.getFontVariationSettings());
                sb.append(sbA6.toString());
            }
            StringBuilder sbA7 = f.a(", textDir=");
            sbA7.append(this.mTextDir);
            sb.append(sbA7.toString());
