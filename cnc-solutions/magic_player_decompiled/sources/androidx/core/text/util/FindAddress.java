...
class FindAddress {
    ...
    public static class ZipRange {
        ...
        public ZipRange(int i4, int i5, int i6, int i7) {
            this.mLow = i4;
            this.mHigh = i5;
            this.mException1 = i6;
            this.mException2 = i7;
        ...
        public boolean matches(String str) {
            ...
            return (this.mLow <= i4 && i4 <= this.mHigh) || i4 == this.mException1 || i4 == this.mException2;
        }
    }
    ...
    */
    ...
    public static MatchResult matchHouseNumber(String str, int i4) {
        if (i4 > 0 && HOUSE_PRE_DELIM.indexOf(str.charAt(i4 - 1)) == -1) {
            return null;
        }
        Matcher matcherRegion = sHouseNumberRe.matcher(str).region(i4, str.length());
    ...
    public static MatchResult matchState(String str, int i4) {
        if (i4 > 0 && WORD_DELIM.indexOf(str.charAt(i4 - 1)) == -1) {
            return null;
        }
        Matcher matcherRegion = sStateRe.matcher(str).region(i4, str.length());
        if (matcherRegion.lookingAt()) {
