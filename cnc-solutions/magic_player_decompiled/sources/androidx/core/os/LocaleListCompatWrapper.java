...
final class LocaleListCompatWrapper implements LocaleListInterface {
    ...
    public LocaleListCompatWrapper(@NonNull Locale... localeArr) {
        ...
        for (int i4 = 0; i4 < localeArr.length; i4++) {
            ...
            if (locale == null) {
                throw new NullPointerException(a.a("list[", i4, "] is null"));
            }
            if (hashSet.contains(locale)) {
                throw new IllegalArgumentException(a.a("list[", i4, "] is a repetition"));
            }
    ...
    private Locale computeFirstMatch(Collection<String> collection, boolean z3) {
        int iComputeFirstMatchIndex = computeFirstMatchIndex(collection, z3);
