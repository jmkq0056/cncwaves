...
public final class LocaleListCompat {
    ...
    public static Locale forLanguageTagCompat(String str) {
        ...
        throw new IllegalArgumentException(h.a("Can not parse language tag: [", str, "]"));
    }
    ...
    public static LocaleListCompat forLanguageTags(@Nullable String str) {
        ...
        for (int i4 = 0; i4 < length; i4++) {
            localeArr[i4] = Build.VERSION.SDK_INT >= 21 ? Locale.forLanguageTag(strArrSplit[i4]) : forLanguageTagCompat(strArrSplit[i4]);
        }
