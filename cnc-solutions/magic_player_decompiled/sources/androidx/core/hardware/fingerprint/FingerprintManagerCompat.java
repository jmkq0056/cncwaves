...
public class FingerprintManagerCompat {
    ...
    private static FingerprintManager.AuthenticationCallback wrapCallback(final AuthenticationCallback authenticationCallback) {
        return new FingerprintManager.AuthenticationCallback() { // from class: androidx.core.hardware.fingerprint.FingerprintManagerCompat.1
            ...
            public void onAuthenticationError(int i4, CharSequence charSequence) {
                authenticationCallback.onAuthenticationError(i4, charSequence);
            }
            ...
            @Override // android.hardware.fingerprint.FingerprintManager.AuthenticationCallback
            public void onAuthenticationHelp(int i4, CharSequence charSequence) {
                authenticationCallback.onAuthenticationHelp(i4, charSequence);
            }
    ...
    public void authenticate(@Nullable CryptoObject cryptoObject, int i4, @Nullable CancellationSignal cancellationSignal, @NonNull AuthenticationCallback authenticationCallback, @Nullable Handler handler) {
        FingerprintManager fingerprintManagerOrNull;
        if (Build.VERSION.SDK_INT < 23 || (fingerprintManagerOrNull = getFingerprintManagerOrNull(this.mContext)) == null) {
            return;
        }
        fingerprintManagerOrNull.authenticate(wrapCryptoObject(cryptoObject), cancellationSignal != null ? (android.os.CancellationSignal) cancellationSignal.getCancellationSignalObject() : null, i4, wrapCallback(authenticationCallback), handler);
    }
