...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public Action(@Nullable IconCompat iconCompat, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, RemoteInput[] remoteInputArr2, boolean z3, int i4, boolean z4, boolean z5) {
            this.mShowsUserInterface = true;
            this.mIcon = iconCompat;
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            Double.isNaN(d6);
            Double.isNaN(dMax2);
            double dMin = Math.min(d5, d6 / dMax2);
        ...
        public Builder setChronometerCountDown(boolean z3) {
            ...
            this.mExtras.putBoolean(NotificationCompat.EXTRA_CHRONOMETER_COUNT_DOWN, z3);
            return this;
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z3) {
            ...
            if (!z3 || nonContextualActions == null || (iMin = Math.min(nonContextualActions.size(), 3)) <= 0) {
                z4 = false;
            } else {
                for (int i4 = 0; i4 < iMin; i4++) {
                    remoteViewsApplyStandardTemplate.addView(R.id.actions, generateActionButton(nonContextualActions.get(i4)));
                }
            }
            int i5 = z4 ? 0 : 8;
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z3 ? R.layout.notification_action_tombstone : R.layout.notification_action);
    ...
    public static abstract class Style {
        ...
        private Bitmap createIconWithBackground(int i4, int i5, int i6, int i7) {
            ...
            Bitmap bitmapCreateColoredBitmap = createColoredBitmap(i8, i7, i5);
            Canvas canvas = new Canvas(bitmapCreateColoredBitmap);
            Drawable drawableMutate = this.mBuilder.mContext.getResources().getDrawable(i4).mutate();
        ...
        */
        ...
        private Bitmap createColoredBitmap(IconCompat iconCompat, int i4, int i5) {
            ...
            int intrinsicWidth = i5 == 0 ? drawableLoadDrawable.getIntrinsicWidth() : i5;
            if (i5 == 0) {
                i5 = drawableLoadDrawable.getIntrinsicHeight();
            }
            Bitmap bitmapCreateBitmap = Bitmap.createBitmap(intrinsicWidth, i5, Bitmap.Config.ARGB_8888);
            drawableLoadDrawable.setBounds(0, 0, intrinsicWidth, i5);
            if (i4 != 0) {
                drawableLoadDrawable.mutate().setColorFilter(new PorterDuffColorFilter(i4, PorterDuff.Mode.SRC_IN));
            }
    ...
    public static final class WearableExtender implements Extender {
        ...
        public Builder extend(Builder builder) {
            ...
            if (i5 != 0) {
                bundle.putInt(KEY_CONTENT_ICON, i5);
            }
            ...
            if (i7 != -1) {
                bundle.putInt(KEY_CONTENT_ACTION_INDEX, i7);
            }
            int i8 = this.mCustomSizePreset;
            if (i8 != 0) {
                bundle.putInt(KEY_CUSTOM_SIZE_PRESET, i8);
            }
            int i9 = this.mCustomContentHeight;
            if (i9 != 0) {
                bundle.putInt(KEY_CUSTOM_CONTENT_HEIGHT, i9);
            }
            int i10 = this.mGravity;
            if (i10 != 80) {
                bundle.putInt(KEY_GRAVITY, i10);
            }
            int i11 = this.mHintScreenTimeout;
            if (i11 != 0) {
                bundle.putInt(KEY_HINT_SCREEN_TIMEOUT, i11);
            }
    ...
    public static Action getActionCompatFromAction(Notification.Action action) {
        ...
        boolean z3 = i6 >= 24 ? action.getExtras().getBoolean(NotificationCompatJellybean.EXTRA_ALLOW_GENERATED_REPLIES) || action.getAllowGeneratedReplies() : action.getExtras().getBoolean(NotificationCompatJellybean.EXTRA_ALLOW_GENERATED_REPLIES);
        boolean z4 = action.getExtras().getBoolean(Action.EXTRA_SHOWS_USER_INTERFACE, true);
        int semanticAction = i6 >= 28 ? action.getSemanticAction() : action.getExtras().getInt(Action.EXTRA_SEMANTIC_ACTION, 0);
        boolean zIsContextual = i6 >= 29 ? action.isContextual() : false;
        if (i6 < 23) {
            return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z3, semanticAction, z4, zIsContextual);
        }
        if (action.getIcon() != null || (i4 = action.icon) == 0) {
            return new Action(action.getIcon() != null ? IconCompat.createFromIconOrNullIfZeroResId(action.getIcon()) : null, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z3, semanticAction, z4, zIsContextual);
        }
        return new Action(i4, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z3, semanticAction, z4, zIsContextual);
    }
    ...
    public static String getGroup(Notification notification) {
        return Build.VERSION.SDK_INT >= 20 ? notification.getGroup() : notification.extras.getString(NotificationCompatExtras.EXTRA_GROUP_KEY);
    }
    ...
    public static String getSortKey(Notification notification) {
        return Build.VERSION.SDK_INT >= 20 ? notification.getSortKey() : notification.extras.getString(NotificationCompatExtras.EXTRA_SORT_KEY);
    }
    ...
    public static class MessagingStyle extends Style {
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            int color = z3 ? ViewCompat.MEASURED_STATE_MASK : -1;
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            int i4 = Build.VERSION.SDK_INT;
            if (i4 >= 24) {
                Notification.MessagingStyle messagingStyle = i4 >= 28 ? new Notification.MessagingStyle(this.mUser.toAndroidPerson()) : new Notification.MessagingStyle(this.mUser.getName());
            ...
            for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                ...
                CharSequence charSequenceMakeMessageLine = z3 ? makeMessageLine(message3) : message3.getText();
