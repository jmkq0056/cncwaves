...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    public Notification build() {
        ...
        if (i4 >= 21 && style != null && (remoteViewsMakeHeadsUpContentView = this.mBuilderCompat.mStyle.makeHeadsUpContentView(this)) != null) {
    ...
    public Notification buildInternal() {
        ...
        if (this.mGroupAlertBehavior != 0) {
            if (notificationBuild4.getGroup() != null && (notificationBuild4.flags & 512) != 0 && this.mGroupAlertBehavior == 2) {
                removeSoundAndVibration(notificationBuild4);
            }
            if (notificationBuild4.getGroup() != null && (notificationBuild4.flags & 512) == 0 && this.mGroupAlertBehavior == 1) {
                removeSoundAndVibration(notificationBuild4);
            }
        }
