...
public final class ShareCompat {
    ...
    public static class IntentReader {
        ...
        public Drawable getCallingActivityIcon() {
            ...
            try {
                ...
                Log.e(TAG, "Could not retrieve icon for calling activity", e4);
                return null;
            }
        }
        ...
        public Drawable getCallingApplicationIcon() {
            ...
            try {
                ...
                Log.e(TAG, "Could not retrieve icon for calling application", e4);
                return null;
            }
        }
        ...
        public CharSequence getCallingApplicationLabel() {
            ...
            try {
                ...
                Log.e(TAG, "Could not retrieve label for calling application", e4);
                return null;
            }
        }
        ...
        public Uri getStream(int i4) {
            ...
            StringBuilder sbA = f.a("Stream items available: ");
            sbA.append(getStreamCount());
            sbA.append(" index requested: ");
            sbA.append(i4);
    ...
    public static void configureMenuItem(@NonNull MenuItem menuItem, @NonNull IntentBuilder intentBuilder) {
        ...
        StringBuilder sbA = f.a(HISTORY_FILENAME_PREFIX);
        sbA.append(intentBuilder.getContext().getClass().getName());
    ...
    public static void configureMenuItem(@NonNull Menu menu, @IdRes int i4, @NonNull IntentBuilder intentBuilder) {
        ...
        throw new IllegalArgumentException(a.a("Could not find menu item with id ", i4, " in the supplied menu"));
    }
}
