...
public class FrameMetricsAggregator {
    ...
    public static class FrameMetricsApi24Impl extends FrameMetricsBaseImpl {
        ...
        public void add(Activity activity) {
            ...
            for (int i4 = 0; i4 <= 8; i4++) {
                ...
                if (sparseIntArrayArr[i4] == null && (this.mTrackingFlags & (1 << i4)) != 0) {
        ...
        public void addDurationItem(SparseIntArray sparseIntArray, long j4) {
    ...
    public FrameMetricsAggregator(int i4) {
        if (Build.VERSION.SDK_INT >= 24) {
            this.mInstance = new FrameMetricsApi24Impl(i4);
        } else {
