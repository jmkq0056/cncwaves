...
public final class TaskStackBuilder implements Iterable<Intent> {
    ...
    @Nullable
    public Intent editIntentAt(int i4) {
        return this.mIntents.get(i4);
    }

    @Deprecated
    public Intent getIntent(int i4) {
        return editIntentAt(i4);
    }
    ...
    public Intent[] getIntents() {
        ...
        for (int i4 = 1; i4 < size; i4++) {
            intentArr[i4] = new Intent(this.mIntents.get(i4));
        }
        return intentArr;
    }

    @Nullable
    public PendingIntent getPendingIntent(int i4, int i5) {
        return getPendingIntent(i4, i5, null);
    }
    ...
    @Nullable
    public PendingIntent getPendingIntent(int i4, int i5, @Nullable Bundle bundle) {
        ...
        return PendingIntent.getActivities(this.mSourceContext, i4, intentArr, i5, bundle);
    }
