...
public abstract class JobIntentService extends Service {
    ...
    public static final class JobWorkEnqueuer extends WorkEnqueuer {
        ...
        public JobWorkEnqueuer(Context context, ComponentName componentName, int i4) {
            super(componentName);
            ensureJobId(i4);
            this.mJobInfo = new JobInfo.Builder(i4, this.mComponentName).setOverrideDeadline(0L).build();
    ...
    public static abstract class WorkEnqueuer {
        ...
        public void ensureJobId(int i4) {
            if (!this.mHasJobId) {
                ...
                StringBuilder sbA = a.a("Given job ID ", i4, " is different than previous ");
    ...
    public static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z3, int i4) {
