        ...
        public static IBinder getBinder(Bundle bundle, String str) {
            if (!sGetIBinderMethodFetched) {
                try {
                    ...
                    Log.i(TAG, "Failed to retrieve getIBinder method", e4);
                }
            ...
            if (method2 != null) {
                try {
                    ...
                    Log.i(TAG, "Failed to invoke getIBinder via reflection", e5);
        ...
        public static void putBinder(Bundle bundle, String str, IBinder iBinder) {
            if (!sPutIBinderMethodFetched) {
                try {
                    ...
                    Log.i(TAG, "Failed to retrieve putIBinder method", e4);
                }
            ...
            if (method2 != null) {
                try {
                    ...
                    Log.i(TAG, "Failed to invoke putIBinder via reflection", e5);
