...
public class SwitchCompat extends CompoundButton {
    ...
    private void animateThumbToCheckedState(boolean z3) {
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this, THUMB_POS, z3 ? 1.0f : 0.0f);
    ...
    */
    ...
    public void setSwitchTextAppearance(Context context, int i4) {
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, i4, androidx.appcompat.R.styleable.TextAppearance);
    ...
    public void setSwitchTypeface(Typeface typeface, int i4) {
        if (i4 <= 0) {
            ...
            int style = ((typefaceDefaultFromStyle != null ? typefaceDefaultFromStyle.getStyle() : 0) ^ (-1)) & i4;
