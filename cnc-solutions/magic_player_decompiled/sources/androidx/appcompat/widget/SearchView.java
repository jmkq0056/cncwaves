...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action != 0) {
                if (action == 1 || action == 2) {
                    ...
                    if (z4 && !this.mSlopBounds.contains(x3, y3)) {
                        z5 = z4;
                        z3 = false;
                    }
                } else {
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i4, String str) {
        ...
        try {
            ...
            return createIntent(str2, columnString3 == null ? null : Uri.parse(columnString3), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_extra_data"), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_query"), i4, str);
            ...
            Log.w(LOG_TAG, "Search suggestions cursor at row " + position + " returned exception.", e4);
            return null;
        }
    }
    ...
    private CharSequence getDecoratedHint(CharSequence charSequence) {
        ...
        this.mSearchHintIcon.setBounds(0, 0, i4, i4);
    ...
    private void launchIntent(Intent intent) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Failed launch activity: " + intent, e4);
        }
    }
    ...
    private void updateCloseButton() {
        boolean z3 = true;
        boolean z4 = !TextUtils.isEmpty(this.mSearchSrcTextView.getText());
        if (!z4 && (!this.mIconifiedByDefault || this.mExpandedInActionView)) {
            z3 = false;
        }
    ...
    private void updateSubmitButton(boolean z3) {
        this.mGoButton.setVisibility((this.mSubmitButtonEnabled && isSubmitAreaEnabled() && hasFocus() && (z3 || !this.mVoiceButtonEnabled)) ? 0 : 8);
    }
    ...
    public boolean onSuggestionsKey(View view, int i4, KeyEvent keyEvent) {
        if (this.mSearchable != null && this.mSuggestionsAdapter != null && keyEvent.getAction() == 0 && keyEvent.hasNoModifiers()) {
            ...
            if (i4 == 21 || i4 == 22) {
                this.mSearchSrcTextView.setSelection(i4 == 21 ? 0 : this.mSearchSrcTextView.length());
    ...
    public boolean requestFocus(int i4, Rect rect) {
        ...
        boolean zRequestFocus = this.mSearchSrcTextView.requestFocus(i4, rect);
        if (zRequestFocus) {
            updateViewsVisibility(false);
        }
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, R.styleable.SearchView, i4, 0);
        ...
        imageView.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(i5));
        ...
        imageView5.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(i5));
        ...
        int i6 = tintTypedArrayObtainStyledAttributes.getInt(R.styleable.SearchView_android_imeOptions, -1);
        if (i6 != -1) {
            setImeOptions(i6);
        }
        int i7 = tintTypedArrayObtainStyledAttributes.getInt(R.styleable.SearchView_android_inputType, -1);
        if (i7 != -1) {
            setInputType(i7);
        }
