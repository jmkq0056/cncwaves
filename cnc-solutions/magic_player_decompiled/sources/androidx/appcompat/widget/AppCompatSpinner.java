...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public void computeContentWidth() {
            ...
            if (i5 == -2) {
                ...
                if (iCompatMeasureContentWidth > i7) {
                    iCompatMeasureContentWidth = i7;
                }
            ...
            setHorizontalOffset(ViewUtils.isLayoutRtl(AppCompatSpinner.this) ? (((width - paddingRight) - getWidth()) - getHorizontalOriginalOffset()) + i4 : paddingLeft + getHorizontalOriginalOffset() + i4);
        }
    ...
    public AppCompatSpinner(@NonNull Context context, int i4) {
        this(context, null, androidx.appcompat.R.attr.spinnerStyle, i4);
    }
