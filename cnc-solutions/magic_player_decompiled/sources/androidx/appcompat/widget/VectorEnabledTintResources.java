...
public class VectorEnabledTintResources extends Resources {
    ...
    public Drawable getDrawable(int i4) {
        ...
        return context != null ? ResourceManagerInternal.get().onDrawableLoadedFromResources(context, this, i4) : super.getDrawable(i4);
    }

    public final Drawable superGetDrawable(int i4) {
