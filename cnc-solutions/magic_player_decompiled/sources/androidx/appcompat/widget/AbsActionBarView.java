...
abstract class AbsActionBarView extends ViewGroup {
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int i4, long j4) {
        ...
        if (i4 != 0) {
            ...
            viewPropertyAnimatorCompatAlpha.setDuration(j4);
            viewPropertyAnimatorCompatAlpha.setListener(this.mVisAnimListener.withFinalVisibility(viewPropertyAnimatorCompatAlpha, i4));
        ...
        viewPropertyAnimatorCompatAlpha2.setDuration(j4);
        viewPropertyAnimatorCompatAlpha2.setListener(this.mVisAnimListener.withFinalVisibility(viewPropertyAnimatorCompatAlpha2, i4));
