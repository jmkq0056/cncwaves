...
public class AppCompatImageHelper {
    ...
    private boolean shouldApplyFrameworkTintUsingColorFilter() {
        ...
        return i4 > 21 ? this.mInternalImageTint != null : i4 == 21;
    }
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i4) {
        ...
        ViewCompat.saveAttributeDataForStyleable(imageView, imageView.getContext(), iArr, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), i4, 0);
        try {
            Drawable drawable = this.mView.getDrawable();
            ...
            if (tintTypedArrayObtainStyledAttributes.hasValue(i5)) {
                ImageViewCompat.setImageTintList(this.mView, tintTypedArrayObtainStyledAttributes.getColorStateList(i5));
            }
            int i6 = R.styleable.AppCompatImageView_tintMode;
            if (tintTypedArrayObtainStyledAttributes.hasValue(i6)) {
                ImageViewCompat.setImageTintMode(this.mView, DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(i6, -1), null));
            }
        } finally {
    ...
    public void setImageResource(int i4) {
        if (i4 != 0) {
            Drawable drawable = AppCompatResources.getDrawable(this.mView.getContext(), i4);
            if (drawable != null) {
                DrawableUtils.fixDrawable(drawable);
            }
            this.mView.setImageDrawable(drawable);
