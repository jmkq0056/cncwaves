...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder sbA = a.a("Invalid icon resource ", iconResource, " for ");
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            String str2 = "android.resource://" + this.mProviderContext.getPackageName() + "/" + i4;
            Drawable drawableCheckIconCache = checkIconCache(str2);
            if (drawableCheckIconCache != null) {
                return drawableCheckIconCache;
            }
            Drawable drawable = ContextCompat.getDrawable(this.mProviderContext, i4);
    ...
    public View getDropDownView(int i4, View view, ViewGroup viewGroup) {
        try {
            ...
            if (viewNewDropDownView != null) {
                ((ChildViewCache) viewNewDropDownView.getTag()).mText1.setText(e4.toString());
            }
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i4) {
    ...
    public View getView(int i4, View view, ViewGroup viewGroup) {
        try {
            ...
            if (viewNewView != null) {
                ((ChildViewCache) viewNewView.getTag()).mText1.setText(e4.toString());
            }
            return viewNewView;
        }
    }
