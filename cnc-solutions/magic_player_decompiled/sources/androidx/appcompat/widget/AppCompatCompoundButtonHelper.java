...
class AppCompatCompoundButtonHelper {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i4) {
        ...
        ViewCompat.saveAttributeDataForStyleable(compoundButton, compoundButton.getContext(), iArr, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), i4, 0);
        try {
            int i5 = R.styleable.CompoundButton_buttonCompat;
            if (!tintTypedArrayObtainStyledAttributes.hasValue(i5) || (resourceId2 = tintTypedArrayObtainStyledAttributes.getResourceId(i5, 0)) == 0) {
                z3 = false;
            } else {
                try {
            ...
            int i7 = R.styleable.CompoundButton_buttonTint;
            if (tintTypedArrayObtainStyledAttributes.hasValue(i7)) {
                CompoundButtonCompat.setButtonTintList(this.mView, tintTypedArrayObtainStyledAttributes.getColorStateList(i7));
            }
            int i8 = R.styleable.CompoundButton_buttonTintMode;
            if (tintTypedArrayObtainStyledAttributes.hasValue(i8)) {
                CompoundButtonCompat.setButtonTintMode(this.mView, DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(i8, -1), null));
            }
        } finally {
