...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    */
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        sbA.append(view.getClass().getSimpleName());
    ...
    private boolean shouldHideActionBarOnFling(float f4) {
        this.mFlingEstimator.fling(0, 0, 0, (int) f4, 0, 0, Integer.MIN_VALUE, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
