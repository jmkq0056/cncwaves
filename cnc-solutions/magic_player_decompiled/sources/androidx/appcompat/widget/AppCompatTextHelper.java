...
class AppCompatTextHelper {
    ...
    */
    ...
    public void onSetTextAppearance(Context context, int i4) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, i4, R.styleable.TextAppearance);
        int i5 = R.styleable.TextAppearance_textAllCaps;
        if (tintTypedArrayObtainStyledAttributes.hasValue(i5)) {
            setAllCaps(tintTypedArrayObtainStyledAttributes.getBoolean(i5, false));
        }
