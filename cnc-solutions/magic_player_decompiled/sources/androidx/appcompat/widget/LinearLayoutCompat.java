...
public class LinearLayoutCompat extends ViewGroup {
        ...
        for (int i6 = 0; i6 < i4; i6++) {
            ...
            if (virtualChildAt.getVisibility() != 8) {
                ...
                if (((ViewGroup.MarginLayoutParams) layoutParams).height == -1) {
                    ...
                    measureChildWithMargins(virtualChildAt, i5, 0, iMakeMeasureSpec, 0);
        ...
        for (int i6 = 0; i6 < i4; i6++) {
            ...
            if (virtualChildAt.getVisibility() != 8) {
                ...
                if (((ViewGroup.MarginLayoutParams) layoutParams).width == -1) {
                    ...
                    measureChildWithMargins(virtualChildAt, iMakeMeasureSpec, 0, i5, 0);
    ...
    */
    ...
    public void setBaselineAlignedChildIndex(int i4) {
        ...
        StringBuilder sbA = f.a("base aligned child index out of range (0, ");
    ...
    public LinearLayoutCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, iArr, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), i4, 0);
        int i5 = tintTypedArrayObtainStyledAttributes.getInt(R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (i5 >= 0) {
            setOrientation(i5);
        }
        ...
        boolean z3 = tintTypedArrayObtainStyledAttributes.getBoolean(R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!z3) {
