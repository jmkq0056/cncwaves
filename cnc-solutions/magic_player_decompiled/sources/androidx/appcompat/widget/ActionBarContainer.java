...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onLayout(boolean z3, int i4, int i5, int i6, int i7) {
        ...
        if (this.mIsSplit) {
            ...
            this.mIsStacked = z6;
            if (!z6 || (drawable = this.mStackedBackground) == null) {
                z4 = z5;
            } else {
    ...
    public void onMeasure(int i4, int i5) {
        int i6;
        if (this.mActionBarView == null && View.MeasureSpec.getMode(i5) == Integer.MIN_VALUE && (i6 = this.mHeight) >= 0) {
        ...
        setMeasuredDimension(getMeasuredWidth(), Math.min((!isCollapsed(this.mActionBarView) ? getMeasuredHeightWithMargins(this.mActionBarView) : !isCollapsed(this.mContextView) ? getMeasuredHeightWithMargins(this.mContextView) : 0) + getMeasuredHeightWithMargins(this.mTabContainer), mode == Integer.MIN_VALUE ? View.MeasureSpec.getSize(i5) : ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED));
    }
