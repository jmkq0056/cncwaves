...
public class TintTypedArray {
    ...
    public Drawable getDrawable(int i4) {
        int resourceId;
        return (!this.mWrapped.hasValue(i4) || (resourceId = this.mWrapped.getResourceId(i4, 0)) == 0) ? this.mWrapped.getDrawable(i4) : AppCompatResources.getDrawable(this.mContext, resourceId);
    }
