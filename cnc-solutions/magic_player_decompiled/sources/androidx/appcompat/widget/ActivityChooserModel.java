...
class ActivityChooserModel extends DataSetObservable {
    ...
    public static final class ActivityResolveInfo implements Comparable<ActivityResolveInfo> {
        ...
        public String toString() {
            StringBuilder sbA = g.a("[", "resolveInfo:");
    ...
    public static final class HistoricalRecord {
        ...
        public int hashCode() {
            ...
            long j4 = this.time;
            return Float.floatToIntBits(this.weight) + ((((iHashCode + 31) * 31) + ((int) (j4 ^ (j4 >>> 32)))) * 31);
        }

        public String toString() {
            StringBuilder sbA = g.a("[", "; activity:");
            sbA.append(this.activity);
            sbA.append("; time:");
    ...
    private ActivityChooserModel(Context context, String str) {
        ...
        if (TextUtils.isEmpty(str) || str.endsWith(HISTORY_FILE_EXTENSION)) {
            ...
            this.mHistoryFileName = a.a(str, HISTORY_FILE_EXTENSION);
        }
    }
    ...
    private boolean loadActivitiesIfNeeded() {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            this.mActivities.add(new ActivityResolveInfo(listQueryIntentActivities.get(i4)));
        }
        return true;
    }
    ...
    */
    ...
    public void setDefaultActivity(int i4) {
        synchronized (this.mInstanceLock) {
            ...
            ActivityInfo activityInfo = activityResolveInfo.resolveInfo.activityInfo;
            addHistoricalRecord(new HistoricalRecord(new ComponentName(activityInfo.packageName, activityInfo.name), System.currentTimeMillis(), f4));
        }
    }
