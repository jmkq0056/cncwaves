...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    private void updateToolbarLogo() {
        ...
        if ((i4 & 2) == 0) {
            drawable = null;
        } else if ((i4 & 1) == 0 || (drawable = this.mLogo) == null) {
            drawable = this.mIcon;
        }
    ...
    public void animateToVisibility(int i4) {
        ViewPropertyAnimatorCompat viewPropertyAnimatorCompat = setupAnimatorToVisibility(i4, DEFAULT_FADE_DURATION_MS);
        ...
        if (i4 != i5) {
            ...
            if (i4 != 0) {
                if (i4 == 1) {
                    ...
                    if (i4 != 2) {
                        throw new IllegalArgumentException(d.a("Invalid navigation mode ", i4));
                    }
