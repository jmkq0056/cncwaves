...
class AppCompatProgressBarHelper {
    ...
    private Drawable tileifyIndeterminate(Drawable drawable) {
        ...
        for (int i4 = 0; i4 < numberOfFrames; i4++) {
            Drawable drawableTileify = tileify(animationDrawable.getFrame(i4), true);
            drawableTileify.setLevel(10000);
            animationDrawable2.addFrame(drawableTileify, animationDrawable.getDuration(i4));
        }
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i4) {
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attributeSet, TINT_ATTRS, i4, 0);
