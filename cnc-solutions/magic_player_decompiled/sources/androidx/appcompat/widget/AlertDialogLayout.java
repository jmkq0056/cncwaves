...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int i4, int i5) {
        ...
        if (view2 != null) {
            int i8 = paddingBottom - iResolveMinimumHeight;
            int iMin = Math.min(i7, measuredHeight);
            if (iMin > 0) {
                i7 -= iMin;
                iResolveMinimumHeight += iMin;
            }
            view2.measure(i4, View.MeasureSpec.makeMeasureSpec(iResolveMinimumHeight, BasicMeasure.EXACTLY));
        ...
        setMeasuredDimension(View.resolveSizeAndState(getPaddingRight() + getPaddingLeft() + iMax, i4, iCombineMeasuredStates), View.resolveSizeAndState(paddingBottom, i5, 0));
        if (mode2 == 1073741824) {
            return true;
        }
