...
public final class AppCompatDrawableManager {
    ...
    public static synchronized PorterDuffColorFilter getPorterDuffColorFilter(int i4, PorterDuff.Mode mode) {
        return ResourceManagerInternal.getPorterDuffColorFilter(i4, mode);
    }
            ...
            INSTANCE.mResourceManager.setHooks(new ResourceManagerInternal.ResourceManagerHooks() { // from class: androidx.appcompat.widget.AppCompatDrawableManager.1
                ...
                public boolean tintDrawable(@NonNull Context context, int i4, @NonNull Drawable drawable) {
                    if (i4 == R.drawable.abc_seekbar_track_material) {
                        ...
                        setPorterDuffColorFilter(drawableFindDrawableByLayerId, ThemeUtils.getThemeAttrColor(context, i5), AppCompatDrawableManager.DEFAULT_MODE);
                        setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(android.R.id.secondaryProgress), ThemeUtils.getThemeAttrColor(context, i5), AppCompatDrawableManager.DEFAULT_MODE);
                    ...
                    setPorterDuffColorFilter(drawableFindDrawableByLayerId2, ThemeUtils.getThemeAttrColor(context, i6), AppCompatDrawableManager.DEFAULT_MODE);
                    setPorterDuffColorFilter(layerDrawable2.findDrawableByLayerId(android.R.id.progress), ThemeUtils.getThemeAttrColor(context, i6), AppCompatDrawableManager.DEFAULT_MODE);
                    return true;
                }
