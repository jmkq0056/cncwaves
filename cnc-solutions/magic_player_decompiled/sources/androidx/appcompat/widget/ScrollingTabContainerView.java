...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public class TabAdapter extends BaseAdapter {
        ...
        public Object getItem(int i4) {
            return ((TabView) ScrollingTabContainerView.this.mTabLayout.getChildAt(i4)).getTab();
        }
        ...
        public View getView(int i4, View view, ViewGroup viewGroup) {
            if (view == null) {
                return ScrollingTabContainerView.this.createTabView((ActionBar.Tab) getItem(i4), true);
            }
            ((TabView) view).bindTab((ActionBar.Tab) getItem(i4));
            return view;
        }
    }
    ...
    public class TabClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            for (int i4 = 0; i4 < childCount; i4++) {
                View childAt = ScrollingTabContainerView.this.mTabLayout.getChildAt(i4);
    ...
    public class TabView extends LinearLayout {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean z3) {
            int i4 = R.attr.actionBarTabStyle;
            super(context, null, i4);
            int[] iArr = {android.R.attr.background};
            this.BG_ATTRS = iArr;
            this.mTab = tab;
            TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, iArr, i4, 0);
    ...
    public class VisibilityAnimListener extends AnimatorListenerAdapter {
        ...
        public VisibilityAnimListener withFinalVisibility(ViewPropertyAnimator viewPropertyAnimator, int i4) {
    ...
    public void animateToTab(int i4) {
        final View childAt = this.mTabLayout.getChildAt(i4);
        Runnable runnable = this.mTabSelector;
        if (runnable != null) {
            removeCallbacks(runnable);
        }
    ...
    public void animateToVisibility(int i4) {
        ...
        if (i4 != 0) {
            ...
            viewPropertyAnimatorAlpha.setListener(this.mVisAnimListener.withFinalVisibility(viewPropertyAnimatorAlpha, i4));
        ...
        viewPropertyAnimatorAlpha2.setListener(this.mVisAnimListener.withFinalVisibility(viewPropertyAnimatorAlpha2, i4));
    ...
    public void onMeasure(int i4, int i5) {
        ...
        if (childCount <= 1 || !(mode == 1073741824 || mode == Integer.MIN_VALUE)) {
            ...
            if (childCount > 2) {
                this.mMaxTabWidth = (int) (View.MeasureSpec.getSize(i4) * 0.4f);
            } else {
                this.mMaxTabWidth = View.MeasureSpec.getSize(i4) / 2;
            }
        ...
        if (!z3 && this.mAllowCollapse) {
            ...
            if (this.mTabLayout.getMeasuredWidth() > View.MeasureSpec.getSize(i4)) {
                performCollapse();
            } else {
                performExpand();
            }
    ...
    public void removeTabAt(int i4) {
        this.mTabLayout.removeViewAt(i4);
        Spinner spinner = this.mTabSpinner;
        if (spinner != null) {
            ((TabAdapter) spinner.getAdapter()).notifyDataSetChanged();
        }
    ...
    public void updateTab(int i4) {
        ((TabView) this.mTabLayout.getChildAt(i4)).update();
        Spinner spinner = this.mTabSpinner;
        if (spinner != null) {
            ((TabAdapter) spinner.getAdapter()).notifyDataSetChanged();
        }
    ...
    public void addTab(ActionBar.Tab tab, int i4, boolean z3) {
        TabView tabViewCreateTabView = createTabView(tab, false);
        this.mTabLayout.addView(tabViewCreateTabView, i4, new LinearLayoutCompat.LayoutParams(0, -1, 1.0f));
        Spinner spinner = this.mTabSpinner;
        if (spinner != null) {
            ((TabAdapter) spinner.getAdapter()).notifyDataSetChanged();
        }
