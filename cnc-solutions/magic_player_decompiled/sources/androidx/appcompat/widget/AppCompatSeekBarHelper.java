...
class AppCompatSeekBarHelper extends AppCompatProgressBarHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i4) {
        ...
        ViewCompat.saveAttributeDataForStyleable(seekBar, seekBar.getContext(), iArr, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), i4, 0);
        ...
        if (tintTypedArrayObtainStyledAttributes.hasValue(i5)) {
            this.mTickMarkTintMode = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(i5, -1), this.mTickMarkTintMode);
            this.mHasTickMarkTintMode = true;
        }
        int i6 = R.styleable.AppCompatSeekBar_tickMarkTint;
        if (tintTypedArrayObtainStyledAttributes.hasValue(i6)) {
            this.mTickMarkTintList = tintTypedArrayObtainStyledAttributes.getColorStateList(i6);
