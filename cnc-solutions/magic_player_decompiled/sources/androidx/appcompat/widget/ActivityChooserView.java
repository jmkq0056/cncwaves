...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public Object getItem(int i4) {
            ...
            return this.mDataModel.getActivity(i4);
        }
        ...
        public int getItemViewType(int i4) {
            return (this.mShowFooterView && i4 == getCount() - 1) ? 1 : 0;
        }
        ...
        public View getView(int i4, View view, ViewGroup viewGroup) {
            ...
            if (this.mShowDefaultActivity && i4 == 0 && this.mHighlightDefaultActivity) {
    ...
    public class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i4, long j4) {
            ...
            if (activityChooserView.mIsSelectingDefaultActivity) {
                if (i4 > 0) {
                    activityChooserView.mAdapter.getDataModel().setDefaultActivity(i4);
                    return;
                }
                return;
            }
            ...
            Intent intentChooseActivity = ActivityChooserView.this.mAdapter.getDataModel().chooseActivity(i4);
            if (intentChooseActivity != null) {
                intentChooseActivity.addFlags(524288);
                ActivityChooserView.this.getContext().startActivity(intentChooseActivity);
            }
    ...
    public void onLayout(boolean z3, int i4, int i5, int i6, int i7) {
        this.mActivityChooserContent.layout(0, 0, i6 - i4, i7 - i5);
        if (isShowingPopup()) {
            return;
        }
        dismissPopup();
    ...
    public void setDefaultActionButtonContentDescription(int i4) {
        this.mDefaultActionButtonContentDescription = i4;
    }

    public void setExpandActivityOverflowButtonContentDescription(int i4) {
        this.mExpandActivityOverflowButtonImage.setContentDescription(getContext().getString(i4));
    }
     ...
     */
    public void showPopupUnchecked(int i4) {
        ...
        if (i4 == Integer.MAX_VALUE || activityCount <= i4 + r02) {
            this.mAdapter.setShowFooterView(false);
            this.mAdapter.setMaxActivityCount(i4);
        } else {
            this.mAdapter.setShowFooterView(true);
            this.mAdapter.setMaxActivityCount(i4 - 1);
        }
    ...
    public ActivityChooserView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        int i5 = R.id.image;
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(i5);
