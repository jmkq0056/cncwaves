    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (iMin < activityCount) {
            ...
            for (int i5 = 0; i5 < activityCount; i5++) {
                ResolveInfo activity2 = activityChooserModel.getActivity(i5);
                subMenuAddSubMenu.add(0, i5, i5, activity2.loadLabel(packageManager)).setIcon(activity2.loadIcon(packageManager)).setOnMenuItemClickListener(this.mOnMenuItemClickListener);
            }
        }
    }
