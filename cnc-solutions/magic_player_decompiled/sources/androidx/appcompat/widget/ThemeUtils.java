...
public class ThemeUtils {
    ...
    public static int getThemeAttrColor(@NonNull Context context, int i4, float f4) {
        return ColorUtils.setAlphaComponent(getThemeAttrColor(context, i4), Math.round(Color.alpha(r0) * f4));
    }
}
