...
public class AppCompatCheckedTextView extends CheckedTextView {
    ...
    public void setCheckMarkDrawable(@DrawableRes int i4) {
        setCheckMarkDrawable(AppCompatResources.getDrawable(getContext(), i4));
    }
    ...
    public AppCompatCheckedTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
