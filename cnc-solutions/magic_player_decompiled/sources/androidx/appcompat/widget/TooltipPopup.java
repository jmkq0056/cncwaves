...
class TooltipPopup {
    ...
    private void computePosition(View view, int i4, int i5, boolean z3, WindowManager.LayoutParams layoutParams) {
        int height;
        int i6;
        ...
        int dimensionPixelOffset3 = this.mContext.getResources().getDimensionPixelOffset(z3 ? R.dimen.tooltip_y_offset_touch : R.dimen.tooltip_y_offset_non_touch);
        ...
        layoutParams.x = (iArr[0] + i4) - (appRootView.getWidth() / 2);
    ...
    public void show(View view, int i4, int i5, boolean z3, CharSequence charSequence) {
        if (isShowing()) {
            hide();
        }
        this.mMessageView.setText(charSequence);
        computePosition(view, i4, i5, z3, this.mLayoutParams);
