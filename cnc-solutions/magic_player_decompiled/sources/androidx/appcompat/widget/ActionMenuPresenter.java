...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            ...
            iMeasureChildForCells = i8 / i13;
            i4 = ((i8 % i13) / iMeasureChildForCells) + i13;
        } else {
        ...
        while (i14 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (actionMenuPresenter.mStrictWidthLimit) {
                    iMeasureChildForCells -= ActionMenuView.measureChildForCells(itemView, i4, iMeasureChildForCells, iMakeMeasureSpec, i6);
                } else {
                ...
                boolean z5 = (i12 > 0 || z4) && i8 > 0 && (!actionMenuPresenter.mStrictWidthLimit || iMeasureChildForCells > 0);
                boolean z6 = z5;
                i5 = size;
                if (z5) {
                    View itemView2 = actionMenuPresenter.getItemView(menuItemImpl2, null, viewGroup);
                    if (actionMenuPresenter.mStrictWidthLimit) {
                        int iMeasureChildForCells2 = ActionMenuView.measureChildForCells(itemView2, i4, iMeasureChildForCells, iMakeMeasureSpec, 0);
                    ...
                    z5 = z7 & (!actionMenuPresenter.mStrictWidthLimit ? i8 + i15 <= 0 : i8 < 0);
                }
                if (z5 && groupId2 != 0) {
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if ((parcelable instanceof SavedState) && (i4 = ((SavedState) parcelable).openSubMenuId) > 0 && (menuItemFindItem = this.mMenu.findItem(i4)) != null) {
