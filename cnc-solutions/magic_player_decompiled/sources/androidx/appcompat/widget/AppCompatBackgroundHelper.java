...
class AppCompatBackgroundHelper {
    ...
    private boolean shouldApplyFrameworkTintUsingColorFilter() {
        ...
        return i4 > 21 ? this.mInternalBackgroundTint != null : i4 == 21;
    }
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i4) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, iArr, i4, 0);
        View view = this.mView;
        ViewCompat.saveAttributeDataForStyleable(view, view.getContext(), iArr, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), i4, 0);
        try {
            int i5 = R.styleable.ViewBackgroundHelper_android_background;
            if (tintTypedArrayObtainStyledAttributes.hasValue(i5)) {
                this.mBackgroundResId = tintTypedArrayObtainStyledAttributes.getResourceId(i5, -1);
            ...
            if (tintTypedArrayObtainStyledAttributes.hasValue(i6)) {
                ViewCompat.setBackgroundTintList(this.mView, tintTypedArrayObtainStyledAttributes.getColorStateList(i6));
            }
            int i7 = R.styleable.ViewBackgroundHelper_backgroundTintMode;
            if (tintTypedArrayObtainStyledAttributes.hasValue(i7)) {
                ViewCompat.setBackgroundTintMode(this.mView, DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(i7, -1), null));
            }
        } finally {
    ...
    public void onSetBackgroundResource(int i4) {
        ...
        setInternalBackgroundTint(appCompatDrawableManager != null ? appCompatDrawableManager.getTintList(this.mView.getContext(), i4) : null);
        applySupportBackgroundTint();
    }
