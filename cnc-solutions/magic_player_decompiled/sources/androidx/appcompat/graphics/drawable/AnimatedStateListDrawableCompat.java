...
public class AnimatedStateListDrawableCompat extends StateListDrawable implements TintAwareDrawable {
    ...
    public static class AnimatedStateListState extends StateListDrawable.StateListState {
        ...
        public int addStateSet(@NonNull int[] iArr, @NonNull Drawable drawable, int i4) {
            int iAddStateSet = super.addStateSet(iArr, drawable);
            this.mStateIds.put(iAddStateSet, Integer.valueOf(i4));
            return iAddStateSet;
        }

        public int addTransition(int i4, int i5, @NonNull Drawable drawable, boolean z3) {
            int iAddChild = super.addChild(drawable);
            long jGenerateTransitionKey = generateTransitionKey(i4, i5);
            long j4 = z3 ? REVERSIBLE_FLAG_BIT : 0L;
            long j5 = iAddChild;
            this.mTransitions.append(jGenerateTransitionKey, Long.valueOf(j5 | j4));
            if (z3) {
        ...
        public boolean isTransitionReversed(int i4, int i5) {
            return (this.mTransitions.get(generateTransitionKey(i4, i5), -1L).longValue() & REVERSED_BIT) != 0;
        }
        ...
        public boolean transitionHasReversibleFlag(int i4, int i5) {
            return (this.mTransitions.get(generateTransitionKey(i4, i5), -1L).longValue() & REVERSIBLE_FLAG_BIT) != 0;
        }
    ...
    public static class AnimationDrawableTransition extends Transition {
        ...
        public AnimationDrawableTransition(AnimationDrawable animationDrawable, boolean z3, boolean z4) {
            super();
    ...
    public static class FrameInterpolator implements TimeInterpolator {
        ...
        public FrameInterpolator(AnimationDrawable animationDrawable, boolean z3) {
        ...
        public int updateFrames(AnimationDrawable animationDrawable, boolean z3) {
            int numberOfFrames = animationDrawable.getNumberOfFrames();
    ...
    private int parseTransition(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        boolean z3 = typedArrayObtainAttributes.getBoolean(R.styleable.AnimatedStateListDrawableTransition_android_reversible, false);
        typedArrayObtainAttributes.recycle();
        if (drawable == null) {
            do {
                next = xmlPullParser.next();
    ...
    public boolean onStateChange(int[] iArr) {
        ...
        boolean z3 = iIndexOfKeyframe != getCurrentIndex() && (selectTransition(iIndexOfKeyframe) || selectDrawable(iIndexOfKeyframe));
