...
public final class AppCompatResources {
    ...
    public static ColorStateList getColorStateList(@NonNull Context context, @ColorRes int i4) {
        ...
        ColorStateList colorStateListInflateColorStateList = inflateColorStateList(context, i4);
        if (colorStateListInflateColorStateList == null) {
            return ContextCompat.getColorStateList(context, i4);
        }
        addColorStateListToCache(context, i4, colorStateListInflateColorStateList);
    ...
    private static ColorStateList inflateColorStateList(Context context, int i4) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Failed to inflate ColorStateList, leaving it to the framework", e4);
            return null;
        }
    }
