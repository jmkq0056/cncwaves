...
final class StandardMenuPopup extends MenuPopup implements PopupWindow.OnDismissListener, View.OnKeyListener {
    ...
    public StandardMenuPopup(Context context, MenuBuilder menuBuilder, View view, int i4, int i5, boolean z3) {
        ...
        this.mAdapter = new MenuAdapter(menuBuilder, LayoutInflater.from(context), z3, ITEM_LAYOUT);
        this.mPopupStyleAttr = i4;
        this.mPopupStyleRes = i5;
        Resources resources = context.getResources();
        this.mPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(R.dimen.abc_config_prefDialogWidth));
        this.mAnchorView = view;
        this.mPopup = new MenuPopupWindow(context, null, i4, i5);
    ...
    public void setForceShowIcon(boolean z3) {
        this.mAdapter.setForceShowIcon(z3);
    }
    ...
    public void setVerticalOffset(int i4) {
        this.mPopup.setVerticalOffset(i4);
    }
