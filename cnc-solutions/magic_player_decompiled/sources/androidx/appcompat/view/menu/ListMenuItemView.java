...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public void onFinishInflate() {
        ...
        int i4 = this.mTextAppearance;
        if (i4 != -1) {
            textView.setTextAppearance(this.mTextAppearanceContext, i4);
        }
    ...
    public void setShortcut(boolean z3, char c4) {
        int i4 = (z3 && this.mItemData.shouldShowShortcut()) ? 0 : 8;
        if (i4 == 0) {
            this.mShortcutView.setText(this.mItemData.getShortcutLabel());
        }
        if (this.mShortcutView.getVisibility() != i4) {
            this.mShortcutView.setVisibility(i4);
        }
    }
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet, int i4) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, R.styleable.MenuView, i4, 0);
