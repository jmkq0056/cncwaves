...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(@NonNull MenuBuilder menuBuilder, boolean z3) {
            ...
            if (panelFeatureStateFindMenuPanel != null) {
                if (!z4) {
                    AppCompatDelegateImpl.this.closePanel(panelFeatureStateFindMenuPanel, z3);
                } else {
    ...
    private void applyFixedSizeWindow() {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i4)) {
            typedArrayObtainStyledAttributes.getValue(i4, contentFrameLayout.getFixedWidthMajor());
        }
        int i5 = R.styleable.AppCompatTheme_windowFixedWidthMinor;
        if (typedArrayObtainStyledAttributes.hasValue(i5)) {
            typedArrayObtainStyledAttributes.getValue(i5, contentFrameLayout.getFixedWidthMinor());
        }
        int i6 = R.styleable.AppCompatTheme_windowFixedHeightMajor;
        if (typedArrayObtainStyledAttributes.hasValue(i6)) {
            typedArrayObtainStyledAttributes.getValue(i6, contentFrameLayout.getFixedHeightMajor());
        }
    ...
    private ViewGroup createSubDecor() {
        ...
        } else if (typedArrayObtainStyledAttributes.getBoolean(i4, false)) {
        ...
        if (viewGroup == null) {
            StringBuilder sbA = f.a("AppCompat does not support the current theme features: { windowActionBar: ");
            sbA.append(this.mHasActionBar);
            sbA.append(", windowActionBarOverlay: ");
            sbA.append(this.mOverlayActionBar);
            sbA.append(", android:windowIsFloating: ");
            sbA.append(this.mIsFloating);
            sbA.append(", windowActionModeOverlay: ");
            sbA.append(this.mOverlayActionMode);
            sbA.append(", windowNoTitle: ");
            sbA.append(this.mWindowNoTitle);
            sbA.append(" }");
    ...
    private boolean isActivityManifestHandlingUiMode() {
        if (!this.mActivityHandlesUiModeChecked && (this.mHost instanceof Activity)) {
            ...
            try {
                ...
                Log.d(AppCompatDelegate.TAG, "Exception while getting ActivityInfo", e4);
    ...
    */
    ...
    private void openPanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
            ...
            if (viewGroup != null && !panelFeatureState.refreshDecorView) {
                ...
                WindowManager.LayoutParams layoutParams2 = new WindowManager.LayoutParams(i4, -2, panelFeatureState.f132x, panelFeatureState.f133y, PointerIconCompat.TYPE_HAND, 8519680, -3);
            ...
            i4 = -2;
            panelFeatureState.isHandled = false;
            WindowManager.LayoutParams layoutParams22 = new WindowManager.LayoutParams(i4, -2, panelFeatureState.f132x, panelFeatureState.f133y, PointerIconCompat.TYPE_HAND, 8519680, -3);
    ...
    private boolean performPanelShortcut(PanelFeatureState panelFeatureState, int i4, KeyEvent keyEvent, int i5) {
        ...
        if ((panelFeatureState.isPrepared || preparePanel(panelFeatureState, keyEvent)) && (menuBuilder = panelFeatureState.menu) != null) {
            zPerformShortcut = menuBuilder.performShortcut(i4, keyEvent, i5);
        }
        if (zPerformShortcut && (i5 & 1) == 0 && this.mDecorContentParent == null) {
            closePanel(panelFeatureState, true);
        }
    ...
    */
    ...
    public View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        if (z4) {
            ...
            z3 = zShouldInheritContext;
        } else {
            z3 = false;
        }
        return this.mAppCompatViewInflater.createView(view, str, context, attributeSet, z3, z4, true, VectorEnabledTintResources.shouldBeUsed());
    }
    ...
    public PanelFeatureState getPanelState(int i4, boolean z3) {
        PanelFeatureState[] panelFeatureStateArr = this.mPanels;
    ...
    public boolean hasWindowFeature(int i4) {
        int iSanitizeWindowFeatureId = sanitizeWindowFeatureId(i4);
        return (iSanitizeWindowFeatureId != 1 ? iSanitizeWindowFeatureId != 2 ? iSanitizeWindowFeatureId != 5 ? iSanitizeWindowFeatureId != 10 ? iSanitizeWindowFeatureId != 108 ? iSanitizeWindowFeatureId != 109 ? false : this.mOverlayActionBar : this.mHasActionBar : this.mOverlayActionMode : this.mFeatureIndeterminateProgress : this.mFeatureProgress : this.mWindowNoTitle) || this.mWindow.hasFeature(i4);
    }
    ...
    */
    ...
    private boolean applyDayNight(boolean z3) {
        ...
        boolean zUpdateForNightMode = updateForNightMode(mapNightMode(this.mContext, iCalculateNightMode), z3);
    ...
    public class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public boolean onPreparePanel(int i4, View view, Menu menu) {
            ...
            boolean zOnPreparePanel = super.onPreparePanel(i4, view, menu);
            if (menuBuilder != null) {
