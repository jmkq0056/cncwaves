...
public abstract class ActionBar {
    ...
    public static abstract class Tab {
        ...
        public abstract Tab setContentDescription(@StringRes int i4);

        public abstract Tab setContentDescription(CharSequence charSequence);

        public abstract Tab setCustomView(int i4);

        public abstract Tab setCustomView(View view);

        public abstract Tab setIcon(@DrawableRes int i4);
        ...
        public abstract Tab setText(int i4);
    ...
    @Deprecated
    public abstract void addTab(Tab tab, int i4);

    @Deprecated
    public abstract void addTab(Tab tab, int i4, boolean z3);
    ...
    @Deprecated
    public abstract Tab getTabAt(int i4);
    ...
    @Deprecated
    public abstract void removeTabAt(int i4);
    ...
    public abstract void setCustomView(int i4);
    ...
    public abstract void setDisplayOptions(int i4);

    public abstract void setDisplayOptions(int i4, int i5);
    ...
    public void setHomeActionContentDescription(@StringRes int i4) {
    }

    public void setHomeActionContentDescription(@Nullable CharSequence charSequence) {
    }

    public void setHomeAsUpIndicator(@DrawableRes int i4) {
    }
    ...
    public abstract void setLogo(@DrawableRes int i4);

    public abstract void setLogo(Drawable drawable);

    @Deprecated
    public abstract void setNavigationMode(int i4);

    @Deprecated
    public abstract void setSelectedNavigationItem(int i4);
    ...
    public abstract void setSubtitle(int i4);

    public abstract void setSubtitle(CharSequence charSequence);

    public abstract void setTitle(@StringRes int i4);
