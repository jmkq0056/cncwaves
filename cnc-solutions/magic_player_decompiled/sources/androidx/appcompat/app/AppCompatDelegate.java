...
public abstract class AppCompatDelegate {
    ...
    public static void setDefaultNightMode(int i4) {
        ...
        } else if (sDefaultNightMode != i4) {
            sDefaultNightMode = i4;
    ...
    @Nullable
    public abstract <T extends View> T findViewById(@IdRes int i4);
    ...
    public abstract boolean hasWindowFeature(int i4);
    ...
    public abstract boolean requestWindowFeature(int i4);

    public abstract void setContentView(@LayoutRes int i4);
