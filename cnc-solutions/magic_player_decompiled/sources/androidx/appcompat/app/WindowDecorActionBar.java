...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        StringBuilder sbA = f.a("Can't make a decor toolbar out of ");
        sbA.append(view != 0 ? view.getClass().getSimpleName() : "null");
    ...
    public void doHide(boolean z3) {
        ...
        ViewPropertyAnimatorCompat viewPropertyAnimatorCompatTranslationY = ViewCompat.animate(this.mContainerView).translationY(f4);
    ...
    public void removeTabAt(int i4) {
        ...
        TabImpl tabImplRemove = this.mTabs.remove(i4);
    ...
    public void setDisplayOptions(int i4, int i5) {
        ...
        this.mDecorToolbar.setDisplayOptions((i4 & i5) | ((i5 ^ (-1)) & displayOptions));
    }
    ...
    public void addTab(ActionBar.Tab tab, int i4, boolean z3) {
        ensureTabsExist();
        this.mTabScrollView.addTab(tab, i4, z3);
        configureTab(tab, i4);
        if (z3) {
            selectTab(tab);
        }
