...
class VersionedParcelParcel extends VersionedParcel {
    ...
    public void closeField() {
        ...
        if (i4 >= 0) {
            ...
            this.mParcel.writeInt(iDataPosition - i5);
    ...
    public VersionedParcel createSubParcel() {
        ...
        return new VersionedParcelParcel(parcel, iDataPosition, i4, b.a(new StringBuilder(), this.mPrefix, "  "), this.mReadCache, this.mWriteCache, this.mParcelizerCache);
    }
