...
class MediaSessionManagerImplBase implements MediaSessionManager.MediaSessionManagerImpl {
    ...
    public boolean isTrustedForMediaControl(@NonNull MediaSessionManager.RemoteUserInfoImpl remoteUserInfoImpl) {
        try {
            ...
            if (DEBUG) {
                StringBuilder sbA = f.a("Package name ");
                sbA.append(remoteUserInfoImpl.getPackageName());
                sbA.append(" doesn't match with the uid ");
                b.a(sbA, remoteUserInfoImpl.getUid(), "MediaSessionManager");
            }
            return false;
        } catch (PackageManager.NameNotFoundException unused) {
            if (DEBUG) {
                StringBuilder sbA2 = f.a("Package ");
                sbA2.append(remoteUserInfoImpl.getPackageName());
                sbA2.append(" doesn't exist");
                Log.d("MediaSessionManager", sbA2.toString());
            }
            return false;
        }
    }
