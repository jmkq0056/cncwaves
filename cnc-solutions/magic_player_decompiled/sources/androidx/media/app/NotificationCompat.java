...
public class NotificationCompat {
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        public int getBigContentViewLayoutResource(int i4) {
        ...
        public RemoteViews generateBigContentView() {
            ...
            if (iMin > 0) {
                for (int i4 = 0; i4 < iMin; i4++) {
                    remoteViewsApplyStandardTemplate.addView(R.id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(i4)));
                }
            }
            if (this.mShowCancelButton) {
                int i5 = R.id.cancel_action;
                remoteViewsApplyStandardTemplate.setViewVisibility(i5, 0);
                remoteViewsApplyStandardTemplate.setInt(i5, "setAlpha", this.mBuilder.mContext.getResources().getInteger(R.integer.cancel_button_image_alpha));
                remoteViewsApplyStandardTemplate.setOnClickPendingIntent(i5, this.mCancelButtonIntent);
            } else {
        ...
        public RemoteViews generateContentView() {
            ...
            if (iMin > 0) {
                for (int i4 = 0; i4 < iMin; i4++) {
                    ...
                    remoteViewsApplyStandardTemplate.addView(R.id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i4])));
                }
            }
            if (this.mShowCancelButton) {
