...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public static int usageForStreamType(int i4) {
        switch (i4) {
        }
        return 2;
    }

    public static String usageToString(int i4) {
        switch (i4) {
            case 0:
    ...
    public static int toVolumeStreamType(boolean z3, int i4, int i5) {
        if ((i4 & 1) == 1) {
            return z3 ? 1 : 7;
        }
        if ((i4 & 4) == 4) {
        ...
        switch (i5) {
            ...
            default:
                if (z3) {
                    throw new IllegalArgumentException(androidx.constraintlayout.solver.a.a("Unknown usage value ", i5, " in audio attributes"));
                }
                return 3;
        }
    }
    ...
    public static class Builder {
        ...
        public Builder setFlags(int i4) {
            this.mFlags = (i4 & AudioAttributesCompat.FLAG_ALL) | this.mFlags;
            return this;
        }

        /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
        public Builder setInternalLegacyStreamType(int i4) {
            switch (i4) {
                case 0:
                    this.mContentType = 1;
                    break;
                ...
                case 10:
                    ...
                    break;
                default:
                    Log.e(AudioAttributesCompat.TAG, "Invalid stream type " + i4 + " for AudioAttributesCompat");
                    break;
            }
            this.mUsage = AudioAttributesCompat.usageForStreamType(i4);
            return this;
        }
        ...
        public Builder setLegacyStreamType(int i4) {
            ...
            return Build.VERSION.SDK_INT >= 21 ? setInternalLegacyStreamType(i4) : this;
        }
