...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static {
        ThreadFactory threadFactory = new ThreadFactory() { // from class: androidx.loader.content.ModernAsyncTask.1
            ...
            public Thread newThread(Runnable runnable) {
                StringBuilder sbA = f.a("ModernAsyncTask #");
                sbA.append(this.mCount.getAndIncrement());
        ...
        this.mFuture = new FutureTask<Result>(workerRunnable) { // from class: androidx.loader.content.ModernAsyncTask.3
            ...
            public void done() {
                try {
                    ...
                    Log.w(ModernAsyncTask.LOG_TAG, e4);
    ...
    public final Result get(long j4, TimeUnit timeUnit) {
