...
class LoaderManagerImpl extends LoaderManager {
    ...
    public static class LoaderObserver<D> implements Observer<D> {
        ...
        public void onChanged(@Nullable D d4) {
            if (LoaderManagerImpl.DEBUG) {
                StringBuilder sbA = f.a("  onLoadFinished in ");
                sbA.append(this.mLoader);
                sbA.append(": ");
                sbA.append(this.mLoader.dataToString(d4));
        ...
        public void reset() {
            if (this.mDeliveredData) {
                if (LoaderManagerImpl.DEBUG) {
                    StringBuilder sbA = f.a("  Resetting: ");
                    sbA.append(this.mLoader);
                    Log.v(LoaderManagerImpl.TAG, sbA.toString());
                }
        ...
        public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
            if (this.mLoaders.size() > 0) {
                ...
                for (int i4 = 0; i4 < this.mLoaders.size(); i4++) {
                    LoaderInfo loaderInfoValueAt = this.mLoaders.valueAt(i4);
                    printWriter.print(str);
                    printWriter.print("  #");
    ...
    private <D> Loader<D> createAndInstallLoader(int i4, @Nullable Bundle bundle, @NonNull LoaderManager.LoaderCallbacks<D> loaderCallbacks, @Nullable Loader<D> loader) {
        try {
            ...
            Loader<D> loaderOnCreateLoader = loaderCallbacks.onCreateLoader(i4, bundle);
            ...
            LoaderInfo loaderInfo = new LoaderInfo(i4, bundle, loaderOnCreateLoader, loader);
            if (DEBUG) {
