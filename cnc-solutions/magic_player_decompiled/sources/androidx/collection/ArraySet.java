...
public final class ArraySet<E> implements Collection<E>, Set<E> {
    ...
    private MapCollections<E, E> getCollection() {
        if (this.mCollections == null) {
            this.mCollections = new MapCollections<E, E>() { // from class: androidx.collection.ArraySet.1
                ...
                @Override // androidx.collection.MapCollections
                public E colSetValue(int i4, E e4) {
                    throw new UnsupportedOperationException("not a map");
                }
            };
        }
    ...
    private int indexOf(Object obj, int i4) {
        ...
        int iBinarySearch = ContainerHelpers.binarySearch(this.mHashes, i5, i4);
        ...
        for (int i7 = iBinarySearch - 1; i7 >= 0 && this.mHashes[i7] == i4; i7--) {
    ...
    private int indexOfNull() {
        ...
        int iBinarySearch = ContainerHelpers.binarySearch(this.mHashes, i4, 0);
        ...
        if (i5 <= 1) {
            ...
            if (iArr.length <= 8 || i5 >= iArr.length / 3) {
                ...
                if (i4 < i6) {
                    ...
                    Object[] objArr2 = this.mArray;
                    System.arraycopy(objArr2, i7, objArr2, i4, this.mSize - i4);
                }
                ...
                if (i4 < i8) {
                    int i9 = i4 + 1;
                    System.arraycopy(iArr, i9, this.mHashes, i4, i8 - i4);
                    System.arraycopy(objArr, i9, this.mArray, i4, this.mSize - i4);
                }
            }
        }
        return e4;
