...
abstract class MapCollections<K, V> {
    ...
    public final class ArrayIterator<T> implements Iterator<T> {
        ...
        public T next() {
            ...
            T t3 = (T) MapCollections.this.colGetEntry(this.mIndex, this.mOffset);
            this.mIndex++;
    ...
    public final class MapIterator implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public V setValue(V v3) {
            if (this.mEntryValid) {
                return (V) MapCollections.this.colSetValue(this.mIndex, v3);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
    ...
    public abstract void colPut(K k4, V v3);

    public abstract void colRemoveAt(int i4);

    public abstract V colSetValue(int i4, V v3);
    ...
    public Object[] toArrayHelper(int i4) {
        ...
        for (int i5 = 0; i5 < iColGetSize; i5++) {
