...
public class LruCache<K, V> {
    ...
    public void entryRemoved(boolean z3, @NonNull K k4, @NonNull V v3, @Nullable V v4) {
    }
    ...
    public final V get(@NonNull K k4) {
        ...
        synchronized (this) {
            ...
            synchronized (this) {
                this.createCount++;
                vPut = this.map.put(k4, vCreate);
                if (vPut != null) {
                    this.map.put(k4, vPut);
                } else {
                    this.size += safeSizeOf(k4, vCreate);
                }
            }
            if (vPut != null) {
                entryRemoved(false, k4, vCreate, vPut);
                return vPut;
            }
    ...
    public final V put(@NonNull K k4, @NonNull V v3) {
        ...
        synchronized (this) {
            ...
            vPut = this.map.put(k4, v3);
            if (vPut != null) {
                this.size -= safeSizeOf(k4, vPut);
            }
        }
        if (vPut != null) {
            entryRemoved(false, k4, vPut, v3);
        }
        trimToSize(this.maxSize);
        return vPut;
    }
    ...
    public final V remove(@NonNull K k4) {
        ...
        Objects.requireNonNull(k4, "key == null");
        synchronized (this) {
            vRemove = this.map.remove(k4);
            if (vRemove != null) {
                this.size -= safeSizeOf(k4, vRemove);
            }
        }
        if (vRemove != null) {
            entryRemoved(false, k4, vRemove, null);
        }
        return vRemove;
    }
    ...
    public int sizeOf(@NonNull K k4, @NonNull V v3) {
        return 1;
    }
