...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, CursorFilter.CursorFilterClient {
    ...
    public long getItemId(int i4) {
        Cursor cursor;
        if (this.mDataValid && (cursor = this.mCursor) != null && cursor.moveToPosition(i4)) {
    ...
    public View getView(int i4, View view, ViewGroup viewGroup) {
        ...
        if (!this.mCursor.moveToPosition(i4)) {
            throw new IllegalStateException(d.a("couldn't move cursor to position ", i4));
        }
        if (view == null) {
    ...
    public void init(Context context, Cursor cursor, int i4) {
        if ((i4 & 1) == 1) {
            i4 |= 2;
    ...
    public CursorAdapter(Context context, Cursor cursor, int i4) {
        init(context, cursor, i4);
    }
}
