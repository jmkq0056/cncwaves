...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
        ...
        public void updateFragmentMaxLifecycle(boolean z3) {
            ...
            if ((itemId != this.mPrimaryItemId || z3) && (fragment = FragmentStateAdapter.this.mFragments.get(itemId)) != null && fragment.isAdded()) {
                ...
                for (int i4 = 0; i4 < FragmentStateAdapter.this.mFragments.size(); i4++) {
                    long jKeyAt = FragmentStateAdapter.this.mFragments.keyAt(i4);
                    Fragment fragmentValueAt = FragmentStateAdapter.this.mFragments.valueAt(i4);
    ...
    private void ensureFragment(int i4) {
        ...
        Fragment fragmentCreateFragment = createFragment(i4);
    ...
    private Long itemForViewHolder(int i4) {
        ...
        for (int i5 = 0; i5 < this.mItemIdToViewHolder.size(); i5++) {
            if (this.mItemIdToViewHolder.valueAt(i5).intValue() == i4) {
                ...
                lValueOf = Long.valueOf(this.mItemIdToViewHolder.keyAt(i5));
            }
        }
        return lValueOf;
    }
    ...
    public void gcFragments() {
        ...
        for (int i4 = 0; i4 < this.mFragments.size(); i4++) {
            long jKeyAt = this.mFragments.keyAt(i4);
        ...
        if (!this.mIsInGracePeriod) {
            ...
            for (int i5 = 0; i5 < this.mFragments.size(); i5++) {
                long jKeyAt2 = this.mFragments.keyAt(i5);
    ...
    public void placeFragmentInViewHolder(@NonNull final FragmentViewHolder fragmentViewHolder) {
        ...
        if (fragment.isAdded() && view.getParent() != null) {
            ...
            if (shouldDelayFragmentTransactions()) {
                ...
                StringBuilder sbA = f.a("f");
                sbA.append(fragmentViewHolder.getItemId());
                fragmentTransactionBeginTransaction.add(fragment, sbA.toString()).setMaxLifecycle(fragment, Lifecycle.State.STARTED).commitNow();
    ...
    public final Parcelable saveState() {
        ...
        for (int i5 = 0; i5 < this.mSavedStates.size(); i5++) {
            long jKeyAt2 = this.mSavedStates.keyAt(i5);
