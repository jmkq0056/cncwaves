...
public final class ViewPager2 extends ViewGroup {
    ...
    public class LinearLayoutManagerImpl extends LinearLayoutManager {
        ...
        public boolean performAccessibilityAction(@NonNull RecyclerView.Recycler recycler, @NonNull RecyclerView.State state, int i4, @Nullable Bundle bundle) {
            return ViewPager2.this.mAccessibilityProvider.handlesLmPerformAccessibilityAction(i4) ? ViewPager2.this.mAccessibilityProvider.onLmPerformAccessibilityAction(i4) : super.performAccessibilityAction(recycler, state, i4, bundle);
        }
    ...
    public class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        public void updatePageAccessibilityActions() {
            ...
            int i5 = zIsRtl ? R.id.accessibilityActionPageLeft : R.id.accessibilityActionPageRight;
            if (zIsRtl) {
                i4 = R.id.accessibilityActionPageRight;
            }
            if (ViewPager2.this.mCurrentItem < itemCount - 1) {
                ViewCompat.replaceAccessibilityAction(viewPager2, new AccessibilityNodeInfoCompat.AccessibilityActionCompat(i5, null), null, this.mActionPageForward);
            }
            if (ViewPager2.this.mCurrentItem > 0) {
                ViewCompat.replaceAccessibilityAction(viewPager2, new AccessibilityNodeInfoCompat.AccessibilityActionCompat(i4, null), null, this.mActionPageBackward);
            }
        }
    }
    ...
    public void requestTransform() {
        ...
        double d4 = i4;
        Double.isNaN(d4);
        float f4 = (float) (relativeScrollPosition - d4);
    ...
    public void setCurrentItemInternal(int i4, boolean z3) {
        ...
        int iMin = Math.min(Math.max(i4, 0), adapter.getItemCount() - 1);
        ...
        double d4 = iMin;
        Double.isNaN(d4);
        if (Math.abs(d4 - relativeScrollPosition) <= 3.0d) {
            this.mRecyclerView.smoothScrollToPosition(iMin);
            return;
        }
        this.mRecyclerView.scrollToPosition(d4 > relativeScrollPosition ? iMin - 3 : iMin + 3);
        RecyclerView recyclerView = this.mRecyclerView;
