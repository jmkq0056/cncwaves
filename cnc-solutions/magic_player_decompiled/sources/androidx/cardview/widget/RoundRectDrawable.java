...
class RoundRectDrawable extends Drawable {
    ...
    public boolean onStateChange(int[] iArr) {
        ...
        boolean z3 = colorForState != this.mPaint.getColor();
        if (z3) {
    ...
    public void setPadding(float f4, boolean z3, boolean z4) {
        if (f4 == this.mPadding && this.mInsetForPadding == z3 && this.mInsetForRadius == z4) {
            return;
        }
        this.mPadding = f4;
        this.mInsetForPadding = z3;
        this.mInsetForRadius = z4;
        updateBounds(null);
        invalidateSelf();
    }
