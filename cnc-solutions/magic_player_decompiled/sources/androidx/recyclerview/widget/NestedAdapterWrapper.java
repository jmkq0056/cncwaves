...
class NestedAdapterWrapper {
    ...
    private RecyclerView.AdapterDataObserver mAdapterObserver = new RecyclerView.AdapterDataObserver() { // from class: androidx.recyclerview.widget.NestedAdapterWrapper.1
        ...
        public void onItemRangeChanged(int i4, int i5) {
            NestedAdapterWrapper nestedAdapterWrapper = NestedAdapterWrapper.this;
            nestedAdapterWrapper.mCallback.onItemRangeChanged(nestedAdapterWrapper, i4, i5, null);
        }
        ...
        public void onItemRangeInserted(int i4, int i5) {
            ...
            nestedAdapterWrapper.mCallback.onItemRangeInserted(nestedAdapterWrapper, i4, i5);
            NestedAdapterWrapper nestedAdapterWrapper2 = NestedAdapterWrapper.this;
        ...
        public void onItemRangeMoved(int i4, int i5, int i6) {
            ...
            NestedAdapterWrapper nestedAdapterWrapper = NestedAdapterWrapper.this;
            nestedAdapterWrapper.mCallback.onItemRangeMoved(nestedAdapterWrapper, i4, i5);
        }
        ...
        public void onItemRangeRemoved(int i4, int i5) {
            NestedAdapterWrapper nestedAdapterWrapper = NestedAdapterWrapper.this;
            nestedAdapterWrapper.mCachedItemCount -= i5;
            nestedAdapterWrapper.mCallback.onItemRangeRemoved(nestedAdapterWrapper, i4, i5);
            NestedAdapterWrapper nestedAdapterWrapper2 = NestedAdapterWrapper.this;
        ...
        public void onItemRangeChanged(int i4, int i5, @Nullable Object obj) {
            NestedAdapterWrapper nestedAdapterWrapper = NestedAdapterWrapper.this;
            nestedAdapterWrapper.mCallback.onItemRangeChanged(nestedAdapterWrapper, i4, i5, obj);
        }
    };
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i4) {
        this.adapter.bindViewHolder(viewHolder, i4);
    }
