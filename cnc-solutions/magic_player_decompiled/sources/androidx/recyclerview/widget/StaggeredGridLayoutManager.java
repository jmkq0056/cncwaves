...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
        ...
        if (i4 > 0) {
            if (i4 == this.mSpanCount) {
                for (int i5 = 0; i5 < this.mSpanCount; i5++) {
                    ...
                    int endAfterPadding = savedState2.mSpanOffsets[i5];
                    ...
                    this.mSpans[i5].setLine(endAfterPadding);
                }
            } else {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        if (this.mLayoutState.mInfinite) {
            i4 = layoutState.mLayoutDirection == 1 ? ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED : Integer.MIN_VALUE;
        } else {
            i4 = layoutState.mLayoutDirection == 1 ? layoutState.mEndLine + layoutState.mAvailable : layoutState.mStartLine - layoutState.mAvailable;
        }
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            if (this.mOrientation == 1) {
                layoutDecoratedWithMargins(next, decoratedMeasurement2, decoratedMeasurement, decoratedMeasurement3, i5);
            } else {
                layoutDecoratedWithMargins(next, decoratedMeasurement, decoratedMeasurement2, i5, decoratedMeasurement3);
            }
            if (layoutParams.mFullSpan) {
                updateAllRemainingSpans(this.mLayoutState.mLayoutDirection, i4);
            } else {
                updateRemainingSpans(span2, this.mLayoutState.mLayoutDirection, i4);
            }
    ...
    */
    ...
    private void setLayoutStateDirection(int i4) {
        ...
        layoutState.mItemDirection = this.mShouldReverseLayout != (i4 == -1) ? -1 : 1;
    }
    ...
    */
    ...
    public boolean checkForGaps() {
        ...
        LazySpanLookup.FullSpanItem firstFullSpanItemInRange = this.mLazySpanLookup.getFirstFullSpanItemInRange(firstChildPosition, i5, i4, true);
        if (firstFullSpanItemInRange == null) {
            this.mLaidOutInvalidFullSpan = false;
            this.mLazySpanLookup.forceInvalidateAfter(i5);
            return false;
        }
        LazySpanLookup.FullSpanItem firstFullSpanItemInRange2 = this.mLazySpanLookup.getFirstFullSpanItemInRange(firstChildPosition, firstFullSpanItemInRange.mPosition, i4 * (-1), true);
    ...
    public void collectAdjacentPrefetchPositions(int i4, int i5, RecyclerView.State state, RecyclerView.LayoutManager.LayoutPrefetchRegistry layoutPrefetchRegistry) {
        ...
        for (int i7 = 0; i7 < this.mSpanCount; i7++) {
            ...
            if (layoutState.mItemDirection == -1) {
                ...
                startLine = this.mSpans[i7].getStartLine(endLine);
            } else {
                endLine = this.mSpans[i7].getEndLine(layoutState.mEndLine);
    ...
    public PointF computeScrollVectorForPosition(int i4) {
        int iCalculateScrollDirectionForPosition = calculateScrollDirectionForPosition(i4);
    ...
    public int[] findFirstCompletelyVisibleItemPositions(int[] iArr) {
        if (iArr == null) {
            ...
            StringBuilder sbA = f.a("Provided int[]'s size must be more than or equal to span count. Expected:");
            sbA.append(this.mSpanCount);
    ...
    */
    ...
    public View onFocusSearchFailed(View view, int i4, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        resolveShouldLayoutReverse();
        int iConvertFocusDirectionToLayoutDirection = convertFocusDirectionToLayoutDirection(i4);
        ...
        if (!z3 && (focusableViewAfter = span.getFocusableViewAfter(lastChildPosition, iConvertFocusDirectionToLayoutDirection)) != null && focusableViewAfter != viewFindContainingItemView) {
            return focusableViewAfter;
        }
        if (preferLastSpan(iConvertFocusDirectionToLayoutDirection)) {
            for (int i5 = this.mSpanCount - 1; i5 >= 0; i5--) {
                View focusableViewAfter2 = this.mSpans[i5].getFocusableViewAfter(lastChildPosition, iConvertFocusDirectionToLayoutDirection);
            ...
            for (int i6 = 0; i6 < this.mSpanCount; i6++) {
                View focusableViewAfter3 = this.mSpans[i6].getFocusableViewAfter(lastChildPosition, iConvertFocusDirectionToLayoutDirection);
                if (focusableViewAfter3 != null && focusableViewAfter3 != viewFindContainingItemView) {
                    return focusableViewAfter3;
                }
            }
        }
        boolean z4 = (this.mReverseLayout ^ true) == (iConvertFocusDirectionToLayoutDirection == -1);
        if (!z3) {
            View viewFindViewByPosition = findViewByPosition(z4 ? span.findFirstPartiallyVisibleItemPosition() : span.findLastPartiallyVisibleItemPosition());
        ...
        if (preferLastSpan(iConvertFocusDirectionToLayoutDirection)) {
            for (int i7 = this.mSpanCount - 1; i7 >= 0; i7--) {
                if (i7 != span.mIndex) {
                    View viewFindViewByPosition2 = findViewByPosition(z4 ? this.mSpans[i7].findFirstPartiallyVisibleItemPosition() : this.mSpans[i7].findLastPartiallyVisibleItemPosition());
            ...
            for (int i8 = 0; i8 < this.mSpanCount; i8++) {
                View viewFindViewByPosition3 = findViewByPosition(z4 ? this.mSpans[i8].findFirstPartiallyVisibleItemPosition() : this.mSpans[i8].findLastPartiallyVisibleItemPosition());
    ...
    public void setMeasuredDimension(Rect rect, int i4, int i5) {
        ...
        if (this.mOrientation == 1) {
            ...
            iChooseSize = RecyclerView.LayoutManager.chooseSize(i4, (this.mSizePerSpan * this.mSpanCount) + paddingRight, getMinimumWidth());
        } else {
            iChooseSize = RecyclerView.LayoutManager.chooseSize(i4, rect.width() + paddingRight, getMinimumWidth());
            iChooseSize2 = RecyclerView.LayoutManager.chooseSize(i5, (this.mSizePerSpan * this.mSpanCount) + paddingBottom, getMinimumHeight());
        }
                ...
                if (savedState == null || savedState.mAnchorPosition == -1 || savedState.mSpanOffsetsSize < 1) {
                    ...
                    if (viewFindViewByPosition != null) {
                        ...
                        if (i6 == Integer.MIN_VALUE) {
                            anchorInfo.mLayoutFromEnd = calculateScrollDirectionForPosition(i5) == 1;
    ...
    */
    ...
    public class Span {
        ...
        public void cacheReferenceLineAndClear(boolean z3, int i4) {
            int endLine = z3 ? getEndLine(Integer.MIN_VALUE) : getStartLine(Integer.MIN_VALUE);
            clear();
            if (endLine == Integer.MIN_VALUE) {
                return;
            }
            if (!z3 || endLine >= StaggeredGridLayoutManager.this.mPrimaryOrientation.getEndAfterPadding()) {
                if (z3 || endLine <= StaggeredGridLayoutManager.this.mPrimaryOrientation.getStartAfterPadding()) {
        ...
        public int findOnePartiallyOrCompletelyVisibleChild(int i4, int i5, boolean z3, boolean z4, boolean z5) {
        ...
        public int findOnePartiallyVisibleChild(int i4, int i5, boolean z3) {
            return findOnePartiallyOrCompletelyVisibleChild(i4, i5, false, false, z3);
        }

        public int findOneVisibleChild(int i4, int i5, boolean z3) {
            return findOnePartiallyOrCompletelyVisibleChild(i4, i5, z3, true, false);
        }
    ...
    public static class LazySpanLookup {
        ...
        private int invalidateFullSpansAfter(int i4) {
            ...
            while (true) {
                ...
                if (this.mFullSpanItems.get(i5).mPosition >= i4) {
                    break;
                }
                i5++;
            }
        ...
        public int invalidateAfter(int i4) {
            ...
            int iInvalidateFullSpansAfter = invalidateFullSpansAfter(i4);
            ...
            Arrays.fill(this.mData, i4, iMin, -1);
            return iMin;
        }
        ...
        public static class FullSpanItem implements Parcelable {
            ...
            public String toString() {
                StringBuilder sbA = f.a("FullSpanItem{mPosition=");
                sbA.append(this.mPosition);
                sbA.append(", mGapDir=");
                sbA.append(this.mGapDir);
                sbA.append(", mHasUnwantedGapAfter=");
                sbA.append(this.mHasUnwantedGapAfter);
                sbA.append(", mGapPerSpan=");
                sbA.append(Arrays.toString(this.mGapPerSpan));
    ...
    private void measureChildWithDecorationsAndMargin(View view, int i4, int i5, boolean z3) {
        ...
        int iUpdateSpecWithExtra = updateSpecWithExtra(i4, i6 + rect.left, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin + rect.right);
        int i7 = ((ViewGroup.MarginLayoutParams) layoutParams).topMargin;
        Rect rect2 = this.mTmpRect;
        int iUpdateSpecWithExtra2 = updateSpecWithExtra(i5, i7 + rect2.top, ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin + rect2.bottom);
        if (z3) {
