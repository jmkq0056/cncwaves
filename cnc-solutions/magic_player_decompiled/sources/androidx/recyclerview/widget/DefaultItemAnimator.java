...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class MoveInfo {
        ...
        public MoveInfo(RecyclerView.ViewHolder viewHolder, int i4, int i5, int i6, int i7) {
    ...
    public boolean animateChange(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i4, int i5, int i6, int i7) {
        ...
        this.mPendingChanges.add(new ChangeInfo(viewHolder, viewHolder2, i4, i5, i6, i7));
        return true;
    }
    ...
    public void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, int i4, int i5, int i6, int i7) {
        final View view = viewHolder.itemView;
        final int i8 = i6 - i4;
        final int i9 = i7 - i5;
        if (i8 != 0) {
    ...
    public void runPendingAnimations() {
        ...
        if (z3 || z4 || z6 || z5) {
            ...
            if (z6) {
                ...
                if (z3 || z4 || z5) {
                    ViewCompat.postOnAnimationDelayed(arrayList3.get(0).itemView, runnable3, Math.max(z4 ? getMoveDuration() : 0L, z5 ? getChangeDuration() : 0L) + (z3 ? getRemoveDuration() : 0L));
                } else {
                    runnable3.run();
                }
            }
    ...
    public static class ChangeInfo {
        ...
        public String toString() {
            StringBuilder sbA = f.a("ChangeInfo{oldHolder=");
            sbA.append(this.oldHolder);
            sbA.append(", newHolder=");
            sbA.append(this.newHolder);
            sbA.append(", fromX=");
            sbA.append(this.fromX);
            sbA.append(", fromY=");
            sbA.append(this.fromY);
            sbA.append(", toX=");
            sbA.append(this.toX);
            sbA.append(", toY=");
            sbA.append(this.toY);
        ...
        public ChangeInfo(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i4, int i5, int i6, int i7) {
