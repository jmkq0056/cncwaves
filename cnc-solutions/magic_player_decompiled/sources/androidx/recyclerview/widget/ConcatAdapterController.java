...
class ConcatAdapterController implements NestedAdapterWrapper.Callback {
    ...
    @NonNull
    private WrapperAndLocalPosition findWrapperAndLocalPosition(int i4) {
        ...
        throw new IllegalArgumentException(d.a("Cannot find wrapper for ", i4));
    }
    ...
    private int indexOfWrapper(RecyclerView.Adapter<RecyclerView.ViewHolder> adapter) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            if (this.mWrappers.get(i4).adapter == adapter) {
                return i4;
            }
        }
        return -1;
    ...
    public long getItemId(int i4) {
        WrapperAndLocalPosition wrapperAndLocalPositionFindWrapperAndLocalPosition = findWrapperAndLocalPosition(i4);
    ...
    public int getLocalAdapterPosition(RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter, RecyclerView.ViewHolder viewHolder, int i4) {
        ...
        int iCountItemsBefore = i4 - countItemsBefore(nestedAdapterWrapper);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i4) {
        return this.mViewTypeStorage.getWrapperForGlobalType(i4).onCreateViewHolder(viewGroup, i4);
    }
    ...
    public void onItemRangeChanged(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i4, int i5) {
        this.mConcatAdapter.notifyItemRangeChanged(i4 + countItemsBefore(nestedAdapterWrapper), i5);
    }

    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeInserted(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i4, int i5) {
        this.mConcatAdapter.notifyItemRangeInserted(i4 + countItemsBefore(nestedAdapterWrapper), i5);
    }
    ...
    public void onItemRangeMoved(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i4, int i5) {
        ...
        this.mConcatAdapter.notifyItemMoved(i4 + iCountItemsBefore, i5 + iCountItemsBefore);
    }

    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeRemoved(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i4, int i5) {
        this.mConcatAdapter.notifyItemRangeRemoved(i4 + countItemsBefore(nestedAdapterWrapper), i5);
    }
    ...
    public boolean addAdapter(int i4, RecyclerView.Adapter<RecyclerView.ViewHolder> adapter) {
        if (i4 < 0 || i4 > this.mWrappers.size()) {
            StringBuilder sbA = f.a("Index must be between 0 and ");
            sbA.append(this.mWrappers.size());
            sbA.append(". Given:");
            sbA.append(i4);
        ...
        this.mWrappers.add(i4, nestedAdapterWrapper);
        Iterator<WeakReference<RecyclerView>> it = this.mAttachedRecyclerViews.iterator();
        while (it.hasNext()) {
            RecyclerView recyclerView = it.next().get();
            if (recyclerView != null) {
    ...
    public void onItemRangeChanged(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i4, int i5, @Nullable Object obj) {
        this.mConcatAdapter.notifyItemRangeChanged(i4 + countItemsBefore(nestedAdapterWrapper), i5, obj);
    }
}
