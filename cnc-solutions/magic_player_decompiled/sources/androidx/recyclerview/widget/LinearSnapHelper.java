...
public class LinearSnapHelper extends SnapHelper {
    ...
    private int estimateNextPositionDiffForFling(RecyclerView.LayoutManager layoutManager, OrientationHelper orientationHelper, int i4, int i5) {
        int[] iArrCalculateScrollDistance = calculateScrollDistance(i4, i5);
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int i4, int i5) {
        ...
        if (layoutManager.canScrollHorizontally()) {
            iEstimateNextPositionDiffForFling = estimateNextPositionDiffForFling(layoutManager, getHorizontalHelper(layoutManager), i4, 0);
        ...
        if (layoutManager.canScrollVertically()) {
            iEstimateNextPositionDiffForFling2 = estimateNextPositionDiffForFling(layoutManager, getVerticalHelper(layoutManager), 0, i5);
        ...
        int i7 = position + iEstimateNextPositionDiffForFling;
        int i8 = i7 >= 0 ? i7 : 0;
        return i8 >= itemCount ? i6 : i8;
    }
}
