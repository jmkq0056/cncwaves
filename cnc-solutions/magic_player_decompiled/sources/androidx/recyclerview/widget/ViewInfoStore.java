...
class ViewInfoStore {
    ...
    private RecyclerView.ItemAnimator.ItemHolderInfo popFromLayoutStep(RecyclerView.ViewHolder viewHolder, int i4) {
        ...
        if (iIndexOfKey >= 0 && (infoRecordValueAt = this.mLayoutHolderMap.valueAt(iIndexOfKey)) != null) {
            int i5 = infoRecordValueAt.flags;
            if ((i5 & i4) != 0) {
                int i6 = (i4 ^ (-1)) & i5;
                infoRecordValueAt.flags = i6;
                if (i4 == 4) {
    ...
    public void addToOldChangeHolders(long j4, RecyclerView.ViewHolder viewHolder) {
        this.mOldChangedHolders.put(j4, viewHolder);
    }
    ...
    public RecyclerView.ViewHolder getFromOldChangeHolders(long j4) {
    ...
    public void process(ProcessCallback processCallback) {
        for (int size = this.mLayoutHolderMap.size() - 1; size >= 0; size--) {
            ...
            int i4 = infoRecordRemoveAt.flags;
            if ((i4 & 3) == 3) {
