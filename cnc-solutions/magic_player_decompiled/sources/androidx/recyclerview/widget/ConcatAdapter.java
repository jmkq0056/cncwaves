...
public final class ConcatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final class Config {
        ...
        public Config(boolean z3, @NonNull StableIdMode stableIdMode) {
    ...
    public int findRelativeAdapterPositionIn(@NonNull RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter, @NonNull RecyclerView.ViewHolder viewHolder, int i4) {
        return this.mController.getLocalAdapterPosition(adapter, viewHolder, i4);
    }
    ...
    public long getItemId(int i4) {
        return this.mController.getItemId(i4);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int i4) {
        return this.mController.getItemViewType(i4);
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i4) {
        this.mController.onBindViewHolder(viewHolder, i4);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    @NonNull
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i4) {
        return this.mController.onCreateViewHolder(viewGroup, i4);
    }
    ...
    public boolean addAdapter(int i4, @NonNull RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter) {
        return this.mController.addAdapter(i4, adapter);
    }
