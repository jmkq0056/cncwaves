...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static class VectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public boolean canReuseBitmap(int i4, int i5) {
            return i4 == this.mCachedBitmap.getWidth() && i5 == this.mCachedBitmap.getHeight();
        }
        ...
        public void createCachedBitmapIfNeeded(int i4, int i5) {
            if (this.mCachedBitmap == null || !canReuseBitmap(i4, i5)) {
                this.mCachedBitmap = Bitmap.createBitmap(i4, i5, Bitmap.Config.ARGB_8888);
        ...
        public void updateCachedBitmap(int i4, int i5) {
            ...
            this.mVPathRenderer.draw(new Canvas(this.mCachedBitmap), i4, i5, null);
        }
    ...
    private void printGroupTree(VGroup vGroup, int i4) {
        ...
        StringBuilder sbA = g.a(strA, "current group is :");
    ...
    public void setAlpha(int i4) {
        ...
        } else if (this.mVectorState.mVPathRenderer.getRootAlpha() != i4) {
            this.mVectorState.mVPathRenderer.setRootAlpha(i4);
            invalidateSelf();
        }
    }
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i4 = 0; i4 < pathDataNodeArr.length; i4++) {
                ...
                sbA.append(pathDataNodeArr[i4].mType);
                sbA.append(":");
                string = sbA.toString();
        ...
        public void printVPath(int i4) {
            ...
            StringBuilder sbA = g.a(strA, "current path is :");
    ...
    public static class VFullPath extends VPath {
        ...
        private Paint.Cap getStrokeLineCap(int i4, Paint.Cap cap) {
            return i4 != 0 ? i4 != 1 ? i4 != 2 ? cap : Paint.Cap.SQUARE : Paint.Cap.ROUND : Paint.Cap.BUTT;
        }

        private Paint.Join getStrokeLineJoin(int i4, Paint.Join join) {
    ...
    public static class VPathRenderer {
        ...
        private void drawGroupTree(VGroup vGroup, Matrix matrix, Canvas canvas, int i4, int i5, ColorFilter colorFilter) {
            ...
            for (int i6 = 0; i6 < vGroup.mChildren.size(); i6++) {
                VObject vObject = vGroup.mChildren.get(i6);
                if (vObject instanceof VGroup) {
                    drawGroupTree((VGroup) vObject, vGroup.mStackedMatrix, canvas, i4, i5, colorFilter);
                } else if (vObject instanceof VPath) {
                    drawPath(vGroup, (VPath) vObject, canvas, i4, i5, colorFilter);
                }
            }
            canvas.restore();
        }

        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i4, int i5, ColorFilter colorFilter) {
            float f4 = i4 / this.mViewportWidth;
        ...
        public void draw(Canvas canvas, int i4, int i5, ColorFilter colorFilter) {
            drawGroupTree(this.mRootGroup, IDENTITY_MATRIX, canvas, i4, i5, colorFilter);
        }
    ...
    public static class VGroup extends VObject {
        ...
        public boolean onStateChanged(int[] iArr) {
            ...
            for (int i4 = 0; i4 < this.mChildren.size(); i4++) {
                zOnStateChanged |= this.mChildren.get(i4).onStateChanged(iArr);
            }
            return zOnStateChanged;
        }
