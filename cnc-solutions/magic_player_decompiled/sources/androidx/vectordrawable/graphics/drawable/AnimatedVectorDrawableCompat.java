...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    private void setupColorAnimator(Animator animator) {
        ...
        if ((animator instanceof AnimatorSet) && (childAnimations = ((AnimatorSet) animator).getChildAnimations()) != null) {
            for (int i4 = 0; i4 < childAnimations.size(); i4++) {
                setupColorAnimator(childAnimations.get(i4));
            }
        }
    ...
    public boolean onLevelChange(int i4) {
        Drawable drawable = this.mDelegateDrawable;
        return drawable != null ? drawable.setLevel(i4) : this.mAnimatedVectorState.mVectorDrawable.setLevel(i4);
    }
        ...
        if (this.mAnimatorListener == null) {
            this.mAnimatorListener = new AnimatorListenerAdapter() { // from class: androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat.2
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    int size = arrayList.size();
                    for (int i4 = 0; i4 < size; i4++) {
                        ((Animatable2Compat.AnimationCallback) arrayList.get(i4)).onAnimationEnd(AnimatedVectorDrawableCompat.this);
                    }
                }
                ...
                public void onAnimationStart(Animator animator) {
                    ...
                    int size = arrayList.size();
                    for (int i4 = 0; i4 < size; i4++) {
                        ((Animatable2Compat.AnimationCallback) arrayList.get(i4)).onAnimationStart(AnimatedVectorDrawableCompat.this);
                    }
                }
            };
        }
    ...
    public void setAlpha(int i4) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setAlpha(i4);
        }
    }
    ...
    public void setAutoMirrored(boolean z3) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setAutoMirrored(z3);
        }
    }
    ...
    public void setTint(int i4) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setTint(i4);
        }
    }
    ...
    public boolean setVisible(boolean z3, boolean z4) {
        ...
        this.mAnimatedVectorState.mVectorDrawable.setVisible(z3, z4);
