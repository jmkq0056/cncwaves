...
public abstract class FragmentStatePagerAdapter extends PagerAdapter {
    ...
    public void destroyItem(@NonNull ViewGroup viewGroup, int i4, @NonNull Object obj) {
        ...
        this.mSavedState.set(i4, fragment.isAdded() ? this.mFragmentManager.saveFragmentInstanceState(fragment) : null);
    ...
    public Object instantiateItem(@NonNull ViewGroup viewGroup, int i4) {
        ...
        Fragment fragment;
        if (this.mFragments.size() > i4 && (fragment = this.mFragments.get(i4)) != null) {
            return fragment;
        }
        if (this.mCurTransaction == null) {
            this.mCurTransaction = this.mFragmentManager.beginTransaction();
        ...
        if (this.mSavedState.size() > i4 && (savedState = this.mSavedState.get(i4)) != null) {
    ...
    public void restoreState(@Nullable Parcelable parcelable, @Nullable ClassLoader classLoader) {
        if (parcelable != null) {
            ...
            for (String str : bundle.keySet()) {
                if (str.startsWith("f")) {
                    int i4 = Integer.parseInt(str.substring(1));
                    ...
                    if (fragment != null) {
                        ...
                        this.mFragments.set(i4, fragment);
                    } else {
    ...
    public Parcelable saveState() {
        ...
        for (int i4 = 0; i4 < this.mFragments.size(); i4++) {
            ...
            if (fragment != null && fragment.isAdded()) {
                ...
                this.mFragmentManager.putFragment(bundle, d.a("f", i4), fragment);
            }
        }
        return bundle;
    }
