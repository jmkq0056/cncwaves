...
public abstract class FragmentManager {
    ...
    @Nullable
    public abstract Fragment findFragmentById(@IdRes int i4);

    @Nullable
    public abstract Fragment findFragmentByTag(@Nullable String str);

    @NonNull
    public abstract BackStackEntry getBackStackEntryAt(int i4);
    ...
    public abstract void popBackStack(@Nullable String str, int i4);

    public abstract boolean popBackStackImmediate();

    public abstract boolean popBackStackImmediate(int i4, int i5);

    public abstract boolean popBackStackImmediate(@Nullable String str, int i4);

    public abstract void putFragment(@NonNull Bundle bundle, @NonNull String str, @NonNull Fragment fragment);

    public abstract void registerFragmentLifecycleCallbacks(@NonNull FragmentLifecycleCallbacks fragmentLifecycleCallbacks, boolean z3);
