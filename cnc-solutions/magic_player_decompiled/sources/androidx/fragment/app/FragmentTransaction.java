...
public abstract class FragmentTransaction {
    ...
    public static final class Op {
        ...
        public Op(int i4, @NonNull Fragment fragment, Lifecycle.State state) {
            this.mCmd = i4;
            this.mFragment = fragment;
        ...
        if (FragmentTransition.supportsTransition()) {
            ...
            if (this.mSharedElementSourceNames == null) {
                ...
                if (this.mSharedElementTargetNames.contains(str)) {
                    throw new IllegalArgumentException(h.a("A shared element with the target name '", str, "' has already been added to the transaction."));
                }
                if (this.mSharedElementSourceNames.contains(transitionName)) {
                    throw new IllegalArgumentException(h.a("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
                }
            }
    ...
    public void doAddOp(int i4, Fragment fragment, @Nullable String str, int i5) {
        ...
        if (cls.isAnonymousClass() || !Modifier.isPublic(modifiers) || (cls.isMemberClass() && !Modifier.isStatic(modifiers))) {
            StringBuilder sbA = f.a("Fragment ");
            sbA.append(cls.getCanonicalName());
            sbA.append(" must be a public static class to be  properly recreated from instance state.");
    ...
    public FragmentTransaction replace(@IdRes int i4, @NonNull Fragment fragment) {
        return replace(i4, fragment, null);
    }
