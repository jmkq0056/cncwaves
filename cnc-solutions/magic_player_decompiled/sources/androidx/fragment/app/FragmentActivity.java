...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    public class HostCallbacks extends FragmentHostCallback<FragmentActivity> implements ViewModelStoreOwner, OnBackPressedDispatcherOwner {
        ...
        @Override // androidx.fragment.app.FragmentHostCallback
        public void onStartIntentSenderFromFragment(@NonNull Fragment fragment, IntentSender intentSender, int i4, @Nullable Intent intent, int i5, int i6, int i7, Bundle bundle) {
    ...
    public static void checkForValidRequestCode(int i4) {
        if ((i4 & SupportMenu.CATEGORY_MASK) != 0) {
    ...
    public void onActivityResult(int i4, int i5, @Nullable Intent intent) {
        ...
        if (fragmentFindFragmentByWho != null) {
            fragmentFindFragmentByWho.onActivityResult(i4 & 65535, i5, intent);
            return;
        }
    ...
    public boolean onCreatePanelMenu(int i4, @NonNull Menu menu) {
        return i4 == 0 ? super.onCreatePanelMenu(i4, menu) | this.mFragments.dispatchCreateOptionsMenu(menu, getMenuInflater()) : super.onCreatePanelMenu(i4, menu);
    }
    ...
    public boolean onPreparePanel(int i4, @Nullable View view, @NonNull Menu menu) {
        return i4 == 0 ? onPrepareOptionsPanel(view, menu) | this.mFragments.dispatchPrepareOptionsMenu(menu) : super.onPreparePanel(i4, view, menu);
    }
    ...
    public void onRequestPermissionsResult(int i4, @NonNull String[] strArr, @NonNull int[] iArr) {
        ...
        if (i5 != 0) {
            ...
            Fragment fragmentFindFragmentByWho = this.mFragments.findFragmentByWho(str);
            if (fragmentFindFragmentByWho != null) {
                fragmentFindFragmentByWho.onRequestPermissionsResult(i4 & 65535, strArr, iArr);
                return;
            }
            Log.w(TAG, "Activity result no fragment exists for who: " + str);
        }
    ...
    public void requestPermissionsFromFragment(@NonNull Fragment fragment, @NonNull String[] strArr, int i4) {
        if (i4 == -1) {
    ...
    public void startIntentSenderFromFragment(@NonNull Fragment fragment, @SuppressLint({"UnknownNullness"}) IntentSender intentSender, int i4, @Nullable Intent intent, int i5, int i6, int i7, @Nullable Bundle bundle) {
