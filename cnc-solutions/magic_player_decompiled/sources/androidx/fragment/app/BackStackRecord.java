...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
        ...
        if (this.mAddToBackStack) {
            ...
            for (int i5 = 0; i5 < size; i5++) {
                ...
                if (fragment != null) {
                    ...
                    if (FragmentManagerImpl.DEBUG) {
                        StringBuilder sbA = f.a("Bump nesting of ");
                        sbA.append(op.mFragment);
                        sbA.append(" to ");
                        sbA.append(op.mFragment.mBackStackNesting);
    ...
    public FragmentTransaction detach(@NonNull Fragment fragment) {
        ...
        StringBuilder sbA = f.a("Cannot detach Fragment attached to a different FragmentManager. Fragment ");
        sbA.append(fragment.toString());
        sbA.append(" is already attached to a FragmentManager.");
    ...
    public void executeOps() {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            ...
            switch (op.mCmd) {
                ...
                case 2:
                default:
                    StringBuilder sbA = f.a("Unknown cmd: ");
                    sbA.append(op.mCmd);
    ...
    */
    ...
    public FragmentTransaction hide(@NonNull Fragment fragment) {
        ...
        StringBuilder sbA = f.a("Cannot hide Fragment attached to a different FragmentManager. Fragment ");
        sbA.append(fragment.toString());
        sbA.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(sbA.toString());
    }
    ...
    public FragmentTransaction remove(@NonNull Fragment fragment) {
        ...
        StringBuilder sbA = f.a("Cannot remove Fragment attached to a different FragmentManager. Fragment ");
        sbA.append(fragment.toString());
        sbA.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(sbA.toString());
    }
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        if (fragment.mFragmentManager != this.mManager) {
            StringBuilder sbA = f.a("Cannot setMaxLifecycle for Fragment not attached to FragmentManager ");
            sbA.append(this.mManager);
            throw new IllegalArgumentException(sbA.toString());
        }
    ...
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        ...
        StringBuilder sbA = f.a("Cannot setPrimaryNavigation for Fragment attached to a different FragmentManager. Fragment ");
        sbA.append(fragment.toString());
        sbA.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(sbA.toString());
    }
    ...
    public FragmentTransaction show(@NonNull Fragment fragment) {
        ...
        StringBuilder sbA = f.a("Cannot show Fragment attached to a different FragmentManager. Fragment ");
        sbA.append(fragment.toString());
        sbA.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(sbA.toString());
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public androidx.fragment.app.Fragment trackAddedFragmentsInPop(java.util.ArrayList<androidx.fragment.app.Fragment> r6, androidx.fragment.app.Fragment r7) {
        /*
            r5 = this;
