...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, SavedStateRegistryOwner {
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        this.mChildFragmentManager.dump(androidx.appcompat.view.a.a(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public void performMultiWindowModeChanged(boolean z3) {
        ...
        this.mChildFragmentManager.dispatchMultiWindowModeChanged(z3);
    }
    ...
    public void performPictureInPictureModeChanged(boolean z3) {
        ...
        this.mChildFragmentManager.dispatchPictureInPictureModeChanged(z3);
    }
    ...
    public final void requestPermissions(@NonNull String[] strArr, int i4) {
        ...
        fragmentHostCallback.onRequestPermissionsFromFragment(this, strArr, i4);
    }
    ...
    public void setAllowEnterTransitionOverlap(boolean z3) {
        ensureAnimationInfo().mAllowEnterTransitionOverlap = Boolean.valueOf(z3);
    }

    public void setAllowReturnTransitionOverlap(boolean z3) {
        ensureAnimationInfo().mAllowReturnTransitionOverlap = Boolean.valueOf(z3);
    }
    ...
    public void setHideReplaced(boolean z3) {
        ensureAnimationInfo().mIsHideReplaced = z3;
    }
    ...
    public void setNextAnim(int i4) {
        ...
        ensureAnimationInfo().mNextAnim = i4;
    }
    ...
    public void setNextTransition(int i4, int i5) {
        ...
        ensureAnimationInfo();
        AnimationInfo animationInfo = this.mAnimationInfo;
        animationInfo.mNextTransition = i4;
        animationInfo.mNextTransitionStyle = i5;
    }
    ...
    public void setStateAfterAnimating(int i4) {
        ensureAnimationInfo().mStateAfterAnimating = i4;
    }
    ...
    public void setUserVisibleHint(boolean z3) {
        if (!this.mUserVisibleHint && z3 && this.mState < 3 && this.mFragmentManager != null && isAdded() && this.mIsCreated) {
            this.mFragmentManager.performPendingDeferredStart(this);
        }
        this.mUserVisibleHint = z3;
        this.mDeferStart = this.mState < 3 && !z3;
        if (this.mSavedFragmentState != null) {
    ...
    public void startIntentSenderForResult(@SuppressLint({"UnknownNullness"}) IntentSender intentSender, int i4, @Nullable Intent intent, int i5, int i6, int i7, @Nullable Bundle bundle) {
        ...
        fragmentHostCallback.onStartIntentSenderFromFragment(this, intentSender, i4, intent, i5, i6, i7, bundle);
    }
    ...
    public static Fragment instantiate(@NonNull Context context, @NonNull String str, @Nullable Bundle bundle) {
        try {
            ...
            throw new InstantiationException(h.a("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e4);
        } catch (java.lang.InstantiationException e5) {
            throw new InstantiationException(h.a("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e5);
        } catch (NoSuchMethodException e6) {
            throw new InstantiationException(h.a("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e6);
        } catch (InvocationTargetException e7) {
            throw new InstantiationException(h.a("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e7);
        }
    }
    ...
    public void startActivityForResult(@SuppressLint({"UnknownNullness"}) Intent intent, int i4, @Nullable Bundle bundle) {
        ...
        fragmentHostCallback.onStartActivityFromFragment(this, intent, i4, bundle);
    }
