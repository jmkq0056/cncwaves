...
public class ChangeTransform extends Transition {
    ...
    public static class Transforms {
        ...
        public int hashCode() {
            ...
            int iFloatToIntBits = (f4 != 0.0f ? Float.floatToIntBits(f4) : 0) * 31;
            float f5 = this.mTranslationY;
            int iFloatToIntBits2 = (iFloatToIntBits + (f5 != 0.0f ? Float.floatToIntBits(f5) : 0)) * 31;
            float f6 = this.mTranslationZ;
            int iFloatToIntBits3 = (iFloatToIntBits2 + (f6 != 0.0f ? Float.floatToIntBits(f6) : 0)) * 31;
            float f7 = this.mScaleX;
            int iFloatToIntBits4 = (iFloatToIntBits3 + (f7 != 0.0f ? Float.floatToIntBits(f7) : 0)) * 31;
            float f8 = this.mScaleY;
            int iFloatToIntBits5 = (iFloatToIntBits4 + (f8 != 0.0f ? Float.floatToIntBits(f8) : 0)) * 31;
            float f9 = this.mRotationX;
            int iFloatToIntBits6 = (iFloatToIntBits5 + (f9 != 0.0f ? Float.floatToIntBits(f9) : 0)) * 31;
            float f10 = this.mRotationY;
            int iFloatToIntBits7 = (iFloatToIntBits6 + (f10 != 0.0f ? Float.floatToIntBits(f10) : 0)) * 31;
            float f11 = this.mRotationZ;
            return iFloatToIntBits7 + (f11 != 0.0f ? Float.floatToIntBits(f11) : 0);
        }
    ...
    */
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        boolean z3 = this.mReparent && !parentsMatch(viewGroup2, (ViewGroup) transitionValues2.values.get(PROPNAME_PARENT));
        ...
        ObjectAnimator objectAnimatorCreateTransformAnimator = createTransformAnimator(transitionValues, transitionValues2, z3);
        if (z3 && objectAnimatorCreateTransformAnimator != null && this.mUseOverlay) {
