...
public class Explode extends Visibility {
    ...
    private void calculateOut(View view, Rect rect, int[] iArr) {
        ...
        if (epicenter == null) {
            iCenterX = Math.round(view.getTranslationX()) + (view.getWidth() / 2) + i4;
            iCenterY = Math.round(view.getTranslationY()) + (view.getHeight() / 2) + i5;
        } else {
        ...
        float fCalculateMaxDistance = calculateMaxDistance(view, iCenterX - i4, iCenterY - i5);
