...
public class TransitionSet extends Transition {
    ...
    public void runAnimators() {
        ...
        for (int i4 = 1; i4 < this.mTransitions.size(); i4++) {
            Transition transition = this.mTransitions.get(i4 - 1);
            final Transition transition2 = this.mTransitions.get(i4);
    ...
    public TransitionSet setOrdering(int i4) {
        if (i4 == 0) {
            ...
            if (i4 != 1) {
                throw new AndroidRuntimeException(d.a("Invalid parameter for TransitionSet ordering: ", i4));
            }
    ...
    public String toString(String str) {
        ...
        for (int i4 = 0; i4 < this.mTransitions.size(); i4++) {
            ...
            sbA.append(this.mTransitions.get(i4).toString(str + "  "));
            string = sbA.toString();
        }
        return string;
    }
    ...
    public Transition mo5clone() {
        ...
        int size = this.mTransitions.size();
        for (int i4 = 0; i4 < size; i4++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i4).mo5clone());
        }
