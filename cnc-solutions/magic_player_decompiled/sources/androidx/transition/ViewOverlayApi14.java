    ...
    public static class OverlayViewGroup extends ViewGroup {
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                this.mDrawables.get(i4).draw(canvas);
            }
        }
        ...
        public ViewParent invalidateChildInParentFast(int i4, int i5, Rect rect) {
            if (!(this.mHostView instanceof ViewGroup) || sInvalidateChildInParentFastMethod == null) {
                return null;
            }
            try {
                getOffset(new int[2]);
                sInvalidateChildInParentFastMethod.invoke(this.mHostView, Integer.valueOf(i4), Integer.valueOf(i5), rect);
                return null;
