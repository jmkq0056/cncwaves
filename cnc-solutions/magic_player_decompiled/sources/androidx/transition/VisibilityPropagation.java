...
public abstract class VisibilityPropagation extends TransitionPropagation {
    ...
    private static int getViewCoordinate(TransitionValues transitionValues, int i4) {
        int[] iArr;
    ...
    public void captureValues(TransitionValues transitionValues) {
        ...
        Integer numValueOf = (Integer) transitionValues.values.get(Visibility.PROPNAME_VISIBILITY);
        if (numValueOf == null) {
