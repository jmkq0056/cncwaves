...
public class Fade extends Visibility {
    ...
    private Animator createAnimation(final View view, float f4, float f5) {
        ...
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(view, ViewUtils.TRANSITION_ALPHA, f5);
    ...
    private static float getStartAlpha(TransitionValues transitionValues, float f4) {
        Float f5;
        return (transitionValues == null || (f5 = (Float) transitionValues.values.get(PROPNAME_TRANSITION_ALPHA)) == null) ? f4 : f5.floatValue();
    }
