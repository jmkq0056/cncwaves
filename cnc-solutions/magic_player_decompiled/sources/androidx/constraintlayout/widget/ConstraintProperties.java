        ...
        switch (i4) {
            case 1:
                if (i6 == 1) {
                    ...
                    if (i6 != 2) {
                        throw new IllegalArgumentException(b.a(f.a("Left to "), sideToString(i6), " undefined"));
                    }
            ...
            case 2:
                if (i6 == 1) {
                    ...
                    if (i6 != 2) {
                        throw new IllegalArgumentException(b.a(f.a("right to "), sideToString(i6), " undefined"));
                    }
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(b.a(sb, sideToString(i6), " unknown"));
        }
    }
