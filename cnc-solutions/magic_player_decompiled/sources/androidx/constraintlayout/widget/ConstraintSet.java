...
public class ConstraintSet {
                                        ...
                                        default:
                                            switch (i5) {
                                                ...
                                                case 76:
                                                    ...
                                                    sbA.append("   ");
                                                    sbA.append(mapToConstant.get(index));
                                                    Log.w(ConstraintSet.TAG, sbA.toString());
                                                    break;
                                                case 77:
                                                    this.mConstraintTag = typedArrayObtainStyledAttributes.getString(index);
                                                    break;
                                                default:
                                                    StringBuilder sbA2 = f.a("Unknown attribute 0x");
                                                    sbA2.append(Integer.toHexString(index));
                                                    sbA2.append("   ");
                                                    sbA2.append(mapToConstant.get(index));
                                                    Log.w(ConstraintSet.TAG, sbA2.toString());
                                                    break;
                                            }
                                            break;
                                    }
        ...
        for (int i4 = 0; i4 < strArr.length; i4++) {
            if (this.mSavedAttributes.containsKey(strArr[i4])) {
                ...
                if (constraintAttribute.getType() != attributeType) {
                    StringBuilder sbA = f.a("ConstraintAttribute is already a ");
                    sbA.append(constraintAttribute.getType().name());
                    throw new IllegalArgumentException(sbA.toString());
                }
            } else {
    ...
    public void applyCustomAttributes(ConstraintLayout constraintLayout) {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if (!this.mConstraints.containsKey(Integer.valueOf(id))) {
                StringBuilder sbA = f.a("id unknown ");
        ...
        switch (i5) {
            case 1:
                if (i7 == 1) {
                    ...
                    if (i7 != 2) {
                        throw new IllegalArgumentException(b.a(f.a("Left to "), sideToString(i7), " undefined"));
                    }
                    Layout layout2 = constraint.layout;
            ...
            case 2:
                if (i7 == 1) {
                    ...
                    if (i7 != 2) {
                        throw new IllegalArgumentException(b.a(f.a("right to "), sideToString(i7), " undefined"));
                    }
                    Layout layout4 = constraint.layout;
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(b.a(sb, sideToString(i7), " unknown"));
        }
    }
    ...
    public void parseColorAttributes(Constraint constraint, String str) {
        ...
        for (int i4 = 0; i4 < strArrSplit.length; i4++) {
            ...
            if (strArrSplit2.length != 2) {
                StringBuilder sbA = f.a(" Unable to parse ");
                sbA.append(strArrSplit[i4]);
                Log.w(TAG, sbA.toString());
            } else {
    ...
    public void parseStringAttributes(Constraint constraint, String str) {
        ...
        for (int i4 = 0; i4 < strArrSplitString.length; i4++) {
            String[] strArrSplit = strArrSplitString[i4].split("=");
            StringBuilder sbA = f.a(" Unable to parse ");
            sbA.append(strArrSplitString[i4]);
            Log.w(TAG, sbA.toString());
    ...
    public void removeFromHorizontalChain(int i4) {
        if (this.mConstraints.containsKey(Integer.valueOf(i4))) {
            ...
            int i9 = layout.startToEnd;
            int i10 = layout.endToStart;
            if (i9 != -1 || i10 != -1) {
                if (i9 != -1 && i10 != -1) {
