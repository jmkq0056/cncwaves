...
public class LinearCurveFit extends CurveFit {
    ...
    private double getLength2D(double d4) {
        ...
        while (i5 < i4) {
            ...
            int i6 = i5 + 1;
            if (d4 < dArr3[i6]) {
                double d9 = (d4 - dArr3[i5]) / (dArr3[i6] - dArr3[i5]);
                double[][] dArr4 = this.mY;
                double d10 = dArr4[i5][0];
                double d11 = dArr4[i6][0];
                double d12 = 1.0d - d9;
                return Math.hypot(d8 - ((dArr4[i6][1] * d9) + (dArr4[i5][1] * d12)), d7 - ((d11 * d9) + (d10 * d12))) + dHypot;
            }
            i5 = i6;
            d5 = d7;
            d6 = d8;
    ...
    public void getPos(double d4, double[] dArr) {
        ...
        while (i7 < i6) {
            ...
            if (d4 < dArr3[i9]) {
                ...
                while (i4 < length2) {
                    double[][] dArr4 = this.mY;
                    dArr[i4] = (dArr4[i9][i4] * d5) + ((1.0d - d5) * dArr4[i7][i4]);
                    i4++;
                }
                return;
            }
    ...
    public void getPos(double d4, float[] fArr) {
        ...
        while (i7 < i6) {
            ...
            if (d4 < dArr2[i9]) {
                ...
                while (i4 < length2) {
                    double[][] dArr3 = this.mY;
                    fArr[i4] = (float) ((dArr3[i9][i4] * d5) + ((1.0d - d5) * dArr3[i7][i4]));
                    i4++;
                }
                return;
            }
    ...
    public double getPos(double d4, int i4) {
        ...
        while (i5 < i6) {
            ...
            if (d4 < dArr2[i7]) {
                ...
                double[][] dArr3 = this.mY;
                return (dArr3[i7][i4] * d5) + ((1.0d - d5) * dArr3[i5][i4]);
            }
            i5 = i7;
        }
        return 0.0d;
