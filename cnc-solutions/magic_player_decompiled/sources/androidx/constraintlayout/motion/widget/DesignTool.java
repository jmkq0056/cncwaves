...
public class DesignTool implements ProxyInterface {
    ...
    private static void Connect(int i4, ConstraintSet constraintSet, View view, HashMap<String, String> map, int i5, int i6) {
        String str = allAttributes.get(Pair.create(Integer.valueOf(i5), Integer.valueOf(i6)));
        String str2 = map.get(str);
        if (str2 != null) {
            String str3 = allMargins.get(str);
            constraintSet.connect(view.getId(), i5, Integer.parseInt(str2), i6, str3 != null ? GetPxFromDp(i4, map.get(str3)) : 0);
        }
    }
    ...
    private static void SetAbsolutePositions(int i4, ConstraintSet constraintSet, View view, HashMap<String, String> map) {
    ...
    private static void SetBias(ConstraintSet constraintSet, View view, HashMap<String, String> map, int i4) {
    ...
    private static void SetDimensions(int i4, ConstraintSet constraintSet, View view, HashMap<String, String> map, int i5) {
        String str = map.get(i5 == 1 ? "layout_height" : "layout_width");
        if (str != null) {
            int iGetPxFromDp = str.equalsIgnoreCase("wrap_content") ? -2 : GetPxFromDp(i4, str);
            if (i5 == 0) {
    ...
    public void setAttributes(int i4, String str, Object obj, Object obj2) {
        ...
        SetDimensions(i4, constraintSet, view, map, 0);
        SetDimensions(i4, constraintSet, view, map, 1);
        Connect(i4, constraintSet, view, map, 6, 6);
        Connect(i4, constraintSet, view, map, 6, 7);
        Connect(i4, constraintSet, view, map, 7, 7);
        Connect(i4, constraintSet, view, map, 7, 6);
        Connect(i4, constraintSet, view, map, 1, 1);
        Connect(i4, constraintSet, view, map, 1, 2);
        Connect(i4, constraintSet, view, map, 2, 2);
        Connect(i4, constraintSet, view, map, 2, 1);
        Connect(i4, constraintSet, view, map, 3, 3);
        Connect(i4, constraintSet, view, map, 3, 4);
        Connect(i4, constraintSet, view, map, 4, 3);
        Connect(i4, constraintSet, view, map, 4, 4);
        Connect(i4, constraintSet, view, map, 5, 5);
        SetBias(constraintSet, view, map, 0);
        SetBias(constraintSet, view, map, 1);
        SetAbsolutePositions(i4, constraintSet, view, map);
