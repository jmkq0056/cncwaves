...
public class ConstraintAnchor {
    ...
    private boolean isConnectionToMe(ConstraintWidget constraintWidget, HashSet<ConstraintWidget> hashSet) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            ConstraintAnchor constraintAnchor = anchors.get(i4);
    ...
    public boolean connect(ConstraintAnchor constraintAnchor, int i4, int i5, boolean z3) {
        if (constraintAnchor == null) {
            reset();
            return true;
        }
        if (!z3 && !isValidConnection(constraintAnchor)) {
            return false;
        }
    ...
    public boolean connect(ConstraintAnchor constraintAnchor, int i4) {
        return connect(constraintAnchor, i4, -1, false);
    }
}
