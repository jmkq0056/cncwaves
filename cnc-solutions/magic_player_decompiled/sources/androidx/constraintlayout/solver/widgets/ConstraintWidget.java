...
public class ConstraintWidget {
    ...
    */
    ...
    public int getOptimizerWrapHeight() {
        ...
        if (this.mMatchConstraintDefaultHeight == 1) {
            iMax = Math.max(this.mMatchConstraintMinHeight, i4);
        } else {
    ...
    public int getOptimizerWrapWidth() {
        ...
        if (this.mMatchConstraintDefaultWidth == 1) {
            iMax = Math.max(this.mMatchConstraintMinWidth, i4);
        } else {
    ...
    */
    ...
    public String toString() {
        ...
        sb.append(this.mType != null ? b.a(f.a("type: "), this.mType, " ") : "");
        sb.append(this.mDebugName != null ? b.a(f.a("id: "), this.mDebugName, " ") : "");
        sb.append("(");
        sb.append(this.mX);
        sb.append(", ");
        sb.append(this.mY);
        ...
        sb.append(" x ");
        return e.a(sb, this.mHeight, ")");
    }

    public void updateFromRuns(boolean z3, boolean z4) {
        int i4;
        int i5;
        boolean zIsResolved = z3 & this.horizontalRun.isResolved();
        boolean zIsResolved2 = z4 & this.verticalRun.isResolved();
