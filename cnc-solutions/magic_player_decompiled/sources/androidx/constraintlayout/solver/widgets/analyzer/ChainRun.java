...
public class ChainRun extends WidgetRun {
    ...
    private ConstraintWidget getFirstVisibleWidget() {
        for (int i4 = 0; i4 < this.widgets.size(); i4++) {
            WidgetRun widgetRun = this.widgets.get(i4);
    ...
    public void applyToWidget() {
        for (int i4 = 0; i4 < this.widgets.size(); i4++) {
            this.widgets.get(i4).applyToWidget();
        }
    }
    ...
    public boolean supportsWrapComputation() {
        int size = this.widgets.size();
        for (int i4 = 0; i4 < size; i4++) {
            if (!this.widgets.get(i4).supportsWrapComputation()) {
                return false;
            }
        }
        return true;
    ...
    public String toString() {
        StringBuilder sbA = f.a("ChainRun ");
        sbA.append(this.orientation == 0 ? "horizontal : " : "vertical : ");
        String string = sbA.toString();
        for (WidgetRun widgetRun : this.widgets) {
            string = a.a(a.a(string, "<") + widgetRun, "> ");
        }
        return string;
    }
