...
public class VerticalWidgetRun extends WidgetRun {
    ...
    public void apply() {
        ...
        if (z3 || this.dimensionBehavior != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            } else if (i4 == 3 && !constraintWidget3.isInVerticalChain()) {
    ...
    public String toString() {
        StringBuilder sbA = f.a("VerticalRun ");
        sbA.append(this.widget.getDebugName());
        return sbA.toString();
    }
    ...
    public void update(Dependency dependency) {
        ...
        int dimensionRatio2;
        int i4 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$widgets$analyzer$WidgetRun$RunType[this.mRunType.ordinal()];
        if (i4 == 1) {
        ...
        if (dimensionDependency.readyToSolve && !dimensionDependency.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            if (i5 == 2) {
            ...
            } else if (i5 == 3 && constraintWidget2.horizontalRun.dimension.resolved) {
                ...
                if (dimensionRatioSide != -1) {
                    if (dimensionRatioSide == 0) {
                        ...
                        ConstraintWidget constraintWidget3 = this.widget;
                        f4 = constraintWidget3.horizontalRun.dimension.value;
                ...
                dimensionRatio2 = (int) ((f4 / dimensionRatio) + 0.5f);
                this.dimension.resolve(dimensionRatio2);
            }
        }
        DependencyNode dependencyNode = this.start;
            ...
            if (dependencyNode2.readyToSolve) {
                ...
                if (!this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                    ...
                    if (constraintWidget5.mMatchConstraintDefaultWidth == 0 && !constraintWidget5.isInVerticalChain()) {
                        ...
                        int i7 = i6 + dependencyNode5.margin;
                ...
                if (!this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && this.matchConstraintsType == 1 && this.start.targets.size() > 0 && this.end.targets.size() > 0) {
                    ...
                    int i9 = (this.end.targets.get(0).value + this.end.margin) - (dependencyNode6.value + this.start.margin);
                ...
                if (this.dimension.resolved && this.start.targets.size() > 0 && this.end.targets.size() > 0) {
                    ...
                    int i11 = dependencyNode7.value + this.start.margin;
                    int i12 = dependencyNode8.value + this.end.margin;
                    ...
                    this.start.resolve((int) ((((i12 - i11) - this.dimension.value) * verticalBiasPercent) + i11 + 0.5f));
