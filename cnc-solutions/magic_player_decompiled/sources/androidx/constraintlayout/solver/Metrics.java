...
public class Metrics {
    ...
    public String toString() {
        ...
        sbA.append(this.measures);
        sbA.append("\nmeasuresWrap: ");
        sbA.append(this.measuresWrap);
        sbA.append("\nmeasuresWrapInfeasible: ");
        sbA.append(this.measuresWrapInfeasible);
        sbA.append("\ndetermineGroups: ");
        sbA.append(this.determineGroups);
        sbA.append("\ninfeasibleDetermineGroups: ");
        sbA.append(this.infeasibleDetermineGroups);
        sbA.append("\ngraphOptimizer: ");
        sbA.append(this.graphOptimizer);
        sbA.append("\nwidgets: ");
        sbA.append(this.widgets);
        sbA.append("\ngraphSolved: ");
        sbA.append(this.graphSolved);
        sbA.append("\nlinearSolved: ");
        sbA.append(this.linearSolved);
        sbA.append("\n");
        return sbA.toString();
    }
}
