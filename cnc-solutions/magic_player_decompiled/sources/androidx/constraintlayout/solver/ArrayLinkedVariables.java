...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public void add(SolverVariable solverVariable, float f4, boolean z3) {
        ...
        if (f4 <= (-f5) || f4 >= f5) {
            ...
            if (length >= iArr7.length) {
                length = iArr7.length;
                int i12 = this.ROW_SIZE * 2;
                this.ROW_SIZE = i12;
                this.mDidFillOnce = false;
                this.mLast = length - 1;
                this.mArrayValues = Arrays.copyOf(this.mArrayValues, i12);
    ...
    public final void put(SolverVariable solverVariable, float f4) {
        ...
        solverVariable.usageInRowCount++;
        solverVariable.addToRow(this.mRow);
        int i13 = this.currentSize + 1;
        this.currentSize = i13;
        if (!this.mDidFillOnce) {
            this.mLast++;
        }
    ...
    public String toString() {
        ...
        String string = "";
        for (int i5 = 0; i4 != -1 && i5 < this.currentSize; i5++) {
            StringBuilder sbA = f.a(androidx.appcompat.view.a.a(string, " -> "));
            sbA.append(this.mArrayValues[i4]);
            sbA.append(" : ");
            StringBuilder sbA2 = f.a(sbA.toString());
            sbA2.append(this.mCache.mIndexedVariables[this.mArrayIndices[i4]]);
