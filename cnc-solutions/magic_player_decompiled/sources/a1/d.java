...
public class d {
    ...
    public final c.b f48b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final c.a f49c;
    ...
    public class a implements Runnable {
        ...
        public final /* synthetic */ c.InterfaceC0001c f53d;

        public a(Context context, String str, String str2, c.InterfaceC0001c interfaceC0001c) {
            this.f50a = context;
            this.f51b = str;
            this.f52c = str2;
            this.f53d = interfaceC0001c;
        }

        @Override // java.lang.Runnable
        public void run() throws Throwable {
            try {
                d.this.d(this.f50a, this.f51b, this.f52c);
                this.f53d.a();
            } catch (b e4) {
                this.f53d.b(e4);
    ...
    public File b(Context context, String str, String str2) {
        String strA = ((f) this.f48b).a(str);
        return q0.a.p(str2) ? new File(a(context), strA) : new File(a(context), h.a(strA, ".", str2));
    }

    public void c(Context context, String str, String str2, c.InterfaceC0001c interfaceC0001c) throws Throwable {
        if (context == null) {
        ...
        if (interfaceC0001c == null) {
            ...
            new Thread(new a(context, str, str2, interfaceC0001c)).start();
        }
    }
    ...
    */
    public final void d(android.content.Context r20, java.lang.String r21, java.lang.String r22) throws java.lang.Throwable {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: a1.d.d(android.content.Context, java.lang.String, java.lang.String):void");
    }
}
