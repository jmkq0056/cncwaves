...
public final class RatingCompat implements Parcelable {
    ...
    public static RatingCompat newStarRating(int i4, float f4) {
        ...
        if (i4 == 3) {
            ...
            if (i4 != 5) {
                Log.e(TAG, "Invalid rating style (" + i4 + ") for a star rating");
                return null;
            }
            f5 = 5.0f;
        }
    ...
    public String toString() {
        StringBuilder sbA = f.a("Rating:style=");
        sbA.append(this.mRatingStyle);
        sbA.append(" rating=");
        float f4 = this.mRatingValue;
        sbA.append(f4 < 0.0f ? "unrated" : String.valueOf(f4));
        return sbA.toString();
    }
