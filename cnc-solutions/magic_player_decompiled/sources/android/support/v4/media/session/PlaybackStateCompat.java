...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public long getCurrentPosition(Long l4) {
        return Math.max(0L, this.mPosition + ((long) (this.mSpeed * (l4 != null ? l4.longValue() : SystemClock.elapsedRealtime() - this.mUpdateTime))));
    }
    ...
    public static final class CustomAction implements Parcelable {
        ...
        public String toString() {
            StringBuilder sbA = f.a("Action:mName='");
            sbA.append((Object) this.mName);
            sbA.append(", mIcon=");
            sbA.append(this.mIcon);
            sbA.append(", mExtras=");
