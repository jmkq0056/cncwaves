...
class MediaControllerCompatApi21 {
    ...
    public interface Callback {
        void onAudioInfoChanged(int i4, int i5, int i6, int i7, int i8);
    ...
    public static class TransportControls {
        ...
        public static void seekTo(Object obj, long j4) {
        ...
        public static void skipToQueueItem(Object obj, long j4) {
            ((MediaController.TransportControls) obj).skipToQueueItem(j4);
        }
    ...
    public static void adjustVolume(Object obj, int i4, int i5) {
        ((MediaController) obj).adjustVolume(i4, i5);
    }
    ...
    public static void setVolumeTo(Object obj, int i4, int i5) {
        ((MediaController) obj).setVolumeTo(i4, i5);
    }
