...
public interface IMediaSession extends IInterface {
    ...
    void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int i4);

    void adjustVolume(int i4, int i5, String str);
    ...
    void setVolumeTo(int i4, int i5, String str);

    void skipToQueueItem(long j4);
