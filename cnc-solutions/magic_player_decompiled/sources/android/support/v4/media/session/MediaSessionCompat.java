...
public class MediaSessionCompat {
    ...
    public static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        public int getRccTransportControlFlagsFromActions(long j4) {
            ...
            if (playbackStateCompat.getState() == 3) {
                ...
                if (position > 0) {
                    if (lastPositionUpdateTime > 0) {
                        j4 = jElapsedRealtime - lastPositionUpdateTime;
                        if (playbackSpeed > 0.0f && playbackSpeed != 1.0f) {
                            j4 = (long) (j4 * playbackSpeed);
                        }
                    }
                    position += j4;
                }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void postToHandler(int i4) {
            ...
            public void postToHandler(int i4, int i5) {
                MediaSessionImplBase.this.postToHandler(i4, i5, 0, null, null);
            }

            public void postToHandler(int i4, Object obj) {
                MediaSessionImplBase.this.postToHandler(i4, 0, 0, obj, null);
            }

            public void postToHandler(int i4, Object obj, int i5) {
        ...
        private void sendCaptioningEnabled(boolean z3) {
            for (int iBeginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onCaptioningEnabledChanged(z3);
        ...
        private void sendRepeatMode(int i4) {
            for (int iBeginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onRepeatModeChanged(i4);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendShuffleMode(int i4) {
            for (int iBeginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onShuffleModeChanged(i4);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        public int getRccStateFromState(int i4) {
            switch (i4) {
                case 0:
                    return 0;
                case 1:
        ...
        public void postToHandler(int i4, int i5, int i6, Object obj, Bundle bundle) {
            synchronized (this.mLock) {
                MessageHandler messageHandler = this.mHandler;
                if (messageHandler != null) {
                    Message messageObtainMessage = messageHandler.obtainMessage(i4, i5, i6, obj);
                    Bundle bundle2 = new Bundle();
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public String toString() {
            StringBuilder sbA = f.a("MediaSession.QueueItem {Description=");
    ...
    public static PlaybackStateCompat getStateWithUpdatedPosition(PlaybackStateCompat playbackStateCompat, MediaMetadataCompat mediaMetadataCompat) {
        ...
        return new PlaybackStateCompat.Builder(playbackStateCompat).setState(playbackStateCompat.getState(), (j4 < 0 || position <= j4) ? position < 0 ? 0L : position : j4, playbackStateCompat.getPlaybackSpeed(), jElapsedRealtime).build();
    }
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public void setCaptioningEnabled(boolean z3) {
            if (this.mCaptioningEnabled != z3) {
                ...
                for (int iBeginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                    try {
                        ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onCaptioningEnabledChanged(z3);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
        ...
        public void setRepeatMode(int i4) {
            if (this.mRepeatMode != i4) {
                ...
                for (int iBeginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                    try {
                        ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onRepeatModeChanged(i4);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
        ...
        public void setShuffleMode(int i4) {
            if (this.mShuffleMode != i4) {
                ...
                for (int iBeginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                    try {
                        ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onShuffleModeChanged(i4);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
