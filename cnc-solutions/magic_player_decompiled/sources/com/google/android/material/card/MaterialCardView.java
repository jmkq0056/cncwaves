...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    public int[] onCreateDrawableState(int i4) {
        int[] iArrOnCreateDrawableState = super.onCreateDrawableState(i4 + 3);
        if (isCheckable()) {
    ...
    public void setCheckable(boolean z3) {
        this.cardViewHelper.setCheckable(z3);
    }
    ...
    public void setCheckedIconResource(@DrawableRes int i4) {
        this.cardViewHelper.setCheckedIcon(AppCompatResources.getDrawable(getContext(), i4));
    }
    ...
    public void setContentPadding(int i4, int i5, int i6, int i7) {
        this.cardViewHelper.setUserContentPadding(i4, i5, i6, i7);
    }
    ...
    public void setRippleColorResource(@ColorRes int i4) {
        this.cardViewHelper.setRippleColor(AppCompatResources.getColorStateList(getContext(), i4));
    }
    ...
    public void setStrokeColor(@ColorInt int i4) {
        this.cardViewHelper.setStrokeColor(ColorStateList.valueOf(i4));
    }
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet, int i4) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, com.google.android.material.R.styleable.MaterialCardView, i4, i5, new int[0]);
