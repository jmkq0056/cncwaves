...
public class MaterialRadioButton extends AppCompatRadioButton {
    ...
    public MaterialRadioButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.MaterialRadioButton, i4, i5, new int[0]);
