...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public int calculateBottomMarginForAnchorView() {
        ...
        return (this.targetParent.getHeight() + iArr2[1]) - i4;
    }
    ...
    public void onViewHidden(int i4) {
        ...
        if (list != null) {
            for (int size = list.size() - 1; size >= 0; size--) {
                this.callbacks.get(size).onDismissed(this, i4);
            }
        }
    ...
    public B setAnchorView(@IdRes int i4) {
        View viewFindViewById = this.targetParent.findViewById(i4);
        if (viewFindViewById != null) {
            return (B) setAnchorView(viewFindViewById);
        }
        throw new IllegalArgumentException(d.a("Unable to find anchor view with id: ", i4));
    }
}
