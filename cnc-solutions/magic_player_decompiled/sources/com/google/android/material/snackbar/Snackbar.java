...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public Snackbar setMaxInlineActionWidth(@Dimension int i4) {
        ((SnackbarContentLayout) this.view.getChildAt(0)).setMaxInlineActionWidth(i4);
        return this;
    }
    ...
    public Snackbar setActionTextColor(@ColorInt int i4) {
        ((SnackbarContentLayout) this.view.getChildAt(0)).getActionView().setTextColor(i4);
        return this;
    }
    ...
    public Snackbar setTextColor(@ColorInt int i4) {
        ((SnackbarContentLayout) this.view.getChildAt(0)).getMessageView().setTextColor(i4);
        return this;
    }
}
