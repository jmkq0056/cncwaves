...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    public BaseProgressIndicator(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i4, @StyleRes int i5) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.BaseProgressIndicator, i4, i5, new int[0]);
    ...
    public void hide() {
        ...
        int i4 = this.minHideDelay;
        if (jUptimeMillis >= ((long) i4)) {
            this.delayedHide.run();
        } else {
            postDelayed(this.delayedHide, ((long) i4) - jUptimeMillis);
        }
    }
