...
final class LinearIndeterminateDisjointAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private void updateSegmentPositions(int i4) {
        for (int i5 = 0; i5 < 4; i5++) {
            this.segmentPositions[i5] = Math.max(0.0f, Math.min(1.0f, this.interpolatorArray[i5].getInterpolation(getFractionInRange(i4, DELAY_TO_MOVE_SEGMENT_ENDS[i5], DURATION_TO_MOVE_SEGMENT_ENDS[i5]))));
        }
    }
