...
public class CircularRevealHelper {
    ...
    private void drawDebugCircle(@NonNull Canvas canvas, int i4, float f4) {
    ...
    private boolean shouldDrawCircularReveal() {
        CircularRevealWidget.RevealInfo revealInfo = this.revealInfo;
        boolean z3 = revealInfo == null || revealInfo.isInvalid();
        return STRATEGY == 0 ? !z3 && this.hasCircularRevealCache : !z3;
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        if (shouldDrawCircularReveal()) {
            ...
            if (i4 == 0) {
                ...
                if (i4 != 2) {
                    throw new IllegalStateException(d.a("Unsupported strategy ", i4));
                }
                this.delegate.actualDraw(canvas);
                if (shouldDrawScrim()) {
                    canvas.drawRect(0.0f, 0.0f, this.view.getWidth(), this.view.getHeight(), this.scrimPaint);
