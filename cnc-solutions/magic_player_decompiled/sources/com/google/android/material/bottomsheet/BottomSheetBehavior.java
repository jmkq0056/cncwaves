...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private int addAccessibilityActionForState(V v3, @StringRes int i4, int i5) {
        return ViewCompat.addAccessibilityAction(v3, v3.getResources().getString(i4), createAccessibilityViewCommandForState(i5));
    }
    ...
    private int calculatePeekHeight() {
        int i4;
        return this.peekHeightAuto ? Math.min(Math.max(this.peekHeightMin, this.parentHeight - ((this.parentWidth * 9) / 16)), this.childHeight) : (this.gestureInsetBottomIgnored || (i4 = this.gestureInsetBottom) <= 0) ? this.peekHeight : Math.max(this.peekHeight, i4 + this.peekHeightGestureInsetBuffer);
    }
    ...
    private void replaceAccessibilityActionForState(V v3, AccessibilityNodeInfoCompat.AccessibilityActionCompat accessibilityActionCompat, int i4) {
        ViewCompat.replaceAccessibilityAction(v3, accessibilityActionCompat, null, createAccessibilityViewCommandForState(i4));
    }
    ...
    private void updateAccessibilityActions() {
        ...
        if (this.state != 6) {
            this.expandHalfwayActionId = addAccessibilityActionForState(v3, R.string.bottomsheet_action_expand_halfway, 6);
        }
        ...
        int i5 = this.state;
        if (i5 == 3) {
            replaceAccessibilityActionForState(v3, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_COLLAPSE, this.fitToContents ? 4 : 6);
            return;
        }
        if (i5 == 4) {
            replaceAccessibilityActionForState(v3, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_EXPAND, this.fitToContents ? 3 : 6);
        } else {
            if (i5 != 6) {
                return;
            }
    ...
    public void dispatchOnSlide(int i4) {
        ...
        if (i4 > i5 || i5 == getExpandedOffset()) {
            ...
            f4 = i7 - i4;
            expandedOffset = i7 - getExpandedOffset();
        }
        float f5 = f4 / expandedOffset;
        for (int i8 = 0; i8 < this.callbacks.size(); i8++) {
            this.callbacks.get(i8).onSlide(v3, f5);
        }
    }
    ...
    public View findScrollingChild(View view) {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            View viewFindScrollingChild = findScrollingChild(viewGroup.getChildAt(i4));
    ...
    public void settleToState(@NonNull View view, int i4) {
        ...
        if (i4 == 4) {
            ...
            if (this.fitToContents && expandedOffset <= (i5 = this.fitToContentsOffset)) {
                i4 = 3;
                expandedOffset = i5;
            }
        } else if (i4 == 3) {
        ...
        startSettlingAnimation(view, i4, expandedOffset, false);
    }
    ...
    public boolean shouldHide(@NonNull View view, float f4) {
        ...
        return Math.abs(((f4 * 0.1f) + ((float) view.getTop())) - ((float) this.collapsedOffset)) / ((float) calculatePeekHeight()) > 0.5f;
    }

    public void startSettlingAnimation(View view, int i4, int i5, boolean z3) {
        ViewDragHelper viewDragHelper = this.viewDragHelper;
    ...
    */
    ...
    public BottomSheetBehavior(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        if (zHasValue) {
            createMaterialShapeDrawable(context, attributeSet, zHasValue, MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, i5));
        } else {
