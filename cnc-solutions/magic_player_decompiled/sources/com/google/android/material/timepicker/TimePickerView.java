...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public void setActiveSelection(int i4) {
        this.minuteView.setChecked(i4 == 12);
        this.hourView.setChecked(i4 == 10);
    }
    ...
    public void updateTime(int i4, int i5, int i6) {
        this.toggle.check(i4 == 1 ? R.id.material_clock_period_pm_button : R.id.material_clock_period_am_button);
        Locale locale = getResources().getConfiguration().locale;
        String str = String.format(locale, TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(i6));
        String str2 = String.format(locale, TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(i5));
