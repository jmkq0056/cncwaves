...
public final class MaterialTimePicker extends DialogFragment {
    ...
    private Pair<Integer, Integer> dataForMode(int i4) {
        if (i4 == 0) {
        ...
        throw new IllegalArgumentException(d.a("no icon for mode: ", i4));
    }

    private TimePickerPresenter initializeOrRetrieveActivePresenterForMode(int i4) {
        if (i4 == 0) {
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, R.styleable.MaterialTimePicker, i4, i5);
