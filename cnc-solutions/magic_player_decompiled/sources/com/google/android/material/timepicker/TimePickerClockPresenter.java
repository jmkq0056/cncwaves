...
class TimePickerClockPresenter implements ClockHandView.OnRotateListener, TimePickerView.OnSelectionChange, TimePickerView.OnPeriodChangeListener, ClockHandView.OnActionUpListener, TimePickerPresenter {
    ...
    public void setSelection(int i4, boolean z3) {
        boolean z4 = i4 == 12;
        this.timePickerView.setAnimateOnTouchUp(z4);
        this.time.selection = i4;
        this.timePickerView.setValues(z4 ? MINUTE_CLOCK_VALUES : getHourClockValues(), z4 ? R.string.material_minute_suffix : R.string.material_hour_suffix);
        this.timePickerView.setHandRotation(z4 ? this.minuteRotation : this.hourRotation, z3);
