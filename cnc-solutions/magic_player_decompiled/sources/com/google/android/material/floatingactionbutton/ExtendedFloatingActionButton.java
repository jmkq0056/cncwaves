...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    public static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public void extendOrShow(@NonNull ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            extendedFloatingActionButton.performMotion(z3 ? extendedFloatingActionButton.extendStrategy : extendedFloatingActionButton.showStrategy, z3 ? this.internalAutoShrinkCallback : this.internalAutoHideCallback);
        }
        ...
        public void shrinkOrHide(@NonNull ExtendedFloatingActionButton extendedFloatingActionButton) {
            boolean z3 = this.autoShrinkEnabled;
            extendedFloatingActionButton.performMotion(z3 ? extendedFloatingActionButton.shrinkStrategy : extendedFloatingActionButton.hideStrategy, z3 ? this.internalAutoShrinkCallback : this.internalAutoHideCallback);
        }
    ...
    public void setExtended(boolean z3) {
        ...
        MotionStrategy motionStrategy = z3 ? this.extendStrategy : this.shrinkStrategy;
        if (motionStrategy.shouldCancel()) {
            return;
        }
        motionStrategy.performNow();
    ...
    public ExtendedFloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.ExtendedFloatingActionButton, i4, i5, new int[0]);
        ...
        typedArrayObtainStyledAttributes.recycle();
        setShapeAppearanceModel(ShapeAppearanceModel.builder(context2, attributeSet, i4, i5, ShapeAppearanceModel.PILL).build());
        saveOriginalTextCsl();
    }
