...
class FloatingActionButtonImpl {
    ...
    private AnimatorSet createAnimator(@NonNull MotionSpec motionSpec, float f4, float f5, float f6) {
        ...
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this.view, (Property<FloatingActionButton, Float>) View.ALPHA, f4);
        motionSpec.getTiming("opacity").apply(objectAnimatorOfFloat);
        arrayList.add(objectAnimatorOfFloat);
        ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(this.view, (Property<FloatingActionButton, Float>) View.SCALE_X, f5);
        motionSpec.getTiming("scale").apply(objectAnimatorOfFloat2);
        workAroundOreoBug(objectAnimatorOfFloat2);
        arrayList.add(objectAnimatorOfFloat2);
        ObjectAnimator objectAnimatorOfFloat3 = ObjectAnimator.ofFloat(this.view, (Property<FloatingActionButton, Float>) View.SCALE_Y, f5);
    ...
    private void workAroundOreoBug(ObjectAnimator objectAnimator) {
        ...
        objectAnimator.setEvaluator(new TypeEvaluator<Float>() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.4
            ...
            public Float evaluate(float f4, Float f5, Float f6) {
                float fFloatValue = this.floatEvaluator.evaluate(f4, (Number) f5, (Number) f6).floatValue();
                if (fFloatValue < 0.1f) {
                    fFloatValue = 0.0f;
                }
