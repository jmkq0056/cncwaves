...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    public class ShadowDelegateImpl implements ShadowViewDelegate {
        ...
        public void setShadowPadding(int i4, int i5, int i6, int i7) {
            ...
            floatingActionButton.setPadding(floatingActionButton.imagePadding + i4, FloatingActionButton.this.imagePadding + i5, FloatingActionButton.this.imagePadding + i6, FloatingActionButton.this.imagePadding + i7);
        }
    }
    ...
    public void onMeasure(int i4, int i5) {
        ...
        int iMin = Math.min(resolveAdjustedSize(sizeDimension, i4), resolveAdjustedSize(sizeDimension, i5));
    ...
    public FloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.FloatingActionButton, i4, i5, new int[0]);
        ...
        ShapeAppearanceModel shapeAppearanceModelBuild = ShapeAppearanceModel.builder(context2, attributeSet, i4, i5, ShapeAppearanceModel.PILL).build();
    ...
    public void hide(@Nullable OnVisibilityChangedListener onVisibilityChangedListener, boolean z3) {
        getImpl().hide(wrapOnVisibilityChangedListener(onVisibilityChangedListener), z3);
    }

    public void show(@Nullable OnVisibilityChangedListener onVisibilityChangedListener, boolean z3) {
