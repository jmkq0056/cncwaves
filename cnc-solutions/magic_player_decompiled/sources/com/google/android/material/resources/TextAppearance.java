...
public class TextAppearance {
    ...
    public TextAppearance(@NonNull Context context, @StyleRes int i4) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(i4, R.styleable.TextAppearance);
        ...
        TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(i4, R.styleable.MaterialTextAppearance);
        int i5 = R.styleable.MaterialTextAppearance_android_letterSpacing;
        this.hasLetterSpacing = typedArrayObtainStyledAttributes2.hasValue(i5);
        this.letterSpacing = typedArrayObtainStyledAttributes2.getFloat(i5, 0.0f);
    ...
    public Typeface getFont(@NonNull Context context) {
        ...
        if (!context.isRestricted()) {
            try {
                ...
                StringBuilder sbA = f.a("Error loading font ");
                sbA.append(this.fontFamily);
                Log.d(TAG, sbA.toString(), e4);
            }
        }
        createFallbackFont();
