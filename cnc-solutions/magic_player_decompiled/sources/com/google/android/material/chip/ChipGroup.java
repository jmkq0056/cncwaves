...
public class ChipGroup extends FlowLayout {
    ...
    public void setCheckedStateForView(@IdRes int i4, boolean z3) {
        ...
        if (viewFindViewById instanceof Chip) {
            ...
            ((Chip) viewFindViewById).setChecked(z3);
    ...
    public ChipGroup(Context context, AttributeSet attributeSet, int i4) {
        ...
        this.checkedId = -1;
        this.protectFromCheckedChange = false;
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, R.styleable.ChipGroup, i4, i5, new int[0]);
