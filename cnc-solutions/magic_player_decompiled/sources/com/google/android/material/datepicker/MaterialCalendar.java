    ...
    private void addActionsToMonthNavigation(@NonNull View view, @NonNull final MonthsPagerAdapter monthsPagerAdapter) {
        ...
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.6
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int i4, int i5) {
                int iFindFirstVisibleItemPosition = i4 < 0 ? MaterialCalendar.this.getLayoutManager().findFirstVisibleItemPosition() : MaterialCalendar.this.getLayoutManager().findLastVisibleItemPosition();
                        ...
                        if (l4 != null && pair.second != null) {
                            ...
                            for (int i4 = spanCount; i4 <= spanCount2; i4++) {
                                ...
                                if (viewFindViewByPosition3 != null) {
                                    ...
                                    canvas.drawRect(i4 == spanCount ? (viewFindViewByPosition.getWidth() / 2) + viewFindViewByPosition.getLeft() : 0, top, i4 == spanCount2 ? (viewFindViewByPosition2.getWidth() / 2) + viewFindViewByPosition2.getLeft() : recyclerView.getWidth(), bottom, MaterialCalendar.this.calendarStyle.rangeFill);
                                }
                            }
                        }
                    }
