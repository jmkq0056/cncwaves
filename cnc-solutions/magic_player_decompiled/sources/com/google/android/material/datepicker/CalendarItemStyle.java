...
final class CalendarItemStyle {
    ...
    @NonNull
    public static CalendarItemStyle create(@NonNull Context context, @StyleRes int i4) {
        Preconditions.checkArgument(i4 != 0, "Cannot create a CalendarItemStyle with a styleResId of 0");
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(i4, R.styleable.MaterialCalendarItem);
