...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private static int getDialogPickerHeight(@NonNull Context context) {
        ...
        int i4 = MonthAdapter.MAXIMUM_WEEKS;
    ...
    private static int getPaddedPickerWidth(@NonNull Context context) {
        ...
        return ((i4 - 1) * resources.getDimensionPixelOffset(com.google.android.material.R.dimen.mtrl_calendar_month_horizontal_padding)) + (resources.getDimensionPixelSize(com.google.android.material.R.dimen.mtrl_calendar_day_width) * i4) + (dimensionPixelOffset * 2);
    }

    private int getThemeResId(Context context) {
        int i4 = this.overrideThemeResId;
        return i4 != 0 ? i4 : this.dateSelector.getDefaultThemeResId(context);
    }
    ...
    public static boolean readMaterialCalendarStyleBoolean(@NonNull Context context, int i4) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, com.google.android.material.R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{i4});
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        if (this.fullscreen) {
            ...
            View viewFindViewById = viewInflate.findViewById(com.google.android.material.R.id.mtrl_calendar_main_pane);
            View viewFindViewById2 = viewInflate.findViewById(com.google.android.material.R.id.mtrl_calendar_frame);
    ...
    public static final class Builder<S> {
        ...
        private Month createDefaultOpenAt() {
            long j4 = this.calendarConstraints.getStart().timeInMillis;
            long j5 = this.calendarConstraints.getEnd().timeInMillis;
            if (!this.dateSelector.getSelectedDays().isEmpty()) {
                long jLongValue = this.dateSelector.getSelectedDays().iterator().next().longValue();
                if (jLongValue >= j4 && jLongValue <= j5) {
                    return Month.create(jLongValue);
                }
            }
            long jThisMonthInUtcMilliseconds = MaterialDatePicker.thisMonthInUtcMilliseconds();
            if (j4 <= jThisMonthInUtcMilliseconds && jThisMonthInUtcMilliseconds <= j5) {
                j4 = jThisMonthInUtcMilliseconds;
            }
            return Month.create(j4);
        }
