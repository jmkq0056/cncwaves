...
public final class CalendarConstraints implements Parcelable {
    ...
    public static final class Builder {
        ...
        public static final long DEFAULT_START = UtcDates.canonicalYearMonthDay(Month.create(Constants.UPNP_MULTICAST_PORT, 0).timeInMillis);
        ...
        public CalendarConstraints build() {
            ...
            Long l4 = this.openAt;
            return new CalendarConstraints(monthCreate, monthCreate2, dateValidator, l4 == null ? null : Month.create(l4.longValue()));
        }
