...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    private void createScrimAnimation(@NonNull View view, boolean z3, boolean z4, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator objectAnimatorOfFloat;
        MotionTiming motionTiming = z3 ? this.expandTiming : this.collapseTiming;
        if (z3) {
            if (!z4) {
                view.setAlpha(0.0f);
            }
    ...
    @NonNull
    public AnimatorSet onCreateExpandedStateChangeAnimation(@NonNull View view, @NonNull final View view2, final boolean z3, boolean z4) {
        ArrayList arrayList = new ArrayList();
        createScrimAnimation(view2, z3, z4, arrayList, new ArrayList());
