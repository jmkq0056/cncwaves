...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    private void createFabTranslationXAnimation(int i4, @NonNull List<Animator> list) {
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(findDependentFab(), Key.TRANSLATION_X, getFabTranslationX(i4));
        ...
        if (Math.abs(actionMenuView.getTranslationX() - getActionMenuViewTranslationX(actionMenuView, i4, z3)) <= 1.0f) {
            ...
            objectAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.bottomappbar.BottomAppBar.7
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    boolean z4 = BottomAppBar.this.pendingMenuResId != 0;
                    BottomAppBar bottomAppBar = BottomAppBar.this;
                    bottomAppBar.replaceMenu(bottomAppBar.pendingMenuResId);
                    BottomAppBar.this.translateActionMenuView(actionMenuView, i4, z3, z4);
                }
            });
    ...
    private void translateActionMenuView(@NonNull ActionMenuView actionMenuView, int i4, boolean z3) {
        translateActionMenuView(actionMenuView, i4, z3, false);
    }
    ...
    public void createFabDefaultXAnimation(final int i4, List<Animator> list) {
        FloatingActionButton floatingActionButtonFindDependentFab = findDependentFab();
    ...
    public int getActionMenuViewTranslationX(@NonNull ActionMenuView actionMenuView, int i4, boolean z3) {
        if (i4 != 1 || !z3) {
            return 0;
        }
        boolean zIsLayoutRtl = ViewUtils.isLayoutRtl(this);
    ...
    public boolean setFabDiameter(@Px int i4) {
        float f4 = i4;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void translateActionMenuView(@NonNull final ActionMenuView actionMenuView, final int i4, final boolean z3, boolean z4) {
        Runnable runnable = new Runnable() { // from class: com.google.android.material.bottomappbar.BottomAppBar.8
            @Override // java.lang.Runnable
            public void run() {
                actionMenuView.setTranslationX(BottomAppBar.this.getActionMenuViewTranslationX(r0, i4, z3));
            }
        };
        if (z4) {
    ...
    public BottomAppBar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.BottomAppBar, i4, i5, new int[0]);
        ...
        ViewUtils.doOnApplyWindowInsets(this, attributeSet, i4, i5, new ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.3
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, @NonNull WindowInsetsCompat windowInsetsCompat, @NonNull ViewUtils.RelativePadding relativePadding) {
                ...
                if (BottomAppBar.this.paddingRightSystemWindowInsets) {
                    boolean z5 = BottomAppBar.this.rightInset != windowInsetsCompat.getSystemWindowInsetRight();
