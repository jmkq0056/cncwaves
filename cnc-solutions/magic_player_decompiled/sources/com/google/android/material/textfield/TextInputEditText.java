...
public class TextInputEditText extends AppCompatEditText {
    ...
    private String getAccessibilityNodeInfoText(@NonNull TextInputLayout textInputLayout) {
        ...
        sb.append(TextUtils.isEmpty(string) ? "" : a.a(", ", string));
        return sb.toString();
    }
    ...
    public void setTextInputLayoutFocusedRectEnabled(boolean z3) {
        this.textInputLayoutFocusedRectEnabled = z3;
    }
    ...
    public TextInputEditText(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.TextInputEditText, i4, R.style.Widget_Design_TextInputEditText, new int[0]);
