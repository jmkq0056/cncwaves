...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    private PorterDuffColorFilter calculatePaintColorTintFilter(@NonNull Paint paint, boolean z3) {
        ...
        if (!z3 || (iCompositeElevationOverlayIfNeeded = compositeElevationOverlayIfNeeded((color = paint.getColor()))) == color) {
            return null;
        }
    ...
    private void maybeDrawCompatShadow(@NonNull Canvas canvas) {
        if (hasCompatShadow()) {
            ...
            float f4 = (getBounds().left - this.drawableState.shadowCompatRadius) - iWidth;
            float f5 = (getBounds().top - this.drawableState.shadowCompatRadius) - iHeight;
    ...
    public int getShadowOffsetX() {
        ...
        double dSin = Math.sin(Math.toRadians(r0.shadowCompatRotation));
        Double.isNaN(d4);
        return (int) (dSin * d4);
    }
    ...
    public int getShadowOffsetY() {
        double d4 = this.drawableState.shadowCompatOffset;
        double dCos = Math.cos(Math.toRadians(r0.shadowCompatRotation));
        Double.isNaN(d4);
        return (int) (dCos * d4);
    }
