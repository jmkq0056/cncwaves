...
public class ShapePath {
    ...
    public static class LineShadowOperation extends ShadowCompatOperation {
        ...
        @Override // com.google.android.material.shape.ShapePath.ShadowCompatOperation
        public void draw(Matrix matrix, @NonNull ShadowRenderer shadowRenderer, int i4, @NonNull Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f1386y - this.startY, this.operation.f1385x - this.startX), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f1386y - this.startY) / (this.operation.f1385x - this.startX)));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        private float f1385x;

        /* JADX INFO: renamed from: y, reason: collision with root package name */
        private float f1386y;
        ...
        public void applyToPath(@NonNull Matrix matrix, @NonNull Path path) {
            ...
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f1385x, this.f1386y);
            path.transform(matrix);
        }
    }
    ...
    public void addArc(float f4, float f5, float f6, float f7, float f8, float f9) {
        ...
        double d4 = f10;
        setEndX((((f6 - f4) / 2.0f) * ((float) Math.cos(Math.toRadians(d4)))) + ((f4 + f6) * 0.5f));
        setEndY((((f7 - f5) / 2.0f) * ((float) Math.sin(Math.toRadians(d4)))) + ((f5 + f7) * 0.5f));
    }
    ...
    public void lineTo(float f4, float f5) {
        ...
        pathLineOperation.f1385x = f4;
        pathLineOperation.f1386y = f5;
