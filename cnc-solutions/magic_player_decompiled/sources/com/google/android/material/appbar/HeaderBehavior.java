...
abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    public final boolean fling(CoordinatorLayout coordinatorLayout, @NonNull V v3, int i4, int i5, float f4) {
    ...
    public boolean onInterceptTouchEvent(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v3, @NonNull MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 0) {
            ...
            boolean z3 = canDragView(v3) && coordinatorLayout.isPointInChildBounds(v3, x3, y4);
    ...
    */
    ...
    public final int scroll(CoordinatorLayout coordinatorLayout, V v3, int i4, int i5, int i6) {
        return setHeaderTopBottomOffset(coordinatorLayout, v3, getTopBottomOffsetForScrollingSibling() - i4, i5, i6);
    }

    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v3, int i4) {
        return setHeaderTopBottomOffset(coordinatorLayout, v3, i4, Integer.MIN_VALUE, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    }

    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v3, int i4, int i5, int i6) {
        int iClamp;
        int topAndBottomOffset = getTopAndBottomOffset();
        if (i5 == 0 || topAndBottomOffset < i5 || topAndBottomOffset > i6 || topAndBottomOffset == (iClamp = MathUtils.clamp(i4, i5, i6))) {
            return 0;
        }
