...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    public class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        private void prepareMenuItems() {
            ...
            for (int i5 = 0; i5 < size; i5++) {
                MenuItemImpl menuItemImpl = NavigationMenuPresenter.this.menu.getVisibleItems().get(i5);
        ...
        public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i4) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    ((TextView) viewHolder.itemView).setText(((NavigationMenuTextItem) this.items.get(i4)).getMenuItem().getTitle());
                    return;
                } else {
                    if (itemViewType != 2) {
                        return;
    ...
    public View inflateHeaderView(@LayoutRes int i4) {
        View viewInflate = this.layoutInflater.inflate(i4, (ViewGroup) this.headerLayout, false);
