...
public final class ThemeEnforcement {
    ...
    private static void checkCompatibleTheme(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i4, @StyleRes int i5) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ThemeEnforcement, i4, i5);
        boolean z3 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.ThemeEnforcement_enforceMaterialTheme, false);
    ...
    private static void checkTextAppearance(@NonNull Context context, AttributeSet attributeSet, @NonNull @StyleableRes int[] iArr, @AttrRes int i4, @StyleRes int i5, @Nullable @StyleableRes int... iArr2) {
        ...
        if (iArr2 == null || iArr2.length == 0) {
            ...
            zIsCustomTextAppearanceValid = isCustomTextAppearanceValid(context, attributeSet, iArr, i4, i5, iArr2);
        }
        typedArrayObtainStyledAttributes.recycle();
    ...
    private static void checkTheme(@NonNull Context context, @NonNull int[] iArr, String str) {
        if (!isTheme(context, iArr)) {
            throw new IllegalArgumentException(h.a("The style on this component requires your app theme to be ", str, " (or a descendant)."));
        }
    }
    ...
    private static boolean isCustomTextAppearanceValid(@NonNull Context context, AttributeSet attributeSet, @NonNull @StyleableRes int[] iArr, @AttrRes int i4, @StyleRes int i5, @NonNull @StyleableRes int... iArr2) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, i4, i5);
        for (int i6 : iArr2) {
            if (typedArrayObtainStyledAttributes.getResourceId(i6, -1) == -1) {
                typedArrayObtainStyledAttributes.recycle();
                return false;
            }
        }
