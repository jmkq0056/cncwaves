...
public class ForegroundLinearLayout extends LinearLayoutCompat {
    ...
    public void onLayout(boolean z3, int i4, int i5, int i6, int i7) {
        ...
        this.foregroundBoundsChanged = z3 | this.foregroundBoundsChanged;
    }
    ...
    public ForegroundLinearLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        this.foregroundBoundsChanged = false;
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.ForegroundLinearLayout, i4, 0, new int[0]);
