...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void calculateCenterAndBounds(@NonNull Context context, @NonNull Rect rect, @NonNull View view) {
        ...
        if (i4 == 8388691 || i4 == 8388693) {
            ...
            this.badgeCenterY = this.savedState.verticalOffset + rect.top;
        }
        if (getNumber() <= 9) {
    ...
    public static BadgeDrawable createFromResource(@NonNull Context context, @XmlRes int i4) {
        AttributeSet drawableXml = DrawableUtils.parseDrawableXml(context, i4, "badge");
    ...
    private void loadDefaultStateFromAttributes(Context context, AttributeSet attributeSet, @AttrRes int i4, @StyleRes int i5) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.Badge, i4, i5, new int[0]);
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i6)) {
            setNumber(typedArrayObtainStyledAttributes.getInt(i6, 0));
        }
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i7)) {
            setBadgeTextColor(readColorFromAttributes(context, typedArrayObtainStyledAttributes, i7));
        }
