...
public final class Detector {
    ...
    public static PDF417DetectorResult detect(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map, boolean z3) {
        BitMatrix blackMatrix = binaryBitmap.getBlackMatrix();
        List<ResultPoint[]> listDetect = detect(z3, blackMatrix);
        if (listDetect.isEmpty()) {
            blackMatrix = blackMatrix.m13clone();
            blackMatrix.rotate180();
            listDetect = detect(z3, blackMatrix);
        }
        return new PDF417DetectorResult(blackMatrix, listDetect);
    }

    private static int[] findGuardPattern(BitMatrix bitMatrix, int i4, int i5, int i6, int[] iArr, int[] iArr2) {
        ...
        if (i10 != length - 1 || patternMatchVariance(iArr2, iArr) >= MAX_AVG_VARIANCE) {
            return null;
        }
    ...
    private static ResultPoint[] findRowsWithPattern(BitMatrix bitMatrix, int i4, int i5, int i6, int i7, int[] iArr) {
        ...
        while (true) {
            ...
            int[] iArrFindGuardPattern = findGuardPattern(bitMatrix, i7, i10, i5, iArr, iArr2);
            if (iArrFindGuardPattern != null) {
                ...
                while (true) {
                    ...
                    int i13 = i12 - 1;
                    int[] iArrFindGuardPattern2 = findGuardPattern(bitMatrix, i7, i13, i5, iArr, iArr2);
        ...
        if (z3) {
            ...
            while (true) {
                ...
                i8 = i16;
                int[] iArrFindGuardPattern3 = findGuardPattern(bitMatrix, iArr4[0], i15, i5, iArr, iArr2);
    ...
    private static float patternMatchVariance(int[] iArr, int[] iArr2) {
        ...
        float f4 = i4;
        float f5 = f4 / i5;
        float f6 = MAX_INDIVIDUAL_VARIANCE * f5;
        float f7 = 0.0f;
