...
final class DecodedBitStreamParser {
    ...
    static {
        ...
        while (true) {
            ...
            bigIntegerArr2[i4] = bigIntegerArr2[i4 - 1].multiply(bigIntegerValueOf);
            i4++;
        }
    }
    ...
    */
    ...
    private static String decodeBase900toBase10(int[] iArr, int i4) throws FormatException {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            bigIntegerAdd = bigIntegerAdd.add(EXP900[(i4 - i5) - 1].multiply(BigInteger.valueOf(iArr[i5])));
        }
    ...
    public static int decodeMacroBlock(int[] iArr, int i4, PDF417ResultMetadata pDF417ResultMetadata) throws FormatException {
        if (i4 + 2 > iArr[0]) {
            throw FormatException.getFormatInstance();
        }
        int[] iArr2 = new int[2];
        ...
        int iTextCompaction = textCompaction(iArr, i4, sb);
        pDF417ResultMetadata.setFileId(sb.toString());
        int i6 = iArr[iTextCompaction] == BEGIN_MACRO_PDF417_OPTIONAL_FIELD ? iTextCompaction + 1 : -1;
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static int numericCompaction(int[] r7, int r8, java.lang.StringBuilder r9) {
        /*
            r0 = 15
            int[] r0 = new int[r0]
            r1 = 0
