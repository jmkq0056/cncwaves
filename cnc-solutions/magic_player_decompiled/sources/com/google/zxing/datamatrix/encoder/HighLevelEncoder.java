...
public final class HighLevelEncoder {
    ...
    public static int lookAheadTest(CharSequence charSequence, int i4, int i5) {
        ...
        while (true) {
            ...
            if (i7 == charSequence.length()) {
                ...
                int[] iArr = new int[6];
                int iFindMinimums = findMinimums(fArr, iArr, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, bArr);
    ...
    private static char randomize253State(int i4) {
        int i5 = ((i4 * 149) % 253) + 1 + WKSRecord.Service.PWDGEN;
        if (i5 > 254) {
            i5 -= 254;
        }
        return (char) i5;
