...
public final class CalendarParsedResult extends ParsedResult {
    ...
    private static String format(boolean z3, long j4) {
        if (j4 < 0) {
            return null;
        }
    ...
    private static long parseDate(String str) throws ParseException {
        ...
        long j4 = dateTimeString + ((long) gregorianCalendar.get(15));
        gregorianCalendar.setTime(new Date(j4));
        return j4 + ((long) gregorianCalendar.get(16));
    }
    ...
    private static long parseDurationMS(CharSequence charSequence) {
        ...
        while (true) {
            ...
            if (strGroup != null) {
                j4 = (jArr[i4] * ((long) Integer.parseInt(strGroup))) + j4;
            }
            i4 = i5;
        }
    }
