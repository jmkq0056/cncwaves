...
public final class RGBLuminanceSource extends LuminanceSource {
    ...
    public LuminanceSource crop(int i4, int i5, int i6, int i7) {
        return new RGBLuminanceSource(this.luminances, this.dataWidth, this.dataHeight, this.left + i4, this.top + i5, i6, i7);
    }
    ...
    public byte[] getRow(int i4, byte[] bArr) {
        ...
        System.arraycopy(this.luminances, ((i4 + this.top) * this.dataWidth) + this.left, bArr, 0, width);
        return bArr;
    }
