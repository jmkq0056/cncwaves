...
final class FieldParser {
    ...
    private static String processFixedAI(int i4, int i5, String str) throws NotFoundException {
        if (str.length() < i4) {
            throw NotFoundException.getNotFoundInstance();
        }
        ...
        String strSubstring2 = str.substring(i4, i6);
        String str2 = "(" + strSubstring + ')' + strSubstring2;
        String fieldsInGeneralPurpose = parseFieldsInGeneralPurpose(str.substring(i6));
        return fieldsInGeneralPurpose == null ? str2 : a.a(str2, fieldsInGeneralPurpose);
    }

    private static String processVariableAI(int i4, int i5, String str) throws NotFoundException {
        String strSubstring = str.substring(0, i4);
        int iMin = Math.min(str.length(), i5 + i4);
        String strSubstring2 = str.substring(i4, iMin);
        String str2 = "(" + strSubstring + ')' + strSubstring2;
