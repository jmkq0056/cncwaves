...
public final class Version {
    ...
    public static final class ECBlocks {
        ...
        public ECBlocks(int i4, ECB... ecbArr) {
            this.ecCodewordsPerBlock = i4;
    ...
    private Version(int i4, int[] iArr, ECBlocks... eCBlocksArr) {
    ...
    public static Version decodeVersionInformation(int i4) {
        ...
        while (true) {
            ...
            if (i5 >= iArr.length) {
                if (i7 <= 3) {
                    return getVersionForNumber(i6);
                }
                return null;
            }
            int i8 = iArr[i5];
            if (i8 == i4) {
                return getVersionForNumber(i5 + 7);
            }
            int iNumBitsDiffering = FormatInformation.numBitsDiffering(i4, i8);
            if (iNumBitsDiffering < i7) {
                i6 = i5 + 7;
    ...
    public static Version getProvisionalVersionForDimension(int i4) throws FormatException {
        if (i4 % 4 != 1) {
            throw FormatException.getFormatInstance();
        }
        try {
            return getVersionForNumber((i4 - 17) / 4);
        } catch (IllegalArgumentException unused) {
            throw FormatException.getFormatInstance();
        }
    }

    public static Version getVersionForNumber(int i4) {
        if (i4 <= 0 || i4 > 40) {
            throw new IllegalArgumentException();
        }
        return VERSIONS[i4 - 1];
    }
    ...
    public BitMatrix buildFunctionPattern() {
        ...
        bitMatrix.setRegion(6, 9, 1, i8);
        bitMatrix.setRegion(9, 6, i8, 1);
