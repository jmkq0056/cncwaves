      ...
      >
        ...
        <div className="flex items-center justify-between px-4 h-14 border-b border-gray-700/50">
          {!collapsed && (
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-sm tracking-wide">CNC Stock</span>
            </div>
          )}
          <button
        ...
        <div className="px-2 pb-4 pt-2 border-t border-gray-700/50">
          <button
            ...
            className="flex items-center gap-3 px-4 py-2.5 w-full rounded-md text-sm text-gray-400 hover:bg-gray-800 hover:text-red-400 transition-colors"
          >
