...
const navItems = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25M9 12l2.25 2.25M11.25 14.25L13.5 12m-7.5-1.5h.75c.621 0 1.125.504 1.125 1.125v.375" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 10.5v6m0 0l-2.25-2.25M12 16.5l2.25-2.25M14.25 2.25H6.75c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h10.5c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-3.375-7.014z" />
      </svg>
    ),
  },
  {
        ...
        <div className="md:hidden flex items-center h-12 px-3 bg-[#1e293b] border-b border-white/10 flex-shrink-0 safe-area-top">
          ...
          <div className="flex items-center gap-2 ml-3">
            <div className="w-6 h-6 rounded-full bg-brand flex items-center justify-center">
              <span className="text-white font-black text-[7px]">CNC</span>
            </div>
