    ...
    <div className="p-4 md:p-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
        ...
        <a
          href="/forms/qr"
          target="_blank"
          className="px-3 py-2 bg-gray-700 text-white rounded-lg text-sm hover:bg-gray-800 flex items-center gap-1.5 w-fit transition-colors"
        >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        ...
        {stats.slice(0, 2).map((s) => (
          <div key={s._id} className="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
      ...
      {filterForm && (
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="bg-gray-100 text-gray-700 text-xs font-medium px-2 py-1 rounded">{filterForm}</span>
      ...
      <div className="md:hidden space-y-2">
        ...
        {!loading && submissions.length === 0 && <p className="text-center py-8 text-gray-400">No submissions</p>}
        {submissions.map((s) => {
          const vals = Object.entries(s.data)
            .filter(([, v]) => v && v !== "false")
            .slice(0, 2)
            .map(([, v]) => v);
          return (
            <div key={s._id} className="bg-white rounded-lg shadow-sm border border-gray-100 p-3">
              ...
              <p className="text-sm text-gray-600 truncate mb-2">{vals.join(" / ") || "-"}</p>
              <div className="flex gap-1 justify-end">
                <button
                  onClick={() => setSelected(s)}
      ...
      <p className="text-sm text-gray-500 mt-3">{total} total submissions</p>

      {/* Detail modal */}
      {selected && (
        <div className="fixed inset-0 bg-black/50 flex items-end md:items-center justify-center z-50">
          <div className="bg-white rounded-t-2xl md:rounded-lg shadow-xl w-full max-w-md max-h-[85vh] overflow-auto">
