...
type FormInfo = { slug: string; title: string; description: string };
      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <div className="grid gap-3">
          {forms.map((f) => (
            ...
            >
              <div className="w-10 h-10 bg-brand-100 text-brand rounded-lg flex items-center justify-center flex-shrink-0">
          ...
          {/* Vacation Schedule - separate link */}
          <Link
            href="/forms/vacation"
            className="flex items-center gap-4 bg-white rounded-lg border border-gray-200 p-4 hover:border-brand hover:shadow-sm transition-all"
          >
            ...
            <div>
              <h3 className="font-medium text-gray-800 text-sm">Vacation Schedule</h3>
              <p className="text-xs text-gray-400">Request vacation weeks</p>
            </div>
            <svg className="w-4 h-4 text-gray-300 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
            </svg>
