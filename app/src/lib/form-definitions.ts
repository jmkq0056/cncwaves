...
export const FORM_DEFINITIONS: FormDefinition[] = [
  // 1. Leftover Food (IMG_6588-6589)
  {
    ...
    fields: [
      ...
      { name: "strips_qty", label: "Strips Qty", type: "number", required: true },
      { name: "hotwings_qty", label: "Hotwings Qty", type: "number", required: true },
      { name: "drumstick_qty", label: "Drumstick Qty", type: "number", required: true },
  ...
  // 9. Daily Items Update (IMG_6612-6617)
  {
    ...
    fields: [
      ...
      { name: "iceberg_qty", label: "Iceberg Qty", type: "number", required: true },
      { name: "tomato_qty", label: "Tomato Qty", type: "number", required: true },
      { name: "red_onions_qty", label: "Red onions Qty", type: "number", required: true },
      { name: "rocula_qty", label: "Rocula Qty", type: "number", required: true },
      { name: "carrets_qty", label: "Carrets Qty", type: "number", required: true },
      { name: "white_cabbag_qty", label: "White cabbag Qty", type: "number", required: true },
      { name: "cheddar_cheese_qty", label: "Cheddar Cheese Qty", type: "number", required: true },
      { name: "cream_cheese_happy_cow_qty", label: "Cream Cheese happy cow Qty", type: "number", required: true },
      { name: "garlic_cheese_qty", label: "Garlic Cheese Qty", type: "number", required: true },
      { name: "emmental_cheese_qty", label: "Emmental Cheese Qty", type: "number", required: true },
      { name: "parmesan_cheese_qty", label: "Parmesan Cheese Qty", type: "number", required: true },
      { name: "pitta_kebab_sauce_qty", label: "Pitta Kebab Sauce Qty", type: "number", required: true },
      { name: "fish_sauce_qty", label: "Fish Sauce Qty", type: "number", required: true },
      { name: "feta_cheese_qty", label: "Feta Cheese Qty", type: "number", required: true },
      { name: "egg_qty", label: "EGG Qty", type: "number", required: true },
      { name: "whipped_cream_qty", label: "Whipped cream Qty", type: "number", required: true },
      { name: "red_coloring_qty", label: "Red Coloring Qty", type: "number", required: true },
      { name: "zirra_spicy_qty", label: "Zirra spicy Qty", type: "number", required: true },
    ],
  },
