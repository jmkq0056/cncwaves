...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m985boximpl(ULong.m991constructorimpl(getMostSignificantBits())), ULong.m985boximpl(ULong.m991constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m2316toUByteArrayTcUX1vc() {
        return UByteArray.m888constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            return Long.compareUnsigned(ULong.m991constructorimpl(j), ULong.m991constructorimpl(other.mostSignificantBits));
        }
        return Long.compareUnsigned(ULong.m991constructorimpl(this.leastSignificantBits), ULong.m991constructorimpl(other.leastSignificantBits));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m2318fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m2317fromUByteArrayGBYM_sE(byte[] ubyteArray) {
