...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public final Instant m2277minusLRDsOJo(long duration) {
        return m2279plusLRDsOJo(Duration.m2223unaryMinusUwyO8pc(duration));
    }

    /* JADX INFO: renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m2278minusUwyO8pc(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.INSTANCE;
        long duration = DurationKt.toDuration(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS);
        Duration.Companion companion2 = Duration.INSTANCE;
        return Duration.m2208plusLRDsOJo(duration, DurationKt.toDuration(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }
    ...
    public static final class Companion {
        ...
        public final Instant fromEpochMilliseconds(long epochMilliseconds) {
            ...
            int i = (int) ((j2 + (1000 & (((j2 ^ 1000) & ((-j2) | j2)) >> 63))) * ((long) 1000000));
        ...
        public final Instant fromEpochSeconds(long epochSeconds, long nanosecondAdjustment) {
            long j = nanosecondAdjustment / MathMethodsKt.NANOS_PER_SECOND;
            if ((nanosecondAdjustment ^ MathMethodsKt.NANOS_PER_SECOND) < 0 && j * MathMethodsKt.NANOS_PER_SECOND != nanosecondAdjustment) {
                j--;
            }
            ...
            long j3 = nanosecondAdjustment % MathMethodsKt.NANOS_PER_SECOND;
            return new Instant(j2, (int) (j3 + ((((j3 ^ MathMethodsKt.NANOS_PER_SECOND) & ((-j3) | j3)) >> 63) & MathMethodsKt.NANOS_PER_SECOND)));
        }
    ...
    public final Instant m2279plusLRDsOJo(long duration) {
        long jM2193getInWholeSecondsimpl = Duration.m2193getInWholeSecondsimpl(duration);
        int iM2195getNanosecondsComponentimpl = Duration.m2195getNanosecondsComponentimpl(duration);
        if (jM2193getInWholeSecondsimpl == 0 && iM2195getNanosecondsComponentimpl == 0) {
            return this;
        }
        long j = this.epochSeconds;
        long j2 = j + jM2193getInWholeSecondsimpl;
        if ((j ^ j2) >= 0 || (jM2193getInWholeSecondsimpl ^ j) < 0) {
            return INSTANCE.fromEpochSeconds(j2, this.nanosecondsOfSecond + iM2195getNanosecondsComponentimpl);
        }
