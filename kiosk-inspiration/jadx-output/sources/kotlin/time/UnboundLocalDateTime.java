...
final class UnboundLocalDateTime {
    ...
    public final <T> T toInstant(int offsetSeconds, Function2<? super Long, ? super Integer, ? extends T> buildInstant) {
        ...
        return buildInstant.invoke(Long.valueOf((((month - ((long) 719528)) * ((long) DateCalculationsKt.SECONDS_PER_DAY)) + ((long) (((getHour() * 3600) + (getMinute() * 60)) + getSecond()))) - ((long) offsetSeconds)), Integer.valueOf(getNanosecond()));
    }

    public String toString() {
        return "UnboundLocalDateTime(" + this.year + '-' + this.month + '-' + this.day + TokenParser.SP + this.hour + AbstractJsonLexerKt.COLON + this.minute + AbstractJsonLexerKt.COLON + this.second + '.' + this.nanosecond + ')';
    }
    ...
    public static final class Companion {
        ...
        public final UnboundLocalDateTime fromInstant(Instant instant) {
            ...
            long j8 = 400;
            long j9 = ((j8 * j5) + ((long) WinError.ERROR_SYSTEM_PROCESS_TERMINATED)) / ((long) 146097);
            long j10 = 365;
            long j11 = 4;
            long j12 = 100;
            ...
            long j14 = j9 + j2;
            int i2 = (int) j13;
            int i3 = ((i2 * 5) + 2) / WinError.ERROR_INVALID_LIST_FORMAT;
            int i4 = i / 3600;
            int i5 = i - (i4 * 3600);
            int i6 = i5 / 60;
            return new UnboundLocalDateTime((int) (j14 + ((long) (i3 / 10))), ((i3 + 2) % 12) + 1, (i2 - (((i3 * 306) + 5) / 10)) + 1, i4, i6, i5 - (i6 * 60), instant.getNanosecondsOfSecond());
        }
    }
}
