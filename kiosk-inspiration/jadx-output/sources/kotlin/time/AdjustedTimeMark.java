...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo2170minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2290minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo2169elapsedNowUwyO8pc() {
        return Duration.m2207minusLRDsOJo(this.mark.mo2169elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo2172plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2208plusLRDsOJo(this.adjustment, duration), null);
    }
}
