...
public final class UtilsKt {
    public static final KotlinType findCorrespondingSupertype(KotlinType subtype, KotlinType supertype, TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            for (KotlinType kotlinType : constructor2.mo2105getSupertypes()) {
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        for (ClassifierDescriptor classifierDescriptorMo2104getDeclarationDescriptor = typeConstructor.mo2104getDeclarationDescriptor(); classifierDescriptorMo2104getDeclarationDescriptor != null; classifierDescriptorMo2104getDeclarationDescriptor = classifierDescriptorMo2104getDeclarationDescriptor.getContainingDeclaration()) {
            debugInfo$lambda$1$unaryPlus("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(classifierDescriptorMo2104getDeclarationDescriptor), sb);
            debugInfo$lambda$1$unaryPlus("javaClass: " + classifierDescriptorMo2104getDeclarationDescriptor.getClass().getCanonicalName(), sb);
        }
