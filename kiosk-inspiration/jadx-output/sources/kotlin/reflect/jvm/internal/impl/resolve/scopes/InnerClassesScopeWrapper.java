...
public final class InnerClassesScopeWrapper extends MemberScopeImpl {
    ...
    public ClassifierDescriptor mo2106getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassifierDescriptor contributedClassifier = this.workerScope.mo2106getContributedClassifier(name, location);
        if (contributedClassifier != null) {
            ClassDescriptor classDescriptor = contributedClassifier instanceof ClassDescriptor ? (ClassDescriptor) contributedClassifier : null;
            if (classDescriptor != null) {
                classifierDescriptor = classDescriptor;
            } else {
                classifierDescriptor = (ClassifierDescriptorWithTypeParameters) (contributedClassifier instanceof TypeAliasDescriptor ? (TypeAliasDescriptor) contributedClassifier : null);
            }
        }
    ...
    public void mo2110recordLookup(Name name, LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        this.workerScope.mo2110recordLookup(name, location);
    }
