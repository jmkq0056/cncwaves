...
public final class ProtoBuf {
        ...
        */
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (getContextReceiverTypeIdList().size() > 0) {
                codedOutputStream.writeRawVarint32(WinError.ERROR_BUSY);
            ...
            if (getMultiFieldValueClassUnderlyingTypeIdList().size() > 0) {
                codedOutputStream.writeRawVarint32(WinError.ERROR_ITERATED_DATA_EXCEEDS_64k);
            ...
            while (true) {
                ...
                if (!z) {
                    try {
                        ...
                        if (((i == true ? 1 : 0) & 1024) == unknownField) {
                            this.valueParameter_ = Collections.unmodifiableList(this.valueParameter_);
                        }
    ...
    public static final class Property extends GeneratedMessageLite.ExtendableMessage<Property> implements PropertyOrBuilder {
            ...
            while (true) {
                ...
                if (!z) {
                    try {
                        ...
                        if (((i == true ? 1 : 0) & 256) == unknownField) {
                            this.contextReceiverType_ = Collections.unmodifiableList(this.contextReceiverType_);
                        }
                        if (((i == true ? 1 : 0) & 512) == 512) {
                            this.contextReceiverTypeId_ = Collections.unmodifiableList(this.contextReceiverTypeId_);
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (getContextReceiverTypeIdList().size() > 0) {
                codedOutputStream.writeRawVarint32(WinError.ERROR_SEM_USER_LIMIT);
                codedOutputStream.writeRawVarint32(this.contextReceiverTypeIdMemoizedSerializedSize);
            }
