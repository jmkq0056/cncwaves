...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo2106getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor classDescriptorMo2106getContributedClassifier = this.javaScope.mo2106getContributedClassifier(name, location);
        if (classDescriptorMo2106getContributedClassifier != null) {
            return classDescriptorMo2106getContributedClassifier;
        }
