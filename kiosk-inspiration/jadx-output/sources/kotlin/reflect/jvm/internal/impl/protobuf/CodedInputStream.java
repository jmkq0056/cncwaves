...
public final class CodedInputStream {
    ...
    public String readString() throws IOException {
        ...
        if (rawVarint32 > this.bufferSize - this.bufferPos || rawVarint32 <= 0) {
            ...
            return new String(readRawBytesSlowPath(rawVarint32), HTTP.UTF_8);
        }
        String str = new String(this.buffer, this.bufferPos, rawVarint32, HTTP.UTF_8);
    ...
    public String readStringRequireUtf8() throws IOException {
        ...
        return new String(rawBytesSlowPath, i, rawVarint32, HTTP.UTF_8);
    }
