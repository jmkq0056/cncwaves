...
public class PropertyDescriptorImpl extends VariableDescriptorWithInitializerImpl implements PropertyDescriptor {
    ...
    */
    ...
    protected PropertyDescriptor doSubstitute(CopyConfiguration copyConfiguration) {
        ...
        propertyDescriptorImplCreateSubstitutedCopy.initialize(propertyGetterDescriptorImpl, propertySetterDescriptorImpl, this.backingField == null ? null : new FieldDescriptorImpl(this.backingField.getAnnotations(), propertyDescriptorImplCreateSubstitutedCopy), this.delegateField == null ? null : new FieldDescriptorImpl(this.delegateField.getAnnotations(), propertyDescriptorImplCreateSubstitutedCopy));
        ...
        if (isConst() && this.compileTimeInitializerFactory != null) {
            propertyDescriptorImplCreateSubstitutedCopy.setCompileTimeInitializer(this.compileTimeInitializer, this.compileTimeInitializerFactory);
        }
