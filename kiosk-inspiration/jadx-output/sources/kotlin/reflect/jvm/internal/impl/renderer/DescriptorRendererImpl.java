...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    */
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassifierDescriptor classifierDescriptorMo2104getDeclarationDescriptor = typeConstructor.mo2104getDeclarationDescriptor();
        if (classifierDescriptorMo2104getDeclarationDescriptor instanceof TypeParameterDescriptor ? true : classifierDescriptorMo2104getDeclarationDescriptor instanceof ClassDescriptor ? true : classifierDescriptorMo2104getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            return renderClassifierName(classifierDescriptorMo2104getDeclarationDescriptor);
        }
        ...
        throw new IllegalStateException(("Unexpected classifier: " + classifierDescriptorMo2104getDeclarationDescriptor.getClass()).toString());
    }
        ...
        CollectionsKt.joinTo$default(list, sb, ", ", null, null, 0, null, new Function1<TypeProjection, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl.appendTypeProjections.1
            ...
            public final CharSequence invoke(TypeProjection it) {
                ...
                if (it.getProjectionKind() != Variance.INVARIANT) {
                    strRenderType = it.getProjectionKind() + TokenParser.SP + strRenderType;
                }
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo2104getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor classConstructorDescriptorMo2098getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (classConstructorDescriptorMo2098getUnsubstitutedPrimaryConstructor = annotationClass.mo2098getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = classConstructorDescriptorMo2098getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
    ...
    */
    ...
    private final void renderWhereSuffix(List<? extends TypeParameterDescriptor> list, StringBuilder sb) {
        ...
        CollectionsKt.joinTo$default(arrayList, sb, ", ", null, null, 0, null, null, WinError.ERROR_INVALID_LEVEL, null);
    }
    ...
    */
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ConstantValue<?> constantValueMo2100getCompileTimeInitializer;
        String strRenderConstant;
        if (!getIncludePropertyConstant() || (constantValueMo2100getCompileTimeInitializer = variableDescriptor.mo2100getCompileTimeInitializer()) == null || (strRenderConstant = renderConstant(constantValueMo2100getCompileTimeInitializer)) == null) {
            return;
        }
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (classConstructorDescriptorMo2098getUnsubstitutedPrimaryConstructor = classDescriptor.mo2098getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(" ");
            renderAnnotations$default(this, sb, classConstructorDescriptorMo2098getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = classConstructorDescriptorMo2098getUnsubstitutedPrimaryConstructor.getVisibility();
            Intrinsics.checkNotNullExpressionValue(visibility2, "getVisibility(...)");
            renderVisibility(visibility2, sb);
            sb.append(renderKeyword("constructor"));
            List<ValueParameterDescriptor> valueParameters = classConstructorDescriptorMo2098getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkNotNullExpressionValue(valueParameters, "getValueParameters(...)");
            renderValueParameters(valueParameters, classConstructorDescriptorMo2098getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Collection<KotlinType> collectionMo2105getSupertypes = classDescriptor.getTypeConstructor().mo2105getSupertypes();
        Intrinsics.checkNotNullExpressionValue(collectionMo2105getSupertypes, "getSupertypes(...)");
        if (collectionMo2105getSupertypes.isEmpty()) {
            return;
        }
        if (collectionMo2105getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(collectionMo2105getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo$default(collectionMo2105getSupertypes, sb, ", ", null, null, 0, null, new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl.renderSuperTypes.1
            {
                super(1);
            }
