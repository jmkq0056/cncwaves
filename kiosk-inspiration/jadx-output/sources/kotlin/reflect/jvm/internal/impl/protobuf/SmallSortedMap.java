    ...
    */
    ...
    private class Entry implements Comparable<SmallSortedMap<K, V>.Entry>, Map.Entry<K, V> {
        ...
        public String toString() {
            ...
            String strValueOf2 = String.valueOf(String.valueOf(this.value));
            return new StringBuilder(strValueOf.length() + 1 + strValueOf2.length()).append(strValueOf).append("=").append(strValueOf2).toString();
        }
