...
public final class NotFoundClasses {
    ...
    public static final class MockClassDescriptor extends ClassDescriptorBase {
        ...
        public MockClassDescriptor(StorageManager storageManager, DeclarationDescriptor container, Name name, boolean z, int i) {
            ...
            super(storageManager2, container, name, SourceElement.NO_SOURCE, false);
            this.isInner = z;
            ...
            while (it.hasNext()) {
                ...
                arrayList.add(TypeParameterDescriptorImpl.createWithDefaultBound(this, Annotations.Companion.getEMPTY(), false, Variance.INVARIANT, Name.identifier("T" + iNextInt), iNextInt, storageManager3));
            }
