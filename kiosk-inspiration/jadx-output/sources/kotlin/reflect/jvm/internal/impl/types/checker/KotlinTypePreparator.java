    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo2105getSupertypes = capturedTypeConstructorImpl.mo2105getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo2105getSupertypes, 10));
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo2105getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo2105getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo2105getSupertypes2, 10));
            Iterator<T> it2 = collectionMo2105getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> collectionMo2105getSupertypes3 = intersectionTypeConstructor.mo2105getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo2105getSupertypes3, 10));
        Iterator<T> it3 = collectionMo2105getSupertypes3.iterator();
        while (it3.hasNext()) {
