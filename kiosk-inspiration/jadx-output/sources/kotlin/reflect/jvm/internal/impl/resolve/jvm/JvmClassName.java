...
public class JvmClassName {
    ...
    public static JvmClassName byClassId(ClassId classId) {
        ...
        return packageFqName.isRoot() ? new JvmClassName(strReplace) : new JvmClassName(packageFqName.asString().replace('.', '/') + RemoteSettings.FORWARD_SLASH_STRING + strReplace);
    }
    ...
    public FqName getPackageFqName() {
        int iLastIndexOf = this.internalName.lastIndexOf(RemoteSettings.FORWARD_SLASH_STRING);
        if (iLastIndexOf == -1) {
