    ...
    public final SimpleType intersectTypes$descriptors(List<? extends SimpleType> types) {
        ...
        for (SimpleType simpleType : types) {
            if (simpleType.getConstructor() instanceof IntersectionTypeConstructor) {
                Collection<KotlinType> collectionMo2105getSupertypes = simpleType.getConstructor().mo2105getSupertypes();
                Intrinsics.checkNotNullExpressionValue(collectionMo2105getSupertypes, "getSupertypes(...)");
                Collection<KotlinType> collection = collectionMo2105getSupertypes;
