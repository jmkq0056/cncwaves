...
public final class JvmAnnotationNames {
    ...
    static {
        ...
        METADATA_DESC = PrinterTextParser.TAGS_ALIGN_LEFT + JvmClassName.byFqNameWithoutInnerClasses(fqName).getInternalName() + ";";
        ...
        SERIALIZED_IR_DESC = PrinterTextParser.TAGS_ALIGN_LEFT + JvmClassName.byFqNameWithoutInnerClasses(fqName2).getInternalName() + ";";
