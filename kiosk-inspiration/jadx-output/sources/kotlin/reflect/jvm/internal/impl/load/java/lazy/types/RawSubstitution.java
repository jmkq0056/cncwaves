...
public final class RawSubstitution extends TypeSubstitution {
    ...
    public TypeProjectionImpl mo2109get(KotlinType key) {
    ...
    private final KotlinType eraseType(KotlinType kotlinType, JavaTypeAttributes javaTypeAttributes) {
        ...
        if (classifierDescriptorMo2104getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return eraseType(this.typeParameterUpperBoundEraser.getErasedUpperBound((TypeParameterDescriptor) classifierDescriptorMo2104getDeclarationDescriptor, javaTypeAttributes.markIsRaw(true)), javaTypeAttributes);
        }
        if (classifierDescriptorMo2104getDeclarationDescriptor instanceof ClassDescriptor) {
            ClassifierDescriptor classifierDescriptorMo2104getDeclarationDescriptor2 = FlexibleTypesKt.upperIfFlexible(kotlinType).getConstructor().mo2104getDeclarationDescriptor();
            if (!(classifierDescriptorMo2104getDeclarationDescriptor2 instanceof ClassDescriptor)) {
                throw new IllegalStateException(("For some reason declaration for upper bound is not a class but \"" + classifierDescriptorMo2104getDeclarationDescriptor2 + "\" while for lower it's \"" + classifierDescriptorMo2104getDeclarationDescriptor + '\"').toString());
            }
            Pair<SimpleType, Boolean> pairEraseInflexibleBasedOnClassDescriptor = eraseInflexibleBasedOnClassDescriptor(FlexibleTypesKt.lowerIfFlexible(kotlinType), (ClassDescriptor) classifierDescriptorMo2104getDeclarationDescriptor, lowerTypeAttr);
            ...
            Pair<SimpleType, Boolean> pairEraseInflexibleBasedOnClassDescriptor2 = eraseInflexibleBasedOnClassDescriptor(FlexibleTypesKt.upperIfFlexible(kotlinType), (ClassDescriptor) classifierDescriptorMo2104getDeclarationDescriptor2, upperTypeAttr);
        ...
        throw new IllegalStateException(("Unexpected declaration kind: " + classifierDescriptorMo2104getDeclarationDescriptor).toString());
    }
