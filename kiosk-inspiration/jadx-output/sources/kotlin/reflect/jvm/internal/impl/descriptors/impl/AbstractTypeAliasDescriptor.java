    ...
    public AbstractTypeAliasDescriptor(StorageManager storageManager, DeclarationDescriptor containingDeclaration, Annotations annotations, Name name, SourceElement sourceElement, DescriptorVisibility visibilityImpl) {
        ...
        this.typeConstructor = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            ...
            public Collection<KotlinType> mo2105getSupertypes() {
                Collection<KotlinType> collectionMo2105getSupertypes = mo2104getDeclarationDescriptor().getUnderlyingType().getConstructor().mo2105getSupertypes();
            ...
            public String toString() {
                return "[typealias " + mo2104getDeclarationDescriptor().getName().asString() + AbstractJsonLexerKt.END_LIST;
            }
            ...
            */
            public final java.lang.Boolean invoke(kotlin.reflect.jvm.internal.impl.types.UnwrappedType r3) {
                /*
                    ...
                    kotlin.reflect.jvm.internal.impl.descriptors.ClassifierDescriptor r3 = r3.mo2104getDeclarationDescriptor()
                ...
                L29:
                    ...
                    return r3
                */
                throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor.C07061.invoke(kotlin.reflect.jvm.internal.impl.types.UnwrappedType):java.lang.Boolean");
            }
        });
    }
