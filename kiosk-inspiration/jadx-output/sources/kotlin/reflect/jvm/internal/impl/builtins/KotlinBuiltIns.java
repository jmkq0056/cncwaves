...
public abstract class KotlinBuiltIns {
    ...
    protected KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor contributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo2106getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
    ...
    private static KotlinType getElementTypeForUnsignedArray(KotlinType kotlinType, ModuleDescriptor moduleDescriptor) {
        ...
        if (classifierDescriptorMo2104getDeclarationDescriptor == null || !UnsignedTypes.INSTANCE.isShortNameOfUnsignedArray(classifierDescriptorMo2104getDeclarationDescriptor.getName()) || (classId = DescriptorUtilsKt.getClassId(classifierDescriptorMo2104getDeclarationDescriptor)) == null || (unsignedClassIdByArrayClassId = UnsignedTypes.INSTANCE.getUnsignedClassIdByArrayClassId(classId)) == null || (classDescriptorFindClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedClassIdByArrayClassId)) == null) {
            return null;
        }
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo2104getDeclarationDescriptor = kotlinType.getConstructor().mo2104getDeclarationDescriptor();
        return (classifierDescriptorMo2104getDeclarationDescriptor == null || getPrimitiveArrayType(classifierDescriptorMo2104getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(classifierDescriptorMo2104getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo2104getDeclarationDescriptor = kotlinType.getConstructor().mo2104getDeclarationDescriptor();
        return (classifierDescriptorMo2104getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) classifierDescriptorMo2104getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        return (classifierDescriptorMo2104getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(classifierDescriptorMo2104getDeclarationDescriptor, fqNameUnsafe);
    }
    ...
    private static boolean classFqNameEquals(ClassifierDescriptor classifierDescriptor, FqNameUnsafe fqNameUnsafe) {
        ...
        if (fqNameUnsafe == null) {
            $$$reportNull$$$0(WinError.ERROR_SEM_OWNER_DIED);
        }
    ...
    private static boolean isNotNullConstructedFromGivenClass(KotlinType kotlinType, FqNameUnsafe fqNameUnsafe) {
        if (kotlinType == null) {
            $$$reportNull$$$0(WinError.ERROR_SEM_USER_LIMIT);
        }
        if (fqNameUnsafe == null) {
            $$$reportNull$$$0(WinError.ERROR_DISK_CHANGE);
        }
    ...
    public static boolean isBoolean(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(WinError.ERROR_BUFFER_OVERFLOW);
        }
    ...
    public static boolean isULongArray(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(WinError.ERROR_SEEK_ON_DEVICE);
        }
    ...
    public static boolean isUnsignedArrayType(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(WinError.ERROR_IS_JOIN_TARGET);
        }
    ...
    private static boolean isConstructedFromGivenClassAndNotNullable(KotlinType kotlinType, FqNameUnsafe fqNameUnsafe) {
        if (kotlinType == null) {
            $$$reportNull$$$0(WinError.ERROR_IS_SUBSTED);
        }
        if (fqNameUnsafe == null) {
            $$$reportNull$$$0(136);
        }
    ...
    public static boolean isNothing(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(WinError.ERROR_NOT_SUBSTED);
        }
    ...
    public static boolean isNothingOrNullableNothing(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(WinError.ERROR_SUBST_TO_SUBST);
        }
    ...
    public static boolean isAnyOrNullableAny(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(WinError.ERROR_JOIN_TO_SUBST);
        }
    ...
    public static boolean isNullableAny(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(WinError.ERROR_SUBST_TO_JOIN);
        }
    ...
    public static boolean isUnit(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(WinError.ERROR_SAME_DRIVE);
        }
