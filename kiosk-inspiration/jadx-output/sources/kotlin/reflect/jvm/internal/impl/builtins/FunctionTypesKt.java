...
public final class FunctionTypesKt {
    public static final FunctionTypeKind getFunctionTypeKind(KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo2104getDeclarationDescriptor != null) {
            return getFunctionTypeKind(classifierDescriptorMo2104getDeclarationDescriptor);
        }
        return null;
    }
    ...
    public static final boolean isBuiltinFunctionalType(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo2104getDeclarationDescriptor = kotlinType.getConstructor().mo2104getDeclarationDescriptor();
        return classifierDescriptorMo2104getDeclarationDescriptor != null && isBuiltinFunctionalClassDescriptor(classifierDescriptorMo2104getDeclarationDescriptor);
    }
    ...
    private static final boolean isTypeAnnotatedWithExtensionFunctionType(KotlinType kotlinType) {
        return kotlinType.getAnnotations().mo2099findAnnotation(StandardNames.FqNames.extensionFunctionType) != null;
    }
    ...
    public static final int contextFunctionTypeParamsCount(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor annotationDescriptorMo2099findAnnotation = kotlinType.getAnnotations().mo2099findAnnotation(StandardNames.FqNames.contextFunctionTypeParams);
        if (annotationDescriptorMo2099findAnnotation == null) {
            return 0;
        }
        ConstantValue constantValue = (ConstantValue) MapsKt.getValue(annotationDescriptorMo2099findAnnotation.getAllValueArguments(), StandardNames.CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME);
    ...
    public static final Name extractParameterNameFromFunctionTypeArgument(KotlinType kotlinType) {
        String value;
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor annotationDescriptorMo2099findAnnotation = kotlinType.getAnnotations().mo2099findAnnotation(StandardNames.FqNames.parameterName);
        if (annotationDescriptorMo2099findAnnotation == null) {
            return null;
        }
        Object objSingleOrNull = CollectionsKt.singleOrNull(annotationDescriptorMo2099findAnnotation.getAllValueArguments().values());
