...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor implements TypeConstructor {
    ...
    */
    ...
    protected boolean isSameClassifier(ClassifierDescriptor classifierDescriptor) {
        ...
        return (classifierDescriptor instanceof ClassDescriptor) && areFqNamesEqual(mo2104getDeclarationDescriptor(), classifierDescriptor);
    }
    ...
    protected Collection<KotlinType> getAdditionalNeighboursInSupertypeGraph(boolean z) {
        ...
        ClassDescriptor classDescriptorMo2097getCompanionObjectDescriptor = classDescriptor.mo2097getCompanionObjectDescriptor();
        if (z && classDescriptorMo2097getCompanionObjectDescriptor != null) {
            smartList.add(classDescriptorMo2097getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
