...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public abstract ClassifierDescriptor mo2104getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor classifierDescriptorMo2104getDeclarationDescriptor = mo2104getDeclarationDescriptor();
        if (hasMeaningfulFqName(classifierDescriptorMo2104getDeclarationDescriptor)) {
            iIdentityHashCode = DescriptorUtils.getFqName(classifierDescriptorMo2104getDeclarationDescriptor).hashCode();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor classifierDescriptorMo2104getDeclarationDescriptor = mo2104getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo2104getDeclarationDescriptor2 = typeConstructor.mo2104getDeclarationDescriptor();
        if (classifierDescriptorMo2104getDeclarationDescriptor2 != null && hasMeaningfulFqName(classifierDescriptorMo2104getDeclarationDescriptor) && hasMeaningfulFqName(classifierDescriptorMo2104getDeclarationDescriptor2)) {
            return isSameClassifier(classifierDescriptorMo2104getDeclarationDescriptor2);
        }
        return false;
    }
