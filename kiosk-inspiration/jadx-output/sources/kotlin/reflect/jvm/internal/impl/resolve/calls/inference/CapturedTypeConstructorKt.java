    ...
    public static final TypeSubstitution wrapWithCapturingSubstitution(TypeSubstitution typeSubstitution, final boolean z) {
        ...
        return new DelegatedTypeSubstitution(typeSubstitution) { // from class: kotlin.reflect.jvm.internal.impl.resolve.calls.inference.CapturedTypeConstructorKt.wrapWithCapturingSubstitution.2
            ...
            public TypeProjection mo2109get(KotlinType key) {
                ...
                TypeProjection typeProjectionMo2109get = super.mo2109get(key);
                if (typeProjectionMo2109get == null) {
                    return null;
                }
                ClassifierDescriptor classifierDescriptorMo2104getDeclarationDescriptor = key.getConstructor().mo2104getDeclarationDescriptor();
                return CapturedTypeConstructorKt.createCapturedIfNeeded(typeProjectionMo2109get, classifierDescriptorMo2104getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) classifierDescriptorMo2104getDeclarationDescriptor : null);
            }
        };
    }
