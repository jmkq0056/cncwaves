...
public final class SignatureEnhancement {
    ...
    */
    ...
    public final List<KotlinType> enhanceTypeParameterBounds(TypeParameterDescriptor typeParameter, List<? extends KotlinType> bounds, LazyJavaResolverContext context) {
        ...
        for (KotlinType kotlinTypeEnhance$default : list) {
            if (!TypeUtilsKt.contains(kotlinTypeEnhance$default, new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.SignatureEnhancement$enhanceTypeParameterBounds$1$1
                ...
                kotlinTypeEnhance$default = enhance$default(this, new SignatureParts(typeParameter, false, context, AnnotationQualifierApplicabilityType.TYPE_PARAMETER_BOUNDS, false, 16, null), kotlinTypeEnhance$default, CollectionsKt.emptyList(), null, false, 12, null);
                if (kotlinTypeEnhance$default == null) {
                    kotlinTypeEnhance$default = kotlinTypeEnhance$default;
                }
            }
    ...
    private final boolean containsFunctionN(KotlinType kotlinType) {
        return TypeUtils.contains(kotlinType, new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.SignatureEnhancement.containsFunctionN.1
            ...
            public final Boolean invoke(UnwrappedType unwrappedType) {
                ClassifierDescriptor classifierDescriptorMo2104getDeclarationDescriptor = unwrappedType.getConstructor().mo2104getDeclarationDescriptor();
                boolean z = false;
                if (classifierDescriptorMo2104getDeclarationDescriptor == null) {
                    return false;
                }
                if (Intrinsics.areEqual(classifierDescriptorMo2104getDeclarationDescriptor.getName(), JavaToKotlinClassMap.INSTANCE.getFUNCTION_N_FQ_NAME().shortName()) && Intrinsics.areEqual(DescriptorUtilsKt.fqNameOrNull(classifierDescriptorMo2104getDeclarationDescriptor), JavaToKotlinClassMap.INSTANCE.getFUNCTION_N_FQ_NAME())) {
                    z = true;
                }
