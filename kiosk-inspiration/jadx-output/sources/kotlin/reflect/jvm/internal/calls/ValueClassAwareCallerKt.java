...
public final class ValueClassAwareCallerKt {
    ...
    private static final List<String> getMfvcUnboxMethods$getUnboxMethodNameSuffixes(SimpleType simpleType) {
        ...
        ClassifierDescriptor classifierDescriptorMo2104getDeclarationDescriptor = simpleType.getConstructor().mo2104getDeclarationDescriptor();
        ...
        MultiFieldValueClassRepresentation<SimpleType> multiFieldValueClassRepresentation = DescriptorUtilsKt.getMultiFieldValueClassRepresentation((ClassDescriptor) classifierDescriptorMo2104getDeclarationDescriptor);
    ...
    public static final List<Method> getMfvcUnboxMethods(SimpleType type) {
        ...
        ClassifierDescriptor classifierDescriptorMo2104getDeclarationDescriptor = type.getConstructor().mo2104getDeclarationDescriptor();
        Intrinsics.checkNotNull(classifierDescriptorMo2104getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
    ...
    */
    ...
    public static final Class<?> toInlineClass(KotlinType kotlinType) {
        ...
        Class<?> inlineClass = toInlineClass(kotlinType.getConstructor().mo2104getDeclarationDescriptor());
        if (inlineClass == null) {
            return null;
        }
