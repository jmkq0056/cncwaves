            ...
            public final Caller<? extends Executable> invoke() {
                ...
                if (constructor instanceof Constructor) {
                    ...
                    if (!Modifier.isStatic(method.getModifiers())) {
                        ...
                        methodCreateJvmStaticInObjectCaller = this.this$0.getDescriptor().getAnnotations().mo2099findAnnotation(UtilKt.getJVM_STATIC()) != null ? this.this$0.createJvmStaticInObjectCaller(method) : this.this$0.createStaticMethodCaller(method);
                    }
