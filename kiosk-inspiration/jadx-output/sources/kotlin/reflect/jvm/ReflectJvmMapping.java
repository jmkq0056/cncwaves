...
public final class ReflectJvmMapping {
    ...
    public static final Method getJavaMethod(KFunction<?> kFunction) {
        ...
        Member memberMo2096getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo2096getMember();
        if (memberMo2096getMember instanceof Method) {
            return (Method) memberMo2096getMember;
        }
        return null;
    }
    ...
    public static final <T> Constructor<T> getJavaConstructor(KFunction<? extends T> kFunction) {
        ...
        KCallableImpl<?> kCallableImplAsKCallableImpl = UtilKt.asKCallableImpl(kFunction);
        Member memberMo2096getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo2096getMember();
        if (memberMo2096getMember instanceof Constructor) {
            return (Constructor) memberMo2096getMember;
        }
        return null;
    }
    ...
    public static final KFunction<?> getKotlinFunction(Method method) throws InvocationTargetException {
