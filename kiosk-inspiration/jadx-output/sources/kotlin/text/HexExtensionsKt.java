...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long j) {
        if (0 > j || j > 2147483647L) {
            throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m1037toStringimpl(ULong.m991constructorimpl(j))));
        }
        return (int) j;
    }
    ...
    */
    ...
    private static final void throwInvalidNumberOfDigits(String str, int i, int i2, String str2, int i3) {
        ...
        throw new NumberFormatException("Expected " + str2 + TokenParser.SP + i3 + " hexadecimal digits at index " + i + ", but was \"" + strSubstring + "\" of length " + (i2 - i));
    }
