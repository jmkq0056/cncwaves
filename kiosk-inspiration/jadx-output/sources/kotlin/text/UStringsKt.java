...
public final class UStringsKt {
    ...
    public static final String m2166toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2168toStringolVBNx4(short s, int i) {
    ...
    public static final String m2167toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m2165toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m912constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m829boximpl(UByte.m835constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m912constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m1092boximpl(UShort.m1098constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM912constructorimpl = UInt.m912constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM912constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM912constructorimpl2 = UInt.m912constructorimpl(i3 * iM912constructorimpl);
            int iM912constructorimpl3 = UInt.m912constructorimpl(UInt.m912constructorimpl(iDigitOf) + iM912constructorimpl2);
            if (Integer.compareUnsigned(iM912constructorimpl3, iM912constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM912constructorimpl3;
        }
        return UInt.m906boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM991constructorimpl = ULong.m991constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM991constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM991constructorimpl2 = ULong.m991constructorimpl(j * jM991constructorimpl);
            long jM991constructorimpl3 = ULong.m991constructorimpl(ULong.m991constructorimpl(((long) UInt.m912constructorimpl(iDigitOf)) & 4294967295L) + jM991constructorimpl2);
            if (Long.compareUnsigned(jM991constructorimpl3, jM991constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM991constructorimpl3;
        }
        return ULong.m985boximpl(j);
    }
}
