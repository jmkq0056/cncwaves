...
public final class UnsignedKt {
    ...
    public static final int m1169uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m912constructorimpl((int) ((((long) i) & 4294967295L) % (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: uintDivide-J1ME1BU, reason: not valid java name */
    public static final int m1168uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m912constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m1170ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? ULong.m991constructorimpl(0L) : ULong.m991constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m991constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m991constructorimpl(j3 + ((long) (Long.compareUnsigned(ULong.m991constructorimpl(j - (j3 * j2)), ULong.m991constructorimpl(j2)) < 0 ? 0 : 1)));
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m1171ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? j : ULong.m991constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m991constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compareUnsigned(ULong.m991constructorimpl(j3), ULong.m991constructorimpl(j2)) < 0) {
            j2 = 0;
        }
        return ULong.m991constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= 2.147483647E9d) {
            return UInt.m912constructorimpl((int) d);
        }
        return UInt.m912constructorimpl(UInt.m912constructorimpl((int) (d - ((double) Integer.MAX_VALUE))) + UInt.m912constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m991constructorimpl((long) d);
        }
        return ULong.m991constructorimpl(ULong.m991constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
