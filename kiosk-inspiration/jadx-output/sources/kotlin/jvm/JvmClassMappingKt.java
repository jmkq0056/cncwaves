...
public final class JvmClassMappingKt {
    ...
    public static final <T> Class<T> getJavaObjectType(KClass<T> kClass) {
        ...
        if (name != null) {
            switch (name.hashCode()) {
                case -1325958191:
                    if (name.equals(PrinterTextParser.ATTR_FORMAT_TEXT_UNDERLINE_TYPE_DOUBLE)) {
