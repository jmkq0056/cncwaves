...
public final class AssetUriFetcher implements Fetcher {
    ...
    public Object fetch(Continuation<? super FetchResult> continuation) {
        String strJoinToString$default = CollectionsKt.joinToString$default(CollectionsKt.drop(this.data.getPathSegments(), 1), RemoteSettings.FORWARD_SLASH_STRING, null, null, 0, null, null, 62, null);
