...
public final class DateKt {
    ...
    public static final GMTDate m527plusHG0u8IE(GMTDate plus, long j) {
        Intrinsics.checkNotNullParameter(plus, "$this$plus");
        return DateJvmKt.GMTDate(Long.valueOf(plus.getTimestamp() + Duration.m2190getInWholeMillisecondsimpl(j)));
    }

    /* JADX INFO: renamed from: minus-HG0u8IE, reason: not valid java name */
    public static final GMTDate m526minusHG0u8IE(GMTDate minus, long j) {
        Intrinsics.checkNotNullParameter(minus, "$this$minus");
        return DateJvmKt.GMTDate(Long.valueOf(minus.getTimestamp() - Duration.m2190getInWholeMillisecondsimpl(j)));
    }
