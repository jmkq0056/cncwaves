...
@DebugMetadata(c = "io.ktor.client.plugins.cookies.HttpCookies$Companion$install$2", f = "HttpCookies.kt", i = {}, l = {WinError.ERROR_CALL_NOT_IMPLEMENTED}, m = "invokeSuspend", n = {}, s = {})
final class HttpCookies$Companion$install$2 extends SuspendLambda implements Function3<PipelineContext<Object, HttpRequestBuilder>, Object, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$plugin.sendCookiesWith$ktor_client_core((HttpRequestBuilder) pipelineContext.getContext(), this) == coroutine_suspended) {
