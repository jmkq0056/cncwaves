...
public final class ServerResponseException extends ResponseException {
    ...
    public ServerResponseException(HttpResponse response, String cachedResponseText) {
        ...
        this.message = "Server error(" + response.getCall().getRequest().getMethod().getValue() + TokenParser.SP + response.getCall().getRequest().getUrl() + ": " + response.getStatus() + ". Text: \"" + cachedResponseText + '\"';
    }
