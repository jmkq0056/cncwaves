...
final class ByteChannelSequentialBase$peekTo$2 extends SuspendLambda implements Function2<SuspendableReadSession, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        ChunkBuffer chunkBuffer = chunkBufferRequest;
        if (chunkBuffer.getWritePosition() - chunkBuffer.getReadPosition() > this.$offset) {
            this.$bytesCopied.element = Math.min(((long) (chunkBuffer.getWritePosition() - chunkBuffer.getReadPosition())) - this.$offset, Math.min(this.$max, ((long) this.$destination.limit()) - this.$destinationOffset));
            Memory.m544copyToJT6ljtQ(chunkBufferRequest.getMemory(), this.$destination, this.$offset, this.$bytesCopied.element, this.$destinationOffset);
        }
