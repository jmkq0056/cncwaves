...
public final class ByteReadChannelKt {
    ...
    @DebugMetadata(c = "io.ktor.utils.io.ByteReadChannelKt", f = "ByteReadChannel.kt", i = {0}, l = {WinUser.WM_SYSKEYUP}, m = "copyAndClose", n = {"dst"}, s = {"L$0"})
    ...
    @DebugMetadata(c = "io.ktor.utils.io.ByteReadChannelKt", f = "ByteReadChannel.kt", i = {0}, l = {WinError.ERROR_NO_DATA}, m = "discardExact", n = {"n"}, s = {"J$0"})
    ...
    */
    public static final java.lang.Object discardExact(io.ktor.utils.io.ByteReadChannel r4, long r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) throws java.io.EOFException {
        /*
            boolean r0 = r7 instanceof io.ktor.utils.io.ByteReadChannelKt.C06601
            if (r0 == 0) goto L14
            r0 = r7
            io.ktor.utils.io.ByteReadChannelKt$discardExact$1 r0 = (io.ktor.utils.io.ByteReadChannelKt.C06601) r0
            int r1 = r0.label
    ...
    private static final Object discardExact$$forInline(ByteReadChannel byteReadChannel, long j, Continuation<? super Unit> continuation) throws EOFException {
        if (((Number) byteReadChannel.discard(j, continuation)).longValue() != j) {
