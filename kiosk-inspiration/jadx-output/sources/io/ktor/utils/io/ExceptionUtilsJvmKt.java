...
public final class ExceptionUtilsJvmKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E exception, Throwable cause) {
        ...
        if (exception instanceof CopyableThrowable) {
            try {
                ...
                objM817constructorimpl = Result.m817constructorimpl(((CopyableThrowable) exception).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM817constructorimpl = Result.m817constructorimpl(ResultKt.createFailure(th));
            }
            return (E) (Result.m823isFailureimpl(objM817constructorimpl) ? null : objM817constructorimpl);
        }
            ...
            return new Function1<Throwable, Throwable>() { // from class: io.ktor.utils.io.ExceptionUtilsJvmKt$createConstructor$$inlined$safeCtor$4
                ...
                public final Throwable invoke(Throwable e) {
                    ...
                    try {
                        ...
                        th.initCause(e);
                        objM817constructorimpl = Result.m817constructorimpl(th);
                    } catch (Throwable th2) {
                        Result.Companion companion2 = Result.INSTANCE;
                    ...
                    return (Throwable) objM817constructorimpl;
                }
            };
        }
        if (length != 1) {
                ...
                return new Function1<Throwable, Throwable>() { // from class: io.ktor.utils.io.ExceptionUtilsJvmKt$createConstructor$$inlined$safeCtor$1
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        try {
                            ...
                            Intrinsics.checkNotNull(objNewInstance, "null cannot be cast to non-null type kotlin.Throwable");
                            objM817constructorimpl = Result.m817constructorimpl((Throwable) objNewInstance);
                        } catch (Throwable th) {
                            Result.Companion companion2 = Result.INSTANCE;
                            objM817constructorimpl = Result.m817constructorimpl(ResultKt.createFailure(th));
                        }
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: io.ktor.utils.io.ExceptionUtilsJvmKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    objM817constructorimpl = Result.m817constructorimpl(function12.invoke(e));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM817constructorimpl = Result.m817constructorimpl(ResultKt.createFailure(th));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM817constructorimpl = Result.m817constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM817constructorimpl = Result.m817constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m823isFailureimpl(objM817constructorimpl)) {
            objM817constructorimpl = numValueOf;
        }
        return ((Number) objM817constructorimpl).intValue();
    }
