...
public final class ByteReadChannelJVMKt {
    ...
    /* JADX INFO: compiled from: ByteReadChannelJVM.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "io.ktor.utils.io.ByteReadChannelJVMKt", f = "ByteReadChannelJVM.kt", i = {0, 0}, l = {WinError.ERROR_DIRECTORY}, m = "joinToImplSuspend", n = {"dst", "close"}, s = {"L$0", "Z$0"})
    ...
    */
    public static final java.lang.Object joinToImplSuspend(io.ktor.utils.io.ByteReadChannel r4, io.ktor.utils.io.ByteWriteChannel r5, boolean r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        /*
            boolean r0 = r7 instanceof io.ktor.utils.io.ByteReadChannelJVMKt.C06591
            if (r0 == 0) goto L14
            r0 = r7
            io.ktor.utils.io.ByteReadChannelJVMKt$joinToImplSuspend$1 r0 = (io.ktor.utils.io.ByteReadChannelJVMKt.C06591) r0
            int r1 = r0.label
    ...
    /* JADX WARN: Removed duplicated region for block: B:26:0x0090 A[Catch: all -> 0x00f4, TRY_ENTER, TRY_LEAVE, TryCatch #0 {all -> 0x00f4, blocks: (B:38:0x00ea, B:40:0x00f0, B:26:0x0090), top: B:55:0x00ea }] */
    /* JADX WARN: Removed duplicated region for block: B:32:0x00c5 A[Catch: all -> 0x0069, TRY_LEAVE, TryCatch #2 {all -> 0x0069, blocks: (B:13:0x0041, B:30:0x00bc, B:32:0x00c5, B:47:0x0103, B:19:0x0065), top: B:59:0x0027 }] */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:35:0x00df -> B:15:0x0045). Please report as a decompilation issue!!! */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
