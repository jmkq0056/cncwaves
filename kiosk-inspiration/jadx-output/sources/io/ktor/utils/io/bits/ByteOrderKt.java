...
public final class ByteOrderKt {
    ...
    public static final short m540reverseByteOrderxj2QHRw(short s) {
        return UShort.m1098constructorimpl(Short.reverseBytes(s));
    }

    /* JADX INFO: renamed from: reverseByteOrder-WZ4Q5Ns, reason: not valid java name */
    public static final int m539reverseByteOrderWZ4Q5Ns(int i) {
        return UInt.m912constructorimpl(Integer.reverseBytes(i));
    }

    /* JADX INFO: renamed from: reverseByteOrder-VKZWuLQ, reason: not valid java name */
    public static final long m538reverseByteOrderVKZWuLQ(long j) {
        return ULong.m991constructorimpl(Long.reverseBytes(j));
    }
}
