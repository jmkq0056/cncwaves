...
public final class CancellableReusableContinuation<T> implements Continuation<T> {
    ...
    public final void close(T value) {
        ...
        resumeWith(Result.m817constructorimpl(value));
    ...
    public final void close(Throwable cause) {
        ...
        Result.Companion companion = Result.INSTANCE;
        resumeWith(Result.m817constructorimpl(ResultKt.createFailure(cause)));
        JobRelation jobRelation = (JobRelation) jobCancellationHandler$FU.getAndSet(this, null);
        if (jobRelation != null) {
            jobRelation.dispose();
        }
    ...
    public void resumeWith(Object result) {
        Object obj;
        Object objM820exceptionOrNullimpl;
        do {
            obj = this.state;
            if (obj == null) {
                objM820exceptionOrNullimpl = Result.m820exceptionOrNullimpl(result);
                if (objM820exceptionOrNullimpl == null) {
                    ResultKt.throwOnFailure(result);
                    objM820exceptionOrNullimpl = result;
                }
            } else if (!(obj instanceof Continuation)) {
                return;
            } else {
                objM820exceptionOrNullimpl = null;
            }
        } while (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(state$FU, this, obj, objM820exceptionOrNullimpl));
    ...
    public final void resumeWithExceptionContinuationOnly(Job job, Throwable exception) {
        ...
        Result.Companion companion = Result.INSTANCE;
        continuation.resumeWith(Result.m817constructorimpl(ResultKt.createFailure(exception)));
    }
}
