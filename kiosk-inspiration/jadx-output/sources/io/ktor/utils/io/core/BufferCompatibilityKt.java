...
public final class BufferCompatibilityKt {
    ...
    public static final void m687fillsEu17AQ(Buffer fill, int i, byte b) {
    ...
    public static final void fill(Buffer buffer, int i, byte b) {
        ...
        MemoryJvmKt.m564fillJT6ljtQ(buffer.getMemory(), buffer.getWritePosition(), i, b);
    ...
    public static final int appendChars(Buffer buffer, CharSequence csq, int i, int i2) {
        Intrinsics.checkNotNullParameter(buffer, "<this>");
        Intrinsics.checkNotNullParameter(csq, "csq");
        int iM804encodeUTF8lBXzO7A = UTF8Kt.m804encodeUTF8lBXzO7A(buffer.getMemory(), csq, i, i2, buffer.getWritePosition(), buffer.getLimit());
        int iM800getCharactersMh2AYeg = EncodeResult.m800getCharactersMh2AYeg(iM804encodeUTF8lBXzO7A) & UShort.MAX_VALUE;
        buffer.commitWritten(EncodeResult.m799getBytesMh2AYeg(iM804encodeUTF8lBXzO7A) & UShort.MAX_VALUE);
        return iM800getCharactersMh2AYeg + i;
    }
