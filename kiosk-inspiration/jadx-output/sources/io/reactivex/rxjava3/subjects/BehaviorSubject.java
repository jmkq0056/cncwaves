...
public final class BehaviorSubject<T> extends Subject<T> {
    ...
    public void onError(Throwable t) {
        ...
        if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.terminalEvent, null, t)) {
    ...
    boolean add(BehaviorDisposable<T> rs) {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.observers, behaviorDisposableArr, behaviorDisposableArr2));
        return true;
    }
        ...
        do {
            ...
            while (true) {
                if (i >= length) {
                    i = -1;
                    break;
                } else if (behaviorDisposableArr[i] == rs) {
                    break;
                } else {
                    i++;
                }
