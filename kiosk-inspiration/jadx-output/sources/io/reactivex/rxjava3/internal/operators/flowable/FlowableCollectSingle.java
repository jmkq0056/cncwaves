...
public final class FlowableCollectSingle<T, U> extends Single<U> implements FuseToFlowable<U> {
    ...
    protected void subscribeActual(SingleObserver<? super U> observer) {
        try {
            this.source.subscribe((FlowableSubscriber) new CollectSubscriber(observer, Objects.requireNonNull(this.initialSupplier.get(), "The initialSupplier returned a null value"), this.collector));
        } catch (Throwable th) {
