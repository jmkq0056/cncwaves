...
public final class ObservablePublishSelector<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    protected void subscribeActual(Observer<? super R> observer) {
        ...
        try {
            ObservableSource observableSource = (ObservableSource) Objects.requireNonNull(this.selector.apply(publishSubjectCreate), "The selector returned a null ObservableSource");
