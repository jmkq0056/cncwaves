            ...
            while (!this.cancelled) {
                ...
                if (!z2) {
                    ...
                    if (num == LEFT_VALUE) {
                        ...
                        try {
                            ObservableSource observableSource = (ObservableSource) Objects.requireNonNull(this.leftEnd.apply(objPoll), "The leftEnd returned a null ObservableSource");
                            ...
                            if (this.error.get() != null) {
                                ...
                                while (it.hasNext()) {
                                    try {
                                        observer.onNext((Object) Objects.requireNonNull(this.resultSelector.apply(objPoll, it.next()), "The resultSelector returned a null value"));
                                    } catch (Throwable th) {
                        ...
                        try {
                            ObservableSource observableSource2 = (ObservableSource) Objects.requireNonNull(this.rightEnd.apply(objPoll), "The rightEnd returned a null ObservableSource");
                            ...
                            if (this.error.get() != null) {
                                ...
                                while (it2.hasNext()) {
                                    try {
                                        observer.onNext((Object) Objects.requireNonNull(this.resultSelector.apply(it2.next(), objPoll), "The resultSelector returned a null value"));
                                    } catch (Throwable th3) {
