...
public final class MaybeFlatMapNotification<T, R> extends AbstractMaybeWithUpstream<T, R> {
    ...
    static final class FlatMapMaybeObserver<T, R> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable {
        ...
        public void onSuccess(T value) {
            try {
                MaybeSource maybeSource = (MaybeSource) Objects.requireNonNull(this.onSuccessMapper.apply(value), "The onSuccessMapper returned a null MaybeSource");
                if (isDisposed()) {
                    return;
                }
        ...
        public void onError(Throwable e) {
            try {
                MaybeSource maybeSource = (MaybeSource) Objects.requireNonNull(this.onErrorMapper.apply(e), "The onErrorMapper returned a null MaybeSource");
                if (isDisposed()) {
                    return;
                }
                maybeSource.subscribe(new InnerObserver());
