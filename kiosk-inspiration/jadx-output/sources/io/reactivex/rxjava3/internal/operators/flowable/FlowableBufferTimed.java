...
public final class FlowableBufferTimed<T, U extends Collection<? super T>> extends AbstractFlowableWithUpstream<T, U> {
    ...
    static final class BufferExactUnboundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Subscription, Runnable, Disposable {
        ...
        public /* bridge */ /* synthetic */ boolean accept(Subscriber a, Object v) {
            return accept((Subscriber<? super Collection>) a, (Collection) v);
        }
            ...
            if (SubscriptionHelper.validate(this.upstream, s)) {
                ...
                try {
                    ...
                    if (!this.cancelled) {
                        ...
                        if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.timer, null, disposableSchedulePeriodicallyDirect)) {
                            return;
                        }
    ...
    static final class BufferExactBoundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Subscription, Runnable, Disposable {
        ...
        public void onNext(T r8) {
            ...
            L2d:
                ...
                io.reactivex.rxjava3.functions.Supplier<U extends java.util.Collection<? super T>> r8 = r7.bufferSupplier     // Catch: java.lang.Throwable -> L64
                java.lang.Object r8 = r8.get()     // Catch: java.lang.Throwable -> L64
                java.lang.String r0 = "The supplied buffer is null"
                java.lang.Object r8 = java.util.Objects.requireNonNull(r8, r0)     // Catch: java.lang.Throwable -> L64
