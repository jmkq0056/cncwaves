            ...
            while (!this.cancelled) {
                ...
                if (!z2) {
                    ...
                    if (num == LEFT_VALUE) {
                        ...
                        this.leftIndex = i + 1;
                        this.lefts.put(Integer.valueOf(i), (UnicastSubject<TRight>) unicastSubjectCreate);
                        try {
                            ...
                            if (this.error.get() != null) {
                                ...
                                try {
                                    observer.onNext((Object) Objects.requireNonNull(this.resultSelector.apply(objPoll, unicastSubjectCreate), "The resultSelector returned a null value"));
