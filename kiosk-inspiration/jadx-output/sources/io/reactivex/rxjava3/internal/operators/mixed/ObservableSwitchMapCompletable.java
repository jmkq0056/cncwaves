    ...
    static final class SwitchMapCompletableObserver<T> implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.inner, switchMapInnerObserver, switchMapInnerObserver2));
        ...
        void innerComplete(SwitchMapInnerObserver sender) {
            if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.inner, sender, null) && this.done) {
                this.errors.tryTerminateConsumer(this.downstream);
            }
        }
