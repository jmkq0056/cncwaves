...
final class ScalarXMapZHelper {
    ...
    static <T> boolean tryAsCompletable(Object obj, Function<? super T, ? extends CompletableSource> function, CompletableObserver completableObserver) {
        ...
        try {
            R.anim animVar = (Object) ((Supplier) obj).get();
            CompletableSource completableSource = animVar != null ? (CompletableSource) Objects.requireNonNull(function.apply(animVar), "The mapper returned a null CompletableSource") : null;
    ...
    static <T, R> boolean tryAsMaybe(Object obj, Function<? super T, ? extends MaybeSource<? extends R>> function, Observer<? super R> observer) {
        ...
        try {
            R.anim animVar = (Object) ((Supplier) obj).get();
            MaybeSource maybeSource = animVar != null ? (MaybeSource) Objects.requireNonNull(function.apply(animVar), "The mapper returned a null MaybeSource") : null;
            if (maybeSource == null) {
    ...
    static <T, R> boolean tryAsSingle(Object obj, Function<? super T, ? extends SingleSource<? extends R>> function, Observer<? super R> observer) {
        ...
        try {
            R.anim animVar = (Object) ((Supplier) obj).get();
            SingleSource singleSource = animVar != null ? (SingleSource) Objects.requireNonNull(function.apply(animVar), "The mapper returned a null SingleSource") : null;
