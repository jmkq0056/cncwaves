...
final class CircularIndeterminateAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private static final int[] DELAY_TO_EXPAND_IN_MS = {0, WinError.ERROR_NO_SECURITY_ON_OBJECT, 2700, 4050};
    private static final int[] DELAY_TO_COLLAPSE_IN_MS = {667, WinError.ERROR_INVALID_COLORSPACE, 3367, 4717};
    private static final int[] DELAY_TO_FADE_IN_MS = {1000, 2350, 3700, WinError.ERROR_CLUSTER_NODE_DOWN};
