...
public final class CalendarConstraints implements Parcelable {
    ...
    public static final class Builder {
        ...
        static final long DEFAULT_START = UtcDates.canonicalYearMonthDay(Month.create(WinError.RPC_S_INVALID_OBJECT, 0).timeInMillis);
        static final long DEFAULT_END = UtcDates.canonicalYearMonthDay(Month.create(LMErr.NERR_BASE, 11).timeInMillis);
