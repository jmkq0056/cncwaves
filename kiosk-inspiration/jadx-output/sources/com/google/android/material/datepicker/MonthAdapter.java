...
class MonthAdapter extends BaseAdapter {
    ...
    private void updateSelectedState(TextView textView, long j, int i) {
        ...
        if (this.dayViewDecorator != null && i != -1) {
            ...
            calendarItemStyle.styleItem(textView, this.dayViewDecorator.getBackgroundColor(context, i2, i3, i, zIsValid, z), this.dayViewDecorator.getTextColor(context, i2, i3, i, zIsValid, z));
