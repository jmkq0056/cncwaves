...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    static final Property<View, Float> WIDTH = new Property<View, Float>(Float.class, PrinterTextParser.ATTR_BARCODE_WIDTH) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.6
    ...
    static final Property<View, Float> HEIGHT = new Property<View, Float>(Float.class, PrinterTextParser.ATTR_BARCODE_HEIGHT) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.7
        @Override // android.util.Property
        public void set(View view, Float f) {
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues(PrinterTextParser.ATTR_BARCODE_WIDTH)) {
                PropertyValuesHolder[] propertyValues = currentMotionSpec.getPropertyValues(PrinterTextParser.ATTR_BARCODE_WIDTH);
                propertyValues[0].setFloatValues(ExtendedFloatingActionButton.this.getWidth(), this.size.getWidth());
                currentMotionSpec.setPropertyValues(PrinterTextParser.ATTR_BARCODE_WIDTH, propertyValues);
            }
            if (currentMotionSpec.hasPropertyValues(PrinterTextParser.ATTR_BARCODE_HEIGHT)) {
                PropertyValuesHolder[] propertyValues2 = currentMotionSpec.getPropertyValues(PrinterTextParser.ATTR_BARCODE_HEIGHT);
                propertyValues2[0].setFloatValues(ExtendedFloatingActionButton.this.getHeight(), this.size.getHeight());
                currentMotionSpec.setPropertyValues(PrinterTextParser.ATTR_BARCODE_HEIGHT, propertyValues2);
            }
