...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(PrinterTextParser.ATTR_BARCODE_WIDTH)) {
            arrayList.add(motionSpec.getAnimator(PrinterTextParser.ATTR_BARCODE_WIDTH, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
        if (motionSpec.hasPropertyValues(PrinterTextParser.ATTR_BARCODE_HEIGHT)) {
            arrayList.add(motionSpec.getAnimator(PrinterTextParser.ATTR_BARCODE_HEIGHT, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }
