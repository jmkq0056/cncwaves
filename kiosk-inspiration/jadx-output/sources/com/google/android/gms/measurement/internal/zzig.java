...
public final class zzig extends zzfy {
    ...
    final zzbl zzb(zzbl zzblVar, zzp zzpVar) {
        if (!"_cmp".equals(zzblVar.zza) || zzblVar.zzb == null || zzblVar.zzb.zza() == 0) {
            return zzblVar;
        }
    ...
    final void zzc(zzbl zzblVar, zzp zzpVar) {
        boolean zZza;
    ...
    public final byte[] zza(zzbl zzblVar, String str) {
        ...
        try {
            ...
            this.zza.zzj().zzc().zza("Log and bundle processed. event, size, time_ms", this.zza.zzg().zza(zzblVar.zza), Integer.valueOf(bArr.length), Long.valueOf((this.zza.zzb().nanoTime() / 1000000) - jNanoTime));
            return bArr;
        } catch (InterruptedException | ExecutionException e) {
