...
public final class zzbn {
    ...
    static {
        ...
        Long lValueOf = Long.valueOf(DefaultOfflineDatabaseReaper.REAPER_TASK_INTERVAL_MS);
        zzc = zzb("measurement.monitoring.sample_period_millis", lValueOf, new zzfv() { // from class: com.google.android.gms.measurement.internal.zzcy
            @Override // com.google.android.gms.measurement.internal.zzfv
            public final Object zza() {
                return Long.valueOf(com.google.android.gms.internal.measurement.zznu.zzt());
            }
        });
        zzd = zza("measurement.config.cache_time", lValueOf, 3600000L, new zzfv() { // from class: com.google.android.gms.measurement.internal.zzdk
            @Override // com.google.android.gms.measurement.internal.zzfv
            public final Object zza() {
                return zzbn.zzby();
            }
        ...
        zzn = zzb("measurement.upload.max_conversions_per_day", Integer.valueOf(WinError.WSABASEERR), new zzfv() { // from class: com.google.android.gms.measurement.internal.zzce
            @Override // com.google.android.gms.measurement.internal.zzfv
            public final Object zza() {
        ...
        zzag = zzb("measurement.alarm_manager.minimum_interval", Long.valueOf(StripeHealthCheckerDefaultConfig.ONLINE_STABLE_RETRY_DELAY_MS), new zzfv() { // from class: com.google.android.gms.measurement.internal.zzdd
            @Override // com.google.android.gms.measurement.internal.zzfv
            public final Object zza() {
                return Long.valueOf(com.google.android.gms.internal.measurement.zznu.zzr());
            }
        });
        zzah = zzb("measurement.upload.stale_data_deletion_interval", lValueOf, new zzfv() { // from class: com.google.android.gms.measurement.internal.zzdc
            @Override // com.google.android.gms.measurement.internal.zzfv
            public final Object zza() {
        ...
        zzaj = zzb("measurement.upload.initial_upload_delay_time", Long.valueOf(IpReaderController.HEARTBEAT_INTERVAL_MS), new zzfv() { // from class: com.google.android.gms.measurement.internal.zzde
            @Override // com.google.android.gms.measurement.internal.zzfv
            public final Object zza() {
