    ...
    public final byte[] zza(zzbl zzblVar, String str) {
        ...
        try {
            ...
            if (next == null || next.zze == null) {
                list = listZzk;
                zzpo zzpoVar = new zzpo(strZzac, DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_lte", zzb().currentTimeMillis(), 0L);
                list.add(zzpoVar);
                zzh().zza(zzpoVar);
            } else {
                list = listZzk;
            ...
            for (int i = 0; i < list.size(); i++) {
                zzgf.zzp.zza zzaVarZzb = zzgf.zzp.zze().zza(list.get(i).zzc).zzb(list.get(i).zzd);
                h_().zza(zzaVarZzb, list.get(i).zze);
            ...
            if (zzbhVarZzd == null) {
                ...
                zzaVar = zzaVarZzp;
                bArr = null;
                long j2 = zzbhVarZzd.zzf;
                zzbhVarZza = zzbhVarZzd.zza(zzblVar.zzd);
                j = j2;
            }
            zzbh zzbhVar = zzbhVarZza;
            zzh().zza(zzbhVar);
            ...
            for (String str2 : zzbeVar.zzf) {
                zzgf.zzh.zza zzaVarZza2 = zzgf.zzh.zze().zza(str2);
                Object objZzc = zzbeVar.zzf.zzc(str2);
                if (objZzc != null) {
            ...
            zzaVar2.zza(zzaVarZza).zza(zzgf.zzl.zza().zza(zzgf.zzg.zza().zza(zzbhVar.zzc).zza(zzblVar.zza)));
