...
public final class zzbd {
    ...
    public final int hashCode() {
        ...
        String str = this.zze;
        return this.zzc.hashCode() + (i * 29) + ((str == null ? 17 : str.hashCode()) * WinError.ERROR_NOT_SUBSTED);
    }
    ...
    public static zzbd zza(Bundle bundle, int i) {
        ...
        for (zzjj.zza zzaVar : zzjl.DMA.zza()) {
            enumMap.put(zzaVar, zzjj.zza(bundle.getString(zzaVar.zze)));
        }
    ...
    static zzbd zza(zzjm zzjmVar, int i) {
        EnumMap enumMap = new EnumMap(zzjj.zza.class);
        enumMap.put(zzjj.zza.AD_USER_DATA, zzjmVar);
    ...
    public static zzbd zza(String str) {
        ...
        int i3 = 0;
        while (i3 < length) {
            enumMap.put(zzaVarArrZza[i3], zzjj.zza(strArrSplit[i2].charAt(0)));
            i3++;
            i2++;
        }
    ...
    zzbd(Boolean bool, int i, Boolean bool2, String str) {
        ...
        this.zzf = enumMap;
        enumMap.put(zzjj.zza.AD_USER_DATA, zzjj.zza(bool));
        this.zzb = i;
        this.zzc = zzh();
        this.zzd = bool2;
        this.zze = str;
