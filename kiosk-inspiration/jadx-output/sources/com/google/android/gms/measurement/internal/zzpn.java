...
public final class zzpn extends zzji {
    ...
    */
    ...
    final long zza(Context context, String str) {
        ...
        MessageDigest messageDigestZzr = zzr();
        ...
        try {
            ...
            if (packageInfo.signatures != null && packageInfo.signatures.length > 0) {
                return zza(messageDigestZzr.digest(packageInfo.signatures[0].toByteArray()));
            }
    ...
    public static long zza(zzbg zzbgVar) {
        ...
        while (it.hasNext()) {
            Object objZzc = zzbgVar.zzc(it.next());
    ...
    public static long zza(long j, long j2) {
        return (j + (j2 * StripeHealthCheckerDefaultConfig.ONLINE_STABLE_RETRY_DELAY_MS)) / DefaultOfflineDatabaseReaper.REAPER_TASK_INTERVAL_MS;
    }
    ...
    private final void zza(String str, String str2, String str3, Bundle bundle, List<String> list, boolean z) {
        ...
        int i = zze().zzs().zza(231100000, true) ? 35 : 0;
        int i2 = 0;
        for (String str4 : new TreeSet(bundle.keySet())) {
            ...
            if (iZzj != 0) {
                zza(bundle, iZzj, str4, iZzj == 3 ? str4 : null);
                bundle.remove(str4);
            } else {
                if (zza(bundle.get(str4))) {
                    zzj().zzw().zza("Nested Bundle parameters are not allowed; discarded. event name, param name, child param name", str2, str3, str4);
                    iZza = 22;
                } else {
                ...
                if (iZza != 0 && !"_ev".equals(str4)) {
                    ...
                    bundle.remove(str4);
                } else if (zzg(str4) && !zza(str4, zzjo.zzd)) {
                    i2++;
                    if (!zza(231100000, true)) {
                        ...
                        zzj().zzm().zza("Item can't contain more than " + i + " item-scoped custom params", zzi().zza(str2), zzi().zza(bundle));
                        zzb(bundle, 28);
                        bundle.remove(str4);
                    }
                }
    ...
    static boolean zzd(String str) {
        ...
        return strZza.equals(Marker.ANY_MARKER) || Arrays.asList(strZza.split(",")).contains(str);
    }
