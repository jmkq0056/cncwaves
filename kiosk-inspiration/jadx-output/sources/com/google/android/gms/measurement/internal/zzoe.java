...
public final class zzoe {
    ...
    public final Bundle zza() {
        ...
        if (str.length() > 6 && iZze >= 4) {
            bundle.putString(zzjj.zza.AD_USER_DATA.zze, (str.charAt(0) == '1' && str.charAt(6) == '1') ? "granted" : "denied");
        }
        return bundle;
    }
    ...
    public static zzoe zza(SharedPreferences sharedPreferences) {
        ...
        if (!Json.UNSET_NAME.equals(strZzb) && strZzb.length() > 754) {
            map.put("GoogleConsent", String.valueOf(strZzb.charAt(WinError.ERROR_BUFFER_ALL_ZEROS)));
        }
        ...
        if (!Json.UNSET_NAME.equals(strZzb2)) {
    ...
    public final String zzb() {
        ...
        if (iZzd >= 0 && iZzd <= 4095) {
            ...
            sb.append(TlvMap.SET_BUZZER_ENABLED_VALUE);
        }
        int iZze = zze();
        if (iZze >= 0 && iZze <= 63) {
