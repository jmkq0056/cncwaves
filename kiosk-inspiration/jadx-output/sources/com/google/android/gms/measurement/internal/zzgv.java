...
public final class zzgv extends zzot {
    ...
    public final void zza(String str, zzov zzovVar, zzgf.zzj zzjVar, zzgu zzguVar) {
        String str2;
        URL url;
        byte[] bArrZzce;
        zzv();
        zzam();
        try {
            url = new URI(zzovVar.zzc()).toURL();
            h_();
            bArrZzce = zzjVar.zzce();
            str2 = str;
        } catch (IllegalArgumentException | MalformedURLException | URISyntaxException unused) {
            str2 = str;
        }
        try {
            zzl().zza(new zzgw(this, str2, url, bArrZzce, zzovVar.zzd(), zzguVar));
        } catch (IllegalArgumentException | MalformedURLException | URISyntaxException unused2) {
            zzj().zzg().zza("Failed to parse URL. Not uploading MeasurementBatch. appId", zzgo.zza(str2), zzovVar.zzc());
        }
    }
