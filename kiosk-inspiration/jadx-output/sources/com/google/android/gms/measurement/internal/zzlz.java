...
public final class zzlz extends zzf {
    ...
    static /* synthetic */ void zza(zzlz zzlzVar, Bundle bundle, zzlw zzlwVar, zzlw zzlwVar2, long j) {
        if (bundle != null) {
    ...
    public final void zza(zzlw zzlwVar, zzlw zzlwVar2, long j, boolean z, Bundle bundle) {
        ...
        if (z3) {
            ...
            if (zzlwVar.zze && zzlwVar.zzf != 0) {
                jCurrentTimeMillis = zzlwVar.zzf;
            }
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzeb zzebVar, Bundle bundle) {
        ...
        this.zzd.put(Integer.valueOf(zzebVar.zza), new zzlw(bundle2.getString("name"), bundle2.getString("referrer_name"), bundle2.getLong(OfflineStorageConstantsKt.ID)));
    }
    ...
    public final void zzb(com.google.android.gms.internal.measurement.zzeb zzebVar, Bundle bundle) {
        ...
        bundle2.putLong(OfflineStorageConstantsKt.ID, zzlwVar.zzc);
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzeb zzebVar, String str, String str2) {
        ...
        zzj().zzq().zza("Setting current screen to name, class", str == null ? AbstractJsonLexerKt.NULL : str, str2);
    ...
    public final void zza(Bundle bundle, long j) {
        ...
        synchronized (this.zzj) {
            ...
            zzj().zzq().zza("Logging screen view with name, class", str == null ? AbstractJsonLexerKt.NULL : str, str2 == null ? AbstractJsonLexerKt.NULL : str2);
