...
final class zzeg extends zzed.zzb {
    ...
    zzeg(zzed zzedVar, String str, String str2, Context context, Bundle bundle) {
        super(zzedVar);
        this.zzc = str;
        this.zzd = str2;
        this.zze = context;
    ...
    public final void zza() {
        ...
        try {
            ...
            ((zzdl) Preconditions.checkNotNull(this.zzg.zzj)).initialize(ObjectWrapper.wrap(this.zze), new zzdz(114010L, Math.max(localVersion, r0), DynamiteModule.getRemoteVersion(this.zze, ModuleDescriptor.MODULE_ID) < localVersion, str, str2, str3, this.zzf, com.google.android.gms.measurement.internal.zzhw.zza(this.zze)), this.zza);
        } catch (Exception e) {
