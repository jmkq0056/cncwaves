    ...
    protected final boolean zza(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        ...
        switch (i) {
            ...
            case 3:
                ...
                zzbw.zzb(parcel);
                logEventAndBundle(string3, string4, bundle2, zzdsVar, j3);
                break;
            case 4:
            ...
            case 5:
                ...
                if (strongBinder2 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface2 instanceof zzdq) {
                        zzdsVar16 = (zzdq) iInterfaceQueryLocalInterface2;
                    } else {
                        zzdsVar16 = new zzds(strongBinder2);
                    }
                }
                zzbw.zzb(parcel);
                getUserProperties(string7, string8, zZzc4, zzdsVar16);
                break;
            case 6:
                ...
                if (strongBinder3 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface3 instanceof zzdq) {
                        zzdsVar15 = (zzdq) iInterfaceQueryLocalInterface3;
                    } else {
                        zzdsVar15 = new zzds(strongBinder3);
                    }
                }
                zzbw.zzb(parcel);
                getMaxUserProperties(string9, zzdsVar15);
                break;
            case 7:
            ...
            case 10:
                ...
                if (strongBinder4 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface4 instanceof zzdq) {
                        zzdsVar14 = (zzdq) iInterfaceQueryLocalInterface4;
                    } else {
                        zzdsVar14 = new zzds(strongBinder4);
                    }
                }
                zzbw.zzb(parcel);
                getConditionalUserProperties(string13, string14, zzdsVar14);
                break;
            case 11:
            ...
            case 16:
                ...
                if (strongBinder5 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface5 instanceof zzdq) {
                        zzdsVar13 = (zzdq) iInterfaceQueryLocalInterface5;
                    } else {
                        zzdsVar13 = new zzds(strongBinder5);
                    }
                }
                zzbw.zzb(parcel);
                getCurrentScreenName(zzdsVar13);
                break;
            case 17:
                ...
                if (strongBinder6 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface6 instanceof zzdq) {
                        zzdsVar12 = (zzdq) iInterfaceQueryLocalInterface6;
                    } else {
                        zzdsVar12 = new zzds(strongBinder6);
                    }
                }
                zzbw.zzb(parcel);
                getCurrentScreenClass(zzdsVar12);
                break;
            case 18:
            ...
            case 19:
                ...
                if (strongBinder8 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface8 instanceof zzdq) {
                        zzdsVar11 = (zzdq) iInterfaceQueryLocalInterface8;
                    } else {
                        zzdsVar11 = new zzds(strongBinder8);
                    }
                }
                zzbw.zzb(parcel);
                getCachedAppInstanceId(zzdsVar11);
                break;
            case 20:
                ...
                if (strongBinder9 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface9 instanceof zzdq) {
                        zzdsVar10 = (zzdq) iInterfaceQueryLocalInterface9;
                    } else {
                        zzdsVar10 = new zzds(strongBinder9);
                    }
                }
                zzbw.zzb(parcel);
                getAppInstanceId(zzdsVar10);
                break;
            case 21:
                ...
                if (strongBinder10 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface10 instanceof zzdq) {
                        zzdsVar9 = (zzdq) iInterfaceQueryLocalInterface10;
                    } else {
                        zzdsVar9 = new zzds(strongBinder10);
                    }
                }
                zzbw.zzb(parcel);
                getGmpAppId(zzdsVar9);
                break;
            case 22:
                ...
                if (strongBinder11 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface11 instanceof zzdq) {
                        zzdsVar8 = (zzdq) iInterfaceQueryLocalInterface11;
                    } else {
                        zzdsVar8 = new zzds(strongBinder11);
                    }
                }
                zzbw.zzb(parcel);
                generateEventId(zzdsVar8);
                break;
            case 23:
            ...
            case 31:
                ...
                if (strongBinder12 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface12 instanceof zzdq) {
                        zzdsVar7 = (zzdq) iInterfaceQueryLocalInterface12;
                    } else {
                        zzdsVar7 = new zzds(strongBinder12);
                    }
                }
                long j20 = parcel.readLong();
                zzbw.zzb(parcel);
                onActivitySaveInstanceState(iObjectWrapperAsInterface10, zzdsVar7, j20);
                break;
            case 32:
                ...
                if (strongBinder13 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface13 instanceof zzdq) {
                        zzdsVar6 = (zzdq) iInterfaceQueryLocalInterface13;
                    } else {
                        zzdsVar6 = new zzds(strongBinder13);
                    }
                }
                long j21 = parcel.readLong();
                zzbw.zzb(parcel);
                performAction(bundle6, zzdsVar6, j21);
                break;
            case 33:
            ...
            case 38:
                ...
                if (strongBinder17 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface17 instanceof zzdq) {
                        zzdsVar5 = (zzdq) iInterfaceQueryLocalInterface17;
                    } else {
                        zzdsVar5 = new zzds(strongBinder17);
                    }
                }
                int i4 = parcel.readInt();
                zzbw.zzb(parcel);
                getTestFlag(zzdsVar5, i4);
                break;
            case 39:
            ...
            case 40:
                ...
                if (strongBinder18 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface18 instanceof zzdq) {
                        zzdsVar4 = (zzdq) iInterfaceQueryLocalInterface18;
                    } else {
                        zzdsVar4 = new zzds(strongBinder18);
                    }
                }
                zzbw.zzb(parcel);
                isDataCollectionEnabled(zzdsVar4);
                break;
            case 41:
            case 47:
            case 49:
            ...
            case 46:
                ...
                if (strongBinder19 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface19 instanceof zzdq) {
                        zzdsVar3 = (zzdq) iInterfaceQueryLocalInterface19;
                    } else {
                        zzdsVar3 = new zzds(strongBinder19);
                    }
                }
                zzbw.zzb(parcel);
                getSessionId(zzdsVar3);
                break;
            case 48:
            ...
            case 57:
                ...
                if (strongBinder20 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface20 instanceof zzdq) {
                        zzdsVar2 = (zzdq) iInterfaceQueryLocalInterface20;
                    } else {
                        zzdsVar2 = new zzds(strongBinder20);
                    }
                }
                long j32 = parcel.readLong();
                zzbw.zzb(parcel);
                onActivitySaveInstanceStateByScionActivityInfo(zzebVar8, zzdsVar2, j32);
                break;
            case 58:
