...
interface zznl {
    ...
    void zza(int i, zziy zziyVar) throws IOException;

    <K, V> void zza(int i, zzlh<K, V> zzlhVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    @Deprecated
    void zza(int i, Object obj, zzme zzmeVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<zziy> list) throws IOException;

    @Deprecated
    void zza(int i, List<?> list, zzme zzmeVar) throws IOException;
    ...
    void zzb(int i, Object obj, zzme zzmeVar) throws IOException;

    void zzb(int i, List<String> list) throws IOException;

    void zzb(int i, List<?> list, zzme zzmeVar) throws IOException;
