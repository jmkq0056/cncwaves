...
public final class WebImage extends AbstractSafeParcelable {
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.put(PrinterTextParser.ATTR_BARCODE_WIDTH, this.zac);
            jSONObject.put(PrinterTextParser.ATTR_BARCODE_HEIGHT, this.zad);
    ...
    public WebImage(JSONObject jSONObject) throws IllegalArgumentException {
        ...
        this(uri, jSONObject.optInt(PrinterTextParser.ATTR_BARCODE_WIDTH, 0), jSONObject.optInt(PrinterTextParser.ATTR_BARCODE_HEIGHT, 0));
    }
}
