...
public class FlexboxLayoutManager extends RecyclerView.LayoutManager implements FlexContainer, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private void updateFlexLines(int childCount) {
        ...
        if (i6 != -1 || (this.mPendingScrollPosition == -1 && !z)) {
            ...
            if (isMainAxisDirectionHorizontal()) {
                ...
                i2 = iMin;
                if (this.mFlexLines.size() > 0) {
                    this.mFlexboxHelper.clearFlexLines(this.mFlexLines, i2);
                    iMin = i2;
            ...
            this.mFlexboxHelper.determineMainSize(iMakeMeasureSpec, iMakeMeasureSpec2, i2);
    ...
    */
    private int layoutFlexLineMainAxisHorizontal(com.google.android.flexbox.FlexLine r19, com.google.android.flexbox.FlexboxLayoutManager.LayoutState r20) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private int layoutFlexLineMainAxisVertical(com.google.android.flexbox.FlexLine r21, com.google.android.flexbox.FlexboxLayoutManager.LayoutState r22) {
        /*
