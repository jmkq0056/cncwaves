...
public final class CCTDestination implements EncodedDestination {
    ...
    public byte[] asByteArray() {
        ...
        return String.format("%s%s%s%s", EXTRAS_VERSION_MARKER, str2, EXTRAS_DELIMITER, str).getBytes(Charset.forName(HTTP.UTF_8));
    }
    ...
    public static CCTDestination fromByteArray(byte[] bArr) {
        ...
        String[] strArrSplit = str.substring(EXTRAS_VERSION_MARKER.length()).split(Pattern.quote(EXTRAS_DELIMITER), 2);
