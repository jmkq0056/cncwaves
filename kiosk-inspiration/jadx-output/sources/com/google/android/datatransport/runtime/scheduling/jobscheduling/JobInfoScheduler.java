...
public class JobInfoScheduler implements WorkScheduler {
    ...
    int getJobId(TransportContext transportContext) {
        ...
        adler32.update(this.context.getPackageName().getBytes(Charset.forName(HTTP.UTF_8)));
        adler32.update(transportContext.getBackendName().getBytes(Charset.forName(HTTP.UTF_8)));
