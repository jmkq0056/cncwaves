...
public abstract class BaseEncoding {
        ...
        Alphabet(String str, char[] cArr) {
            ...
            try {
                ...
                try {
                    ...
                    String strValueOf = String.valueOf(new String(cArr));
    ...
    static class StandardBaseEncoding extends BaseEncoding {
        ...
        int decodeTo(byte[] bArr, CharSequence charSequence) throws DecodingException {
            ...
            CharSequence charSequenceTrimTrailingPadding = trimTrailingPadding(charSequence);
            if (!this.alphabet.isValidPaddingStartPosition(charSequenceTrimTrailingPadding.length())) {
                throw new DecodingException(new StringBuilder(32).append("Invalid input length ").append(charSequenceTrimTrailingPadding.length()).toString());
            }
            int i = 0;
            int i2 = 0;
            while (i < charSequenceTrimTrailingPadding.length()) {
                ...
                for (int i4 = 0; i4 < this.alphabet.charsPerChunk; i4++) {
                    ...
                    if (i + i4 < charSequenceTrimTrailingPadding.length()) {
                        jDecode |= (long) this.alphabet.decode(charSequenceTrimTrailingPadding.charAt(i3 + i));
                        i3++;
                    }
                }
        ...
        public InputStream decodingStream(final Reader reader) {
            ...
            return new InputStream() { // from class: com.google.common.io.BaseEncoding.StandardBaseEncoding.2
                ...
                /* JADX WARN: Code restructure failed: missing block: B:24:0x0081, code lost:
                    ...
                    throw new com.google.common.io.BaseEncoding.DecodingException(new java.lang.StringBuilder(41).append("Padding cannot start at index ").append(r5.readChars).toString());
                 */
