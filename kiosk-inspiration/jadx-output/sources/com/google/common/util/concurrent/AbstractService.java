...
public abstract class AbstractService implements Service {
    ...
    private static ListenerCallQueue.Event<Service.Listener> terminatedEvent(final Service.State state) {
        return new ListenerCallQueue.Event<Service.Listener>() { // from class: com.google.common.util.concurrent.AbstractService.3
            ...
            public String toString() {
                ...
                return new StringBuilder(String.valueOf(strValueOf).length() + 21).append("terminated({from = ").append(strValueOf).append("})").toString();
            }
        };
    }
    ...
    private static ListenerCallQueue.Event<Service.Listener> stoppingEvent(final Service.State state) {
        return new ListenerCallQueue.Event<Service.Listener>() { // from class: com.google.common.util.concurrent.AbstractService.4
            ...
            public String toString() {
                String strValueOf = String.valueOf(state);
                return new StringBuilder(String.valueOf(strValueOf).length() + 19).append("stopping({from = ").append(strValueOf).append("})").toString();
            }
        };
    }
    ...
    public final void awaitTerminated(long j, TimeUnit timeUnit) throws TimeoutException {
        if (this.monitor.enterWhenUninterruptibly(this.isStopped, j, timeUnit)) {
            ...
            throw new TimeoutException(new StringBuilder(String.valueOf(strValueOf).length() + 65 + String.valueOf(strValueOf2).length()).append("Timed out waiting for ").append(strValueOf).append(" to reach a terminal state. Current state: ").append(strValueOf2).toString());
        }
    }
    ...
    private void checkCurrentState(Service.State state) {
        ...
        if (state2 != state) {
            if (state2 == Service.State.FAILED) {
                String strValueOf = String.valueOf(this);
                String strValueOf2 = String.valueOf(state);
                throw new IllegalStateException(new StringBuilder(String.valueOf(strValueOf).length() + 56 + String.valueOf(strValueOf2).length()).append("Expected the service ").append(strValueOf).append(" to be ").append(strValueOf2).append(", but the service has FAILED").toString(), failureCause());
            }
            String strValueOf3 = String.valueOf(this);
            String strValueOf4 = String.valueOf(state);
            String strValueOf5 = String.valueOf(state2);
            throw new IllegalStateException(new StringBuilder(String.valueOf(strValueOf3).length() + 38 + String.valueOf(strValueOf4).length() + String.valueOf(strValueOf5).length()).append("Expected the service ").append(strValueOf3).append(" to be ").append(strValueOf4).append(", but was ").append(strValueOf5).toString());
        }
    }
    ...
    protected final void notifyStopped() {
        ...
        try {
            ...
            switch (AnonymousClass6.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()]) {
                ...
                case 6:
                    String strValueOf = String.valueOf(state);
                    throw new IllegalStateException(new StringBuilder(String.valueOf(strValueOf).length() + 43).append("Cannot notifyStopped() when the service is ").append(strValueOf).toString());
                case 2:
                case 3:
                case 4:
                    this.snapshot = new StateSnapshot(Service.State.TERMINATED);
    ...
    public String toString() {
        ...
        String strValueOf = String.valueOf(state());
        return new StringBuilder(String.valueOf(simpleName).length() + 3 + String.valueOf(strValueOf).length()).append(simpleName).append(" [").append(strValueOf).append("]").toString();
    }
    ...
    private void enqueueFailedEvent(final Service.State state, final Throwable th) {
        this.listeners.enqueue(new ListenerCallQueue.Event<Service.Listener>(this) { // from class: com.google.common.util.concurrent.AbstractService.5
            ...
            public String toString() {
                ...
                return new StringBuilder(String.valueOf(strValueOf).length() + 27 + String.valueOf(strValueOf2).length()).append("failed({from = ").append(strValueOf).append(", cause = ").append(strValueOf2).append("})").toString();
            }
        });
    }
