...
public final class MoreExecutors {
    ...
    static class Application {
        ...
        final void addDelayedShutdownHook(final ExecutorService executorService, final long j, final TimeUnit timeUnit) {
            ...
            addShutdownHook(MoreExecutors.newThread(new StringBuilder(String.valueOf(strValueOf).length() + 24).append("DelayedShutdownHook-for-").append(strValueOf).toString(), new Runnable(this) { // from class: com.google.common.util.concurrent.MoreExecutors.Application.1
    ...
    private static class ListeningDecorator extends AbstractListeningExecutorService {
        ...
        public final String toString() {
            ...
            return new StringBuilder(String.valueOf(string).length() + 2 + String.valueOf(strValueOf).length()).append(string).append("[").append(strValueOf).append("]").toString();
        }
    }
    ...
    private static final class ScheduledListeningDecorator extends ListeningDecorator implements ListeningScheduledExecutorService {
        ...
        private static final class NeverSuccessfulListenableFutureTask extends AbstractFuture.TrustedFuture<Void> implements Runnable {
            ...
            protected String pendingToString() {
                String strValueOf = String.valueOf(this.delegate);
                return new StringBuilder(String.valueOf(strValueOf).length() + 7).append("task=[").append(strValueOf).append("]").toString();
            }
        }
    }
