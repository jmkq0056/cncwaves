    ...
    public ServiceManager startAsync() {
        ...
        while (it2.hasNext()) {
            ...
            try {
                ...
                logger2.log(level, new StringBuilder(String.valueOf(strValueOf).length() + 24).append("Unable to start Service ").append(strValueOf).toString(), (Throwable) e);
            }
        }
        return this;
    }
    ...
    private static final class ServiceManagerState {
        ...
        void markReady() {
            ...
            try {
                ...
                throw new IllegalArgumentException(new StringBuilder(String.valueOf(strValueOf).length() + 89).append("Services started transitioning asynchronously before the ServiceManager was constructed: ").append(strValueOf).toString());
            } finally {
                this.monitor.leave();
            }
        }
        ...
        void awaitHealthy(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                if (!this.monitor.waitForUninterruptibly(this.awaitHealthGuard, j, timeUnit)) {
                    ...
                    throw new TimeoutException(new StringBuilder(String.valueOf(strValueOf).length() + 93).append("Timeout waiting for the services to become healthy. The following services have not started: ").append(strValueOf).toString());
                }
                checkHealthy();
            } finally {
                this.monitor.leave();
        ...
        void awaitStopped(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                ...
                throw new TimeoutException(new StringBuilder(String.valueOf(strValueOf).length() + 83).append("Timeout waiting for the services to stop. The following services have not stopped: ").append(strValueOf).toString());
            } finally {
                this.monitor.leave();
            }
        }
        ...
        void enqueueFailedEvent(final Service service) {
            this.listeners.enqueue(new ListenerCallQueue.Event<Listener>(this) { // from class: com.google.common.util.concurrent.ServiceManager.ServiceManagerState.2
                ...
                public String toString() {
                    ...
                    return new StringBuilder(String.valueOf(strValueOf).length() + 18).append("failed({service=").append(strValueOf).append("})").toString();
                }
            });
        }
