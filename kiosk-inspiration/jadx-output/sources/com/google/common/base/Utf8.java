...
public final class Utf8 {
    public static int encodedLength(CharSequence charSequence) {
        ...
        throw new IllegalArgumentException(new StringBuilder(54).append("UTF-8 length does not fit in int: ").append(((long) iEncodedLengthGeneral) + 4294967296L).toString());
    }
