...
public final class Suppliers {
    ...
    static class ExpiringMemoizingSupplier<T> implements Supplier<T>, Serializable {
        ...
        public String toString() {
            ...
            return new StringBuilder(String.valueOf(strValueOf).length() + 62).append("Suppliers.memoizeWithExpiration(").append(strValueOf).append(", ").append(this.durationNanos).append(", NANOS)").toString();
        }
    }
