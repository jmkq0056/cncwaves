...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(this, precomputedPositive(i, bitSet, strConcat)) { // from class: com.google.common.base.CharMatcher.1
    ...
    private static final class Is extends FastMatcher {
        ...
        public String toString() {
            ...
            return new StringBuilder(String.valueOf(strShowCharacter).length() + 18).append("CharMatcher.is('").append(strShowCharacter).append("')").toString();
        }
    }
    ...
    private static final class IsNot extends FastMatcher {
        ...
        public String toString() {
            String strShowCharacter = CharMatcher.showCharacter(this.match);
            return new StringBuilder(String.valueOf(strShowCharacter).length() + 21).append("CharMatcher.isNot('").append(strShowCharacter).append("')").toString();
        }
    }
    ...
    private static final class IsEither extends FastMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public String toString() {
            String strShowCharacter = CharMatcher.showCharacter(this.match1);
            String strShowCharacter2 = CharMatcher.showCharacter(this.match2);
            return new StringBuilder(String.valueOf(strShowCharacter).length() + 21 + String.valueOf(strShowCharacter2).length()).append("CharMatcher.anyOf(\"").append(strShowCharacter).append(strShowCharacter2).append("\")").toString();
        }
    }
    ...
    private static final class InRange extends FastMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public String toString() {
            String strShowCharacter = CharMatcher.showCharacter(this.startInclusive);
            String strShowCharacter2 = CharMatcher.showCharacter(this.endInclusive);
            return new StringBuilder(String.valueOf(strShowCharacter).length() + 27 + String.valueOf(strShowCharacter2).length()).append("CharMatcher.inRange('").append(strShowCharacter).append("', '").append(strShowCharacter2).append("')").toString();
        }
    }
