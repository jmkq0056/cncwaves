...
public abstract class EndpointPair<N> implements Iterable<N> {
    ...
    private static final class Ordered<N> extends EndpointPair<N> {
        ...
        public String toString() {
            ...
            return new StringBuilder(String.valueOf(strValueOf).length() + 6 + String.valueOf(strValueOf2).length()).append("<").append(strValueOf).append(" -> ").append(strValueOf2).append(">").toString();
        }
    }
