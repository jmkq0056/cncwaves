...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength17to32(byte[] bArr, int i, int i2) {
        ...
        return hashLength16(Long.rotateRight(jLoad64 + jLoad642, 43) + Long.rotateRight(jLoad643, 30) + (LittleEndianByteArray.load64(bArr, i3 - 16) * K2), jLoad64 + Long.rotateRight(jLoad642 + K2, 18) + jLoad643, j);
    }
    ...
    private static long hashLength33To64(byte[] bArr, int i, int i2) {
        ...
        return hashLength16(Long.rotateRight(jLoad644 + jLoad645, 43) + Long.rotateRight(jLoad646, 30) + ((jHashLength16 + LittleEndianByteArray.load64(bArr, i3 - 24)) * j), jLoad644 + Long.rotateRight(jLoad645 + jLoad64, 18) + jLoad646, j);
    }
    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            char c2 = c;
            long jLoad642 = jRotateRight2 + jArr[0] + LittleEndianByteArray.load64(bArr2, i8 + 40);
            ...
            if (i8 == i4) {
                ...
                long jLoad643 = jRotateRight5 + (jArr3[0] * 9) + LittleEndianByteArray.load64(bArr2, i6 - 23);
