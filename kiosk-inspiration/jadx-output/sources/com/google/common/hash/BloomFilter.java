...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
    ...
    static <T> BloomFilter<T> create(Funnel<? super T> funnel, long j, double d, Strategy strategy) {
        ...
        try {
            ...
            throw new IllegalArgumentException(new StringBuilder(57).append("Could not create BloomFilter of ").append(jOptimalNumOfBits).append(" bits").toString(), e);
        }
    }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    i3 = b;
                    i = i5;
                    throw new IOException(new StringBuilder(WinError.ERROR_IS_JOINED).append("Unable to deserialize BloomFilter from InputStream. strategyOrdinal: ").append(i3).append(" numHashFunctions: ").append(i2).append(" dataLength: ").append(i).toString(), e);
                }
