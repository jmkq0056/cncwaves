...
public final class LongMath {
    ...
    static final long[] powersOf10 = {1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, MathMethodsKt.NANOS_PER_SECOND, RealConnection.IDLE_CONNECTION_HEALTHY_NS, 100000000000L, 1000000000000L, 10000000000000L, 100000000000000L, 1000000000000000L, 10000000000000000L, 100000000000000000L, 1000000000000000000L};
    static final long[] halfPowersOf10 = {3, 31, 316, 3162, 31622, 316227, 3162277, 31622776, 316227766, 3162277660L, 31622776601L, 316227766016L, 3162277660168L, 31622776601683L, 316227766016837L, 3162277660168379L, 31622776601683793L, 316227766016837933L, 3162277660168379331L};
    static final long[] factorials = {1, 1, 2, 6, 24, 120, 720, 5040, 40320, 362880, 3628800, 39916800, 479001600, 6227020800L, 87178291200L, 1307674368000L, 20922789888000L, 355687428096000L, 6402373705728000L, 121645100408832000L, 2432902008176640000L};
    static final int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, WinError.ERROR_VOLUME_CONTAINS_SYS_FILES, WinError.RPC_S_INVALID_TAG, 887, WinError.ERROR_ARITHMETIC_OVERFLOW, 361, 265, 206, 169, WinError.ERROR_SAME_DRIVE, WinError.ERROR_NO_VOLUME_LABEL, WinError.ERROR_BUFFER_OVERFLOW, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    static final int[] biggestSimpleBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, WinError.ERROR_NO_SUCH_PRIVILEGE, WinError.ERROR_UNWIND_CONSOLIDATE, HttpStatus.SC_INSUFFICIENT_SPACE_ON_RESOURCE, 287, WinError.ERROR_TOO_MANY_MODULES, 169, WinError.ERROR_SUBST_TO_SUBST, WinError.ERROR_BAD_DRIVER_LEVEL, WinError.ERROR_SEM_OWNER_DIED, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
    ...
    public static long gcd(long j, long j2) {
        ...
        MathPreconditions.checkNonNegative(PrinterTextParser.TAGS_FORMAT_TEXT_BOLD, j2);
        if (j == 0) {
            return j2;
        }
        if (j2 == 0) {
    ...
    public static long saturatedPow(long j, int i) {
        ...
        int i2 = (int) j;
        if (i2 == -2) {
            return i >= 64 ? ((long) (i & 1)) + Long.MAX_VALUE : (i & 1) == 0 ? 1 << i : (-1) << i;
        }
        if (i2 == -1) {
            return (i & 1) == 0 ? 1L : -1L;
        }
    ...
    public static double roundToDouble(long j, RoundingMode roundingMode) {
        ...
        switch (AnonymousClass1.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 8:
                ...
                int iCompare2 = Longs.compare(j3, j4);
                if (iCompare2 >= 0) {
                    if (iCompare2 <= 0) {
