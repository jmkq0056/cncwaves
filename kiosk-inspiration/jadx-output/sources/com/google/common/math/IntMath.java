...
public final class IntMath {
    ...
    static final int[] powersOf10 = {1, 10, 100, 1000, WinError.WSABASEERR, 100000, 1000000, 10000000, 100000000, 1000000000};
    ...
    private static final int[] factorials = {1, 1, 2, 6, 24, WinError.ERROR_CALL_NOT_IMPLEMENTED, WinError.ERROR_IMAGE_MACHINE_TYPE_MISMATCH_EXE, WinError.ERROR_CLUSTER_NODE_EXISTS, 40320, 362880, 3628800, 39916800, 479001600};
    static int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, 65536, 2345, 477, WinError.ERROR_BAD_EXE_FORMAT, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
    ...
    public static int gcd(int i, int i2) {
        ...
        MathPreconditions.checkNonNegative(PrinterTextParser.TAGS_FORMAT_TEXT_BOLD, i2);
        if (i == 0) {
            return i2;
        }
        if (i2 == 0) {
