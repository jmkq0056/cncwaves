    ...
    C offset(C c, long j) {
        ...
        for (long j2 = 0; j2 < j; j2++) {
            ...
            if (c2 == null) {
                ...
                throw new IllegalArgumentException(new StringBuilder(String.valueOf(strValueOf).length() + 51).append("overflowed computing offset(").append(strValueOf).append(", ").append(j).append(")").toString());
            }
        }
        return c2;
    }
