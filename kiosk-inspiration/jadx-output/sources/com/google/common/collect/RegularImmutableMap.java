    ...
    private static Object createHashTable(Object[] objArr, int i, int i2, int i3) {
        ...
        if (i2 <= 128) {
            ...
            for (int i8 = 0; i8 < i; i8++) {
                int i9 = (i8 * 2) + i3;
                int i10 = (i7 * 2) + i3;
                Object objRequireNonNull = Objects.requireNonNull(objArr[i9]);
                Object objRequireNonNull2 = Objects.requireNonNull(objArr[i9 ^ 1]);
                ...
                while (true) {
                    ...
                    if (i12 == 255) {
                        ...
                        if (objRequireNonNull.equals(objArr[i12])) {
                            int i13 = i12 ^ 1;
                            duplicateKey = new ImmutableMap.Builder.DuplicateKey(objRequireNonNull, objRequireNonNull2, Objects.requireNonNull(objArr[i13]));
        ...
        if (i2 <= 32768) {
            ...
            for (int i15 = 0; i15 < i; i15++) {
                int i16 = (i15 * 2) + i3;
                int i17 = (i14 * 2) + i3;
                Object objRequireNonNull3 = Objects.requireNonNull(objArr[i16]);
                Object objRequireNonNull4 = Objects.requireNonNull(objArr[i16 ^ 1]);
                ...
                while (true) {
                    ...
                    if (i19 == 65535) {
                        ...
                        if (objRequireNonNull3.equals(objArr[i19])) {
                            int i20 = i19 ^ 1;
                            duplicateKey = new ImmutableMap.Builder.DuplicateKey(objRequireNonNull3, objRequireNonNull4, Objects.requireNonNull(objArr[i20]));
        ...
        while (i21 < i) {
            int i23 = (i21 * 2) + i3;
            int i24 = (i22 * 2) + i3;
            Object objRequireNonNull5 = Objects.requireNonNull(objArr[i23]);
            Object objRequireNonNull6 = Objects.requireNonNull(objArr[i23 ^ i5]);
            ...
            while (true) {
                ...
                if (i26 == -1) {
                    ...
                    if (objRequireNonNull5.equals(objArr[i26])) {
                        int i27 = i26 ^ 1;
                        duplicateKey = new ImmutableMap.Builder.DuplicateKey(objRequireNonNull5, objRequireNonNull6, Objects.requireNonNull(objArr[i27]));
