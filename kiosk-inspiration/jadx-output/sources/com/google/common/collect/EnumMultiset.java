...
public final class EnumMultiset<E extends Enum<E>> extends AbstractMultiset<E> implements Serializable {
    ...
    private void checkIsE(Object obj) {
        ...
        throw new ClassCastException(new StringBuilder(String.valueOf(strValueOf).length() + 21 + String.valueOf(strValueOf2).length()).append("Expected an ").append(strValueOf).append(" but got ").append(strValueOf2).toString());
    }
