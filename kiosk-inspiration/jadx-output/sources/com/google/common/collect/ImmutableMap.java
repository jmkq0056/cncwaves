...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    static IllegalArgumentException conflictException(String str, Object obj, Object obj2) {
        ...
        return new IllegalArgumentException(new StringBuilder(String.valueOf(str).length() + 34 + String.valueOf(strValueOf).length() + String.valueOf(strValueOf2).length()).append("Multiple entries with same ").append(str).append(": ").append(strValueOf).append(" and ").append(strValueOf2).toString());
    }
