...
public final class AttributeContext extends GeneratedMessageLite<AttributeContext, Builder> implements AttributeContextOrBuilder {
    ...
    /* JADX INFO: renamed from: com.google.rpc.context.AttributeContext$1, reason: invalid class name */
    ...
    public static final class Auth extends GeneratedMessageLite<Auth, Builder> implements AuthOrBuilder {
        ...
        public void mergeClaims(Struct struct) {
            ...
            if (struct2 != null && struct2 != Struct.getDefaultInstance()) {
                this.claims_ = Struct.newBuilder(this.claims_).mergeFrom(struct).buildPartial();
            } else {
                this.claims_ = struct;
            }
        }
    ...
    public void mergeOrigin(Peer peer) {
        ...
        if (peer2 != null && peer2 != Peer.getDefaultInstance()) {
            this.origin_ = Peer.newBuilder(this.origin_).mergeFrom(peer).buildPartial();
        } else {
            this.origin_ = peer;
        }
    }
    ...
    public void mergeSource(Peer peer) {
        ...
        if (peer2 != null && peer2 != Peer.getDefaultInstance()) {
            this.source_ = Peer.newBuilder(this.source_).mergeFrom(peer).buildPartial();
        } else {
            this.source_ = peer;
        }
    }
    ...
    public void mergeDestination(Peer peer) {
        ...
        if (peer2 != null && peer2 != Peer.getDefaultInstance()) {
            this.destination_ = Peer.newBuilder(this.destination_).mergeFrom(peer).buildPartial();
        } else {
            this.destination_ = peer;
        }
    }
    ...
    public void mergeApi(Api api) {
        ...
        if (api2 != null && api2 != Api.getDefaultInstance()) {
            this.api_ = Api.newBuilder(this.api_).mergeFrom(api).buildPartial();
        } else {
            this.api_ = api;
        }
    }
