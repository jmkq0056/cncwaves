...
public final class Detector {
    private static final int[] EXPECTED_CORNER_BITS = {3808, 476, LMErr.NERR_DevNotRedirected, WinError.ERROR_INVALID_SEPARATOR_FILE};
    ...
    static final class Point {
        ...
        public String toString() {
            return "<" + this.x + TokenParser.SP + this.y + Typography.greater;
        }
    }
}
