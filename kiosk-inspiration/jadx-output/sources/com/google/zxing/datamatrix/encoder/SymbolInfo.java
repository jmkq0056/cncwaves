...
public class SymbolInfo {
    ...
    static {
        SymbolInfo[] symbolInfoArr = {new SymbolInfo(false, 3, 5, 8, 8, 1), new SymbolInfo(false, 5, 7, 10, 10, 1), new SymbolInfo(true, 5, 7, 16, 6, 1), new SymbolInfo(false, 8, 10, 12, 12, 1), new SymbolInfo(true, 10, 11, 14, 6, 2), new SymbolInfo(false, 12, 12, 14, 14, 1), new SymbolInfo(true, 16, 14, 24, 10, 1), new SymbolInfo(false, 18, 14, 16, 16, 1), new SymbolInfo(false, 22, 18, 18, 18, 1), new SymbolInfo(true, 22, 18, 16, 10, 2), new SymbolInfo(false, 30, 20, 20, 20, 1), new SymbolInfo(true, 32, 24, 16, 14, 2), new SymbolInfo(false, 36, 24, 22, 22, 1), new SymbolInfo(false, 44, 28, 24, 24, 1), new SymbolInfo(true, 49, 28, 22, 14, 2), new SymbolInfo(false, 62, 36, 14, 14, 4), new SymbolInfo(false, 86, 42, 16, 16, 4), new SymbolInfo(false, WinError.ERROR_INVALID_TARGET_HANDLE, 48, 18, 18, 4), new SymbolInfo(false, WinError.ERROR_DIR_NOT_ROOT, 56, 20, 20, 4), new SymbolInfo(false, WinError.ERROR_ATOMIC_LOCKS_NOT_SUPPORTED, 68, 22, 22, 4), new SymbolInfo(false, HttpStatus.SC_NO_CONTENT, 84, 24, 24, 4, 102, 42), new SymbolInfo(false, 280, 112, 14, 14, 16, WinError.ERROR_JOIN_TO_SUBST, 56), new SymbolInfo(false, 368, WinError.ERROR_DIR_NOT_ROOT, 16, 16, 16, 92, 36), new SymbolInfo(false, 456, 192, 18, 18, 16, WinError.ERROR_INVALID_TARGET_HANDLE, 48), new SymbolInfo(false, WinError.ERROR_PAGEFILE_CREATE_FAILED, WinError.ERROR_FORMS_AUTH_REQUIRED, 20, 20, 16, WinError.ERROR_DIR_NOT_ROOT, 56), new SymbolInfo(false, WinError.ERROR_DBG_CONTROL_BREAK, 272, 22, 22, 16, WinError.ERROR_ATOMIC_LOCKS_NOT_SUPPORTED, 68), new SymbolInfo(false, 816, 336, 24, 24, 16, 136, 56), new SymbolInfo(false, ClientProto.OAUTH_SCOPES_FIELD_NUMBER, HttpStatus.SC_REQUEST_TIMEOUT, 18, 18, 36, 175, 68), new SymbolInfo(false, WinError.ERROR_NULL_LM_PASSWORD, 496, 20, 20, 36, WinUser.VK_RCONTROL, 62), new DataMatrixSymbolInfo144()};
