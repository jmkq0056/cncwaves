...
final class MatrixUtil {
    ...
    private static final int[][] POSITION_ADJUSTMENT_PATTERN_COORDINATE_TABLE = {new int[]{-1, -1, -1, -1, -1, -1, -1}, new int[]{6, 18, -1, -1, -1, -1, -1}, new int[]{6, 22, -1, -1, -1, -1, -1}, new int[]{6, 26, -1, -1, -1, -1, -1}, new int[]{6, 30, -1, -1, -1, -1, -1}, new int[]{6, 34, -1, -1, -1, -1, -1}, new int[]{6, 22, 38, -1, -1, -1, -1}, new int[]{6, 24, 42, -1, -1, -1, -1}, new int[]{6, 26, 46, -1, -1, -1, -1}, new int[]{6, 28, 50, -1, -1, -1, -1}, new int[]{6, 30, 54, -1, -1, -1, -1}, new int[]{6, 32, 58, -1, -1, -1, -1}, new int[]{6, 34, 62, -1, -1, -1, -1}, new int[]{6, 26, 46, 66, -1, -1, -1}, new int[]{6, 26, 48, 70, -1, -1, -1}, new int[]{6, 26, 50, 74, -1, -1, -1}, new int[]{6, 30, 54, 78, -1, -1, -1}, new int[]{6, 30, 56, 82, -1, -1, -1}, new int[]{6, 30, 58, 86, -1, -1, -1}, new int[]{6, 34, 62, 90, -1, -1, -1}, new int[]{6, 28, 50, 72, 94, -1, -1}, new int[]{6, 26, 50, 74, 98, -1, -1}, new int[]{6, 30, 54, 78, 102, -1, -1}, new int[]{6, 28, 54, 80, WinError.ERROR_SEM_USER_LIMIT, -1, -1}, new int[]{6, 32, 58, 84, 110, -1, -1}, new int[]{6, 30, 58, 86, WinError.ERROR_INVALID_TARGET_HANDLE, -1, -1}, new int[]{6, 34, 62, 90, WinError.ERROR_INVALID_VERIFY_SWITCH, -1, -1}, new int[]{6, 26, 50, 74, 98, 122, -1}, new int[]{6, 30, 54, 78, 102, 126, -1}, new int[]{6, 26, 52, 78, 104, 130, -1}, new int[]{6, 30, 56, 82, 108, WinError.ERROR_IS_JOINED, -1}, new int[]{6, 34, 60, 86, 112, WinError.ERROR_JOIN_TO_JOIN, -1}, new int[]{6, 30, 58, 86, WinError.ERROR_INVALID_TARGET_HANDLE, 142, -1}, new int[]{6, 34, 62, 90, WinError.ERROR_INVALID_VERIFY_SWITCH, WinError.ERROR_IS_SUBST_PATH, -1}, new int[]{6, 30, 54, 78, 102, 126, WinError.ERROR_SYSTEM_TRACE}, new int[]{6, 24, 50, 76, 102, 128, WinError.ERROR_LABEL_TOO_LONG}, new int[]{6, 28, 54, 80, WinError.ERROR_SEM_USER_LIMIT, WinError.ERROR_SEEK_ON_DEVICE, WinError.ERROR_NOT_LOCKED}, new int[]{6, 32, 58, 84, 110, 136, 162}, new int[]{6, 26, 54, 82, 110, WinError.ERROR_JOIN_TO_JOIN, 166}, new int[]{6, 30, 58, 86, WinError.ERROR_INVALID_TARGET_HANDLE, 142, WinError.ERROR_BUSY}};
