...
final class FormatInformation {
    ...
    private static final int[][] FORMAT_INFO_DECODE_LOOKUP = {new int[]{FORMAT_INFO_MASK_QR, 0}, new int[]{20773, 1}, new int[]{24188, 2}, new int[]{23371, 3}, new int[]{17913, 4}, new int[]{16590, 5}, new int[]{20375, 6}, new int[]{19104, 7}, new int[]{30660, 8}, new int[]{29427, 9}, new int[]{32170, 10}, new int[]{30877, 11}, new int[]{26159, 12}, new int[]{25368, 13}, new int[]{27713, 14}, new int[]{26998, 15}, new int[]{5769, 16}, new int[]{WinError.ERROR_CLUSTER_INVALID_NETWORK, 17}, new int[]{7399, 18}, new int[]{WinError.ERROR_LOG_BLOCK_VERSION, 19}, new int[]{1890, 20}, new int[]{WinError.ERROR_CLIENT_SERVER_PARAMETERS_INVALID, 21}, new int[]{3340, 22}, new int[]{LMErr.NERR_DevNotRedirected, 23}, new int[]{13663, 24}, new int[]{12392, 25}, new int[]{16177, 26}, new int[]{14854, 27}, new int[]{9396, 28}, new int[]{WinError.ERROR_DS_MODIFYDN_DISALLOWED_BY_INSTANCE_TYPE, 29}, new int[]{11994, 30}, new int[]{11245, 31}};
