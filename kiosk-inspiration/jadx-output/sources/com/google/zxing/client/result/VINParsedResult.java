...
public final class VINParsedResult extends ParsedResult {
    ...
    public String getDisplayResult() {
        ...
        sb.append(this.worldManufacturerID).append(TokenParser.SP);
        sb.append(this.vehicleDescriptorSection).append(TokenParser.SP);
        sb.append(this.vehicleIdentifierSection).append('\n');
        String str = this.countryCode;
        if (str != null) {
            sb.append(str).append(TokenParser.SP);
        }
        sb.append(this.modelYear).append(TokenParser.SP);
        sb.append(this.plantCode).append(TokenParser.SP);
