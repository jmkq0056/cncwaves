...
public final class EciesAeadHkdfHybridEncrypt implements HybridEncrypt {
    ...
    public byte[] encrypt(final byte[] plaintext, final byte[] contextInfo) throws GeneralSecurityException {
        EciesHkdfSenderKem.KemKey kemKeyGenerateKey = this.senderKem.generateKey(this.hkdfHmacAlgo, this.hkdfSalt, contextInfo, this.demHelper.getSymmetricKeySizeInBytes(), this.ecPointFormat);
        byte[] bArrEncrypt = this.demHelper.getAead(kemKeyGenerateKey.getSymmetricKey()).encrypt(plaintext, EMPTY_AAD);
