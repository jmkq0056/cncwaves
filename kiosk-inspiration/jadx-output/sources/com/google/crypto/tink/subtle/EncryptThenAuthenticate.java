...
public final class EncryptThenAuthenticate implements Aead {
    ...
    public byte[] encrypt(final byte[] plaintext, final byte[] associatedData) throws GeneralSecurityException {
        ...
        return Bytes.concat(bArrEncrypt, this.mac.computeMac(Bytes.concat(associatedData, bArrEncrypt, Arrays.copyOf(ByteBuffer.allocate(8).putLong(((long) associatedData.length) * 8).array(), 8))));
    }
