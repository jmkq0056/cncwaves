...
final class ArrayDecoders {
    ...
    static int decodeExtension(int i, byte[] bArr, int i2, int i3, GeneratedMessageLite.ExtendableMessage<?, ?> extendableMessage, GeneratedMessageLite.GeneratedExtension<?, ?> generatedExtension, UnknownFieldSchema<UnknownFieldSetLite, UnknownFieldSetLite> unknownFieldSchema, Registers registers) throws IOException {
        ...
        if (generatedExtension.descriptor.isRepeated() && generatedExtension.descriptor.isPacked()) {
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[generatedExtension.getLiteType().ordinal()]) {
                ...
                case 14:
                    ...
                    UnknownFieldSetLite unknownFieldSetLite2 = (UnknownFieldSetLite) SchemaUtil.filterUnknownEnumList(i6, (List<Integer>) intArrayList4, generatedExtension.descriptor.getEnumType(), unknownFieldSetLite != UnknownFieldSetLite.getDefaultInstance() ? unknownFieldSetLite : null, (UnknownFieldSchema<UT, Object>) unknownFieldSchema);
        ...
        if (generatedExtension.getLiteType() == WireFormat.FieldType.ENUM) {
            ...
            if (generatedExtension.descriptor.getEnumType().findValueByNumber(registers.int1) == null) {
                ...
                SchemaUtil.storeUnknownEnum(i6, registers.int1, unknownFieldSetLiteNewInstance, unknownFieldSchema);
                return i2;
            }
            ...
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[generatedExtension.getLiteType().ordinal()]) {
                ...
                case 16:
                    ...
                    break;
                case 17:
                    i2 = decodeGroupField(Protobuf.getInstance().schemaFor((Class) generatedExtension.getMessageDefaultInstance().getClass()), bArr, i2, i3, (i6 << 3) | 4, registers);
                    objValueOf = registers.object1;
                    break;
                case 18:
        ...
        int i7 = AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[generatedExtension.getLiteType().ordinal()];
        if ((i7 == 17 || i7 == 18) && (field = fieldSet.getField(generatedExtension.descriptor)) != null) {
    ...
    /* JADX INFO: renamed from: com.google.crypto.tink.shaded.protobuf.ArrayDecoders$1, reason: invalid class name */
