    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder sb, int i) {
        ...
        for (String str : treeSet) {
            ...
            if (strSubstring.endsWith(LIST_SUFFIX) && !strSubstring.endsWith(BUILDER_LIST_SUFFIX) && !strSubstring.equals(LIST_SUFFIX)) {
                String str2 = strSubstring.substring(0, 1).toLowerCase() + strSubstring.substring(1, strSubstring.length() - LIST_SUFFIX.length());
            ...
            if (strSubstring.endsWith(MAP_SUFFIX) && !strSubstring.equals(MAP_SUFFIX)) {
                String str3 = strSubstring.substring(0, 1).toLowerCase() + strSubstring.substring(1, strSubstring.length() - MAP_SUFFIX.length());
            ...
            if (((Method) map2.get("set" + strSubstring)) != null && (!strSubstring.endsWith(BYTES_SUFFIX) || !map.containsKey("get" + strSubstring.substring(0, strSubstring.length() - BYTES_SUFFIX.length())))) {
