...
public final class RsaKemHybridEncrypt implements HybridEncrypt {
    ...
    public byte[] encrypt(final byte[] plaintext, final byte[] contextInfo) throws GeneralSecurityException {
        ...
        byte[] bArrEncrypt = this.aeadFactory.createAead(Hkdf.computeHkdf(this.hkdfHmacAlgo, bArrGenerateSecret, this.hkdfSalt, contextInfo, this.aeadFactory.getKeySizeInBytes())).encrypt(plaintext, RsaKem.EMPTY_AAD);
