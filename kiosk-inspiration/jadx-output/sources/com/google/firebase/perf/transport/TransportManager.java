...
public class TransportManager implements AppStateMonitor.AppStateCallback {
        ...
        while (!this.pendingEventsQueue.isEmpty()) {
            ...
            if (pendingPerfEventPoll != null) {
                this.executorService.execute(new Runnable() { // from class: com.google.firebase.perf.transport.TransportManager$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m324xd2410da6(pendingPerfEventPoll);
                    }
                });
            }
        }
    ...
    /* JADX INFO: renamed from: lambda$finishInitialization$0$com-google-firebase-perf-transport-TransportManager, reason: not valid java name */
    /* synthetic */ void m324xd2410da6(PendingPerfEvent pendingPerfEvent) {
    ...
    public void onUpdateAppState(ApplicationProcessState applicationProcessState) {
        ...
        if (isInitialized()) {
            this.executorService.execute(new Runnable() { // from class: com.google.firebase.perf.transport.TransportManager$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m328x3928ae6c();
                }
            });
        }
    }

    /* JADX INFO: renamed from: lambda$onUpdateAppState$1$com-google-firebase-perf-transport-TransportManager, reason: not valid java name */
    /* synthetic */ void m328x3928ae6c() {
    ...
    public void log(final TraceMetric traceMetric, final ApplicationProcessState applicationProcessState) {
        this.executorService.execute(new Runnable() { // from class: com.google.firebase.perf.transport.TransportManager$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m325lambda$log$2$comgooglefirebaseperftransportTransportManager(traceMetric, applicationProcessState);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$log$2$com-google-firebase-perf-transport-TransportManager, reason: not valid java name */
    /* synthetic */ void m325lambda$log$2$comgooglefirebaseperftransportTransportManager(TraceMetric traceMetric, ApplicationProcessState applicationProcessState) {
    ...
    public void log(final NetworkRequestMetric networkRequestMetric, final ApplicationProcessState applicationProcessState) {
        this.executorService.execute(new Runnable() { // from class: com.google.firebase.perf.transport.TransportManager$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m326lambda$log$3$comgooglefirebaseperftransportTransportManager(networkRequestMetric, applicationProcessState);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$log$3$com-google-firebase-perf-transport-TransportManager, reason: not valid java name */
    /* synthetic */ void m326lambda$log$3$comgooglefirebaseperftransportTransportManager(NetworkRequestMetric networkRequestMetric, ApplicationProcessState applicationProcessState) {
    ...
    public void log(final GaugeMetric gaugeMetric, final ApplicationProcessState applicationProcessState) {
        this.executorService.execute(new Runnable() { // from class: com.google.firebase.perf.transport.TransportManager$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m327lambda$log$4$comgooglefirebaseperftransportTransportManager(gaugeMetric, applicationProcessState);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$log$4$com-google-firebase-perf-transport-TransportManager, reason: not valid java name */
    /* synthetic */ void m327lambda$log$4$comgooglefirebaseperftransportTransportManager(GaugeMetric gaugeMetric, ApplicationProcessState applicationProcessState) {
    ...
    private PerfMetric setApplicationInfoAndBuild(PerfMetric.Builder builder, ApplicationProcessState applicationProcessState) {
        ...
        if (builder.hasTraceMetric() || builder.hasNetworkRequestMetric()) {
            applicationProcessState2 = ((ApplicationInfo.Builder) applicationProcessState2.mo354clone()).putAllCustomAttributes(getGlobalCustomAttributes());
        }
    ...
    private void updateFirebaseInstallationIdIfPossibleAndNeeded() {
        ...
        if (this.configResolver.isPerformanceMonitoringEnabled()) {
            if (!this.applicationInfoBuilder.hasAppInstanceId() || this.isForegroundState) {
                try {
                    str = (String) Tasks.await(this.firebaseInstallationsApi.getId(), StripeHealthCheckerDefaultConfig.ONLINE_STABLE_RETRY_DELAY_MS, TimeUnit.MILLISECONDS);
