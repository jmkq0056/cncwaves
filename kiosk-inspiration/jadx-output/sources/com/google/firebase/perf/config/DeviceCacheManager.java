        ...
        if (this.sharedPref == null && context != null) {
            this.serialExecutor.execute(new Runnable() { // from class: com.google.firebase.perf.config.DeviceCacheManager$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m313xa0ef4a14(context);
                }
            });
        }
    }

    /* JADX INFO: renamed from: lambda$setContext$0$com-google-firebase-perf-config-DeviceCacheManager, reason: not valid java name */
    /* synthetic */ void m313xa0ef4a14(Context context) {
        if (this.sharedPref != null || context == null) {
            return;
        }
