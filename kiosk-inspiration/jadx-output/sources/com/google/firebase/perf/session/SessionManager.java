    ...
    public void setApplicationContext(final Context context) {
        ...
        this.syncInitFuture = Executors.newSingleThreadExecutor().submit(new Runnable() { // from class: com.google.firebase.perf.session.SessionManager$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m317xa16819e0(context, perfSession);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$setApplicationContext$0$com-google-firebase-perf-session-SessionManager, reason: not valid java name */
    /* synthetic */ void m317xa16819e0(Context context, PerfSession perfSession) {
