...
public class MemoryGaugeCollector {
    ...
    /* JADX INFO: renamed from: lambda$scheduleMemoryMetricCollectionWithRate$0$com-google-firebase-perf-session-gauges-MemoryGaugeCollector, reason: not valid java name */
    /* synthetic */ void m323x5ca50e9a(Timer timer) {
    ...
    /* JADX INFO: renamed from: lambda$scheduleMemoryMetricCollectionOnce$1$com-google-firebase-perf-session-gauges-MemoryGaugeCollector, reason: not valid java name */
    /* synthetic */ void m322x5390f99e(Timer timer) {
        AndroidMemoryReading androidMemoryReadingSyncCollectMemoryMetric = syncCollectMemoryMetric(timer);
        if (androidMemoryReadingSyncCollectMemoryMetric != null) {
            this.memoryMetricReadings.add(androidMemoryReadingSyncCollectMemoryMetric);
        }
