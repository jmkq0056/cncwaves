...
public final class FirebaseAnalytics {
    ...
    public static zzlm getScionFrontendApiImplementation(Context context, Bundle bundle) {
        zzed zzedVarZza = zzed.zza(context, (String) null, (String) null, (String) null, bundle);
        if (zzedVarZza == null) {
            return null;
        }
        return new zzc(zzedVarZza);
    }
            ...
            try {
                try {
                    if (this.zzc == null) {
                        ...
                        firebaseAnalytics.zzc = new zzb(firebaseAnalytics, 0, 1, 30L, TimeUnit.SECONDS, new ArrayBlockingQueue(100));
                    } else {
                        firebaseAnalytics = this;
                    }
