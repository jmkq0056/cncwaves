...
final class JsonValueObjectEncoderContext implements ObjectEncoderContext, ValueEncoderContext {
    ...
    private JsonValueObjectEncoderContext internalAdd(String str, Object obj) throws EncodingException, IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        if (obj == null) {
            this.jsonWriter.nullValue();
    ...
    private JsonValueObjectEncoderContext internalAddIgnoreNullValues(String str, Object obj) throws EncodingException, IOException {
        if (obj == null) {
            return this;
        }
        maybeUnNest();
