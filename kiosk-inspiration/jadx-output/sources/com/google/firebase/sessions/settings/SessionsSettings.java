...
public final class SessionsSettings {
    ...
    @DebugMetadata(c = "com.google.firebase.sessions.settings.SessionsSettings", f = "SessionsSettings.kt", i = {0}, l = {WinError.ERROR_JOIN_TO_JOIN, WinError.ERROR_SUBST_TO_SUBST}, m = "updateSettings", n = {"this"}, s = {"L$0"})
    ...
    public final long m352getSessionRestartTimeoutUwyO8pc() {
        Duration durationMo350getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo350getSessionRestartTimeoutFghU774();
        if (durationMo350getSessionRestartTimeoutFghU774 != null) {
            long rawValue = durationMo350getSessionRestartTimeoutFghU774.getRawValue();
            if (m351isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration durationMo350getSessionRestartTimeoutFghU7742 = this.remoteSettings.mo350getSessionRestartTimeoutFghU774();
        if (durationMo350getSessionRestartTimeoutFghU7742 != null) {
            long rawValue2 = durationMo350getSessionRestartTimeoutFghU7742.getRawValue();
            if (m351isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m351isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m2206isPositiveimpl(sessionRestartTimeout) && Duration.m2201isFiniteimpl(sessionRestartTimeout);
    }
