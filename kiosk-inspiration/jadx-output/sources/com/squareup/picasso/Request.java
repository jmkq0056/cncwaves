...
public final class Request {
    ...
    public String toString() {
        ...
        if (this.targetWidth > 0) {
            sb.append(" resize(").append(this.targetWidth).append(AbstractJsonLexerKt.COMMA).append(this.targetHeight).append(')');
        }
        if (this.centerCrop) {
        ...
        if (this.rotationDegrees != 0.0f) {
            ...
            if (this.hasRotationPivot) {
                sb.append(" @ ").append(this.rotationPivotX).append(AbstractJsonLexerKt.COMMA).append(this.rotationPivotY);
            }
            sb.append(')');
        }
        if (this.purgeable) {
        ...
        if (this.config != null) {
            sb.append(TokenParser.SP).append(this.config);
        }
