...
public final class LongArrayProtoAdapter extends ProtoAdapter<long[]> {
    ...
    public LongArrayProtoAdapter(ProtoAdapter<Long> originalAdapter) {
        super(FieldEncoding.LENGTH_DELIMITED, (KClass<?>) Reflection.getOrCreateKotlinClass(long[].class), (String) null, originalAdapter.getSyntax(), new long[0]);
