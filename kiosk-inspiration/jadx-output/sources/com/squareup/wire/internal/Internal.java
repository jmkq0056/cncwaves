...
public final class Internal {
    ...
    public static final <T> List<T> m361redactElements(List<? extends T> list, ProtoAdapter<T> protoAdapter) {
        return Internal__InternalKt.m363redactElements(list, protoAdapter);
    }

    /* JADX INFO: renamed from: -redactElements, reason: not valid java name */
    public static final <K, V> Map<K, V> m362redactElements(Map<K, ? extends V> map, ProtoAdapter<V> protoAdapter) {
        return Internal__InternalKt.m364redactElements(map, protoAdapter);
    }
