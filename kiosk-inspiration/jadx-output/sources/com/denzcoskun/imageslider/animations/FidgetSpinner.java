...
/* JADX INFO: compiled from: FidgetSpinner.kt */
...
public final class FidgetSpinner implements ViewPager.PageTransformer {
    ...
    public void transformPage(View view, float position) {
        ...
        if (position <= 0) {
            view.setAlpha(1.0f);
            view.setRotation(36000 * Math.abs(position) * Math.abs(position) * Math.abs(position) * Math.abs(position) * Math.abs(position) * Math.abs(position) * Math.abs(position));
        } else if (position <= 1) {
            view.setAlpha(1.0f);
            view.setRotation((-36000) * Math.abs(position) * Math.abs(position) * Math.abs(position) * Math.abs(position) * Math.abs(position) * Math.abs(position) * Math.abs(position));
        } else {
