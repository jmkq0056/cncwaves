...
public interface ShlObj {
    ...
    public static final WinDef.DWORD SHGFP_TYPE_CURRENT = new WinDef.DWORD(0);
    public static final WinDef.DWORD SHGFP_TYPE_DEFAULT = new WinDef.DWORD(1);
