...
public final /* data */ class NumericInput extends Input {
    ...
    public static /* synthetic */ NumericInput copy$default(NumericInput numericInput, boolean z, String str, String str2, String str3, String str4, List list, int i, Object obj) {
        ...
        if ((i & 8) != 0) {
            str3 = numericInput.skipButtonText;
        }
        if ((i & 16) != 0) {
            str4 = numericInput.submitButtonText;
        }
        if ((i & 32) != 0) {
    ...
    public final NumericInput copy(boolean required, String title, String description, String skipButtonText, String submitButtonText, List<Toggle> toggles) {
        Intrinsics.checkNotNullParameter(title, "title");
        Intrinsics.checkNotNullParameter(toggles, "toggles");
        return new NumericInput(required, title, description, skipButtonText, submitButtonText, toggles);
    }
    ...
    public String toString() {
        return "NumericInput(required=" + this.required + ", title=" + this.title + ", description=" + this.description + ", skipButtonText=" + this.skipButtonText + ", submitButtonText=" + this.submitButtonText + ", toggles=" + this.toggles + ')';
    }
    ...
    public /* synthetic */ NumericInput(boolean z, String str, String str2, String str3, String str4, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public NumericInput(boolean z, String title, String str, String str2, String str3, List<Toggle> toggles) {
        super(z, title, str, str2, toggles, null, null, FormType.NUMERIC, 96, null);
        Intrinsics.checkNotNullParameter(title, "title");
        Intrinsics.checkNotNullParameter(toggles, "toggles");
        this.required = z;
        this.title = title;
