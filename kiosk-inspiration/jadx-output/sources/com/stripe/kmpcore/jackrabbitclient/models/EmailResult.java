...
public final /* data */ class EmailResult extends CollectInputsSingleResult {
    ...
    public String toString() {
        return "EmailResult(skipped=" + this.skipped + ", email=██, toggles=" + this.toggles + ')';
    }
    ...
    public /* synthetic */ EmailResult(boolean z, String str, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public EmailResult(boolean z, String str, List<? extends ToggleResult> toggles) {
        super(z, toggles, null, null, str, null, null, null, FormType.EMAIL, 236, null);
        Intrinsics.checkNotNullParameter(toggles, "toggles");
        this.skipped = z;
        this.email = str;
