...
public final /* data */ class SignatureInput extends Input {
    ...
    public static /* synthetic */ SignatureInput copy$default(SignatureInput signatureInput, boolean z, String str, String str2, String str3, String str4, List list, int i, Object obj) {
        ...
        if ((i & 8) != 0) {
            str3 = signatureInput.skipButtonText;
        }
        if ((i & 16) != 0) {
            str4 = signatureInput.submitButtonText;
        }
        if ((i & 32) != 0) {
    ...
    public final SignatureInput copy(boolean required, String title, String description, String skipButtonText, String submitButtonText, List<Toggle> toggles) {
        Intrinsics.checkNotNullParameter(title, "title");
        Intrinsics.checkNotNullParameter(toggles, "toggles");
        return new SignatureInput(required, title, description, skipButtonText, submitButtonText, toggles);
    }
    ...
    public String toString() {
        return "SignatureInput(required=" + this.required + ", title=" + this.title + ", description=" + this.description + ", skipButtonText=" + this.skipButtonText + ", submitButtonText=" + this.submitButtonText + ", toggles=" + this.toggles + ')';
    }
    ...
    public /* synthetic */ SignatureInput(boolean z, String str, String str2, String str3, String str4, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public SignatureInput(boolean z, String title, String str, String str2, String str3, List<Toggle> toggles) {
        super(z, title, str, str2, toggles, null, null, FormType.SIGNATURE, 96, null);
        Intrinsics.checkNotNullParameter(title, "title");
        Intrinsics.checkNotNullParameter(toggles, "toggles");
        this.required = z;
        this.title = title;
