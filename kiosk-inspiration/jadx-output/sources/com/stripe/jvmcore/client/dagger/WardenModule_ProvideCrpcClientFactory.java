...
public final class WardenModule_ProvideCrpcClientFactory implements Factory<CrpcClient> {
    ...
    public WardenModule_ProvideCrpcClientFactory(Provider<OkHttpClientProvider> provider, Provider<CrpcClient.BaseUrlProvider> provider2, Provider<CrpcClient.CrpcRequestContextProvider> provider3, Provider<CustomCrpcInterceptor> provider4, Provider<HttpClientConfigurator> provider5, Provider<LogWriter> provider6) {
    ...
    public CrpcClient get() {
        return provideCrpcClient(this.okHttpClientProvider.get(), this.serviceUrlProvider.get(), this.crpcRequestContextProvider.get(), this.traceLoggingInterceptorProvider.get(), this.httpClientConfiguratorProvider.get(), this.logWriterProvider.get());
    }

    public static WardenModule_ProvideCrpcClientFactory create(Provider<OkHttpClientProvider> provider, Provider<CrpcClient.BaseUrlProvider> provider2, Provider<CrpcClient.CrpcRequestContextProvider> provider3, Provider<CustomCrpcInterceptor> provider4, Provider<HttpClientConfigurator> provider5, Provider<LogWriter> provider6) {
        return new WardenModule_ProvideCrpcClientFactory(provider, provider2, provider3, provider4, provider5, provider6);
    }
    ...
    public static CrpcClient provideCrpcClient(OkHttpClientProvider okHttpClientProvider, CrpcClient.BaseUrlProvider baseUrlProvider, CrpcClient.CrpcRequestContextProvider crpcRequestContextProvider, CustomCrpcInterceptor customCrpcInterceptor, HttpClientConfigurator httpClientConfigurator, LogWriter logWriter) {
        return (CrpcClient) Preconditions.checkNotNullFromProvides(WardenModule.INSTANCE.provideCrpcClient(okHttpClientProvider, baseUrlProvider, crpcRequestContextProvider, customCrpcInterceptor, httpClientConfigurator, logWriter));
    }
}
