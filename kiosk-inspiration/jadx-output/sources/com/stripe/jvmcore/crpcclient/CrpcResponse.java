...
@Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\t\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b6\u0018\u0000 \u000e*\u0012\b\u0000\u0010\u0001*\f\u0012\u0004\u0012\u0002H\u0001\u0012\u0002\b\u00030\u00022\u00020\u0003:\u0004\r\u000e\u000f\u0010B\u0011\b\u0004\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\u0002\u0010\u0006J\b\u0010\n\u001a\u00020\u000bH&J\b\u0010\f\u001a\u00020\u000bH\u0016R\u0015\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\n\n\u0002\u0010\t\u001a\u0004\b\u0007\u0010\b\u0082\u0001\u0003\u0011\u0012\u0013¨\u0006\u0014"}, d2 = {"Lcom/stripe/jvmcore/crpcclient/CrpcResponse;", "M", "Lcom/squareup/wire/Message;", "", "durationMillis", "", "(Ljava/lang/Long;)V", "getDurationMillis", "()Ljava/lang/Long;", "Ljava/lang/Long;", "toLogString", "", "toString", "ApplicationError", "Companion", "RpcError", "Success", "Lcom/stripe/jvmcore/crpcclient/CrpcResponse$ApplicationError;", "Lcom/stripe/jvmcore/crpcclient/CrpcResponse$RpcError;", "Lcom/stripe/jvmcore/crpcclient/CrpcResponse$Success;", "crpcclient"}, k = 1, mv = {1, 9, 0}, xi = 48)
public abstract class CrpcResponse<M extends Message<M, ?>> {
    ...
    private static final Moshi moshi = new Moshi.Builder().add((JsonAdapter.Factory) new WireJsonAdapterFactory(0 == true ? 1 : 0, false, 3, 0 == true ? 1 : 0)).build();
    ...
    /* JADX INFO: compiled from: CrpcResponse.kt */
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0000\u0018\u0000*\u0012\b\u0001\u0010\u0001*\f\u0012\u0004\u0012\u0002H\u0001\u0012\u0002\b\u00030\u00022\b\u0012\u0004\u0012\u0002H\u00010\u0003B\u0019\u0012\u0006\u0010\u0004\u001a\u00028\u0001\u0012\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u0006¢\u0006\u0002\u0010\u0007J\b\u0010\u000b\u001a\u00020\fH\u0016R\u0013\u0010\u0004\u001a\u00028\u0001¢\u0006\n\n\u0002\u0010\n\u001a\u0004\b\b\u0010\t¨\u0006\r"}, d2 = {"Lcom/stripe/jvmcore/crpcclient/CrpcResponse$Success;", "M", "Lcom/squareup/wire/Message;", "Lcom/stripe/jvmcore/crpcclient/CrpcResponse;", "response", "durationMillis", "", "(Lcom/squareup/wire/Message;Ljava/lang/Long;)V", "getResponse", "()Lcom/squareup/wire/Message;", "Lcom/squareup/wire/Message;", "toLogString", "", "crpcclient"}, k = 1, mv = {1, 9, 0}, xi = 48)
    public static final class Success<M extends Message<M, ?>> extends CrpcResponse<M> {
        ...
        @Override // com.stripe.jvmcore.crpcclient.CrpcResponse
        public String toLogString() {
            StringBuilder sb = new StringBuilder("response=");
            Extensions extensions = Extensions.INSTANCE;
            M m = this.response;
            TerminalMessageRedactor terminalMessageRedactor = TerminalMessageRedactor.INSTANCE;
            Moshi moshi = CrpcResponse.moshi;
            Intrinsics.checkNotNullExpressionValue(moshi, "access$getMoshi$cp(...)");
            return sb.append(extensions.toLogJson(m, terminalMessageRedactor, moshi)).toString();
        }
    }

    /* JADX INFO: compiled from: CrpcResponse.kt */
    @Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\t\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\u0006\u0018\u0000*\u0012\b\u0001\u0010\u0001*\f\u0012\u0004\u0012\u0002H\u0001\u0012\u0002\b\u00030\u00022\b\u0012\u0004\u0012\u0002H\u00010\u0003B#\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0007\u0012\n\b\u0002\u0010\b\u001a\u0004\u0018\u00010\t¢\u0006\u0002\u0010\nJ\b\u0010\u0013\u001a\u00020\u0007H\u0016R\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0011\u0010\r\u001a\u00020\u000e8F¢\u0006\u0006\u001a\u0004\b\r\u0010\u000fR\u0011\u0010\u0010\u001a\u00020\u000e8F¢\u0006\u0006\u001a\u0004\b\u0010\u0010\u000fR\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u0011\u0010\u0012¨\u0006\u0014"}, d2 = {"Lcom/stripe/jvmcore/crpcclient/CrpcResponse$ApplicationError;", "M", "Lcom/squareup/wire/Message;", "Lcom/stripe/jvmcore/crpcclient/CrpcResponse;", "code", "Lcom/stripe/proto/net/rpc/base/ApplicationEC;", "message", "", "durationMillis", "", "(Lcom/stripe/proto/net/rpc/base/ApplicationEC;Ljava/lang/String;Ljava/lang/Long;)V", "getCode", "()Lcom/stripe/proto/net/rpc/base/ApplicationEC;", "isAuthError", "", "()Z", "isCancellation", "getMessage", "()Ljava/lang/String;", "toLogString", "crpcclient"}, k = 1, mv = {1, 9, 0}, xi = 48)
    public static final class ApplicationError<M extends Message<M, ?>> extends CrpcResponse<M> {
        ...
        public final boolean isCancellation() {
            if (this.code != ApplicationEC.ILLEGAL_STATE) {
                return false;
            }
            String str = this.message;
            return Intrinsics.areEqual(str, QueryPaymentMethodResponse.PaymentRequestStatus.PAYMENT_CANCELED.toString()) ? true : Intrinsics.areEqual(str, QueryPaymentIntentNextActionsResponse.ActionStatus.ACTION_CANCELED.toString()) ? true : Intrinsics.areEqual(str, QueryCollectDataResponse.QueryCollectDataStatus.CANCELED.toString()) ? true : Intrinsics.areEqual(str, "Transaction is cancelled by the user.");
        }
    }

    /* JADX INFO: compiled from: CrpcResponse.kt */
    @Metadata(d1 = {"\u00002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0002\b\u0007\u0018\u0000*\u0012\b\u0001\u0010\u0001*\f\u0012\u0004\u0012\u0002H\u0001\u0012\u0002\b\u00030\u00022\b\u0012\u0004\u0012\u0002H\u00010\u0003B/\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0007\u0012\n\b\u0002\u0010\b\u001a\u0004\u0018\u00010\t\u0012\n\b\u0002\u0010\n\u001a\u0004\u0018\u00010\u000b¢\u0006\u0002\u0010\fJ\b\u0010\u0018\u001a\u00020\u0007H\u0016R\u0013\u0010\n\u001a\u0004\u0018\u00010\u000b¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000eR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u000f\u0010\u0010R\u0011\u0010\u0011\u001a\u00020\u00128F¢\u0006\u0006\u001a\u0004\b\u0011\u0010\u0013R\u0011\u0010\u0014\u001a\u00020\u00128F¢\u0006\u0006\u001a\u0004\b\u0014\u0010\u0013R\u0011\u0010\u0015\u001a\u00020\u00128F¢\u0006\u0006\u001a\u0004\b\u0015\u0010\u0013R\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u0016\u0010\u0017¨\u0006\u0019"}, d2 = {"Lcom/stripe/jvmcore/crpcclient/CrpcResponse$RpcError;", "M", "Lcom/squareup/wire/Message;", "Lcom/stripe/jvmcore/crpcclient/CrpcResponse;", "code", "Lcom/stripe/proto/net/rpc/base/RpcEC;", "message", "", "durationMillis", "", "cause", "", "(Lcom/stripe/proto/net/rpc/base/RpcEC;Ljava/lang/String;Ljava/lang/Long;Ljava/lang/Throwable;)V", "getCause", "()Ljava/lang/Throwable;", "getCode", "()Lcom/stripe/proto/net/rpc/base/RpcEC;", "isNetworkError", "", "()Z", "isRetryable", "isSSLError", "getMessage", "()Ljava/lang/String;", "toLogString", "crpcclient"}, k = 1, mv = {1, 9, 0}, xi = 48)
    public static final class RpcError<M extends Message<M, ?>> extends CrpcResponse<M> {
        ...
        public final boolean isSSLError() {
            return this.cause instanceof SSLException;
        }
    }
}
