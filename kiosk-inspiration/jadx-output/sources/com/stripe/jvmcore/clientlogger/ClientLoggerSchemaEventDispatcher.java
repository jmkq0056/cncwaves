...
@Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\b\u0002\b\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B/\u0012\b\b\u0001\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006\u0012\u0006\u0010\u0007\u001a\u00020\b\u0012\u000e\b\u0001\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u000b0\n¢\u0006\u0002\u0010\fJ\u001c\u0010\r\u001a\u00020\u000e2\f\u0010\u000f\u001a\b\u0012\u0004\u0012\u00020\u00020\u0010H\u0096@¢\u0006\u0002\u0010\u0011R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u000b0\nX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0012"}, d2 = {"Lcom/stripe/jvmcore/clientlogger/ClientLoggerSchemaEventDispatcher;", "Lcom/stripe/jvmcore/batchdispatcher/Dispatcher;", "Lcom/stripe/proto/api/gator/LogEvent;", "io", "Lkotlinx/coroutines/CoroutineDispatcher;", "api", "Lcom/stripe/proto/terminal/clientlogger/pub/api/ClientLoggerApi;", "logWriter", "Lcom/stripe/logwriter/LogWriter;", "isNetworkAvailable", "Ljavax/inject/Provider;", "", "(Lkotlinx/coroutines/CoroutineDispatcher;Lcom/stripe/proto/terminal/clientlogger/pub/api/ClientLoggerApi;Lcom/stripe/logwriter/LogWriter;Ljavax/inject/Provider;)V", "dispatch", "Lcom/stripe/jvmcore/batchdispatcher/Dispatcher$Result;", "batch", "", "(Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "clientlogger"}, k = 1, mv = {1, 9, 0}, xi = 48)
public final class ClientLoggerSchemaEventDispatcher implements Dispatcher<LogEvent> {
    ...
    /* JADX INFO: renamed from: com.stripe.jvmcore.clientlogger.ClientLoggerSchemaEventDispatcher$dispatch$2, reason: invalid class name */
    /* JADX INFO: compiled from: ClientLoggerDispatchers.kt */
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Dispatcher.Result>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return ClientLoggerSchemaEventDispatcher.this.new AnonymousClass2(this.$batch, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                if (!((Boolean) ClientLoggerSchemaEventDispatcher.this.isNetworkAvailable.get()).booleanValue()) {
                    return Dispatcher.Result.Retry.INSTANCE;
                }
                List<LogEvent> list = this.$batch;
                ClientLoggerSchemaEventDispatcher clientLoggerSchemaEventDispatcher = ClientLoggerSchemaEventDispatcher.this;
                ArrayList arrayList = new ArrayList();
                Iterator<T> it = list.iterator();
                while (it.hasNext()) {
                    com.stripe.proto.terminal.clientlogger.pub.api.LogEvent clientLoggerLogEvent = UtilsKt.toClientLoggerLogEvent((LogEvent) it.next(), clientLoggerSchemaEventDispatcher.logWriter);
                ...
                return ClientLoggerDispatchersKt.toResult(ClientLoggerSchemaEventDispatcher.this.api.reportLogEvents(new ReportLogEventsRequest(arrayList2, null, 2, 0 == true ? 1 : 0)));
            }
