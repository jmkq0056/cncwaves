...
public final class ClientLoggerEventDispatcher implements Dispatcher<ProxyEventPb> {
    ...
    public ClientLoggerEventDispatcher(@IO CoroutineDispatcher io2, Lazy<ClientLoggerApi> api, LogWriter logWriter, @IsNetworkAvailable Provider<Boolean> isNetworkAvailable) {
    ...
    /* JADX INFO: renamed from: com.stripe.jvmcore.clientlogger.ClientLoggerEventDispatcher$dispatch$2, reason: invalid class name */
    /* JADX INFO: compiled from: ClientLoggerDispatchers.kt */
    ...
    @DebugMetadata(c = "com.stripe.jvmcore.clientlogger.ClientLoggerEventDispatcher$dispatch$2", f = "ClientLoggerDispatchers.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Dispatcher.Result>, Object> {
        ...
        AnonymousClass2(List<ProxyEventPb> list, Continuation<? super AnonymousClass2> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return ClientLoggerEventDispatcher.this.new AnonymousClass2(this.$batch, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                if (!((Boolean) ClientLoggerEventDispatcher.this.isNetworkAvailable.get()).booleanValue()) {
                    return Dispatcher.Result.Retry.INSTANCE;
                }
                List<ProxyEventPb> list = this.$batch;
                ClientLoggerEventDispatcher clientLoggerEventDispatcher = ClientLoggerEventDispatcher.this;
                ArrayList arrayList = new ArrayList();
                Iterator<T> it = list.iterator();
                while (it.hasNext()) {
                    com.stripe.proto.terminal.clientlogger.pub.api.ProxyEventPb clientLoggerProxyEventPb = UtilsKt.toClientLoggerProxyEventPb((ProxyEventPb) it.next(), clientLoggerEventDispatcher.logWriter);
                ...
                return ClientLoggerDispatchersKt.toResult(((ClientLoggerApi) ClientLoggerEventDispatcher.this.api.get()).reportEvent(new ReportEventRequest(arrayList2, null, 2, 0 == true ? 1 : 0)));
            }
    ...
    public Object dispatch(List<? extends ProxyEventPb> list, Continuation<? super Dispatcher.Result> continuation) {
