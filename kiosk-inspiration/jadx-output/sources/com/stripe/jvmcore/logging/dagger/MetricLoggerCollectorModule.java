...
@Metadata(d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\t\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0007\u0018\u00002\u00020\u0001B?\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\n\b\u0002\u0010\u0006\u001a\u0004\u0018\u00010\u0005\u0012\n\b\u0002\u0010\u0007\u001a\u0004\u0018\u00010\u0005\u0012\n\b\u0002\u0010\b\u001a\u0004\u0018\u00010\u0005¢\u0006\u0002\u0010\tJ.\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\r0\f2\u000e\b\u0001\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u00100\u000f2\u0006\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\u0014H\u0007R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0012\u0010\u0004\u001a\u0004\u0018\u00010\u0005X\u0082\u0004¢\u0006\u0004\n\u0002\u0010\nR\u0012\u0010\u0006\u001a\u0004\u0018\u00010\u0005X\u0082\u0004¢\u0006\u0004\n\u0002\u0010\nR\u0012\u0010\u0007\u001a\u0004\u0018\u00010\u0005X\u0082\u0004¢\u0006\u0004\n\u0002\u0010\nR\u0012\u0010\b\u001a\u0004\u0018\u00010\u0005X\u0082\u0004¢\u0006\u0004\n\u0002\u0010\n¨\u0006\u0015"}, d2 = {"Lcom/stripe/jvmcore/logging/dagger/MetricLoggerCollectorModule;", "", "metricsFile", "", "overrideMaxBatchBytes", "", "overrideMaxEntryBytes", "overrideMaxFileBytes", "overridePruneFileBytes", "(Ljava/lang/String;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;)V", "Ljava/lang/Long;", "provideCollector", "Lcom/stripe/jvmcore/batchdispatcher/Collector;", "Lcom/stripe/proto/api/gator/ProxyEventPb;", "filesDir", "Ldagger/Lazy;", "Ljava/io/File;", "logWriter", "Lcom/stripe/logwriter/LogWriter;", "loggerExceptionListener", "Lcom/stripe/loggingmodels/LoggerExceptionListener;", "logging"}, k = 1, mv = {1, 9, 0}, xi = 48)
@Module
public final class MetricLoggerCollectorModule {
    ...
    public MetricLoggerCollectorModule(String metricsFile, Long l, Long l2, Long l3, Long l4) {
    ...
    /*  JADX ERROR: NullPointerException in pass: InitCodeVariables
        ...
        */
    public /* synthetic */ MetricLoggerCollectorModule(java.lang.String r2, java.lang.Long r3, java.lang.Long r4, java.lang.Long r5, java.lang.Long r6, int r7, kotlin.jvm.internal.DefaultConstructorMarker r8) {
        /*
            r1 = this;
            r8 = r7 & 1
            if (r8 == 0) goto L6
            java.lang.String r2 = "metrics_wire"
        L6:
            r8 = r7 & 2
            r0 = 0
            if (r8 == 0) goto Lc
        ...
        L27:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.stripe.jvmcore.logging.dagger.MetricLoggerCollectorModule.<init>(java.lang.String, java.lang.Long, java.lang.Long, java.lang.Long, java.lang.Long, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }

    @Provides
    @Singleton
    public final Collector<ProxyEventPb> provideCollector(@ForApplication Lazy<File> filesDir, LogWriter logWriter, LoggerExceptionListener loggerExceptionListener) {
        Intrinsics.checkNotNullParameter(filesDir, "filesDir");
        Intrinsics.checkNotNullParameter(logWriter, "logWriter");
        Intrinsics.checkNotNullParameter(loggerExceptionListener, "loggerExceptionListener");
        return new QueueFileCollector(new QueueFileProtoSerializer(ProxyEventPb.ADAPTER, new ProxyEventPb(null, null, null, null, null, 31, null), new WireLogger(logWriter, this.metricsFile)), new QueueFileCollector.Configuration(this.overrideMaxBatchBytes, this.overrideMaxEntryBytes, this.overrideMaxFileBytes, this.overridePruneFileBytes), LazyExtKt.lazilyMap(filesDir, new Function1<File, File>() { // from class: com.stripe.jvmcore.logging.dagger.MetricLoggerCollectorModule.provideCollector.1
            {
                super(1);
            }
            ...
            public final File invoke(File it) {
                ...
                return new File(it, MetricLoggerCollectorModule.this.metricsFile);
            }
