...
public final class DatabaseMigrationV3ToV4 extends BaseDatabaseMigration {
    ...
    public void customMigration(SupportSQLiteDatabase database) {
        ...
        database.execSQL("DROP INDEX IF EXISTS index_offline_api_request_offline_id");
        database.execSQL("DROP INDEX IF EXISTS index_offline_api_request_connection_id");
        database.execSQL("DROP INDEX IF EXISTS index_offline_api_request_stripe_api_entity_id");
        database.execSQL("DROP INDEX IF EXISTS index_offline_api_request_account_id");
        createApiRequestTable(database);
        database.execSQL("INSERT INTO offline_api_request ( offline_id, connection_id, stripe_api_entity_id, account_id, type, deleted, data_blob, iv_blob, created_timestamp, id) SELECT offline_id, connection_id, payment_intent_id, account_id, type, deleted, data_blob, iv_blob, created_timestamp, id FROM offline_payment_intent;  ");
        database.execSQL("DROP TABLE offline_payment_intent;  ");
    }
}
