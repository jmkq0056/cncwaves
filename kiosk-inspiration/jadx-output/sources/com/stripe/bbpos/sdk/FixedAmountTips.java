...
public final class FixedAmountTips extends Message<FixedAmountTips, Builder> {
    ...
    public /* synthetic */ FixedAmountTips(int i, int i2, String str, List list, ByteString byteString, int i3, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public FixedAmountTips(int i, int i2, String amount, List<String> tipsAmountOptions, ByteString unknownFields) {
    ...
    public int hashCode() {
        ...
        int iHashCode = (((((((unknownFields().hashCode() * 37) + Integer.hashCode(this.currencyCode)) * 37) + Integer.hashCode(this.currencyExponent)) * 37) + this.amount.hashCode()) * 37) + this.tipsAmountOptions.hashCode();
    ...
    public String toString() {
        ...
        if (!this.tipsAmountOptions.isEmpty()) {
            arrayList2.add("tipsAmountOptions=" + Internal.sanitize(this.tipsAmountOptions));
        }
        return CollectionsKt.joinToString$default(arrayList, ", ", "FixedAmountTips{", "}", 0, null, null, 56, null);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ FixedAmountTips copy$default(FixedAmountTips fixedAmountTips, int i, int i2, String str, List list, ByteString byteString, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = fixedAmountTips.currencyCode;
        }
        if ((i3 & 2) != 0) {
            i2 = fixedAmountTips.currencyExponent;
        }
        if ((i3 & 4) != 0) {
        ...
        String str2 = str;
        return fixedAmountTips.copy(i, i2, str2, list, byteString2);
    }
    ...
    /* JADX INFO: compiled from: FixedAmountTips.kt */
    @Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J%\u0010\b\u001a\u00020\u00052\u0017\u0010\t\u001a\u0013\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f0\n¢\u0006\u0002\b\rH\u0086\bø\u0001\u0000R\u0016\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082T¢\u0006\u0002\n\u0000\u0082\u0002\u0007\n\u0005\b\u009920\u0001¨\u0006\u000e"}, d2 = {"Lcom/stripe/bbpos/sdk/FixedAmountTips$Companion;", "", "()V", "ADAPTER", "Lcom/squareup/wire/ProtoAdapter;", "Lcom/stripe/bbpos/sdk/FixedAmountTips;", "serialVersionUID", "", "build", "body", "Lkotlin/Function1;", "Lcom/stripe/bbpos/sdk/FixedAmountTips$Builder;", "", "Lkotlin/ExtensionFunctionType;", "sdk-protos_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    public static final class Companion {
        ...
        public final /* synthetic */ FixedAmountTips build(Function1<? super Builder, Unit> body) {
    ...
    static {
        ...
        ADAPTER = new ProtoAdapter<FixedAmountTips>(fieldEncoding, orCreateKotlinClass, syntax) { // from class: com.stripe.bbpos.sdk.FixedAmountTips$Companion$ADAPTER$1
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(ProtoWriter writer, FixedAmountTips value) throws IOException {
                ...
                ProtoAdapter.STRING.asRepeated().encodeWithTag(writer, 4, value.tipsAmountOptions);
                writer.writeBytes(value.unknownFields());
            }

            @Override // com.squareup.wire.ProtoAdapter
            public void encode(ReverseProtoWriter writer, FixedAmountTips value) throws IOException {
                Intrinsics.checkNotNullParameter(writer, "writer");
                Intrinsics.checkNotNullParameter(value, "value");
                writer.writeBytes(value.unknownFields());
                ProtoAdapter.STRING.asRepeated().encodeWithTag(writer, 4, value.tipsAmountOptions);
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public FixedAmountTips decode(ProtoReader reader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag == -1) {
                        return new FixedAmountTips(iIntValue, iIntValue2, strDecode, arrayList, reader.endMessageAndGetUnknownFields(jBeginMessage));
                    }
                    if (iNextTag == 1) {
