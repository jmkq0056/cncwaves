...
/* JADX INFO: compiled from: SetPinPadButtonsResult.kt */
/* JADX INFO: loaded from: classes3.dex */
@Metadata(d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\u0018\u0000 \u00122\u000e\u0012\u0004\u0012\u00020\u0000\u0012\u0004\u0012\u00020\u00020\u0001:\u0002\u0011\u0012B\u0019\u0012\b\b\u0002\u0010\u0003\u001a\u00020\u0004\u0012\b\b\u0002\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\u001a\u0010\b\u001a\u00020\u00002\b\b\u0002\u0010\u0003\u001a\u00020\u00042\b\b\u0002\u0010\u0005\u001a\u00020\u0006J\u0013\u0010\t\u001a\u00020\u00042\b\u0010\n\u001a\u0004\u0018\u00010\u000bH\u0096\u0002J\b\u0010\f\u001a\u00020\rH\u0016J\b\u0010\u000e\u001a\u00020\u0002H\u0016J\b\u0010\u000f\u001a\u00020\u0010H\u0016R\u0010\u0010\u0003\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\u0013"}, d2 = {"Lcom/stripe/bbpos/sdk/SetPinPadButtonsResult;", "Lcom/squareup/wire/Message;", "Lcom/stripe/bbpos/sdk/SetPinPadButtonsResult$Builder;", "isSuccess", "", "unknownFields", "Lokio/ByteString;", "(ZLokio/ByteString;)V", "copy", "equals", "other", "", "hashCode", "", "newBuilder", "toString", "", "Builder", "Companion", "sdk-protos_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
public final class SetPinPadButtonsResult extends Message<SetPinPadButtonsResult, Builder> {
    ...
    public SetPinPadButtonsResult(boolean z, ByteString unknownFields) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SetPinPadButtonsResult)) {
            return false;
        }
        SetPinPadButtonsResult setPinPadButtonsResult = (SetPinPadButtonsResult) other;
    ...
    public String toString() {
        ...
        return CollectionsKt.joinToString$default(arrayList, ", ", "SetPinPadButtonsResult{", "}", 0, null, null, 56, null);
    }
    ...
    public final SetPinPadButtonsResult copy(boolean isSuccess, ByteString unknownFields) {
        Intrinsics.checkNotNullParameter(unknownFields, "unknownFields");
        return new SetPinPadButtonsResult(isSuccess, unknownFields);
    }

    /* JADX INFO: compiled from: SetPinPadButtonsResult.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00000\u0001B\u0005¢\u0006\u0002\u0010\u0003J\b\u0010\u0006\u001a\u00020\u0002H\u0016J\u000e\u0010\u0004\u001a\u00020\u00002\u0006\u0010\u0004\u001a\u00020\u0005R\u0012\u0010\u0004\u001a\u00020\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000¨\u0006\u0007"}, d2 = {"Lcom/stripe/bbpos/sdk/SetPinPadButtonsResult$Builder;", "Lcom/squareup/wire/Message$Builder;", "Lcom/stripe/bbpos/sdk/SetPinPadButtonsResult;", "()V", "isSuccess", "", "build", "sdk-protos_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    ...
    static {
        ...
        ADAPTER = new ProtoAdapter<SetPinPadButtonsResult>(fieldEncoding, orCreateKotlinClass, syntax) { // from class: com.stripe.bbpos.sdk.SetPinPadButtonsResult$Companion$ADAPTER$1
            ...
            public int encodedSize(SetPinPadButtonsResult value) {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(ProtoWriter writer, SetPinPadButtonsResult value) throws IOException {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(ReverseProtoWriter writer, SetPinPadButtonsResult value) throws IOException {
                Intrinsics.checkNotNullParameter(writer, "writer");
                Intrinsics.checkNotNullParameter(value, "value");
                writer.writeBytes(value.unknownFields());
                if (value.isSuccess) {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public SetPinPadButtonsResult redact(SetPinPadButtonsResult value) {
                Intrinsics.checkNotNullParameter(value, "value");
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public SetPinPadButtonsResult decode(ProtoReader reader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag == -1) {
                        return new SetPinPadButtonsResult(zBooleanValue, reader.endMessageAndGetUnknownFields(jBeginMessage));
                    }
                    if (iNextTag == 1) {
