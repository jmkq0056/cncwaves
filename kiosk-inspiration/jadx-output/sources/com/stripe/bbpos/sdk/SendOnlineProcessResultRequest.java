...
/* JADX INFO: compiled from: SendOnlineProcessResultRequest.kt */
/* JADX INFO: loaded from: classes3.dex */
@Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\u0018\u0000 \u00122\u000e\u0012\u0004\u0012\u00020\u0000\u0012\u0004\u0012\u00020\u00020\u0001:\u0002\u0011\u0012B\u001b\u0012\n\b\u0002\u0010\u0003\u001a\u0004\u0018\u00010\u0004\u0012\b\b\u0002\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\u001c\u0010\b\u001a\u00020\u00002\n\b\u0002\u0010\u0003\u001a\u0004\u0018\u00010\u00042\b\b\u0002\u0010\u0005\u001a\u00020\u0006J\u0013\u0010\t\u001a\u00020\n2\b\u0010\u000b\u001a\u0004\u0018\u00010\fH\u0096\u0002J\b\u0010\r\u001a\u00020\u000eH\u0016J\b\u0010\u000f\u001a\u00020\u0002H\u0016J\b\u0010\u0010\u001a\u00020\u0004H\u0016R\u0012\u0010\u0003\u001a\u0004\u0018\u00010\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\u0013"}, d2 = {"Lcom/stripe/bbpos/sdk/SendOnlineProcessResultRequest;", "Lcom/squareup/wire/Message;", "Lcom/stripe/bbpos/sdk/SendOnlineProcessResultRequest$Builder;", "tlv", "", "unknownFields", "Lokio/ByteString;", "(Ljava/lang/String;Lokio/ByteString;)V", "copy", "equals", "", "other", "", "hashCode", "", "newBuilder", "toString", "Builder", "Companion", "sdk-protos_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
public final class SendOnlineProcessResultRequest extends Message<SendOnlineProcessResultRequest, Builder> {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SendOnlineProcessResultRequest)) {
            return false;
        }
        SendOnlineProcessResultRequest sendOnlineProcessResultRequest = (SendOnlineProcessResultRequest) other;
    ...
    public String toString() {
        ...
        return CollectionsKt.joinToString$default(arrayList, ", ", "SendOnlineProcessResultRequest{", "}", 0, null, null, 56, null);
    }
    ...
    public final SendOnlineProcessResultRequest copy(String tlv, ByteString unknownFields) {
        Intrinsics.checkNotNullParameter(unknownFields, "unknownFields");
        return new SendOnlineProcessResultRequest(tlv, unknownFields);
    }

    /* JADX INFO: compiled from: SendOnlineProcessResultRequest.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00000\u0001B\u0005¢\u0006\u0002\u0010\u0003J\b\u0010\u0006\u001a\u00020\u0002H\u0016J\u0010\u0010\u0004\u001a\u00020\u00002\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005R\u0014\u0010\u0004\u001a\u0004\u0018\u00010\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000¨\u0006\u0007"}, d2 = {"Lcom/stripe/bbpos/sdk/SendOnlineProcessResultRequest$Builder;", "Lcom/squareup/wire/Message$Builder;", "Lcom/stripe/bbpos/sdk/SendOnlineProcessResultRequest;", "()V", "tlv", "", "build", "sdk-protos_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    ...
    public static final class Companion {
        ...
        public final /* synthetic */ SendOnlineProcessResultRequest build(Function1<? super Builder, Unit> body) {
    ...
    static {
        ...
        ADAPTER = new ProtoAdapter<SendOnlineProcessResultRequest>(fieldEncoding, orCreateKotlinClass, syntax) { // from class: com.stripe.bbpos.sdk.SendOnlineProcessResultRequest$Companion$ADAPTER$1
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(ProtoWriter writer, SendOnlineProcessResultRequest value) throws IOException {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(ReverseProtoWriter writer, SendOnlineProcessResultRequest value) throws IOException {
                Intrinsics.checkNotNullParameter(writer, "writer");
                Intrinsics.checkNotNullParameter(value, "value");
                writer.writeBytes(value.unknownFields());
                ProtoAdapter.STRING.encodeWithTag(writer, 1, value.tlv);
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public SendOnlineProcessResultRequest decode(ProtoReader reader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag == -1) {
                        return new SendOnlineProcessResultRequest(strDecode, reader.endMessageAndGetUnknownFields(jBeginMessage));
                    }
                    if (iNextTag == 1) {
