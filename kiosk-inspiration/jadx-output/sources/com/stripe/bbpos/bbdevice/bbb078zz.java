...
class bbb078zz extends bbb005zz {
    bbb078zz(aaa003zz aaa003zzVar, aaa011zz aaa011zzVar) {
    ...
    void aaa000(List<ccc067zz> list, boolean z) {
        ...
        try {
            if (ccc067zzVarAaa000 == null) {
                this.aaa000.aaa005(false, ccc071zz.aaa000(ccc067zzVarAaa0002));
            } else if (Integer.parseInt(ccc067zzVarAaa000.aaa001, 16) == 0) {
                this.aaa000.aaa005(true, ccc071zz.aaa000(ccc067zzVarAaa0002));
            } else {
                this.aaa000.aaa005(false, ccc071zz.aaa000(ccc067zzVarAaa0002));
            }
