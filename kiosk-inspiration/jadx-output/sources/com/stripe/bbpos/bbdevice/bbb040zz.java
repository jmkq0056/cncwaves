...
class bbb040zz extends bbb005zz {
    bbb040zz(aaa003zz aaa003zzVar, aaa011zz aaa011zzVar) {
        super(aaa003zzVar, aaa011zzVar);
    }

    void aaa000(List<ccc067zz> list, boolean z) {
        ccc067zz ccc067zzVarAaa000 = ccc068zz.aaa000(list, "DE");
        ccc067zz ccc067zzVarAaa0002 = ccc068zz.aaa000(list, "DF8659");
        String str = ccc067zzVarAaa0002 == null ? "" : ccc067zzVarAaa0002.aaa001;
        ...
        try {
            ...
            if (z2) {
                hashtable.put("CC", str);
            } else if (ccc067zzVarAaa0003 != null) {
                hashtable.put("errorMessage", ccc034zz.aaa003(ccc067zzVarAaa0003.aaa001));
            }
            this.aaa000.aaa000(z2, hashtable);
