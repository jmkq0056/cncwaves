...
class bbb022zz extends bbb005zz {
    bbb022zz(aaa003zz aaa003zzVar, aaa011zz aaa011zzVar) {
    ...
    void aaa000(List<ccc067zz> list, boolean z) {
        ...
        if (ccc067zzVarAaa0005 == null) {
            this.aaa001.aaa000(ccc010zz.ccc028, (byte) 12);
            return;
        }
        try {
            ...
            if (i != 0) {
                if (i == 1) {
                    this.aaa001.aaa000(ccc010zz.ccc028, (byte) 0);
                    if (z) {
                        return;
                    }
                    this.aaa000.aaa009(new Hashtable<>());
                    return;
                }
                if (i == 2) {
                    this.aaa001.aaa000(ccc010zz.ccc028, (byte) 0);
            ...
            if (i2 > 0) {
                if (ccc067zzVarAaa000 != null) {
                    ...
                    StringBuilder sbAppend = sb.append(str.substring(0, str.length() - i2)).append(".");
                    String str2 = ccc067zzVarAaa000.aaa001;
                    string = sbAppend.append(str2.substring(str2.length() - i2)).toString();
                } else {
                    string = null;
                }
                if (ccc067zzVarAaa0006 != null) {
                    ...
                    StringBuilder sbAppend2 = sb2.append(str3.substring(0, str3.length() - i2)).append(".");
                    String str4 = ccc067zzVarAaa0006.aaa001;
                    strSubstring2 = sbAppend2.append(str4.substring(str4.length() - i2)).toString();
                } else {
                    strSubstring2 = null;
                }
                if (ccc067zzVarAaa0002 != null) {
                    StringBuilder sb3 = new StringBuilder();
                    String str5 = ccc067zzVarAaa0002.aaa001;
                    StringBuilder sbAppend3 = sb3.append(str5.substring(0, str5.length() - i2)).append(".");
                    String str6 = ccc067zzVarAaa0002.aaa001;
                    strSubstring3 = sbAppend3.append(str6.substring(str6.length() - i2)).toString();
                }
                String str7 = strSubstring3;
                strSubstring3 = string;
                strSubstring = str7;
            } else {
                strSubstring = null;
                strSubstring2 = null;
            ...
            if (ccc067zzVarAaa0007 != null && !ccc067zzVarAaa0007.aaa001.equals("")) {
