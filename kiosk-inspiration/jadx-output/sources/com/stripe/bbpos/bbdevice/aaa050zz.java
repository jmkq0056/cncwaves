...
class aaa050zz extends aaa012zz {
    aaa050zz(aaa003zz aaa003zzVar, aaa011zz aaa011zzVar) {
    ...
    void aaa000(String str) {
        ...
        String str2 = "DF24" + ccc034zz.aaa001(str.length() / 2) + str;
        aaa011zz aaa011zzVar = this.aaa001;
        aaa011zzVar.aaa005 = 0;
        aaa011zzVar.aaa003 = new aaa010zz(ccc010zz.bbb054, (byte) 0, (byte) 0, ccc071zz.aaa005(str2));
