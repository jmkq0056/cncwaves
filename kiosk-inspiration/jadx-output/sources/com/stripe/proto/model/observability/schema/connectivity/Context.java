...
public final class Context extends Message<Context, Builder> {
    ...
    @WireField(adapter = "com.stripe.proto.model.observability.schema.connectivity.EthernetContext#ADAPTER", oneofName = "context", schemaIndex = 1, tag = 2)
    public final EthernetContext ethernet;

    @WireField(adapter = "com.stripe.proto.model.observability.schema.connectivity.WifiContext#ADAPTER", oneofName = "context", schemaIndex = 0, tag = 1)
    ...
    public /* synthetic */ Context(WifiContext wifiContext, EthernetContext ethernetContext, ByteString byteString, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : wifiContext, (i & 2) != 0 ? null : ethernetContext, (i & 4) != 0 ? ByteString.EMPTY : byteString);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Context(WifiContext wifiContext, EthernetContext ethernetContext, ByteString unknownFields) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(unknownFields(), context.unknownFields()) && Intrinsics.areEqual(this.wifi, context.wifi) && Intrinsics.areEqual(this.ethernet, context.ethernet);
    }
    ...
    public int hashCode() {
        ...
        int iHashCode3 = iHashCode2 + (ethernetContext != null ? ethernetContext.hashCode() : 0);
    ...
    public final Context copy(WifiContext wifi, EthernetContext ethernet, ByteString unknownFields) {
        Intrinsics.checkNotNullParameter(unknownFields, "unknownFields");
        return new Context(wifi, ethernet, unknownFields);
    }

    /* JADX INFO: compiled from: Context.kt */
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00000\u0001B\u0005¢\u0006\u0002\u0010\u0003J\b\u0010\b\u001a\u00020\u0002H\u0016J\u0010\u0010\u0004\u001a\u00020\u00002\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005J\u0010\u0010\u0006\u001a\u00020\u00002\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007R\u0014\u0010\u0004\u001a\u0004\u0018\u00010\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\u0004\u0018\u00010\u00078\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000¨\u0006\t"}, d2 = {"Lcom/stripe/proto/model/observability/schema/connectivity/Context$Builder;", "Lcom/squareup/wire/Message$Builder;", "Lcom/stripe/proto/model/observability/schema/connectivity/Context;", "()V", "ethernet", "Lcom/stripe/proto/model/observability/schema/connectivity/EthernetContext;", "wifi", "Lcom/stripe/proto/model/observability/schema/connectivity/WifiContext;", "build", "internal_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    ...
    /* JADX INFO: compiled from: Context.kt */
    @Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J%\u0010\b\u001a\u00020\u00052\u0017\u0010\t\u001a\u0013\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f0\n¢\u0006\u0002\b\rH\u0086\bø\u0001\u0000R\u0016\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082T¢\u0006\u0002\n\u0000\u0082\u0002\u0007\n\u0005\b\u009920\u0001¨\u0006\u000e"}, d2 = {"Lcom/stripe/proto/model/observability/schema/connectivity/Context$Companion;", "", "()V", "ADAPTER", "Lcom/squareup/wire/ProtoAdapter;", "Lcom/stripe/proto/model/observability/schema/connectivity/Context;", "serialVersionUID", "", "build", "body", "Lkotlin/Function1;", "Lcom/stripe/proto/model/observability/schema/connectivity/Context$Builder;", "", "Lkotlin/ExtensionFunctionType;", "internal_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    ...
    static {
        ...
        ADAPTER = new ProtoAdapter<Context>(fieldEncoding, orCreateKotlinClass, syntax) { // from class: com.stripe.proto.model.observability.schema.connectivity.Context$Companion$ADAPTER$1
            @Override // com.squareup.wire.ProtoAdapter
            public int encodedSize(Context value) {
                Intrinsics.checkNotNullParameter(value, "value");
                return value.unknownFields().size() + WifiContext.ADAPTER.encodedSizeWithTag(1, value.wifi) + EthernetContext.ADAPTER.encodedSizeWithTag(2, value.ethernet);
            }
            ...
            public Context redact(Context value) {
                ...
                return value.copy(wifiContextRedact, ethernetContext != null ? EthernetContext.ADAPTER.redact(ethernetContext) : null, ByteString.EMPTY);
            }
            ...
            public Context decode(ProtoReader reader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag == -1) {
                        return new Context(wifiContextDecode, ethernetContextDecode, reader.endMessageAndGetUnknownFields(jBeginMessage));
                    }
                    if (iNextTag == 1) {
