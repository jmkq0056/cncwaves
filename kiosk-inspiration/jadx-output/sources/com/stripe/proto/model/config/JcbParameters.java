...
public final class JcbParameters extends Message<JcbParameters, Builder> {
    ...
    public JcbParameters() {
        this(null, null, null, null, null, null, null, 127, null);
    }

    public /* synthetic */ JcbParameters(String str, String str2, String str3, String str4, String str5, String str6, ByteString byteString, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public JcbParameters(String contactless_floor_limit, String contactless_transaction_limit, String contactless_cvm_required_limit, String tac_default, String tac_denial, String tac_online, ByteString unknownFields) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof JcbParameters)) {
            return false;
        }
        JcbParameters jcbParameters = (JcbParameters) other;
        return Intrinsics.areEqual(unknownFields(), jcbParameters.unknownFields()) && Intrinsics.areEqual(this.contactless_floor_limit, jcbParameters.contactless_floor_limit) && Intrinsics.areEqual(this.contactless_transaction_limit, jcbParameters.contactless_transaction_limit) && Intrinsics.areEqual(this.contactless_cvm_required_limit, jcbParameters.contactless_cvm_required_limit) && Intrinsics.areEqual(this.tac_default, jcbParameters.tac_default) && Intrinsics.areEqual(this.tac_denial, jcbParameters.tac_denial) && Intrinsics.areEqual(this.tac_online, jcbParameters.tac_online);
    }
    ...
    public String toString() {
        ...
        return CollectionsKt.joinToString$default(arrayList, ", ", "JcbParameters{", "}", 0, null, null, 56, null);
    }

    public static /* synthetic */ JcbParameters copy$default(JcbParameters jcbParameters, String str, String str2, String str3, String str4, String str5, String str6, ByteString byteString, int i, Object obj) {
        if ((i & 1) != 0) {
            str = jcbParameters.contactless_floor_limit;
        }
        if ((i & 2) != 0) {
            str2 = jcbParameters.contactless_transaction_limit;
        }
        if ((i & 4) != 0) {
            str3 = jcbParameters.contactless_cvm_required_limit;
        }
        if ((i & 8) != 0) {
            str4 = jcbParameters.tac_default;
        }
        if ((i & 16) != 0) {
            str5 = jcbParameters.tac_denial;
        }
        if ((i & 32) != 0) {
            str6 = jcbParameters.tac_online;
        }
        if ((i & 64) != 0) {
            byteString = jcbParameters.unknownFields();
        }
        String str7 = str6;
        ByteString byteString2 = byteString;
        String str8 = str5;
        String str9 = str3;
        return jcbParameters.copy(str, str2, str9, str4, str8, str7, byteString2);
    }

    public final JcbParameters copy(String contactless_floor_limit, String contactless_transaction_limit, String contactless_cvm_required_limit, String tac_default, String tac_denial, String tac_online, ByteString unknownFields) {
        Intrinsics.checkNotNullParameter(contactless_floor_limit, "contactless_floor_limit");
        Intrinsics.checkNotNullParameter(contactless_transaction_limit, "contactless_transaction_limit");
        Intrinsics.checkNotNullParameter(contactless_cvm_required_limit, "contactless_cvm_required_limit");
        Intrinsics.checkNotNullParameter(tac_default, "tac_default");
        ...
        Intrinsics.checkNotNullParameter(tac_online, "tac_online");
        Intrinsics.checkNotNullParameter(unknownFields, "unknownFields");
        return new JcbParameters(contactless_floor_limit, contactless_transaction_limit, contactless_cvm_required_limit, tac_default, tac_denial, tac_online, unknownFields);
    }

    /* JADX INFO: compiled from: JcbParameters.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0007\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00000\u0001B\u0005¢\u0006\u0002\u0010\u0003J\b\u0010\u000b\u001a\u00020\u0002H\u0016J\u000e\u0010\u0004\u001a\u00020\u00002\u0006\u0010\u0004\u001a\u00020\u0005J\u000e\u0010\u0006\u001a\u00020\u00002\u0006\u0010\u0006\u001a\u00020\u0005J\u000e\u0010\u0007\u001a\u00020\u00002\u0006\u0010\u0007\u001a\u00020\u0005J\u000e\u0010\b\u001a\u00020\u00002\u0006\u0010\b\u001a\u00020\u0005J\u000e\u0010\t\u001a\u00020\u00002\u0006\u0010\t\u001a\u00020\u0005J\u000e\u0010\n\u001a\u00020\u00002\u0006\u0010\n\u001a\u00020\u0005R\u0012\u0010\u0004\u001a\u00020\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0006\u001a\u00020\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0007\u001a\u00020\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\b\u001a\u00020\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\t\u001a\u00020\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\n\u001a\u00020\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000¨\u0006\f"}, d2 = {"Lcom/stripe/proto/model/config/JcbParameters$Builder;", "Lcom/squareup/wire/Message$Builder;", "Lcom/stripe/proto/model/config/JcbParameters;", "()V", "contactless_cvm_required_limit", "", "contactless_floor_limit", "contactless_transaction_limit", "tac_default", "tac_denial", "tac_online", "build", "terminal_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    public static final class Builder extends Message.Builder<JcbParameters, Builder> {
        ...
        public JcbParameters build() {
            return new JcbParameters(this.contactless_floor_limit, this.contactless_transaction_limit, this.contactless_cvm_required_limit, this.tac_default, this.tac_denial, this.tac_online, buildUnknownFields());
        }
    }

    /* JADX INFO: compiled from: JcbParameters.kt */
    @Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J%\u0010\b\u001a\u00020\u00052\u0017\u0010\t\u001a\u0013\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f0\n¢\u0006\u0002\b\rH\u0086\bø\u0001\u0000R\u0016\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082T¢\u0006\u0002\n\u0000\u0082\u0002\u0007\n\u0005\b\u009920\u0001¨\u0006\u000e"}, d2 = {"Lcom/stripe/proto/model/config/JcbParameters$Companion;", "", "()V", "ADAPTER", "Lcom/squareup/wire/ProtoAdapter;", "Lcom/stripe/proto/model/config/JcbParameters;", "serialVersionUID", "", "build", "body", "Lkotlin/Function1;", "Lcom/stripe/proto/model/config/JcbParameters$Builder;", "", "Lkotlin/ExtensionFunctionType;", "terminal_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    public static final class Companion {
        ...
        public final /* synthetic */ JcbParameters build(Function1<? super Builder, Unit> body) {
    ...
    static {
        ...
        final KClass orCreateKotlinClass = Reflection.getOrCreateKotlinClass(JcbParameters.class);
        final Syntax syntax = Syntax.PROTO_3;
        ADAPTER = new ProtoAdapter<JcbParameters>(fieldEncoding, orCreateKotlinClass, syntax) { // from class: com.stripe.proto.model.config.JcbParameters$Companion$ADAPTER$1
            @Override // com.squareup.wire.ProtoAdapter
            public int encodedSize(JcbParameters value) {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(ProtoWriter writer, JcbParameters value) throws IOException {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(ReverseProtoWriter writer, JcbParameters value) throws IOException {
                Intrinsics.checkNotNullParameter(writer, "writer");
                Intrinsics.checkNotNullParameter(value, "value");
                writer.writeBytes(value.unknownFields());
                if (!Intrinsics.areEqual(value.tac_online, "")) {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public JcbParameters redact(JcbParameters value) {
                Intrinsics.checkNotNullParameter(value, "value");
                return JcbParameters.copy$default(value, null, null, null, null, null, null, ByteString.EMPTY, 63, null);
            }

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.squareup.wire.ProtoAdapter
            public JcbParameters decode(ProtoReader reader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag != -1) {
                        ...
                        return new JcbParameters(strDecode, strDecode2, strDecode3, strDecode4, strDecode5, strDecode6, reader.endMessageAndGetUnknownFields(jBeginMessage));
                    }
                }
            }
        };
