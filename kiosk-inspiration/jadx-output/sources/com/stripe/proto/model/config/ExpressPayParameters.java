...
public final class ExpressPayParameters extends Message<ExpressPayParameters, Builder> {
    ...
    public /* synthetic */ ExpressPayParameters(String str, String str2, String str3, String str4, String str5, String str6, ByteString byteString, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public ExpressPayParameters(String contactless_floor_limit, String contactless_transaction_limit, String contactless_cvm_required_limit, String tac_default, String tac_denial, String tac_online, ByteString unknownFields) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExpressPayParameters)) {
            return false;
        }
        ExpressPayParameters expressPayParameters = (ExpressPayParameters) other;
        return Intrinsics.areEqual(unknownFields(), expressPayParameters.unknownFields()) && Intrinsics.areEqual(this.contactless_floor_limit, expressPayParameters.contactless_floor_limit) && Intrinsics.areEqual(this.contactless_transaction_limit, expressPayParameters.contactless_transaction_limit) && Intrinsics.areEqual(this.contactless_cvm_required_limit, expressPayParameters.contactless_cvm_required_limit) && Intrinsics.areEqual(this.tac_default, expressPayParameters.tac_default) && Intrinsics.areEqual(this.tac_denial, expressPayParameters.tac_denial) && Intrinsics.areEqual(this.tac_online, expressPayParameters.tac_online);
    }
    ...
    public String toString() {
        ...
        return CollectionsKt.joinToString$default(arrayList, ", ", "ExpressPayParameters{", "}", 0, null, null, 56, null);
    }

    public static /* synthetic */ ExpressPayParameters copy$default(ExpressPayParameters expressPayParameters, String str, String str2, String str3, String str4, String str5, String str6, ByteString byteString, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        if ((i & 64) != 0) {
            byteString = expressPayParameters.unknownFields();
        }
        String str7 = str6;
        ByteString byteString2 = byteString;
        String str8 = str5;
        String str9 = str3;
        return expressPayParameters.copy(str, str2, str9, str4, str8, str7, byteString2);
    }

    public final ExpressPayParameters copy(String contactless_floor_limit, String contactless_transaction_limit, String contactless_cvm_required_limit, String tac_default, String tac_denial, String tac_online, ByteString unknownFields) {
        Intrinsics.checkNotNullParameter(contactless_floor_limit, "contactless_floor_limit");
        Intrinsics.checkNotNullParameter(contactless_transaction_limit, "contactless_transaction_limit");
        Intrinsics.checkNotNullParameter(contactless_cvm_required_limit, "contactless_cvm_required_limit");
        Intrinsics.checkNotNullParameter(tac_default, "tac_default");
    ...
    /* JADX INFO: compiled from: ExpressPayParameters.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0007\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00000\u0001B\u0005¢\u0006\u0002\u0010\u0003J\b\u0010\u000b\u001a\u00020\u0002H\u0016J\u000e\u0010\u0004\u001a\u00020\u00002\u0006\u0010\u0004\u001a\u00020\u0005J\u000e\u0010\u0006\u001a\u00020\u00002\u0006\u0010\u0006\u001a\u00020\u0005J\u000e\u0010\u0007\u001a\u00020\u00002\u0006\u0010\u0007\u001a\u00020\u0005J\u000e\u0010\b\u001a\u00020\u00002\u0006\u0010\b\u001a\u00020\u0005J\u000e\u0010\t\u001a\u00020\u00002\u0006\u0010\t\u001a\u00020\u0005J\u000e\u0010\n\u001a\u00020\u00002\u0006\u0010\n\u001a\u00020\u0005R\u0012\u0010\u0004\u001a\u00020\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0006\u001a\u00020\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0007\u001a\u00020\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\b\u001a\u00020\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\t\u001a\u00020\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\n\u001a\u00020\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000¨\u0006\f"}, d2 = {"Lcom/stripe/proto/model/config/ExpressPayParameters$Builder;", "Lcom/squareup/wire/Message$Builder;", "Lcom/stripe/proto/model/config/ExpressPayParameters;", "()V", "contactless_cvm_required_limit", "", "contactless_floor_limit", "contactless_transaction_limit", "tac_default", "tac_denial", "tac_online", "build", "terminal_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    ...
    /* JADX INFO: compiled from: ExpressPayParameters.kt */
    @Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J%\u0010\b\u001a\u00020\u00052\u0017\u0010\t\u001a\u0013\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f0\n¢\u0006\u0002\b\rH\u0086\bø\u0001\u0000R\u0016\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082T¢\u0006\u0002\n\u0000\u0082\u0002\u0007\n\u0005\b\u009920\u0001¨\u0006\u000e"}, d2 = {"Lcom/stripe/proto/model/config/ExpressPayParameters$Companion;", "", "()V", "ADAPTER", "Lcom/squareup/wire/ProtoAdapter;", "Lcom/stripe/proto/model/config/ExpressPayParameters;", "serialVersionUID", "", "build", "body", "Lkotlin/Function1;", "Lcom/stripe/proto/model/config/ExpressPayParameters$Builder;", "", "Lkotlin/ExtensionFunctionType;", "terminal_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    public static final class Companion {
        ...
        public final /* synthetic */ ExpressPayParameters build(Function1<? super Builder, Unit> body) {
    ...
    static {
        ...
        final KClass orCreateKotlinClass = Reflection.getOrCreateKotlinClass(ExpressPayParameters.class);
        final Syntax syntax = Syntax.PROTO_3;
        ADAPTER = new ProtoAdapter<ExpressPayParameters>(fieldEncoding, orCreateKotlinClass, syntax) { // from class: com.stripe.proto.model.config.ExpressPayParameters$Companion$ADAPTER$1
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(ProtoWriter writer, ExpressPayParameters value) throws IOException {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(ReverseProtoWriter writer, ExpressPayParameters value) throws IOException {
                Intrinsics.checkNotNullParameter(writer, "writer");
                Intrinsics.checkNotNullParameter(value, "value");
                writer.writeBytes(value.unknownFields());
                if (!Intrinsics.areEqual(value.tac_online, "")) {
            ...
            public ExpressPayParameters redact(ExpressPayParameters value) {
                Intrinsics.checkNotNullParameter(value, "value");
                return ExpressPayParameters.copy$default(value, null, null, null, null, null, null, ByteString.EMPTY, 63, null);
            }

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.squareup.wire.ProtoAdapter
            public ExpressPayParameters decode(ProtoReader reader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag != -1) {
                        ...
                        return new ExpressPayParameters(strDecode, strDecode2, strDecode3, strDecode4, strDecode5, strDecode6, reader.endMessageAndGetUnknownFields(jBeginMessage));
                    }
                }
            }
        };
