...
@Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\r\b\u0086\u0081\u0002\u0018\u0000 \u00102\b\u0012\u0004\u0012\u00020\u00000\u00012\u00020\u0002:\u0001\u0010B\u000f\b\u0002\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005R\u0014\u0010\u0003\u001a\u00020\u0004X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007j\u0002\b\bj\u0002\b\tj\u0002\b\nj\u0002\b\u000bj\u0002\b\fj\u0002\b\rj\u0002\b\u000ej\u0002\b\u000f¨\u0006\u0011"}, d2 = {"Lcom/stripe/proto/model/payments/CreditCardBrand;", "", "Lcom/squareup/wire/WireEnum;", "value", "", "(Ljava/lang/String;II)V", "getValue", "()I", "INVALID_CARD_BRAND", "DEFAULT", "VISA", "MASTERCARD", "AMERICAN_EXPRESS", "DISCOVER", "JCB", "DINERS", "Companion", "terminal_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
public final class CreditCardBrand implements WireEnum {
    ...
    public static final CreditCardBrand DEFAULT;
    public static final CreditCardBrand DINERS;
    public static final CreditCardBrand DISCOVER;
    public static final CreditCardBrand INVALID_CARD_BRAND;
    ...
    private static final /* synthetic */ CreditCardBrand[] $values() {
        return new CreditCardBrand[]{INVALID_CARD_BRAND, DEFAULT, VISA, MASTERCARD, AMERICAN_EXPRESS, DISCOVER, JCB, DINERS};
    }
    ...
    static {
        final CreditCardBrand creditCardBrand = new CreditCardBrand("INVALID_CARD_BRAND", 0, 0);
        INVALID_CARD_BRAND = creditCardBrand;
        DEFAULT = new CreditCardBrand("DEFAULT", 1, 1);
        VISA = new CreditCardBrand("VISA", 2, 2);
        MASTERCARD = new CreditCardBrand("MASTERCARD", 3, 3);
        AMERICAN_EXPRESS = new CreditCardBrand("AMERICAN_EXPRESS", 4, 4);
        DISCOVER = new CreditCardBrand("DISCOVER", 5, 5);
        JCB = new CreditCardBrand("JCB", 6, 6);
        DINERS = new CreditCardBrand("DINERS", 7, 7);
        ...
        ADAPTER = new EnumAdapter<CreditCardBrand>(orCreateKotlinClass, syntax, creditCardBrand) { // from class: com.stripe.proto.model.payments.CreditCardBrand$Companion$ADAPTER$1
            {
    ...
    /* JADX INFO: compiled from: CreditCardBrand.kt */
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0006\u001a\u0004\u0018\u00010\u00052\u0006\u0010\u0007\u001a\u00020\bH\u0007R\u0016\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\t"}, d2 = {"Lcom/stripe/proto/model/payments/CreditCardBrand$Companion;", "", "()V", "ADAPTER", "Lcom/squareup/wire/ProtoAdapter;", "Lcom/stripe/proto/model/payments/CreditCardBrand;", "fromValue", "value", "", "terminal_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    public static final class Companion {
        ...
        public final CreditCardBrand fromValue(int value) {
            switch (value) {
                case 0:
                    return CreditCardBrand.INVALID_CARD_BRAND;
                case 1:
                    return CreditCardBrand.DEFAULT;
                case 2:
