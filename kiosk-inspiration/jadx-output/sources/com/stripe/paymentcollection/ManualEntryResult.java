...
public final /* data */ class ManualEntryResult extends PaymentCollectionResult {
    ...
    public final ManualEntryResult copy(ManualEntryResultModel data, TippingState.EndState tipResult) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ManualEntryResult)) {
            return false;
        }
        ManualEntryResult manualEntryResult = (ManualEntryResult) other;
