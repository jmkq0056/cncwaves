...
public final class DisplayCartPostCollectionHandler extends PaymentCollectionStateHandler {
    ...
    public void onExit(PaymentCollectionState to) {
        ...
        super.onExit(to);
        getStageEventLogger().closeWaitForPosCommandLog(getData(), PendingPosCommand.START_COLLECTION);
    }
    ...
    public void onPaymentCollectionDataUpdate(PaymentCollectionData paymentCollectionData, PaymentCollectionData old) {
        ...
        if (paymentCollectionData.getConfirmedCollection()) {
