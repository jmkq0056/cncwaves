...
public final class OnlineConfirmationHandler extends PaymentCollectionStateHandler {
    ...
    public void onExit(PaymentCollectionState to) {
        ...
        if (data == null || data.getChargeAttempt() != null) {
            return;
        }
        getDiscreteEventLogger().logOnlineConfirmResult(data);
    }
    ...
    public void onPaymentCollectionDataUpdate(PaymentCollectionData paymentCollectionData, PaymentCollectionData old) {
        ...
        if (Intrinsics.areEqual(paymentCollectionData.getDynamicCurrencyConversionSelectionStatus(), DynamicCurrencyConversionSelectionStatus.Requested.INSTANCE)) {
            StateMachine.StateHandler.transitionTo$default(this, PaymentCollectionState.DCC_SELECTION, null, 2, null);
        } else if (paymentCollectionData.getChargeAttempt() != null) {
