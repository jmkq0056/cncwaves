...
/* JADX INFO: compiled from: AccountSelectionLogger.kt */
...
public final class AccountSelectionLogger extends StageEventLogHelper<PaymentCollectionDomain, PaymentCollectionDomain.Builder, StageScope, StageScope.Builder> {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AccountSelectionLogger(HealthLogger<PaymentCollectionDomain, PaymentCollectionDomain.Builder, StageScope, StageScope.Builder> logger, EndToEndEventLogger endToEventLogger) {
        super(logger, "AccountSelection", endToEventLogger, LatencyCategory.USER_ACTION);
        Intrinsics.checkNotNullParameter(logger, "logger");
        Intrinsics.checkNotNullParameter(endToEventLogger, "endToEventLogger");
    }

    public final void openLog() {
        StageEventLogHelper.openLogHelper$default(this, null, new Function2<StageScope.Builder, Timer, Unit>() { // from class: com.stripe.paymentcollection.metrics.AccountSelectionLogger.openLog.1
            ...
            public final void invoke2(StageScope.Builder openLogHelper, Timer event) {
                ...
                openLogHelper.account_selection = event;
            }
        }, 1, null);
    }
    ...
    public final void closeLog(final PaymentCollectionData data, final PaymentCollectionState nextState) {
        ...
        closeLogHelper(data, new Function1<Map<String, String>, Pair<? extends Outcome, ? extends Map<String, String>>>() { // from class: com.stripe.paymentcollection.metrics.AccountSelectionLogger.closeLog.1

            /* JADX INFO: renamed from: com.stripe.paymentcollection.metrics.AccountSelectionLogger$closeLog$1$WhenMappings */
            /* JADX INFO: compiled from: AccountSelectionLogger.kt */
            ...
            public final Pair<Outcome, Map<String, String>> invoke(Map<String, String> tagMap) {
                ...
                Pair pair;
                String simpleName;
                AccountSelectionFailureReason accountSelectionFailureReason;
                ...
                if (i == 1) {
                    ...
                    if (i2 == -1) {
                        accountSelectionFailureReason = AccountSelectionFailureReason.UNKNOWN;
                    } else if (i2 == 1) {
                        accountSelectionFailureReason = AccountSelectionFailureReason.MERCHANT_CANCELLED;
                    } else if (i2 == 2) {
                        accountSelectionFailureReason = AccountSelectionFailureReason.HARDWARE_CANCELLED;
                    } else if (i2 == 3) {
                        accountSelectionFailureReason = AccountSelectionFailureReason.CUSTOMER_CANCELLED;
                    } else {
                        throw new NoWhenBranchMatchedException();
                    }
                    pair = new Pair(result, accountSelectionFailureReason);
                } else if (i == 3) {
                    pair = new Pair(Result.FAILURE, AccountSelectionFailureReason.COLLECTION_FAILURE);
                } else {
                    pair = new Pair(Result.FAILURE, AccountSelectionFailureReason.UNKNOWN);
                }
                Result result2 = (Result) pair.component1();
                AccountSelectionFailureReason accountSelectionFailureReason2 = (AccountSelectionFailureReason) pair.component2();
                ...
                AccountSelectionFailureReason accountSelectionFailureReason3 = accountSelectionFailureReason2;
                if (accountSelectionFailureReason3 != null) {
                    if (!Intrinsics.areEqual(Reflection.getOrCreateKotlinClass(AccountSelectionFailureReason.class), Reflection.getOrCreateKotlinClass(MagStripePaymentCollectionAuthority.class))) {
                        simpleName2 = Reflection.getOrCreateKotlinClass(AccountSelectionFailureReason.class).getSimpleName();
                        Intrinsics.checkNotNull(simpleName2);
                    }
                    tagMap.put(simpleName2, accountSelectionFailureReason3.name());
                }
