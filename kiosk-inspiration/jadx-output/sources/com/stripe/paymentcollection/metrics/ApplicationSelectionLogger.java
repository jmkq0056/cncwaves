...
/* JADX INFO: compiled from: ApplicationSelectionLogger.kt */
...
public final class ApplicationSelectionLogger extends StageEventLogHelper<PaymentCollectionDomain, PaymentCollectionDomain.Builder, StageScope, StageScope.Builder> {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ApplicationSelectionLogger(HealthLogger<PaymentCollectionDomain, PaymentCollectionDomain.Builder, StageScope, StageScope.Builder> logger, EndToEndEventLogger endToEndEventLogger) {
        super(logger, "ApplicationSelection", endToEndEventLogger, LatencyCategory.USER_ACTION);
        Intrinsics.checkNotNullParameter(logger, "logger");
        Intrinsics.checkNotNullParameter(endToEndEventLogger, "endToEndEventLogger");
    }

    public final void openLog() {
        StageEventLogHelper.openLogHelper$default(this, null, new Function2<StageScope.Builder, Timer, Unit>() { // from class: com.stripe.paymentcollection.metrics.ApplicationSelectionLogger.openLog.1
            ...
            public final void invoke2(StageScope.Builder openLogHelper, Timer event) {
                ...
                openLogHelper.application_selection = event;
            }
        }, 1, null);
    }
    ...
    public final void closeLog(final PaymentCollectionData data, final PaymentCollectionState nextState) {
        ...
        closeLogHelper(data, new Function1<Map<String, String>, Pair<? extends Outcome, ? extends Map<String, String>>>() { // from class: com.stripe.paymentcollection.metrics.ApplicationSelectionLogger.closeLog.1

            /* JADX INFO: renamed from: com.stripe.paymentcollection.metrics.ApplicationSelectionLogger$closeLog$1$WhenMappings */
            /* JADX INFO: compiled from: ApplicationSelectionLogger.kt */
            ...
            public /* synthetic */ class WhenMappings {
                ...
                static {
                    ...
                    try {
                        iArr2[PaymentCollectionState.LANGUAGE_SELECTION.ordinal()] = 1;
                    ...
                    try {
                        iArr2[PaymentCollectionState.PREPARE_TO_COLLECT_AGAIN.ordinal()] = 3;
            ...
            public final Pair<Outcome, Map<String, String>> invoke(Map<String, String> tagMap) {
                ...
                Pair pair;
                String simpleName;
                ApplicationSelectionFailureReason applicationSelectionFailureReason;
                ...
                if (i == 1) {
                    ...
                    if (i2 == -1) {
                        applicationSelectionFailureReason = ApplicationSelectionFailureReason.UNKNOWN;
                    } else if (i2 == 1) {
                        applicationSelectionFailureReason = ApplicationSelectionFailureReason.MERCHANT_CANCELLED;
                    } else if (i2 == 2) {
                        applicationSelectionFailureReason = ApplicationSelectionFailureReason.HARDWARE_CANCELLED;
                    } else if (i2 == 3) {
                        applicationSelectionFailureReason = ApplicationSelectionFailureReason.CUSTOMER_CANCELLED;
                    } else {
                        throw new NoWhenBranchMatchedException();
                    }
                    pair = new Pair(result, applicationSelectionFailureReason);
                } else if (i == 3) {
                    pair = new Pair(Result.FAILURE, ApplicationSelectionFailureReason.COLLECTION_FAILURE);
                } else {
                    pair = new Pair(Result.FAILURE, ApplicationSelectionFailureReason.UNKNOWN);
                }
                Result result2 = (Result) pair.component1();
                ApplicationSelectionFailureReason applicationSelectionFailureReason2 = (ApplicationSelectionFailureReason) pair.component2();
                ...
                if (actionType2 != null) {
                    if (Intrinsics.areEqual(Reflection.getOrCreateKotlinClass(ActionType.class), Reflection.getOrCreateKotlinClass(MagStripePaymentCollectionAuthority.class))) {
                        ...
                        simpleName = Reflection.getOrCreateKotlinClass(ActionType.class).getSimpleName();
                        Intrinsics.checkNotNull(simpleName);
                    }
                    tagMap.put(simpleName, actionType2.name());
                }
                ApplicationSelectionFailureReason applicationSelectionFailureReason3 = applicationSelectionFailureReason2;
                if (applicationSelectionFailureReason3 != null) {
                    if (!Intrinsics.areEqual(Reflection.getOrCreateKotlinClass(ApplicationSelectionFailureReason.class), Reflection.getOrCreateKotlinClass(MagStripePaymentCollectionAuthority.class))) {
                        simpleName2 = Reflection.getOrCreateKotlinClass(ApplicationSelectionFailureReason.class).getSimpleName();
                        Intrinsics.checkNotNull(simpleName2);
                    }
                    tagMap.put(simpleName2, applicationSelectionFailureReason3.name());
                }
