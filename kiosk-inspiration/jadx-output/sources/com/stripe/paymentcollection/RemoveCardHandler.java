...
public final class RemoveCardHandler extends PaymentCollectionStateHandler {
    ...
    public void onEnter(PaymentCollectionData current, PaymentCollectionState from) {
        ...
        if (current != null) {
            getStageEventLogger().openRemoveCardLog();
    ...
    public void onExit(PaymentCollectionState to) {
        ...
        if (data != null) {
            getStageEventLogger().closeRemoveCardLog(data);
        }
    }
    ...
    public void onPaymentCollectionDataUpdate(PaymentCollectionData paymentCollectionData, PaymentCollectionData old) {
        ...
        if (paymentCollectionData.getCardSlotState() == ContactCardSlotState.EMPTY) {
            transitionTo(PaymentCollectionState.COLLECTION_COMPLETE, "Card removed.");
        } else {
            yieldEvent(new PresentRemoveCardEvent(new RemoveCardModel(paymentCollectionData.getAmount(), paymentCollectionData.getSelectedLanguage(), null, 4, null)));
        }
    }
}
