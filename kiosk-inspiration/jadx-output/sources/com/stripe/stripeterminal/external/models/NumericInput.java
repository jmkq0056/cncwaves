...
public final /* data */ class NumericInput implements Input {
    ...
    public /* synthetic */ NumericInput(boolean z, String str, String str2, String str3, String str4, List list, DefaultConstructorMarker defaultConstructorMarker) {
        this(z, str, str2, str3, str4, list);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ NumericInput copy$default(NumericInput numericInput, boolean z, String str, String str2, String str3, String str4, List list, int i, Object obj) {
        if ((i & 1) != 0) {
            z = numericInput.required;
        }
        if ((i & 2) != 0) {
            str = numericInput.title;
        }
        if ((i & 4) != 0) {
            str2 = numericInput.description;
        }
        if ((i & 8) != 0) {
            str3 = numericInput.submitButtonText;
        }
        if ((i & 16) != 0) {
            str4 = numericInput.skipButtonText;
        }
        if ((i & 32) != 0) {
            list = numericInput.toggles;
        }
        String str5 = str4;
        List list2 = list;
        return numericInput.copy(z, str, str2, str3, str5, list2);
    }
    ...
    public final NumericInput copy(boolean required, String title, String description, String submitButtonText, String skipButtonText, List<Toggle> toggles) {
        Intrinsics.checkNotNullParameter(title, "title");
        Intrinsics.checkNotNullParameter(toggles, "toggles");
        return new NumericInput(required, title, description, submitButtonText, skipButtonText, toggles);
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.required == numericInput.required && Intrinsics.areEqual(this.title, numericInput.title) && Intrinsics.areEqual(this.description, numericInput.description) && Intrinsics.areEqual(this.submitButtonText, numericInput.submitButtonText) && Intrinsics.areEqual(this.skipButtonText, numericInput.skipButtonText) && Intrinsics.areEqual(this.toggles, numericInput.toggles);
    }
    ...
    public String toString() {
        return "NumericInput(required=" + this.required + ", title=" + this.title + ", description=" + this.description + ", submitButtonText=" + this.submitButtonText + ", skipButtonText=" + this.skipButtonText + ", toggles=" + this.toggles + ')';
    }

    private NumericInput(boolean z, String str, String str2, String str3, String str4, List<Toggle> list) {
        this.required = z;
        this.title = str;
    ...
    /* synthetic */ NumericInput(boolean z, String str, String str2, String str3, String str4, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {
        List list2;
        String str5;
    ...
    public static final class Builder {
        ...
        public final NumericInput build() {
            return new NumericInput(this.required, this.title, this.description, this.submitButtonText, this.skipButtonText, this.toggles, null);
        }
    }
}
