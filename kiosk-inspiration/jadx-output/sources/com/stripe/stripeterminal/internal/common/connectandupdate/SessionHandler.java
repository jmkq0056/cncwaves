...
public final class SessionHandler extends ConnectAndUpdateStateHandler {
    private final ReaderConnectionController readerConnectionController;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    @Inject
    public SessionHandler(ReaderConnectionController readerConnectionController) {
        super(ConnectAndUpdateState.START_SESSION);
    ...
    public void onEnter(ConnectAndUpdateApplicationData current, ConnectAndUpdateState from) {
        ...
        this.readerConnectionController.startSession(device);
    }
}
