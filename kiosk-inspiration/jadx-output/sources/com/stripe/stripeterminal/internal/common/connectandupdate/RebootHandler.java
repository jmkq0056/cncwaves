...
public final class RebootHandler extends ConnectAndUpdateStateHandler {
    private final ReaderConnectionController readerConnectionController;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    @Inject
    public RebootHandler(ReaderConnectionController readerConnectionController) {
        super(ConnectAndUpdateState.REBOOT);
    ...
    public void onEnter(ConnectAndUpdateApplicationData current, ConnectAndUpdateState from) {
        ...
        this.readerConnectionController.reboot(device);
    }
}
