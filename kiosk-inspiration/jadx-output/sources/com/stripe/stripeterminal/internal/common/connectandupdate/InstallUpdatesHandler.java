...
public final class InstallUpdatesHandler extends ConnectAndUpdateStateHandler {
    ...
    public void onEnter(ConnectAndUpdateApplicationData current, ConnectAndUpdateState from) {
        ...
        if (current == null || (updateSummary = current.getUpdateSummary()) == null) {
            return;
        }
