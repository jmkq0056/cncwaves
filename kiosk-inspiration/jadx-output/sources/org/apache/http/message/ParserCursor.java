...
public class ParserCursor {
    ...
    public String toString() {
        return "[" + Integer.toString(this.lowerBound) + Typography.greater + Integer.toString(this.pos) + Typography.greater + Integer.toString(this.upperBound) + AbstractJsonLexerKt.END_LIST;
    }
}
