...
public class UriPatternMatcher<T> {
    ...
    protected boolean matchUriRequestPattern(String str, String str2) {
        ...
        return (str.endsWith(Marker.ANY_MARKER) && str2.startsWith(str.substring(0, str.length() - 1))) || (str.startsWith(Marker.ANY_MARKER) && str2.endsWith(str.substring(1, str.length())));
    }
