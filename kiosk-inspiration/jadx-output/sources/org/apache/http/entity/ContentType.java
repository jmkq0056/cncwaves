...
public final class ContentType implements Serializable {
    ...
    static {
        ...
        ContentType contentTypeCreate2 = create("application/x-www-form-urlencoded", Consts.ISO_8859_1);
        APPLICATION_FORM_URLENCODED = contentTypeCreate2;
        ContentType contentTypeCreate3 = create("application/json", Consts.UTF_8);
        ...
        ContentType contentTypeCreate9 = create(Utils.MIME_TYPE_JPEG);
        ...
        ContentType contentTypeCreate13 = create(Utils.MIME_TYPE_WEBP);
        ...
        ContentType contentTypeCreate16 = create(HTTP.PLAIN_TEXT_TYPE, Consts.ISO_8859_1);
    ...
    private static ContentType create(String str, NameValuePair[] nameValuePairArr, boolean z) {
        ...
        while (true) {
            ...
            if (nameValuePair.getName().equalsIgnoreCase(HttpAuthHeader.Parameters.Charset)) {
    ...
    public ContentType withParameters(NameValuePair... nameValuePairArr) throws UnsupportedCharsetException {
        ...
        if (this.charset != null && !linkedHashMap.containsKey(HttpAuthHeader.Parameters.Charset)) {
            arrayList.add(new BasicNameValuePair(HttpAuthHeader.Parameters.Charset, this.charset.name()));
        }
