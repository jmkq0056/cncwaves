...
public class DefaultHttpRequestFactory implements HttpRequestFactory {
    ...
    private static final String[] RFC2616_COMMON_METHODS = {FirebasePerformance.HttpMethod.GET};
    private static final String[] RFC2616_ENTITY_ENC_METHODS = {FirebasePerformance.HttpMethod.POST, FirebasePerformance.HttpMethod.PUT};
    private static final String[] RFC2616_SPECIAL_METHODS = {FirebasePerformance.HttpMethod.HEAD, FirebasePerformance.HttpMethod.OPTIONS, FirebasePerformance.HttpMethod.DELETE, FirebasePerformance.HttpMethod.TRACE, FirebasePerformance.HttpMethod.CONNECT};
    private static final String[] RFC5789_ENTITY_ENC_METHODS = {FirebasePerformance.HttpMethod.PATCH};
