...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final Buffer copyTo(OutputStream out, long offset, long byteCount) throws IOException {
        ...
        if (byteCount != 0) {
            ...
            while (j2 > 0) {
                ...
                int iMin = (int) Math.min(segment2.limit - i, j2);
                out.write(segment2.data, i, iMin);
                j2 -= (long) iMin;
    ...
    public final byte m2627deprecated_getByte(long index) {
    ...
    */
    ...
    public Buffer writeUtf8CodePoint(int codePoint) {
        ...
        if (codePoint < 65536) {
            ...
            segmentWritableSegment$okio2.data[segmentWritableSegment$okio2.limit] = (byte) ((codePoint >> 12) | WinError.ERROR_FORMS_AUTH_REQUIRED);
