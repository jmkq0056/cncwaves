...
public final class Buffer {
    ...
    */
    ...
    public static final okio.Buffer commonWriteDecimalLong(okio.Buffer buffer, long j) {
        ...
        if (j >= 100000000) {
            i = j < 1000000000000L ? j < RealConnection.IDLE_CONNECTION_HEALTHY_NS ? j < MathMethodsKt.NANOS_PER_SECOND ? 9 : 10 : j < 100000000000L ? 11 : 12 : j < 1000000000000000L ? j < 10000000000000L ? 13 : j < 100000000000000L ? 14 : 15 : j < 100000000000000000L ? j < 10000000000000000L ? 16 : 17 : j < 1000000000000000000L ? 18 : 19;
        } else if (j >= 10000) {
    ...
    */
        ...
        while (i < i2) {
            ...
            if (cCharAt2 < 128) {
                ...
                if (cCharAt2 < 2048) {
                    ...
                    segmentWritableSegment$okio3.data[segmentWritableSegment$okio3.limit] = (byte) ((cCharAt2 >> '\f') | WinError.ERROR_FORMS_AUTH_REQUIRED);
    ...
    public static final okio.Buffer commonWriteUtf8CodePoint(okio.Buffer buffer, int i) {
        ...
        if (i < 65536) {
            ...
            segmentWritableSegment$okio2.data[segmentWritableSegment$okio2.limit] = (byte) ((i >> 12) | WinError.ERROR_FORMS_AUTH_REQUIRED);
