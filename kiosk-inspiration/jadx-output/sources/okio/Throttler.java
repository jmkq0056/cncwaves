...
public final class Throttler {
    ...
    private final long nanosToBytes(long j) {
        return (j * this.bytesPerSecond) / MathMethodsKt.NANOS_PER_SECOND;
    }

    private final long bytesToNanos(long j) {
        return (j * MathMethodsKt.NANOS_PER_SECOND) / this.bytesPerSecond;
    }
