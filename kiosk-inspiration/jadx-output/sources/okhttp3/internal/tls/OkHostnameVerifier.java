...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final boolean verifyHostname(String hostname, String pattern) {
        ...
        if (str2 != null && str2.length() != 0 && !StringsKt.startsWith$default(hostname, ".", false, 2, (Object) null) && !StringsKt.endsWith$default(hostname, "..", false, 2, (Object) null) && (str = pattern) != null && str.length() != 0 && !StringsKt.startsWith$default(pattern, ".", false, 2, (Object) null) && !StringsKt.endsWith$default(pattern, "..", false, 2, (Object) null)) {
            ...
            if (!StringsKt.contains$default((CharSequence) str3, (CharSequence) Marker.ANY_MARKER, false, 2, (Object) null)) {
                return Intrinsics.areEqual(hostname, strAsciiToLowercase);
            }
            if (!StringsKt.startsWith$default(strAsciiToLowercase, "*.", false, 2, (Object) null) || StringsKt.indexOf$default((CharSequence) str3, GMTDateParser.ANY, 1, false, 4, (Object) null) != -1 || hostname.length() < strAsciiToLowercase.length() || Intrinsics.areEqual("*.", strAsciiToLowercase)) {
                return false;
            }
