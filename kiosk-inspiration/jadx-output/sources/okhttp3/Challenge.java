...
public final class Challenge {
    ...
    public final Challenge withCharset(Charset charset) {
        ...
        mutableMap.put(HttpAuthHeader.Parameters.Charset, strName);
    ...
    public final Map<String, String> m2511deprecated_authParams() {
        return this.authParams;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = HttpAuthHeader.Parameters.Realm, imports = {}))
    /* JADX INFO: renamed from: -deprecated_realm, reason: not valid java name */
    public final String m2513deprecated_realm() {
        return realm();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = HttpAuthHeader.Parameters.Charset, imports = {}))
    /* JADX INFO: renamed from: -deprecated_charset, reason: not valid java name */
    public final Charset m2512deprecated_charset() {
        return charset();
    }
