...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    public final int m2537deprecated_size() {
        return size();
    }
    ...
    public static final class Companion {
        ...
        public final Headers m2539deprecated_of(String... namesAndValues) {
            Intrinsics.checkNotNullParameter(namesAndValues, "namesAndValues");
        ...
        /* JADX INFO: renamed from: -deprecated_of, reason: not valid java name */
        public final Headers m2538deprecated_of(Map<String, String> headers) {
            Intrinsics.checkNotNullParameter(headers, "headers");
            return of(headers);
        }
        ...
        public final void checkValue(String value, String name) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (cCharAt != '\t' && (' ' > cCharAt || cCharAt >= 127)) {
                    throw new IllegalArgumentException((Util.format("Unexpected char %#04x at %d in %s value", Integer.valueOf(cCharAt), Integer.valueOf(i), name) + (Util.isSensitiveHeader(name) ? "" : ": " + value)).toString());
                }
            }
        }
    }
