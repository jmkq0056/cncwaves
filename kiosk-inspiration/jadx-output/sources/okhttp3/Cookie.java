...
public final class Cookie {
    ...
    public static final class Companion {
        ...
        public final boolean pathMatch(HttpUrl url, String path) {
            ...
            return StringsKt.startsWith$default(strEncodedPath, path, false, 2, (Object) null) && (StringsKt.endsWith$default(path, RemoteSettings.FORWARD_SLASH_STRING, false, 2, (Object) null) || strEncodedPath.charAt(path.length()) == '/');
        }
        ...
        public final Cookie parse$okhttp(long currentTimeMillis, HttpUrl url, String setCookie) {
            ...
            while (i < length) {
                ...
                } else if (StringsKt.equals(strTrimSubstring3, io.ktor.client.utils.CacheControl.MAX_AGE, true)) {
            ...
            if (str == null || !StringsKt.startsWith$default(str, RemoteSettings.FORWARD_SLASH_STRING, false, 2, (Object) cookie3)) {
                String strEncodedPath = url.encodedPath();
        ...
        private final long parseExpires(String s, int pos, int limit) {
            ...
            if (70 <= i && i < 100) {
                i += WinError.RPC_S_INVALID_OBJECT;
            }
            if (i >= 0 && i < 70) {
                i += 2000;
            }
