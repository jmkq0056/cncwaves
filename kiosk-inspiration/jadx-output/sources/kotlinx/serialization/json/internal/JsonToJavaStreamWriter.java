...
public final class JsonToJavaStreamWriter implements InternalJsonWriter {
        ...
        while (i < count) {
            ...
            if (c < 128) {
                ...
                if (c < 2048) {
                    ...
                    int i14 = (c >> '\f') | WinError.ERROR_FORMS_AUTH_REQUIRED;
    ...
    private final void writeUtf8CodePoint(int codePoint) throws IOException {
        ...
        if (codePoint < 65536) {
            ...
            int i5 = (codePoint >> 12) | WinError.ERROR_FORMS_AUTH_REQUIRED;
            byte[] bArr4 = this.buffer;
