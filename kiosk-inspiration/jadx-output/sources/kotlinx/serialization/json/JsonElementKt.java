...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m2484JsonPrimitive7apg3OU(byte b) {
        return m2485JsonPrimitiveVKZWuLQ(ULong.m991constructorimpl(((long) b) & 255));
    }

    @ExperimentalSerializationApi
    /* JADX INFO: renamed from: JsonPrimitive-xj2QHRw, reason: not valid java name */
    public static final JsonPrimitive m2487JsonPrimitivexj2QHRw(short s) {
        return m2485JsonPrimitiveVKZWuLQ(ULong.m991constructorimpl(((long) s) & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    @ExperimentalSerializationApi
    /* JADX INFO: renamed from: JsonPrimitive-WZ4Q5Ns, reason: not valid java name */
    public static final JsonPrimitive m2486JsonPrimitiveWZ4Q5Ns(int i) {
        return m2485JsonPrimitiveVKZWuLQ(ULong.m991constructorimpl(((long) i) & 4294967295L));
    }

    @ExperimentalSerializationApi
    /* JADX INFO: renamed from: JsonPrimitive-VKZWuLQ, reason: not valid java name */
    public static final JsonPrimitive m2485JsonPrimitiveVKZWuLQ(long j) {
