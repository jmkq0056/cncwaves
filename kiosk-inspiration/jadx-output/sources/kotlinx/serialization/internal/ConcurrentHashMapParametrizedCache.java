...
final class ConcurrentHashMapParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo2446getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            try {
                ...
                objM817constructorimpl = Result.m817constructorimpl(this.compute.invoke(key, types));
            } catch (Throwable th) {
            ...
            Object objPutIfAbsent = concurrentHashMap2.putIfAbsent(arrayList2, resultM816boximpl);
