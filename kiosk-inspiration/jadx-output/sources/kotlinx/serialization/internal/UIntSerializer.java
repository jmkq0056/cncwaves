...
public final class UIntSerializer implements KSerializer<UInt> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UInt.m906boximpl(m2465deserializeOGnWXxg(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m2466serializeQn1smSk(encoder, ((UInt) obj).getData());
    }
    ...
    public void m2466serializeQn1smSk(Encoder encoder, int value) {
    ...
    public int m2465deserializeOGnWXxg(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UInt.m912constructorimpl(decoder.decodeInline(getDescriptor()).decodeInt());
    }
}
