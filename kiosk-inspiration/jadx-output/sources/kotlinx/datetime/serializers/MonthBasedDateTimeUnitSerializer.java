...
public final class MonthBasedDateTimeUnitSerializer implements KSerializer<DateTimeUnit.MonthBased> {
    ...
    private static final Lazy descriptor = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new Function0<SerialDescriptor>() { // from class: kotlinx.datetime.serializers.MonthBasedDateTimeUnitSerializer$descriptor$2
    ...
    public void serialize(Encoder encoder, DateTimeUnit.MonthBased value) {
        ...
        compositeEncoderBeginStructure.encodeIntElement(INSTANCE.getDescriptor(), 0, value.getMonths());
    ...
    public DateTimeUnit.MonthBased deserialize(Decoder decoder) {
        ...
        if (!compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            while (true) {
                ...
                int iDecodeElementIndex = compositeDecoderBeginStructure.decodeElementIndex(monthBasedDateTimeUnitSerializer.getDescriptor());
                if (iDecodeElementIndex == -1) {
                    z = z2;
                    break;
                }
                if (iDecodeElementIndex == 0) {
                    iDecodeIntElement = compositeDecoderBeginStructure.decodeIntElement(monthBasedDateTimeUnitSerializer.getDescriptor(), 0);
                    z2 = true;
                } else {
        ...
        return new DateTimeUnit.MonthBased(iDecodeIntElement);
    }
}
