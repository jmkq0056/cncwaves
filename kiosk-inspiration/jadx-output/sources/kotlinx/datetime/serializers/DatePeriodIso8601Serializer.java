...
public final class DatePeriodIso8601Serializer implements KSerializer<DatePeriod> {
    ...
    public DatePeriod deserialize(Decoder decoder) {
        ...
        DateTimePeriod dateTimePeriod = DateTimePeriod.INSTANCE.parse(decoder.decodeString());
        if (dateTimePeriod instanceof DatePeriod) {
            return (DatePeriod) dateTimePeriod;
        }
        throw new SerializationException(dateTimePeriod + " is not a date-based period");
    }
