...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    /* JADX INFO: compiled from: Select.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.selects.SelectImplementation", f = "Select.kt", i = {}, l = {WinError.ERROR_CHECKING_FILE_SYSTEM}, m = "processResultAndInvokeBlockRecoveringException", n = {}, s = {})
    static final class C08101 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C08101(SelectImplementation<R> selectImplementation, Continuation<? super C08101> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    */
    public final java.lang.Object processResultAndInvokeBlockRecoveringException(kotlinx.coroutines.selects.SelectImplementation<R>.ClauseData r5, java.lang.Object r6, kotlin.coroutines.Continuation<? super R> r7) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r7 instanceof kotlinx.coroutines.selects.SelectImplementation.C08101
            if (r0 == 0) goto L14
            r0 = r7
            kotlinx.coroutines.selects.SelectImplementation$processResultAndInvokeBlockRecoveringException$1 r0 = (kotlinx.coroutines.selects.SelectImplementation.C08101) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
        ...
        L34:
            ...
            java.lang.Object r5 = r5.invokeBlock(r6, r0)     // Catch: java.lang.Throwable -> L2a
            if (r5 != r1) goto L44
            return r1
        L44:
            return r5
