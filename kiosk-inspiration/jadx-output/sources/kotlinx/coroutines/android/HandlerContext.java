...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    private final void cancelOnRejection(CoroutineContext context, Runnable block) {
        ...
        Dispatchers.getIO().mo2388dispatch(context, block);
    }
    ...
    public int hashCode() {
        return System.identityHashCode(this.handler) ^ (this.invokeImmediately ? WinError.ERROR_NETWORK_UNREACHABLE : WinError.ERROR_RETRY);
    }
