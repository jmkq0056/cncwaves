...
final class ReactiveSubscriber<T> implements Subscriber<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.reactive.ReactiveSubscriber", f = "ReactiveFlow.kt", i = {}, l = {WinError.ERROR_NO_VOLUME_LABEL}, m = "takeNextOrNull", n = {}, s = {})
    ...
    */
    public final java.lang.Object takeNextOrNull(kotlin.coroutines.Continuation<? super T> r5) throws java.lang.Throwable {
        ...
        L38:
            ...
            r0.label = r3
            java.lang.Object r5 = r5.mo2336receiveCatchingJP2dKIU(r0)
            if (r5 != r1) goto L46
            return r1
        L46:
            java.lang.Throwable r0 = kotlinx.coroutines.channels.ChannelResult.m2347exceptionOrNullimpl(r5)
            if (r0 != 0) goto L55
            boolean r0 = r5 instanceof kotlinx.coroutines.channels.ChannelResult.Failed
            if (r0 == 0) goto L54
            kotlinx.coroutines.channels.ChannelResult.m2347exceptionOrNullimpl(r5)
            r5 = 0
        L54:
            return r5
        L55:
    ...
    public void onNext(T value) {
        if (!ChannelResult.m2353isSuccessimpl(this.channel.mo2332trySendJP2dKIU(value))) {
