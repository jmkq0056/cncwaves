...
public final class SubscribedFlowCollector<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.SubscribedFlowCollector", f = "Share.kt", i = {0, 0}, l = {HttpStatus.SC_UNSUPPORTED_MEDIA_TYPE, HttpStatus.SC_INSUFFICIENT_SPACE_ON_RESOURCE}, m = "onSubscription", n = {"this", "safeCollector"}, s = {"L$0", "L$1"})
