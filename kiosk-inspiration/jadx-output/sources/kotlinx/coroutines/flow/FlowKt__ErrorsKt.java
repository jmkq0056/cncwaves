...
public final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt", f = "Errors.kt", i = {0}, l = {WinError.ERROR_TOO_MANY_MUXWAITERS}, m = "catchImpl", n = {"fromDownstream"}, s = {"L$0"})
    ...
    static final class C07821 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C07821) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$3", f = "Errors.kt", i = {}, l = {WinUser.SM_MOUSEHORIZONTALWHEELPRESENT}, m = "invokeSuspend", n = {}, s = {})
    ...
    */
    ...
    public static final <T> Flow<T> m2372catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
