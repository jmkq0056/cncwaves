    ...
    public boolean tryEmit(T value) {
        ...
        for (Continuation<Unit> continuation : continuationArrFindSlotsToResumeLocked) {
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m817constructorimpl(Unit.INSTANCE));
            }
        }
        return z;
    }
        ...
        synchronized (this) {
            try {
                if (tryEmitLocked(t)) {
                    try {
                        Result.Companion companion = Result.INSTANCE;
                        cancellableContinuationImpl2.resumeWith(Result.m817constructorimpl(Unit.INSTANCE));
                    ...
                    try {
                        Emitter emitter2 = new Emitter(this, getHead() + ((long) getTotalSize()), t, cancellableContinuationImpl2);
                ...
                for (Continuation<Unit> continuation2 : continuationArrFindSlotsToResumeLocked) {
                    if (continuation2 != null) {
                        ...
                        continuation2.resumeWith(Result.m817constructorimpl(Unit.INSTANCE));
                    }
                }
