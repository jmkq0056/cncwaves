    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) {
        ...
        L19:
            ...
            kotlin.ResultKt.throwOnFailure(r10)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L2c
            goto L63
        L2c:
            r10 = move-exception
            goto L60
        ...
        L36:
            ...
            r2.<init>()
            kotlinx.coroutines.flow.Flow r4 = r8.$this_take$inlined     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L5c
            kotlinx.coroutines.flow.FlowKt__LimitKt$take$2$1 r5 = new kotlinx.coroutines.flow.FlowKt__LimitKt$take$2$1     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L5c
            int r6 = r8.$count$inlined     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L5c
            r5.<init>(r2, r6, r9, r10)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L5c
            kotlinx.coroutines.flow.FlowCollector r5 = (kotlinx.coroutines.flow.FlowCollector) r5     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L5c
            r0.L$0 = r10     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L5c
            r0.label = r3     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L5c
            java.lang.Object r9 = r4.collect(r5, r0)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L5c
            if (r9 != r1) goto L63
            return r1
        L5c:
            r9 = move-exception
