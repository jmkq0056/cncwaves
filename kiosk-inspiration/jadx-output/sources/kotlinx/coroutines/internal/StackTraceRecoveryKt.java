...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM817constructorimpl = Result.m817constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m820exceptionOrNullimpl(objM817constructorimpl) == null) {
            obj2 = objM817constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM817constructorimpl2 = Result.m817constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM817constructorimpl2 = Result.m817constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m820exceptionOrNullimpl(objM817constructorimpl2) == null) {
