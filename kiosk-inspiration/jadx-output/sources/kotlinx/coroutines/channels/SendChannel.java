...
public interface SendChannel<E> {
    ...
    void mo2401invokeOnClose(Function1<? super Throwable, Unit> handler);
    ...
    Object mo2332trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object objMo2332trySendJP2dKIU = sendChannel.mo2332trySendJP2dKIU(e);
            if (ChannelResult.m2353isSuccessimpl(objMo2332trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2347exceptionOrNullimpl = ChannelResult.m2347exceptionOrNullimpl(objMo2332trySendJP2dKIU);
