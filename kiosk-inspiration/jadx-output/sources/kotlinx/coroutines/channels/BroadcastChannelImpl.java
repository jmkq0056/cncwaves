...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    subscriberConflated.mo2332trySendJP2dKIU(getValue());
                }
    ...
    */
    ...
    public Object mo2332trySendJP2dKIU(E element) {
        ...
        try {
            if (isClosedForSend()) {
                return super.mo2332trySendJP2dKIU(element);
            }
            List<? extends BufferedChannel<E>> list = this.subscribers;
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo2332trySendJP2dKIU(element);
            }
    ...
    @DebugMetadata(c = "kotlinx.coroutines.channels.BroadcastChannelImpl$registerSelectForSend$2", f = "BroadcastChannel.kt", i = {}, l = {WinError.ERROR_NOT_OWNER}, m = "invokeSuspend", n = {}, s = {})
