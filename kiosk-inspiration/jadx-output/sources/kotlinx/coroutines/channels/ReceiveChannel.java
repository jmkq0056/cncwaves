...
public interface ReceiveChannel<E> {
    ...
    Object mo2336receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo2337tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2337tryReceivePtdJZtk = receiveChannel.mo2337tryReceivePtdJZtk();
            if (ChannelResult.m2353isSuccessimpl(objMo2337tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2349getOrThrowimpl(objMo2337tryReceivePtdJZtk);
            }
            Throwable thM2347exceptionOrNullimpl = ChannelResult.m2347exceptionOrNullimpl(objMo2337tryReceivePtdJZtk);
            if (thM2347exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2347exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo2336receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m2348getOrNullimpl(r4)
                return r4
            */
