...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.get$context()).mo2389scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2320delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2321toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2321toDelayMillisLRDsOJo(long j) {
        boolean zM2206isPositiveimpl = Duration.m2206isPositiveimpl(j);
        if (zM2206isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m2190getInWholeMillisecondsimpl(Duration.m2208plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM2206isPositiveimpl) {
