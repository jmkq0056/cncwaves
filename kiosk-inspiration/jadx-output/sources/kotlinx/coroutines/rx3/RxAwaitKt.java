...
public final class RxAwaitKt {
    ...
    /* JADX INFO: compiled from: RxAwait.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.rx3.RxAwaitKt", f = "RxAwait.kt", i = {0}, l = {WinError.ERROR_SEM_OWNER_DIED}, m = "awaitOrDefault", n = {"default"}, s = {"L$0"})
    static final class C08031<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C08041<T> extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
    ...
    */
    public static final <T> java.lang.Object awaitSingle(io.reactivex.rxjava3.core.MaybeSource<T> r4, kotlin.coroutines.Continuation<? super T> r5) {
        /*
            boolean r0 = r5 instanceof kotlinx.coroutines.rx3.RxAwaitKt.C08041
            if (r0 == 0) goto L14
            r0 = r5
            kotlinx.coroutines.rx3.RxAwaitKt$awaitSingle$1 r0 = (kotlinx.coroutines.rx3.RxAwaitKt.C08041) r0
            int r1 = r0.label
    ...
    */
    public static final /* synthetic */ java.lang.Object awaitOrDefault(io.reactivex.rxjava3.core.MaybeSource r4, java.lang.Object r5, kotlin.coroutines.Continuation r6) {
        /*
            boolean r0 = r6 instanceof kotlinx.coroutines.rx3.RxAwaitKt.C08031
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.rx3.RxAwaitKt$awaitOrDefault$1 r0 = (kotlinx.coroutines.rx3.RxAwaitKt.C08031) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    public static final Object await(CompletableSource completableSource, Continuation<? super Unit> continuation) {
        ...
        completableSource.subscribe(new CompletableObserver() { // from class: kotlinx.coroutines.rx3.RxAwaitKt$await$2$1
            ...
            public void onComplete() {
                ...
                cancellableContinuation.resumeWith(Result.m817constructorimpl(Unit.INSTANCE));
            }
    ...
    public static final <T> Object awaitSingleOrNull(MaybeSource<T> maybeSource, Continuation<? super T> continuation) {
        ...
        maybeSource.subscribe(new MaybeObserver<T>() { // from class: kotlinx.coroutines.rx3.RxAwaitKt$awaitSingleOrNull$2$1
            ...
            public void onError(Throwable error) {
                CancellableContinuation<T> cancellableContinuation = cancellableContinuationImpl2;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m817constructorimpl(ResultKt.createFailure(error)));
            }
        });
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
        ...
        observableSource.subscribe(new Observer<T>() { // from class: kotlinx.coroutines.rx3.RxAwaitKt$awaitOne$2$1
            ...
            public void onNext(T t2) {
                ...
                if (i == 1 || i == 2) {
                    ...
                    CancellableContinuation<T> cancellableContinuation = cancellableContinuationImpl2;
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuation.resumeWith(Result.m817constructorimpl(t2));
                ...
                if (i == 3 || i == 4) {
                    if (mode == Mode.SINGLE && this.seenValue) {
                        if (cancellableContinuationImpl2.isActive()) {
                            ...
                            cancellableContinuation2.resumeWith(Result.m817constructorimpl(ResultKt.createFailure(new IllegalArgumentException("More than one onNext value for " + mode))));
                        }
            ...
            public void onComplete() {
                if (this.seenValue) {
                    if (cancellableContinuationImpl2.isActive()) {
                        CancellableContinuation<T> cancellableContinuation = cancellableContinuationImpl2;
                        Result.Companion companion = Result.INSTANCE;
                        cancellableContinuation.resumeWith(Result.m817constructorimpl(this.value));
                        return;
                    }
                    return;
                }
                if (mode == Mode.FIRST_OR_DEFAULT) {
                    CancellableContinuation<T> cancellableContinuation2 = cancellableContinuationImpl2;
                    Result.Companion companion2 = Result.INSTANCE;
                    cancellableContinuation2.resumeWith(Result.m817constructorimpl(t));
                    ...
                    cancellableContinuation3.resumeWith(Result.m817constructorimpl(ResultKt.createFailure(new NoSuchElementException("No value received via onNext for " + mode))));
                }
            }
