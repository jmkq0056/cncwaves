...
final class RxObservableCoroutine<T> extends AbstractCoroutine<Unit> implements ProducerScope<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.rx3.RxObservableCoroutine", f = "RxObservable.kt", i = {0, 0}, l = {WinError.ERROR_NO_MORE_SEARCH_HANDLES}, m = "send", n = {"this", "element"}, s = {"L$0", "L$1"})
    static final class C08091 extends ContinuationImpl {
        ...
        C08091(RxObservableCoroutine<T> rxObservableCoroutine, Continuation<? super C08091> continuation) {
            super(continuation);
    ...
    public /* bridge */ /* synthetic */ void mo2401invokeOnClose(Function1 function1) {
    ...
    public Object mo2332trySendJP2dKIU(T element) {
        if (!Mutex.DefaultImpls.tryLock$default(this.mutex, null, 1, null)) {
        ...
        return ChannelResult.INSTANCE.m2356closedJP2dKIU(thDoLockedNext);
    }
    ...
    */
    public java.lang.Object send(T r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r6 instanceof kotlinx.coroutines.rx3.RxObservableCoroutine.C08091
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.rx3.RxObservableCoroutine$send$1 r0 = (kotlinx.coroutines.rx3.RxObservableCoroutine.C08091) r0
            int r1 = r0.label
