    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i2 < i) {
            if (((jArr2[i2 >> 3] >> ((i2 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableFloatFloatMap.findFirstAvailableSlot(i3 >>> 7);
                long j = i3 & 127;
                long[] jArr3 = mutableFloatFloatMap.metadata;
                int i4 = iFindFirstAvailableSlot >> 3;
                int i5 = (iFindFirstAvailableSlot & 7) << 3;
                jArr3[i4] = (jArr3[i4] & (~(255 << i5))) | (j << i5);
                int i6 = mutableFloatFloatMap._capacity;
                ...
                fArr4[iFindFirstAvailableSlot] = fArr2[i2];
            } else {
                jArr = jArr2;
            }
            i2++;
