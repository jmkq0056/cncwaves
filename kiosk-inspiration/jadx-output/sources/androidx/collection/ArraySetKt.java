    ...
    public static final <E> E removeAtInternal(ArraySet<E> arraySet, int i) {
        ...
        if (arraySet.getHashes().length > 8 && arraySet.get_size$collection() < arraySet.getHashes().length / 3) {
            ...
            if (i > 0) {
                ...
                objArr = array;
                ArraysKt.copyInto$default(objArr, arraySet.getArray(), 0, 0, i, 6, (Object) null);
                i2 = i;
            } else {
                i2 = i;
                objArr = array;
            ...
            if (i2 < i4) {
                int i6 = i2 + 1;
                ArraysKt.copyInto(hashes, arraySet.getHashes(), i2, i6, i3);
                ArraysKt.copyInto(objArr, arraySet.getArray(), i2, i6, i3);
            }
        } else {
            if (i < i4) {
                int i7 = i + 1;
                ArraysKt.copyInto(arraySet.getHashes(), arraySet.getHashes(), i, i7, i3);
                ArraysKt.copyInto(arraySet.getArray(), arraySet.getArray(), i, i7, i3);
            }
            arraySet.getArray()[i4] = null;
        }
