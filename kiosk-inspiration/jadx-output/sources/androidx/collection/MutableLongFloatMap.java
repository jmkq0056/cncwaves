    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i2 < i) {
            if (((jArr2[i2 >> 3] >> ((i2 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableLongFloatMap.findFirstAvailableSlot(i3 >>> 7);
                long j2 = i3 & 127;
