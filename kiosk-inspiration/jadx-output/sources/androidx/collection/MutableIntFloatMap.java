    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i2 < i) {
            if (((jArr2[i2 >> 3] >> ((i2 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableIntFloatMap.findFirstAvailableSlot(i4 >>> 7);
                long j = i4 & 127;
                ...
                int i7 = mutableIntFloatMap._capacity;
