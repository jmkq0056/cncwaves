    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i2 < i) {
            if (((jArr2[i2 >> 3] >> ((i2 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableIntLongMap.findFirstAvailableSlot(i4 >>> 7);
                long j = i4 & 127;
                long[] jArr5 = mutableIntLongMap.metadata;
                int i5 = iFindFirstAvailableSlot >> 3;
                int i6 = (iFindFirstAvailableSlot & 7) << 3;
                jArr5[i5] = (jArr5[i5] & (~(255 << i6))) | (j << i6);
                int i7 = mutableIntLongMap._capacity;
