    ...
    */
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            StringBuilder sbAppend = new StringBuilder("Keyframe ").append(i).append(": fraction ");
            float fraction = keyframe.getFraction();
            Object value = AbstractJsonLexerKt.NULL;
            StringBuilder sbAppend2 = sbAppend.append(fraction < 0.0f ? AbstractJsonLexerKt.NULL : Float.valueOf(keyframe.getFraction())).append(", , value : ");
            if (keyframe.hasValue()) {
                value = keyframe.getValue();
            }
            Log.d(TAG, sbAppend2.append(value).toString());
        }
    }
