...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    */
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:47:0x00de A[PHI: r1
      0x00de: PHI (r1v45 int) = (r1v26 int), (r1v49 int) binds: [B:41:0x00c7, B:45:0x00da] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    int i5 = RecyclerView.this.mReusableIntPair[0];
                    int i6 = RecyclerView.this.mReusableIntPair[1];
                    i3 -= i5;
                    i4 -= i6;
                    ...
                    if (smoothScroller != null && !smoothScroller.isPendingInitialRun() && smoothScroller.isRunning()) {
                        ...
                        if (itemCount == 0) {
                            ...
                            smoothScroller.onAnimation(i5, i6);
                        } else {
                            smoothScroller.onAnimation(i5, i6);
                        }
                    }
                ...
                recyclerView3.dispatchNestedScroll(i, i2, i7, i8, null, 1, recyclerView3.mReusableIntPair);
        ...
        */
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z) {
            ...
            if (!z && (viewFindHiddenNonRemovedView = RecyclerView.this.mChildHelper.findHiddenNonRemovedView(i)) != null) {
                ...
                childViewHolderInt.addFlags(WinError.ERROR_DS_OPERATIONS_ERROR);
                return childViewHolderInt;
            }
