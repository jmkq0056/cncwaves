...
public final class SharedPreferencesMigrationKt {
    ...
    static final class C01061 extends SuspendLambda implements Function2<Preferences, Continuation<? super Boolean>, Object> {
        final /* synthetic */ Set<String> $keysToMigrate;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01061(Set<String> set, Continuation<? super C01061> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01061 c01061 = new C01061(this.$keysToMigrate, continuation);
            c01061.L$0 = obj;
            return c01061;
        }
        ...
        public final Object invoke(Preferences preferences, Continuation<? super Boolean> continuation) {
            return ((C01061) create(preferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }
