    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder sb, int i) {
        ...
        for (String str : treeSet) {
            ...
            if (strReplaceFirst.endsWith(LIST_SUFFIX) && !strReplaceFirst.endsWith(BUILDER_LIST_SUFFIX) && !strReplaceFirst.equals(LIST_SUFFIX)) {
                String str2 = strReplaceFirst.substring(0, 1).toLowerCase() + strReplaceFirst.substring(1, strReplaceFirst.length() - LIST_SUFFIX.length());
            ...
            if (strReplaceFirst.endsWith(MAP_SUFFIX) && !strReplaceFirst.equals(MAP_SUFFIX)) {
                String str3 = strReplaceFirst.substring(0, 1).toLowerCase() + strReplaceFirst.substring(1, strReplaceFirst.length() - MAP_SUFFIX.length());
            ...
            if (((java.lang.reflect.Method) map2.get("set" + strReplaceFirst)) != null && (!strReplaceFirst.endsWith(BYTES_SUFFIX) || !map.containsKey("get" + strReplaceFirst.substring(0, strReplaceFirst.length() - BYTES_SUFFIX.length())))) {
