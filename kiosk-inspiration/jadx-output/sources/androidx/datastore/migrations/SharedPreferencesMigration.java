...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    @DebugMetadata(c = "androidx.datastore.migrations.SharedPreferencesMigration", f = "SharedPreferencesMigration.kt", i = {0}, l = {WinError.ERROR_IS_JOIN_PATH}, m = "shouldMigrate", n = {"this"}, s = {"L$0"})
    static final class C01051 extends ContinuationImpl {
        ...
        C01051(SharedPreferencesMigration<T> sharedPreferencesMigration, Continuation<? super C01051> continuation) {
            super(continuation);
    ...
    */
    public java.lang.Object shouldMigrate(T r5, kotlin.coroutines.Continuation<? super java.lang.Boolean> r6) {
        /*
            r4 = this;
            boolean r0 = r6 instanceof androidx.datastore.migrations.SharedPreferencesMigration.C01051
            if (r0 == 0) goto L14
            r0 = r6
            androidx.datastore.migrations.SharedPreferencesMigration$shouldMigrate$1 r0 = (androidx.datastore.migrations.SharedPreferencesMigration.C01051) r0
            int r1 = r0.label
