...
@DebugMetadata(c = "androidx.datastore.core.SingleProcessDataStore$data$1", f = "SingleProcessDataStore.kt", i = {}, l = {WinError.ERROR_INVALID_CATEGORY}, m = "invokeSuspend", n = {}, s = {})
        ...
        if (i == 0) {
            ...
            if (FlowKt.emitAll(flowCollector, new Flow<T>() { // from class: androidx.datastore.core.SingleProcessDataStore$data$1$invokeSuspend$$inlined$map$1
                ...
                public static final class AnonymousClass2 implements FlowCollector<State<T>> {
                    ...
                    @DebugMetadata(c = "androidx.datastore.core.SingleProcessDataStore$data$1$invokeSuspend$$inlined$map$1$2", f = "SingleProcessDataStore.kt", i = {}, l = {WinError.ERROR_NOT_SUBSTED}, m = "emit", n = {}, s = {})
