            ...
            public final void invoke2(X x) {
                ...
                if (objectRef.element != r4) {
                    if (objectRef.element != 0) {
                        ...
                        mediatorLiveData2.removeSource((LiveData<S>) ((LiveData) t));
                    }
                    ...
                    if (objectRef.element != 0) {
                        ...
                        mediatorLiveData3.addSource((LiveData<S>) ((LiveData) t2), new Transformations$sam$androidx_lifecycle_Observer$0(new Function1<Y, Unit>() { // from class: androidx.lifecycle.Transformations.switchMap.1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
