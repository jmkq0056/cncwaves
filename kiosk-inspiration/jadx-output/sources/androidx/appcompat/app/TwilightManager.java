...
class TwilightManager {
    ...
    private void updateState(Location location) {
        ...
        twilightCalculator.calculateTwilight(jCurrentTimeMillis - DefaultOfflineDatabaseReaper.REAPER_TASK_INTERVAL_MS, location.getLatitude(), location.getLongitude());
        ...
        if (j2 == -1 || j3 == -1) {
            ...
            j = j2 + StripeHealthCheckerDefaultConfig.ONLINE_STABLE_RETRY_DELAY_MS;
        }
