...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        if (str == null || str.isEmpty() || TlbConst.TYPELIB_MINOR_VERSION_SHELL.equals(str)) {
            return null;
        }
        try {
            int i = Integer.parseInt(str);
            String str2 = "android.resource://" + this.mProviderContext.getPackageName() + RemoteSettings.FORWARD_SLASH_STRING + i;
