    ...
    private void onMeasureExactFormat(int i, int i2) {
            ...
            while (i22 < childCount) {
                ...
                if ((j3 & j4) == 0) {
                    ...
                    if (!z8 || !layoutParams3.preventEdgeOffset) {
                        ...
                        z = true;
                        i4 = i22;
                        childAt2.setPadding(i23 + i17, 0, i23, 0);
                    } else {
                        i4 = i22;
                        z = true;
                    }
        ...
        if (i8 <= 0 || j2 == 0 || (i8 >= i12 - 1 && !z9 && iMax2 <= 1)) {
            ...
            if (z9) {
                ...
                if ((j2 & ((long) (1 << i24))) != 0 && !((LayoutParams) getChildAt(i24).getLayoutParams()).preventEdgeOffset) {
                    fBitCount -= 0.5f;
                }
            }
            int i25 = fBitCount > 0.0f ? (int) ((i8 * i17) / fBitCount) : i3;
            boolean z10 = z6;
