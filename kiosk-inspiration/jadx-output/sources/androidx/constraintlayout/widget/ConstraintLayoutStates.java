...
public class ConstraintLayoutStates {
    ...
    private void parseConstraintSet(Context context, XmlPullParser xmlPullParser) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (attributeName != null && attributeValue != null && OfflineStorageConstantsKt.ID.equals(attributeName)) {
                int identifier = attributeValue.contains(RemoteSettings.FORWARD_SLASH_STRING) ? context.getResources().getIdentifier(attributeValue.substring(attributeValue.indexOf(47) + 1), OfflineStorageConstantsKt.ID, context.getPackageName()) : -1;
                if (identifier == -1) {
