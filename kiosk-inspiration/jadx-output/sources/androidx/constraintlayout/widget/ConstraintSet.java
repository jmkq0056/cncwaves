    ...
    */
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            Constraint constraint = constraintSet.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m40clone());
            }
        }
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void removeFromVerticalChain(int r11) {
        /*
            r10 = this;
            java.util.HashMap<java.lang.Integer, androidx.constraintlayout.widget.ConstraintSet$Constraint> r0 = r10.mConstraints
    ...
    */
    ...
    private int[] convertReferenceString(View view, String str) {
        ...
        while (i < strArrSplit.length) {
            ...
            if (iIntValue == 0) {
                iIntValue = context.getResources().getIdentifier(strTrim, OfflineStorageConstantsKt.ID, context.getPackageName());
            }
    ...
    class WriteJsonEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                Layout layout = constraint.layout;
                writeDimension(PrinterTextParser.ATTR_BARCODE_HEIGHT, layout.mHeight, layout.heightDefault, layout.heightPercent, layout.heightMin, layout.heightMax, layout.constrainedHeight);
                writeDimension(PrinterTextParser.ATTR_BARCODE_WIDTH, layout.mWidth, layout.widthDefault, layout.widthPercent, layout.widthMin, layout.widthMax, layout.constrainedWidth);
