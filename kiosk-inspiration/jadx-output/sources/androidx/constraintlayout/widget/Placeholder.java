...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            canvas.drawRGB(WinError.ERROR_FILE_TOO_LARGE, WinError.ERROR_FILE_TOO_LARGE, WinError.ERROR_FILE_TOO_LARGE);
            Paint paint = new Paint();
            paint.setARGB(255, WinError.ERROR_THREAD_1_INACTIVE, WinError.ERROR_THREAD_1_INACTIVE, WinError.ERROR_THREAD_1_INACTIVE);
