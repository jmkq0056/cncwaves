...
public class Transition implements TypedValues {
    ...
    static class OnSwipe {
        ...
        */
        float getDestinationPosition(float r6, float r7, float r8) {
            /*
                r5 = this;
                ...
                float r8 = r8 * r0
                float r8 = r8 * r7
                float r7 = r5.mMaxAcceleration
                float r8 = r8 / r7
                float r8 = r8 + r6
                int r7 = r5.mOnTouchUp
                r1 = 0
            ...
            L32:
                return r1
            L33:
                float r6 = java.lang.Math.min(r2, r8)
            ...
            L4a:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.state.Transition.OnSwipe.getDestinationPosition(float, float, float):float");
        }
    ...
    public float[] getPath(String str) {
        WidgetState widgetState = this.mState.get(str);
        float[] fArr = new float[WinError.ERROR_INVALID_LEVEL];
