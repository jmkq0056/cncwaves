...
public class ConstraintWidget {
    ...
    public StringBuilder serialize(StringBuilder sb) {
        ...
        serializeSize(sb, PrinterTextParser.ATTR_BARCODE_WIDTH, this.mWidth, this.mMinWidth, this.mMaxDimension[0], this.mWidthOverride, this.mMatchConstraintMinWidth, this.mMatchConstraintDefaultWidth, this.mMatchConstraintPercentWidth, this.mWeight[0]);
        serializeSize(sb, PrinterTextParser.ATTR_BARCODE_HEIGHT, this.mHeight, this.mMinHeight, this.mMaxDimension[1], this.mHeightOverride, this.mMatchConstraintMinHeight, this.mMatchConstraintDefaultHeight, this.mMatchConstraintPercentHeight, this.mWeight[1]);
