...
public class ViewTransition {
    ...
    /* JADX WARN: Removed duplicated region for block: B:32:0x0093 A[Catch: IOException -> 0x00d1, XmlPullParserException -> 0x00d6, TryCatch #2 {IOException -> 0x00d1, XmlPullParserException -> 0x00d6, blocks: (B:3:0x002a, B:33:0x00cb, B:11:0x0039, B:14:0x0045, B:15:0x004d, B:32:0x0093, B:17:0x0051, B:22:0x0062, B:20:0x005a, B:23:0x006a, B:25:0x0070, B:26:0x0074, B:28:0x007c, B:29:0x0084, B:31:0x008c), top: B:40:0x002a }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ViewTransition(android.content.Context r6, org.xmlpull.v1.XmlPullParser r7) {
        /*
    ...
    /* synthetic */ void m38x14d7500(View[] viewArr) {
        if (this.mSetsTag != -1) {
            for (View view : viewArr) {
    ...
    private void updateTransition(MotionScene.Transition transition, View view) {
        ...
        if (keyFrames != null) {
            ...
            while (it.hasNext()) {
                keyFrames2.addKey(it.next().mo37clone().setViewId(id));
            }
