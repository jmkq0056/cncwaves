...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    void setState(TransitionState transitionState) {
        ...
        int iOrdinal = transitionState2.ordinal();
        ...
        if (iOrdinal == 2 && transitionState == TransitionState.FINISHED) {
            fireTransitionCompleted();
        }
    }
    ...
    */
    ...
    class Model {
        ...
        void copy(ConstraintWidgetContainer constraintWidgetContainer, ConstraintWidgetContainer constraintWidgetContainer2) {
            ...
            for (ConstraintWidget constraintWidget3 : children) {
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            if (constraintWidget.mTop.mTarget != null) {
                strConcat = "T".concat(constraintWidget.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? "T" : "B");
            } else {
                strConcat = "__";
            }
            StringBuilder sbAppend = new StringBuilder().append(sb.append(strConcat).toString());
            if (constraintWidget.mBottom.mTarget != null) {
                strConcat2 = "B".concat(constraintWidget.mBottom.mTarget.mType != ConstraintAnchor.Type.TOP ? "B" : "T");
            } else {
                strConcat2 = "__";
            }
            StringBuilder sbAppend2 = new StringBuilder().append(sbAppend.append(strConcat2).toString());
            ConstraintAnchor constraintAnchor = constraintWidget.mLeft.mTarget;
            String str2 = PrinterTextParser.TAGS_ALIGN_LEFT;
            if (constraintAnchor != null) {
                strConcat3 = PrinterTextParser.TAGS_ALIGN_LEFT.concat(constraintWidget.mLeft.mTarget.mType == ConstraintAnchor.Type.LEFT ? PrinterTextParser.TAGS_ALIGN_LEFT : PrinterTextParser.TAGS_ALIGN_RIGHT);
            } else {
                strConcat3 = "__";
            }
            StringBuilder sbAppend3 = new StringBuilder().append(sbAppend2.append(strConcat3).toString());
            if (constraintWidget.mRight.mTarget != null) {
                if (constraintWidget.mRight.mTarget.mType != ConstraintAnchor.Type.LEFT) {
                    str2 = PrinterTextParser.TAGS_ALIGN_RIGHT;
                }
                strConcat4 = PrinterTextParser.TAGS_ALIGN_RIGHT.concat(str2);
            }
            Log.v(MotionLayout.TAG, str + sbAppend3.append(strConcat4).toString() + " ---  " + constraintWidget);
        }
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str4 = (((constraintWidget.mTop.mTarget != null ? "T" : "_") + (constraintWidget.mBottom.mTarget != null ? "B" : "_")) + (constraintWidget.mLeft.mTarget != null ? PrinterTextParser.TAGS_ALIGN_LEFT : "_")) + (constraintWidget.mRight.mTarget != null ? PrinterTextParser.TAGS_ALIGN_RIGHT : "_");
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if ((this.mDebugPath & 1) == 1 && !isInEditMode()) {
            ...
            StringBuilder sbAppend = new StringBuilder().append(this.mLastFps + " fps " + Debug.getState(this, this.mBeginState) + " -> ").append(Debug.getState(this, this.mEndState)).append(" (progress: ").append(((int) (getProgress() * 1000.0f)) / 10.0f).append(" ) state=");
            int i = this.mCurrentState;
            String string = sbAppend.append(i == -1 ? "undefined" : Debug.getState(this, i)).toString();
    ...
    */
    ...
    @Override // androidx.constraintlayout.widget.ConstraintLayout, android.view.ViewGroup, android.view.View
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) throws Throwable {
