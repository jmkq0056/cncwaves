...
public class MotionController {
    ...
    void buildPath(float[] fArr, int i) {
        ...
        while (i2 < i) {
            ...
            if (viewOscillator != null) {
                fArr[i3] = fArr[i3] + viewOscillator.get(fMin);
            } else if (viewSpline != null) {
                fArr[i3] = fArr[i3] + viewSpline.get(fMin);
            }
            if (viewOscillator2 != null) {
                int i4 = i3 + 1;
                fArr[i4] = fArr[i4] + viewOscillator2.get(fMin);
            } else if (viewSpline2 != null) {
                int i5 = i3 + 1;
                fArr[i5] = fArr[i5] + viewSpline2.get(fMin);
            }
            i2++;
            f = 1.0f;
        }
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        for (String str7 : this.mEndMotionPath.mAttributes.keySet()) {
            if (this.mStartMotionPath.mAttributes.containsKey(str7) && !hashSet2.contains("CUSTOM," + str7)) {
                hashSet4.add(str7);
            }
        }
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (motionPathsArr[i7].mAttributes.containsKey(str8) && (constraintAttribute = motionPathsArr[i7].mAttributes.get(str8)) != null) {
        ...
        while (true) {
            ...
            if (iArr2[i14] < MotionPaths.sNames.length) {
                String str9 = MotionPaths.sNames[this.mInterpolateVariables[i14]] + " [";
            ...
            while (i17 < i4) {
                if (motionPathsArr[i17].hasCustomData(str10)) {
                    if (dArr4 == null) {
                        dArr3 = new double[i4];
                        int[] iArr3 = new int[2];
                        iArr3[c2] = motionPathsArr[i17].getCustomDataCount(str10);
                        iArr3[0] = i4;
                    ...
                    motionPathsArr[i3].getCustomData(str10, dArr4[i18], 0);
                    i18++;
                } else {
                    c = c2;
                    i3 = i17;
    ...
    boolean interpolate(View view, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            if (pathRotate != null) {
                ...
                adjustedPosition = f7;
                pathRotate2 = pathRotate.setPathRotate(view2, keyCache, f7, j, dArr3[0], dArr3[1]) | pathRotate2;
            } else {
                view2 = view;
            }
            int i = 1;
            ...
            view2 = view;
            float f8 = this.mStartMotionPath.mX + ((this.mEndMotionPath.mX - this.mStartMotionPath.mX) * adjustedPosition);
            float f9 = f8 + 0.5f;
            int i3 = (int) f9;
            float f10 = this.mStartMotionPath.mY + ((this.mEndMotionPath.mY - this.mStartMotionPath.mY) * adjustedPosition) + 0.5f;
            int i4 = (int) f10;
            int i5 = (int) (f9 + this.mStartMotionPath.mWidth + ((this.mEndMotionPath.mWidth - this.mStartMotionPath.mWidth) * adjustedPosition));
            int i6 = (int) (f10 + this.mStartMotionPath.mHeight + ((this.mEndMotionPath.mHeight - this.mStartMotionPath.mHeight) * adjustedPosition));
            int i7 = i5 - i3;
            int i8 = i6 - i4;
