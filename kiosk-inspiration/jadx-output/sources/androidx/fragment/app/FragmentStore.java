...
class FragmentStore {
    ...
    FragmentState getSavedState(String str) {
        return this.mSavedState.get(str);
    }

    FragmentState setSavedState(String str, FragmentState fragmentState) {
    ...
    void restoreSaveState(ArrayList<FragmentState> arrayList) {
