...
public final class SizeFCompat {
    ...
    public SizeFCompat(float f, float f2) {
        this.mWidth = Preconditions.checkArgumentFinite(f, PrinterTextParser.ATTR_BARCODE_WIDTH);
        this.mHeight = Preconditions.checkArgumentFinite(f2, PrinterTextParser.ATTR_BARCODE_HEIGHT);
    }
