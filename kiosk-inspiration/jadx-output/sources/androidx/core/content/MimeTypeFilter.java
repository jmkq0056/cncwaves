...
public final class MimeTypeFilter {
    ...
    public static String matches(String str, String[] strArr) {
        ...
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(strArrSplit, str2.split(RemoteSettings.FORWARD_SLASH_STRING))) {
                return str2;
            }
        }
        return null;
    ...
    public static String matches(String[] strArr, String str) {
        ...
        String[] strArrSplit = str.split(RemoteSettings.FORWARD_SLASH_STRING);
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(str2.split(RemoteSettings.FORWARD_SLASH_STRING), strArrSplit)) {
                return str2;
            }
        }
        return null;
