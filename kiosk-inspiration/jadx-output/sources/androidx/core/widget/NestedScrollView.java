...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    */
    ...
    private int scrollBy(int i, int i2, int i3, boolean z) {
        ...
        iArr[1] = 0;
        dispatchNestedScroll(0, scrollY2, 0, i7 - scrollY2, this.mScrollOffset, i3, iArr);
        int i8 = i5 + this.mScrollOffset[1];
        int i9 = i7 - this.mScrollConsumed[1];
        int i10 = scrollY + i9;
        if (i10 < 0) {
            if (z3) {
                EdgeEffectCompat.onPullDistance(this.mEdgeGlowTop, (-i9) / getHeight(), i2 / getWidth());
                if (!this.mEdgeGlowBottom.isFinished()) {
                    this.mEdgeGlowBottom.onRelease();
                }
            }
        } else if (i10 > scrollRange && z3) {
            EdgeEffectCompat.onPullDistance(this.mEdgeGlowBottom, i9 / getHeight(), 1.0f - (i2 / getWidth()));
