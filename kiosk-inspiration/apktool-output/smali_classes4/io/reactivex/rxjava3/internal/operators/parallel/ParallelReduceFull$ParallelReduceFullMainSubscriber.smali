...
.method constructor <init>(Lorg/reactivestreams/Subscriber;ILio/reactivex/rxjava3/functions/BiFunction;)V
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;->current:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;->remaining:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;->error:Lio/reactivex/rxjava3/internal/util/AtomicThrowable;

    .line 71
    new-array p1, p2, [Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullInnerSubscriber;
    ...
    .line 73
    new-instance v1, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullInnerSubscriber;

    invoke-direct {v1, p0, p3}, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullInnerSubscriber;-><init>(Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;Lio/reactivex/rxjava3/functions/BiFunction;)V
    ...
    .line 75
    :cond_0
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;->subscribers:[Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullInnerSubscriber;
    ...
    .line 77
    iget-object p1, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;->remaining:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method addValue(Ljava/lang/Object;)Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$SlotPair;
    ...
    .line 85
    new-instance v0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$SlotPair;

    invoke-direct {v0}, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$SlotPair;-><init>()V
    ...
    .line 91
    :cond_0
    invoke-virtual {v0}, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$SlotPair;->tryAcquireSlot()I
    ...
    .line 102
    :goto_1
    invoke-virtual {v0}, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$SlotPair;->releaseSlot()Z
    ...
    .line 103
    iget-object p1, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;->current:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public cancel()V
    ...
    .line 113
    invoke-virtual {v3}, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullInnerSubscriber;->cancel()V
...
.method innerComplete(Ljava/lang/Object;)V
    ...
    .line 136
    :try_start_0
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;->reducer:Lio/reactivex/rxjava3/functions/BiFunction;

    iget-object v1, p1, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$SlotPair;->first:Ljava/lang/Object;

    iget-object p1, p1, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$SlotPair;->second:Ljava/lang/Object;
    ...
    check-cast p1, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$SlotPair;
    ...
    .line 154
    iget-object p1, p1, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$SlotPair;->first:Ljava/lang/Object;
    ...
    .line 156
    :cond_1
    iget-object p1, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;->downstream:Lorg/reactivestreams/Subscriber;
