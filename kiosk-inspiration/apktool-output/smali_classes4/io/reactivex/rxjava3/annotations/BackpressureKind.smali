...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v2, v3}, Lio/reactivex/rxjava3/annotations/BackpressureKind;-><init>(Ljava/lang/String;I)V
    ...
    .line 33
    new-instance v2, Lio/reactivex/rxjava3/annotations/BackpressureKind;

    const-string v3, "SPECIAL"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lio/reactivex/rxjava3/annotations/BackpressureKind;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lio/reactivex/rxjava3/annotations/BackpressureKind;->SPECIAL:Lio/reactivex/rxjava3/annotations/BackpressureKind;
    ...
    invoke-direct {v3, v4, v5}, Lio/reactivex/rxjava3/annotations/BackpressureKind;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lio/reactivex/rxjava3/annotations/BackpressureKind;->UNBOUNDED_IN:Lio/reactivex/rxjava3/annotations/BackpressureKind;

    .line 43
    new-instance v4, Lio/reactivex/rxjava3/annotations/BackpressureKind;

    const-string v5, "ERROR"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lio/reactivex/rxjava3/annotations/BackpressureKind;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lio/reactivex/rxjava3/annotations/BackpressureKind;->ERROR:Lio/reactivex/rxjava3/annotations/BackpressureKind;
    ...
    invoke-direct {v5, v6, v7}, Lio/reactivex/rxjava3/annotations/BackpressureKind;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lio/reactivex/rxjava3/annotations/BackpressureKind;->NONE:Lio/reactivex/rxjava3/annotations/BackpressureKind;

    .line 20
    filled-new-array/range {v0 .. v5}, [Lio/reactivex/rxjava3/annotations/BackpressureKind;

    move-result-object v0

    sput-object v0, Lio/reactivex/rxjava3/annotations/BackpressureKind;->$VALUES:[Lio/reactivex/rxjava3/annotations/BackpressureKind;
