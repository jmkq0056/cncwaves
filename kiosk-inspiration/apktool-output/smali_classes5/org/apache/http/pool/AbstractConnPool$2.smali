...
.method public get(JLjava/util/concurrent/TimeUnit;)Lorg/apache/http/pool/PoolEntry;
    ...
    .line 254
    iget-object p2, v9, Lorg/apache/http/pool/AbstractConnPool$2;->this$0:Lorg/apache/http/pool/AbstractConnPool;

    invoke-static {p2}, Lorg/apache/http/pool/AbstractConnPool;->access$400(Lorg/apache/http/pool/AbstractConnPool;)I
    ...
    iget-object v0, v9, Lorg/apache/http/pool/AbstractConnPool$2;->this$0:Lorg/apache/http/pool/AbstractConnPool;

    invoke-static {v0}, Lorg/apache/http/pool/AbstractConnPool;->access$400(Lorg/apache/http/pool/AbstractConnPool;)I
    ...
    invoke-virtual {p2, p1}, Lorg/apache/http/pool/AbstractConnPool;->validate(Lorg/apache/http/pool/PoolEntry;)Z
    ...
    invoke-virtual {p2, p1, v1}, Lorg/apache/http/pool/AbstractConnPool;->release(Lorg/apache/http/pool/PoolEntry;Z)V
    :try_end_3
    ...
    :cond_1
    :try_start_5
    iget-object p2, v9, Lorg/apache/http/pool/AbstractConnPool$2;->done:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 264
    iget-object p2, v9, Lorg/apache/http/pool/AbstractConnPool$2;->entryRef:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 267
    iget-object p2, v9, Lorg/apache/http/pool/AbstractConnPool$2;->val$callback:Lorg/apache/http/concurrent/FutureCallback;

    if-eqz p2, :cond_2

    .line 268
    invoke-interface {p2, p1}, Lorg/apache/http/concurrent/FutureCallback;->completed(Ljava/lang/Object;)V
    :try_end_5
    ...
    invoke-virtual {p2, p1, v2}, Lorg/apache/http/pool/AbstractConnPool;->release(Lorg/apache/http/pool/PoolEntry;Z)V
