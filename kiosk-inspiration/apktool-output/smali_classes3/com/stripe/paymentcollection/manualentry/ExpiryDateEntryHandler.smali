.class public final Lcom/stripe/paymentcollection/manualentry/ExpiryDateEntryHandler;
...
.method public constructor <init>(Lcom/stripe/paymentcollection/PaymentCollectionEventDelegate;Lcom/stripe/paymentcollection/log/PaymentCollectionLogger;)V
    ...
    .line 119
    iput-object p2, p0, Lcom/stripe/paymentcollection/manualentry/ExpiryDateEntryHandler;->logger:Lcom/stripe/paymentcollection/log/PaymentCollectionLogger;

    return-void
.end method

.method private final sendExpiryEntryUiEvent(Lcom/stripe/paymentcollection/manualentry/ManualEntryData;)V
    .locals 6

    .line 135
    invoke-virtual {p0}, Lcom/stripe/paymentcollection/manualentry/ExpiryDateEntryHandler;->getEventDelegate()Lcom/stripe/paymentcollection/PaymentCollectionEventDelegate;
    ...
    .line 137
    new-instance v2, Lcom/stripe/hardware/paymentcollection/ExpiryDateModel;
    ...
    .line 139
    invoke-virtual {p1}, Lcom/stripe/paymentcollection/manualentry/ManualEntryData;->getExpiryDateUnmaskedDigits()Ljava/lang/String;
    ...
    .line 137
    invoke-direct {v2, v3, v4, v5, p1}, Lcom/stripe/hardware/paymentcollection/ExpiryDateModel;-><init>(Lcom/stripe/currency/Amount;Ljava/lang/String;ZLcom/stripe/hardware/paymentcollection/TransactionType;)V
...
.method public onEnter(Lcom/stripe/paymentcollection/manualentry/ManualEntryData;Lcom/stripe/paymentcollection/manualentry/ManualEntryState;)V
    ...
    .line 123
    iget-object p2, p0, Lcom/stripe/paymentcollection/manualentry/ExpiryDateEntryHandler;->logger:Lcom/stripe/paymentcollection/log/PaymentCollectionLogger;

    const/4 v0, 0x0

    new-array v0, v0, [Lkotlin/Pair;

    const-string v1, "ExpiryDateEntryHandler.onEnter"
    ...
    .line 125
    invoke-direct {p0, p1}, Lcom/stripe/paymentcollection/manualentry/ExpiryDateEntryHandler;->sendExpiryEntryUiEvent(Lcom/stripe/paymentcollection/manualentry/ManualEntryData;)V

    .line 126
    invoke-virtual {p0}, Lcom/stripe/paymentcollection/manualentry/ExpiryDateEntryHandler;->sendStartPinEvent()V
...
.method public bridge synthetic onEnter(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/stripe/paymentcollection/manualentry/ExpiryDateEntryHandler;->onEnter(Lcom/stripe/paymentcollection/manualentry/ManualEntryData;Lcom/stripe/paymentcollection/manualentry/ManualEntryState;)V
