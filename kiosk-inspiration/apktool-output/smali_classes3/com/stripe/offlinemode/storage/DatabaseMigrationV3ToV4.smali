.class public final Lcom/stripe/offlinemode/storage/DatabaseMigrationV3ToV4;
.super Lcom/stripe/offlinemode/storage/BaseDatabaseMigration;
.source "DatabaseMigrationV3ToV4.kt"
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/stripe/offlinemode/storage/DatabaseMigrationV3ToV4;",
...
.method public customMigration(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    .line 18
    const-string v0, "DROP INDEX IF EXISTS index_offline_api_request_offline_id"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 19
    const-string v0, "DROP INDEX IF EXISTS index_offline_api_request_connection_id"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 20
    const-string v0, "DROP INDEX IF EXISTS index_offline_api_request_stripe_api_entity_id"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 21
    const-string v0, "DROP INDEX IF EXISTS index_offline_api_request_account_id"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 23
    invoke-virtual {p0, p1}, Lcom/stripe/offlinemode/storage/DatabaseMigrationV3ToV4;->createApiRequestTable(Landroidx/sqlite/db/SupportSQLiteDatabase;)V

    .line 26
    const-string v0, "INSERT INTO offline_api_request ( offline_id, connection_id, stripe_api_entity_id, account_id, type, deleted, data_blob, iv_blob, created_timestamp, id) SELECT offline_id, connection_id, payment_intent_id, account_id, type, deleted, data_blob, iv_blob, created_timestamp, id FROM offline_payment_intent;  "

    .line 25
    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 32
    const-string v0, "DROP TABLE offline_payment_intent;  "
