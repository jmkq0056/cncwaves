...
.method public static createByte(Ljava/lang/String;)Landroid/support/media/ExifInterface$ExifAttribute;
    ...
    invoke-direct {p0, v1, v1, v2}, Landroid/support/media/ExifInterface$ExifAttribute;-><init>(II[B)V
...
.method public static createSLong(ILjava/nio/ByteOrder;)Landroid/support/media/ExifInterface$ExifAttribute;
    ...
    invoke-static {p0, p1}, Landroid/support/media/ExifInterface$ExifAttribute;->createSLong([ILjava/nio/ByteOrder;)Landroid/support/media/ExifInterface$ExifAttribute;
...
.method public static createUShort(ILjava/nio/ByteOrder;)Landroid/support/media/ExifInterface$ExifAttribute;
    ...
    invoke-static {p0, p1}, Landroid/support/media/ExifInterface$ExifAttribute;->createUShort([ILjava/nio/ByteOrder;)Landroid/support/media/ExifInterface$ExifAttribute;
...
.method private getValue(Ljava/nio/ByteOrder;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Landroid/support/media/ExifInterface$ExifAttribute;->bytes:[B

    invoke-direct {v4, v0}, Landroid/support/media/ExifInterface$ByteOrderedDataInputStream;-><init>([B)V
    :try_end_0
    ...
    .line 3052
    :try_start_1
    invoke-virtual {v4, p1}, Landroid/support/media/ExifInterface$ByteOrderedDataInputStream;->setByteOrder(Ljava/nio/ByteOrder;)V
    ...
    .line 3162
    :try_start_2
    invoke-virtual {v4}, Landroid/support/media/ExifInterface$ByteOrderedDataInputStream;->close()V
    :try_end_2
    ...
    .line 3149
    invoke-virtual {v4}, Landroid/support/media/ExifInterface$ByteOrderedDataInputStream;->readDouble()D
    ...
    .line 3142
    invoke-virtual {v4}, Landroid/support/media/ExifInterface$ByteOrderedDataInputStream;->readFloat()F
    ...
    .line 3133
    invoke-virtual {v4}, Landroid/support/media/ExifInterface$ByteOrderedDataInputStream;->readInt()I
    ...
    .line 3119
    invoke-virtual {v4}, Landroid/support/media/ExifInterface$ByteOrderedDataInputStream;->readShort()S
    ...
    .line 3110
    invoke-virtual {v4}, Landroid/support/media/ExifInterface$ByteOrderedDataInputStream;->readUnsignedInt()J
    ...
    .line 3096
    invoke-virtual {v4}, Landroid/support/media/ExifInterface$ByteOrderedDataInputStream;->readUnsignedShort()I
    ...
    .line 3162
    :try_start_8
    invoke-virtual {v3}, Landroid/support/media/ExifInterface$ByteOrderedDataInputStream;->close()V
    :try_end_8
