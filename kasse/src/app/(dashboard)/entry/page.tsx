      ...
      <div className="flex-shrink-0 border-t bg-white safe-area-bottom">
        <div className="flex items-center px-4 py-3 gap-2 max-w-sm mx-auto">
          ...
          {step.id === "review" ? (
            ...
            <button onClick={() => goStep(STEPS.length - 1)} className="w-12 h-12 rounded-xl bg-gray-100 text-brand flex items-center justify-center flex-shrink-0" title="Summary">
